(() => {
  const translations = {
    en: {
      ...
      install_screenshots_lead: 'Load snapdom before Uxnote, on the same page, and every annotation offers a screenshot of the region it is about:',
    ...
    fr: {
      ...
      install_screenshots_lead: 'Chargez snapdom avant Uxnote, sur la même page, et chaque annotation propose une capture de la zone qu’elle vise :',
