(()=>{var Ao=Object.defineProperty,To=Object.defineProperties;var So=Object.getOwnPropertyDescriptors;var Pe=Object.getOwnPropertySymbols;var Mo=Object.prototype.hasOwnProperty,No=Object.prototype.propertyIsEnumerable;var Oe=(d,h,C)=>h in d?Ao(d,h,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[h]=C,Rt=(d,h)=>{for(var C in h||(h={}))Mo.call(h,C)&&Oe(d,C,h[C]);if(Pe)for(var C of Pe(h))No.call(h,C)&&Oe(d,C,h[C]);return d},Be=(d,h)=>To(d,So(h));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),h=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,Fe=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",gt=h("isToolVisibleAtFirstLaunch")||h("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),wt=h("isToolOnTopAtLaunch")||h("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),He=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Ue=h("colorForHighlight")||h("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Pt=h("colorForTextHighligh")||h("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Ot=h("colorForElementHighlight")||h("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Bt="#4e9cf6",K=nt(Ue||Ot||Pt||Bt,Bt),De=nt(Pt||K,K),je=nt(Ot||K,K),xt={text:kt(De,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:kt(je,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:kt(K,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=wt!=null?R(wt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const Ft="wn-toolbar-pos",G=d&&(d.dataset.dock||d.dataset.layout)||"",Ht=`uxnote:site:${C}`,Ut=`uxnote:import-files:${C}`,Dt=`uxnote:hidden:${C}`,bt=`uxnote:pending:${C}`,jt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=jt?{url:jt,apiKey:d&&d.dataset.serverApiKey||""}:null,Kt=R(d&&d.dataset.jsonExport,!0),yt=R(d&&d.dataset.jsonImport,!0),Ke=R(d&&d.dataset.mailExport,!0),Xe=h("isBackdropVisible")||h("isbackdropvisible")||h("backdropVisible")||h("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),qe=.2,Xt=R(Xe,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:xt,customPosition:!1,dimEnabled:Xt,dimOpacity:Xt?qe:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},qt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function Q(){return qt?qt.matches:window.innerWidth<=640}function Yt(){const t=hn();t&&(k=t);const e=gn(),n=gt!=null?!R(gt,!0):null;r.hidden=e!==null?e:n!==null?n:R(He,!1),yt&&(r.importFiles=vn()),Vt(),xn(),Ye(),Ve(),Je(),ot(r.hidden),E?It():Cn(),V(),Nt(),fe(),Vn(),E||Te(),pn()}function Vt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Ye(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,k==="left"&&(p.style.left="18px",p.style.right="auto"),document.body.appendChild(p),r.panel=p,p.style.display="none";const m=p.querySelector(".wn-annot-delete-all");m&&m.addEventListener("click",async g=>{g.stopPropagation(),await Qn()});const y=document.createElement("div");y.className="wn-annot-marker-layer wn-annotator",document.body.appendChild(y),r.markerLayer=y;const f=document.createElement("div");f.className="wn-annot-outline wn-annotator",f.style.display="none",document.body.appendChild(f),r.outlineBox=f;const b=document.createElement("div");b.className="wn-annot-tip wn-annotator",b.textContent="Active mode",document.body.appendChild(b),r.tip=b,t.addEventListener("click",kn),A(),st(),it(),P(),at(),un(),_e()}function Jt(){r.dimOverlay&&r.dimOverlay.classList.toggle("is-visible",!r.hidden)}function Je(){if(!r.dimEnabled||r.dimOverlay)return;const t=document.createElement("div");t.className="wn-annot-dimmer",t.setAttribute("aria-hidden","true"),t.style.setProperty("--wn-dim-opacity",String(r.dimOpacity));const e=document.body.firstChild;e?document.body.insertBefore(t,e):document.body.appendChild(t),r.dimOverlay=t,Jt()}function _t(){if(!r.visibilityToggle)return;const t=r.visibilityToggle,n=Q()&&r.toolbar&&!r.hidden?r.toolbar:document.body;t.parentNode!==n&&(t.parentNode&&t.parentNode.removeChild(t),n===r.toolbar?r.toolbar.insertBefore(t,r.toolbar.firstChild):document.body.appendChild(t))}function _e(){if(r.visibilityToggle)return;const t=document.createElement("button");t.type="button",t.className="wn-annot-visibility-btn wn-annotator",t.setAttribute("aria-label","Masquer Uxnote"),t.setAttribute("data-tip","Masquer Uxnote"),t.innerHTML=Ae(),t.addEventListener("click",Ln),r.visibilityToggle=t,_t(),rt(),re()}function We(){if(r.commentModal)return r.commentModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-comment-card wn-annotator";const n=document.createElement("h4");n.textContent="Add a comment";const o=document.createElement("textarea");o.className="wn-annotator",o.placeholder="Your comment...";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator",i.textContent="Cancel";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",s.textContent="Save",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t),r.commentModal={backdrop:t,modal:e,textarea:o,title:n,okBtn:s,cancelBtn:i},r.commentModal}function tt(){const t=r.commentModal;if(!t||!r.toolbar||!t.backdrop.classList.contains("show"))return;const e=t.modal,n=r.toolbar.getBoundingClientRect(),o=.75*(parseFloat(getComputedStyle(e).fontSize)||16);e.style.left=`${n.left+n.width/2}px`,k==="top"?(e.style.top=`${n.bottom+o}px`,e.style.bottom=""):(e.style.top="",e.style.bottom=`${window.innerHeight-n.top+o}px`)}function Wt(t,e=""){return new Promise(n=>{const o=We(),{backdrop:a,textarea:i,title:s,okBtn:l,cancelBtn:c}=o;s.textContent=t||"Add a comment",i.value=e||"",i.placeholder="Your comment...",a.classList.add("show"),tt(),i.focus(),i.select();const p=b=>{a.classList.remove("show"),l.removeEventListener("click",m),c.removeEventListener("click",y),document.removeEventListener("keydown",f),window.removeEventListener("resize",tt),n(b)},m=()=>{p({comment:i.value.trim()})},y=()=>p(null),f=b=>{b.key==="Escape"&&p(null),b.key==="Enter"&&!(b.shiftKey||b.altKey)&&(b.preventDefault(),m())};l.textContent="Save",c.textContent="Cancel",l.addEventListener("click",m),c.addEventListener("click",y),document.addEventListener("keydown",f),window.addEventListener("resize",tt)})}async function vt(t){const e=await Wt(t);return e||null}function Ze(){if(r.exportModal)return r.exportModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator";const n=document.createElement("h4");n.textContent="Export annotations";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator",o.textContent="The export holds every annotation of this site, on every page.";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator",i.textContent="Cancel";const s=document.createElement("button");s.type="button",s.className="wn-annot-pill primary wn-annotator",s.textContent="Export file",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t);const l=()=>{t.classList.remove("show"),document.removeEventListener("keydown",c)},c=m=>{m.key==="Escape"&&l()},p=m=>{m.target===t&&l()};return i.addEventListener("click",l),t.addEventListener("click",p),s.addEventListener("click",()=>{to(),l()}),r.exportModal={backdrop:t,onKey:c},r.exportModal}function Ge(){if(!Kt)return;const t=Ze();t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function Qe(){if(r.importModal)return r.importModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-import-modal";const n=document.createElement("h4");n.textContent="Import JSON files";const o=document.createElement("div");o.className="wn-annot-import-body wn-annotator";const a=document.createElement("label");a.className="wn-annot-import-drop wn-annotator";const i=document.createElement("input");i.type="file",i.accept="application/json",i.multiple=!0,i.className="wn-annotator";const s=document.createElement("div"),l=document.createElement("div");l.className="wn-annot-import-drop-title wn-annotator",l.textContent="Drop JSON files here";const c=document.createElement("div");c.className="wn-annot-import-drop-sub wn-annotator",c.textContent="or click to select files",s.appendChild(l),s.appendChild(c),a.appendChild(i),a.appendChild(s);const p=document.createElement("div");p.className="wn-annot-import-panel wn-annotator";const m=document.createElement("div");m.className="wn-annot-import-title-row wn-annotator";const y=document.createElement("h5");y.textContent="Loaded files";const f=document.createElement("span");f.className="wn-annot-import-count wn-annotator",f.textContent="0";const b=document.createElement("p");b.textContent="Files are saved automatically.";const g=document.createElement("div");g.className="wn-annot-import-list wn-annotator",m.appendChild(y),m.appendChild(f),p.appendChild(m),p.appendChild(b),p.appendChild(g);const u=document.createElement("div");u.className="wn-annot-actions wn-annotator";const w=document.createElement("button");w.type="button",w.className="wn-annot-pill cancel wn-annotator",w.textContent="Close",u.appendChild(w),o.appendChild(a),o.appendChild(p),e.appendChild(n),e.appendChild(o),e.appendChild(u),t.appendChild(e),document.body.appendChild(t);const L=()=>{t.classList.remove("show"),document.removeEventListener("keydown",N)},N=x=>{x.key==="Escape"&&L()},Z=x=>{x.target===t&&L()};return w.addEventListener("click",L),t.addEventListener("click",Z),["dragenter","dragover"].forEach(x=>{a.addEventListener(x,v=>{v.preventDefault(),v.stopPropagation(),a.classList.add("dragover")})}),["dragleave","drop"].forEach(x=>{a.addEventListener(x,v=>{v.preventDefault(),v.stopPropagation(),a.classList.remove("dragover")})}),a.addEventListener("drop",x=>{var ht;const v=(ht=x.dataTransfer)==null?void 0:ht.files;v&&v.length&&Zt(Array.from(v))}),i.addEventListener("change",x=>{const v=x.target.files;v&&v.length&&Zt(Array.from(v)),i.value=""}),g.addEventListener("click",x=>{const v=x.target.closest("[data-import-remove]");v&&an(v.dataset.importRemove)}),r.importModal={backdrop:t,modal:e,fileInput:i,fileList:g,filesCount:f,onKey:N,close:L},r.importModal}function tn(){if(!yt)return;const t=Qe();et(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function et(){if(!r.importModal)return;const{fileList:t,filesCount:e}=r.importModal,{fileCounts:n}=en();if(t.innerHTML="",r.importFiles.length)r.importFiles.forEach(o=>{const a=document.createElement("div");a.className="wn-annot-import-card wn-annotator";const i=document.createElement("div");i.className="wn-annot-import-meta wn-annotator";const s=document.createElement("div");s.className="wn-annot-import-name wn-annotator",s.textContent=o.name;const l=document.createElement("div");l.className="wn-annot-import-sub wn-annotator";const c=n.get(o.id)||0,p=o.pageUrl?` | ${ln(o.pageUrl,36)}`:"";l.textContent=`${c} comments | ${sn(o.size)}${p}`,i.appendChild(s),i.appendChild(l);const m=document.createElement("div");m.className="wn-annot-import-actions wn-annotator";const y=document.createElement("div");y.className="wn-annot-import-badge wn-annotator",y.textContent=String(c);const f=document.createElement("button");f.type="button",f.className="wn-annot-import-remove wn-annotator",f.dataset.importRemove=o.id,f.textContent="x",m.appendChild(y),m.appendChild(f),a.appendChild(i),a.appendChild(m),t.appendChild(a)});else{const o=document.createElement("div");o.className="wn-annot-import-empty wn-annotator",o.textContent="No imported files yet.",t.appendChild(o)}e.textContent=String(r.importFiles.length)}function en(){const t=new Map;return r.annotations.forEach(e=>{e.importFileId&&t.set(e.importFileId,(t.get(e.importFileId)||0)+1)}),{fileCounts:t}}async function Zt(t){if(!t||!t.length)return;const e=new Set(r.annotations.map(o=>o.id));let n=0;for(const o of t){const a=await nn(o,e);if(!a)continue;const{fileMeta:i,annotations:s}=a;s.length&&(r.importFiles.push(i),r.annotations.push(...s),n+=s.length)}if(!n){et();return}M(),oe(),q(),V(),F(),et()}async function nn(t,e){let n;try{const c=await t.text();n=JSON.parse(c)}catch(c){return await Qt(`Invalid JSON in ${t.name}.`,"Import error"),null}const o=Array.isArray(n)?n:n.annotations;if(!Array.isArray(o))return await Qt(`Unsupported JSON format in ${t.name}.`,"Import error"),null;const a=Array.isArray(n)?t.lastModified:n.createdAt,i=Array.isArray(n)?"":n.pageUrl||"",s=ye(),l=o.filter(Lt).map(c=>on(c,{createdAt:a,pageUrl:i,fileId:s,existingIds:e}));return{fileMeta:{id:s,name:t.name,size:t.size,pageUrl:i,importedAt:Date.now()},annotations:l}}function on(t,e){const n=t&&typeof t=="object"?t:{},o=n.pageUrl||e.pageUrl||window.location.href,a=rn(n.id,e.existingIds),i=Be(Rt({},n),{id:a,createdAt:n.createdAt||e.createdAt||Date.now(),pageUrl:o,importFileId:e.fileId});return i.pageKey||(i.pageKey=T(o)),i}function rn(t,e){if(t&&!e.has(t))return e.add(t),t;let n;do n=pt();while(e.has(n));return e.add(n),n}function an(t){const e=r.importFiles.filter(n=>n.id!==t);e.length!==r.importFiles.length&&(r.importFiles=e,r.annotations=r.annotations.filter(n=>n.importFileId!==t),M(),oe(),q(),V(),F(),et())}function sn(t){if(!t)return"0 B";const e=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),e.length-1),o=t/Math.pow(1024,n);return`${o.toFixed(o<10&&n>0?1:0)} ${e[n]}`}function ln(t,e){return typeof t!="string"?"":t.length<=e?t:t.slice(0,e-3)+"..."}function cn(){if(r.dialogModal)return r.dialogModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator";const n=document.createElement("h4");n.className="wn-annotator";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t),r.dialogModal={backdrop:t,modal:e,title:n,message:o,okBtn:s,cancelBtn:i},r.dialogModal}function Gt({title:t="Information",message:e="",okLabel:n="OK",cancelLabel:o="Cancel",dismissOnBackdrop:a=!0}){return new Promise(i=>{const{backdrop:s,title:l,message:c,okBtn:p,cancelBtn:m}=cn();l.textContent=t,c.textContent=e,p.textContent=n;const y=!!o;m.style.display=y?"inline-flex":"none",m.textContent=o||"";const f=L=>{s.classList.remove("show"),p.removeEventListener("click",b),m.removeEventListener("click",g),s.removeEventListener("click",u),document.removeEventListener("keydown",w),i(L)},b=()=>f(!0),g=()=>f(!1),u=L=>{L.target===s&&a&&f(!1)},w=L=>{L.key==="Escape"&&f(!1),(L.metaKey||L.ctrlKey)&&L.key==="Enter"&&b()};p.addEventListener("click",b),m.addEventListener("click",g),s.addEventListener("click",u),document.addEventListener("keydown",w),s.classList.add("show"),p.focus()})}async function dn(t,e="Confirmation"){return Gt({title:e,message:t,okLabel:"Confirm",cancelLabel:"Cancel"})}async function Qt(t,e="Information"){await Gt({title:e,message:t,okLabel:"OK",cancelLabel:null})}function pn(){document.addEventListener("mouseup",At),document.addEventListener("touchend",At),document.addEventListener("pointerup",At),document.addEventListener("mousemove",Tn),document.addEventListener("click",Sn,!0),window.addEventListener("resize",$),window.addEventListener("resize",st),window.addEventListener("resize",it),window.addEventListener("resize",P),window.addEventListener("resize",rt),window.addEventListener("scroll",$,{passive:!0}),bo()}function un(){if(!r.panel)return;const t=r.panel.querySelector("#wn-filter-search");if(!t)return;t.value=r.filters.query;const e=()=>{r.filters.query=t.value.trim().toLowerCase(),A()};t.addEventListener("input",e)}function O(t,e={}){const n=e.keepOutline;if(r.mode===t){r.mode=null,te(),Ct(),n||lt();return}r.mode=t,te(),mn(t),t!=="element"&&lt()}function te(){r.toolbar.querySelectorAll('button[data-action="mode"]').forEach(e=>{e.getAttribute("data-mode")===r.mode?e.classList.add("active"):e.classList.remove("active")})}function mn(t){let e="";if(t==="text"?e="Select text then release to add a note.":t==="element"&&(e="Hover an element, click to annotate."),!e)return Ct();r.tip.textContent=e,r.tip.classList.add("show"),P(),requestAnimationFrame(P),requestAnimationFrame(P)}function Ct(){r.tip.classList.remove("show")}function fn(){if(r.toast)return r.toast;const t=document.createElement("div");return t.className="wn-annot-toast wn-annotator",t.setAttribute("aria-live","polite"),document.body.appendChild(t),r.toast=t,t}function B(t){if(!t)return;const e=fn();e.textContent=t,e.classList.add("show"),r.toastTimer&&clearTimeout(r.toastTimer),r.toastTimer=setTimeout(()=>{e.classList.remove("show")},2200)}function hn(){try{const t=localStorage.getItem(Ft);if(t==="top"||t==="bottom")return t}catch(t){}return null}function gn(){try{const t=localStorage.getItem(Dt);return t==null?null:t==="true"}catch(t){return null}}function wn(t){try{localStorage.setItem(Dt,t?"true":"false")}catch(e){}}function xn(){if(!document||!document.documentElement)return;const t=document.documentElement,e=r.colors||xt,n=(i,s)=>{s&&t.style.setProperty(i,s)},o=e.text,a=e.element;n("--wn-text-highlight",o.base),n("--wn-text-highlight-overlay",o.overlay),n("--wn-text-highlight-soft",o.soft),n("--wn-element-highlight",a.base),n("--wn-element-highlight-soft",a.soft),n("--wn-element-highlight-soft-end",a.softer),n("--wn-element-highlight-strong",a.strong),n("--wn-element-highlight-shadow",a.shadow),n("--wn-marker-text",a.text)}function kt(t,e={}){var s,l,c;const n=nt(t,"#000000"),o=(s=e.softAlpha)!=null?s:.12,a=(l=e.softerAlpha)!=null?l:.04,i=(c=e.overlayAlpha)!=null?c:.7;return{base:n,overlay:S(n,i,S("#000000",i)),soft:S(n,o,S("#000000",o)),softer:S(n,a,S("#000000",a)),strong:S(n,.9,n),shadow:S(n,.24,"rgba(0,0,0,0.24)"),pill:S(n,.16,"rgba(0,0,0,0.16)"),pillBorder:S(n,.28,"rgba(0,0,0,0.28)"),text:bn(n)}}function nt(t,e){const n=Et(t);return n||Et(e)||"#000000"}function Et(t){if(!t||typeof t!="string")return null;const n=t.trim().match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i);if(!n)return null;const o=n[1];return`#${(o.length===3?o.split("").map(i=>i+i).join(""):o).toLowerCase()}`}function ee(t){const e=Et(t);if(!e)return null;const n=parseInt(e.slice(1),16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function S(t,e=1,n=""){const o=ee(t);if(!o)return n||"";const a=typeof e=="number"&&e>=0&&e<=1?e:1;return`rgba(${o.r}, ${o.g}, ${o.b}, ${a})`}function bn(t){const e=ee(t);return e?.299*e.r+.587*e.g+.114*e.b>160?"#0b1622":"#ffffff":"#0b1622"}function I(t){const e=r.colors||xt,n=t&&t.type;return n==="text"?e.text:n==="screenshot"?e.screenshot:e.element}function ne(t,e){!t||!e||(t.style.setProperty("--wn-marker-bg",e.base),t.style.setProperty("--wn-marker-text",e.text),t.style.setProperty("--wn-marker-shadow",e.shadow))}function yn(t,e){!t||!e||(t.style.setProperty("--wn-item-accent",e.base),t.style.setProperty("--wn-item-accent-strong",e.strong),t.style.setProperty("--wn-item-accent-shadow",e.shadow),t.style.setProperty("--wn-item-accent-soft",e.soft),t.style.setProperty("--wn-item-accent-soft-end",e.softer),t.style.setProperty("--wn-item-number-bg",e.pill),t.style.setProperty("--wn-item-number-border",e.pillBorder),t.style.setProperty("--wn-item-number-text","#000000"))}function R(t,e=!1){if(t==null||t==="")return e;const n=String(t).toLowerCase();return n==="true"||n==="1"||n==="yes"||n==="on"?!0:n==="false"||n==="0"||n==="no"||n==="off"?!1:e}function vn(){try{const t=localStorage.getItem(Ut),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>n&&typeof n=="object").map(n=>({id:n.id||ye(),name:String(n.name||"Imported file"),size:Number(n.size||0),pageUrl:typeof n.pageUrl=="string"?n.pageUrl:"",importedAt:Number(n.importedAt||0)})):[]}catch(t){return[]}}function oe(){try{localStorage.setItem(Ut,JSON.stringify(r.importFiles||[]))}catch(t){}}function P(){if(!r.tip||!r.toolbar)return;const t=r.toolbar.getBoundingClientRect(),e=r.tip,n=10,o=t.left+t.width/2,a=k==="bottom";e.style.left=`${o}px`,e.style.right="",e.style.transform="translateX(-50%)",e.style.top="",e.style.bottom="";const i=e.getBoundingClientRect();if(a){const s=Math.max(8,t.top-n-i.height);e.style.top=`${s}px`}else{const s=t.bottom+n;e.style.top=`${s}px`}}function Lt(t){return!!t&&(t.type==="text"||t.type==="element"||t.type==="screenshot")}function Cn(){try{const t=localStorage.getItem(Ht),e=t?JSON.parse(t):[];r.annotations=(e||[]).filter(Lt),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=T(n.pageUrl||window.location.href))})}catch(t){console.warn("Annotator storage error",t),r.annotations=[]}}function M(){if(E){$e();return}try{localStorage.setItem(Ht,JSON.stringify(r.annotations))}catch(t){console.warn("Annotator storage save error",t)}}async function kn(t){const e=t.target.closest("button");if(!e||!e.classList.contains("wn-annotator"))return;const n=e.getAttribute("data-action");if(n){if(n==="mode"){const o=e.getAttribute("data-mode");if(o==="screenshot"){await Co();return}O(o);return}if(n==="export"){Ge();return}if(n==="import"){tn();return}if(n==="mail"){await eo();return}if(n==="toggle-panel"){En();return}if(n==="toggle-pos"){An(k==="bottom"?"top":"bottom"),ae();return}}}function En(){const t=r.panel.style.display==="none";r.panel.style.display=t?"":"none",at()}function Ln(){ot(!r.hidden)}function ot(t){r.hidden=t,wn(t),document.body.classList.toggle("wn-annot-hidden",t),t&&(O(null),Ct(),lt()),re(),Jt(),rt(),st(),t||($(),it(),P()),document.dispatchEvent(new CustomEvent("uxnote:visibility",{detail:{hidden:t}}))}function re(){if(!r.visibilityToggle)return;const t=r.hidden?"Show Uxnote":"Hide Uxnote";r.visibilityToggle.classList.toggle("is-muted",r.hidden),r.visibilityToggle.innerHTML=r.hidden?mo():Ae(),r.visibilityToggle.setAttribute("aria-label",t),r.visibilityToggle.setAttribute("aria-pressed",r.hidden?"true":"false"),r.visibilityToggle.setAttribute("data-tip",t)}function rt(){const t=r.visibilityToggle;if(!t)return;_t();const e=18;if(Q()){r.hidden?(t.style.bottom=`${e}px`,t.style.left=`${e}px`,t.style.top="",t.style.right=""):(t.style.top="",t.style.right="",t.style.bottom="",t.style.left="");return}t.style.left="",t.style.right="",k==="top"?(t.style.top=`${e}px`,t.style.bottom=""):(t.style.bottom=`${e}px`,t.style.top="")}function at(){if(!r.panel||!r.toolbar)return;const t=r.toolbar.querySelector('button[data-action="toggle-panel"]');if(!t)return;const e=r.panel.style.display==="none";t.classList.toggle("active",!e)}function it(){if(!r.panel||!r.toolbar)return;const t=r.panel,e=18,n=r.toolbar.getBoundingClientRect();if(Q()){t.style.width="100vw",t.style.maxHeight="100vh",t.style.height="100vh",t.style.left="0",t.style.right="0",t.style.top="0",t.style.bottom="0",t.style.borderRadius="0";return}t.style.width=`min(360px, calc(100vw - ${e*2}px))`,t.style.maxHeight=`calc(100vh - ${e*2}px)`,t.style.left="auto",t.style.right=`${e}px`,t.style.top=`${e}px`,t.style.bottom=`${e}px`,t.style.height="",t.style.borderRadius="",k==="left"?(t.style.left=`${n.width+e}px`,t.style.right=`${e}px`):k==="right"&&(t.style.right=`${n.width+e}px`,t.style.left=`${e}px`)}function An(t){k=t==="top"?"top":"bottom";const e=r.toolbar;e&&(e.classList.remove("wn-pos-top","wn-pos-bottom","wn-pos-left","wn-pos-right"),e.classList.add(`wn-pos-${k}`));try{localStorage.setItem(Ft,k)}catch(n){}ae(),rt(),P(),tt(),it(),st()}function ae(){if(!r.toolbar)return;const t=r.toolbar.querySelector('button[data-action="toggle-pos"]');t&&(t.innerHTML=k==="top"?Ee():Le())}function st(){if(!r.toolbar||r.customPosition||!(G==="push"||G==="dock"||G==="pad"||G==="true"))return;const t=document.body;r.basePadding||Vt();const e=r.basePadding;if(r.hidden){t.style.paddingTop=`${e.top}px`,t.style.paddingRight=`${e.right}px`,t.style.paddingBottom=`${e.bottom}px`,t.style.paddingLeft=`${e.left}px`;return}const n=r.toolbar.getBoundingClientRect(),o=Rt({},e);k==="top"?o.top=e.top+n.height:k==="bottom"?o.bottom=e.bottom+n.height:k==="left"?o.left=e.left+n.width:k==="right"&&(o.right=e.right+n.width),t.style.paddingTop=`${o.top}px`,t.style.paddingRight=`${o.right}px`,t.style.paddingBottom=`${o.bottom}px`,t.style.paddingLeft=`${o.left}px`}async function At(){if(r.mode!=="text")return;const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return;const e=t.getRangeAt(0);if(!e)return;if(!(H(e.commonAncestorContainer)&&H(e.startContainer)&&H(e.endContainer))){t.removeAllRanges(),B("Cette zone est une popup/overlay, annotation bloqu\xE9e.");return}const o=t.toString().trim();if(!o)return;const a=await vt("Comment for this highlight?");if(!a)return;const{comment:i}=a,s=pt(),l=$n(e,o),c=ct(e,s);t.removeAllRanges();const p={id:s,type:"text",target:l,comment:i.trim(),snippet:o.slice(0,180),pageUrl:window.location.href,pageKey:T(window.location.href),createdAt:Date.now(),status:"active"};r.annotations.push(p),M(),U(p,c),A(),O(null,{keepOutline:!0})}function Tn(t){if(r.mode!=="element")return;const e=t.target;if(!e||!H(e)){lt();return}const n=e.getBoundingClientRect();Nn(n)}async function Sn(t){if(r.mode!=="element")return;const e=t.target;if(!e||!H(e)){B("Cette zone est une popup/overlay, annotation bloqu\xE9e.");return}t.preventDefault(),t.stopPropagation();const n=await vt("Comment for this element?");if(!n)return;const{comment:o}=n,a=pt(),i=St(e),s=Bn(e),l=e.getBoundingClientRect(),c={id:a,type:"element",target:{xpath:i,css:s,tag:e.tagName.toLowerCase()},comment:o.trim(),snippet:e.innerText?e.innerText.trim().slice(0,120):e.tagName,pageUrl:window.location.href,pageKey:T(window.location.href),rect:{x:l.x+window.scrollX,y:l.y+window.scrollY,w:l.width,h:l.height},createdAt:Date.now(),status:"active"};r.annotations.push(c),M(),U(c,e),ue(e,a),A(),O(null,{keepOutline:!0})}function Tt(t){const e=t&&t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}}function X(t){const e=r.highlightSpans[t];return e?Array.isArray(e)?e:[e]:Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`))}function q(){Object.keys(r.highlightSpans||{}).forEach(t=>{X(t).forEach(e=>{e&&e.parentNode&&Tt(e)})}),r.highlightSpans={},Array.from(document.querySelectorAll(".uxnote-textmark[data-uxnote-id], .wn-annot-highlight[data-wn-annot-id]")).forEach(t=>{t&&t.parentNode&&Tt(t)}),Object.values(r.markers||{}).forEach(t=>{t&&t.el&&t.el.parentNode&&t.el.parentNode.removeChild(t.el)}),r.markerLayer&&(r.markerLayer.innerHTML=""),r.markers={},Object.keys(r.elementTargets||{}).forEach(t=>{me(t)}),r.elementTargets={},Array.from(document.querySelectorAll(".uxnote-annotated[data-uxnote-ids]")).forEach(t=>{delete t.dataset.uxnoteIds,t.classList.remove("uxnote-annotated")})}function Mn(t){const e=r.markers[t];e&&e.el&&e.el.parentNode&&e.el.parentNode.removeChild(e.el),e&&e.frame&&e.frame.parentNode&&e.frame.parentNode.removeChild(e.frame),delete r.markers[t],me(t);let n=X(t);n.length||(n=Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)),n.length||(n=Array.from(document.querySelectorAll(`.wn-annot-highlight[data-wn-annot-id="${t}"]`)))),n.forEach(o=>{o&&Tt(o)}),delete r.highlightSpans[t]}function F(){Object.entries(r.markers).forEach(([t,e])=>{const n=r.annotations.findIndex(o=>o.id===t);n!==-1&&(e.el.textContent=n+1)})}function Nn(t){const e=r.outlineBox;e.style.display="block",e.style.left=`${t.x+window.scrollX}px`,e.style.top=`${t.y+window.scrollY}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`}function lt(){r.outlineBox.style.display="none"}function ie(t){return t?t.classList&&t.classList.contains("wn-annotator")||t.parentElement&&ie(t.parentElement):!1}function H(t){if(!t)return!1;const e=t.nodeType===Node.ELEMENT_NODE?t:t.nodeType===Node.DOCUMENT_NODE?document.body:t.parentElement;if(!e||ie(e))return!1;if(e.closest){if(e.closest("[data-uxnote-ignore]"))return!1;if(e.closest("[data-uxnote-allow]"))return!0;if(e.closest('#uxnote-root, .wn-annotator, dialog, [popover], [role="dialog"], [role="menu"], [role="tooltip"], [aria-modal="true"]'))return!1}return!0}function $n(t,e){return{startXPath:St(t.startContainer),startOffset:t.startOffset,endXPath:St(t.endContainer),endOffset:t.endOffset,quote:e?String(e).slice(0,200):""}}function ct(t,e){let n=[];const o=t.cloneRange();if(zn(o).forEach(i=>{const s=In(i,{start:i===o.startContainer?o.startOffset:0,end:i===o.endContainer?o.endOffset:i.length},e);s&&n.push(s)}),!n.length){const i=document.createElement("span");i.className="uxnote-textmark",i.dataset.uxnoteId=e,i.addEventListener("click",l=>{l.stopPropagation(),_(e)});const s=o.extractContents();i.appendChild(s),o.insertNode(i),n=[i]}return r.highlightSpans[e]=n,n[0]}function Io(t,e){return ct(t,e)}function se(t,e){const n=document.createRange();return n.selectNodeContents(e),t.compareBoundaryPoints(Range.END_TO_START,n)>0&&t.compareBoundaryPoints(Range.START_TO_END,n)<0}function zn(t){const e=[],n=document.createTreeWalker(t.commonAncestorContainer,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();)if(!(!o.nodeValue||!o.nodeValue.trim())){try{if(t.intersectsNode){if(!t.intersectsNode(o))continue}else if(!se(t,o))continue}catch(a){if(!se(t,o))continue}e.push(o)}return e}function In(t,e,n){if(!t||!t.parentNode)return null;const{start:o,end:a}=e;let i=t,s=a;if(o>0&&(i=i.splitText(o),s=a-o),s<i.length&&i.splitText(s),!i.parentNode)return null;const l=document.createElement("span");return l.className="uxnote-textmark",l.dataset.uxnoteId=n,l.addEventListener("click",c=>{c.stopPropagation(),_(n)}),i.parentNode.insertBefore(l,i),l.appendChild(i),l}function le(t){return t?typeof t.isConnected=="boolean"?t.isConnected:document.body&&document.body.contains(t):!1}function Rn(t,e){if(!t||!e)return null;const n=Math.max(t.x,e.x),o=Math.max(t.y,e.y),a=Math.min(t.x+t.width,e.x+e.width),i=Math.min(t.y+t.height,e.y+e.height),s=a-n,l=i-o;return s<=0||l<=0?null:{x:n,y:o,width:s,height:l}}function ce(t){if(!t||!le(t)||!t.getBoundingClientRect)return null;let e=t.getBoundingClientRect();if(!e.width||!e.height)return null;let n=t;for(;n&&n.nodeType===1;){if(n.tagName==="DETAILS"&&!n.open){const p=n.querySelector("summary");if(p&&!p.contains(t))return null}if(n.hasAttribute&&n.hasAttribute("hidden")||(n.getAttribute&&n.getAttribute("aria-hidden"))==="true")return null;const a=window.getComputedStyle(n);if(a.display==="none"||a.visibility==="hidden"||a.visibility==="collapse"||a.opacity==="0")return null;const i=a.overflowX||a.overflow,s=a.overflowY||a.overflow;if(i&&i!=="visible"||s&&s!=="visible"){const p=n.getBoundingClientRect(),m=Rn(e,p);if(!m)return null;e=m}n=n.parentElement}return e}function Pn(t){let e=t&&t.nodeType===1?t:null;for(;e&&e.nodeType===1&&e!==document.body;){const n=window.getComputedStyle(e),o=n.zIndex;if(n.position!=="static"&&o!=="auto"||n.opacity!=="1"||n.transform!=="none"||n.filter!=="none"||n.perspective!=="none"||n.mixBlendMode!=="normal"||n.isolation==="isolate"||n.willChange&&n.willChange!=="auto"||n.contain&&n.contain!=="none")return e;e=e.parentElement}return document.body}function de(t){if(!t||t.nodeType!==1)return r.markerLayer||document.body;const e=t.offsetParent;return e&&e.nodeType===1?e:Pn(t)||r.markerLayer||document.body}function pe(t){return t===document.body||t===r.markerLayer||t===document.documentElement}function On(t){if(!t||t.nodeType!==1)return!1;let e=!1,n=t;for(;n&&n.nodeType===1&&n!==document.body;){if(n.tagName==="DETAILS"&&!n.open&&(n.open=!0,e=!0),n.tagName==="DIALOG"&&!n.open)try{typeof n.showModal=="function"?n.showModal():typeof n.show=="function"&&n.show(),e=!0}catch(a){}if(n.hasAttribute&&n.hasAttribute("popover"))try{typeof n.showPopover=="function"&&(n.showPopover(),e=!0)}catch(a){}if(n.hasAttribute&&n.hasAttribute("data-uxnote-open")){const a=n.getAttribute("data-uxnote-open");if(a){const i=document.querySelector(a);i&&typeof i.click=="function"&&(i.click(),e=!0)}}const o=n.getAttribute&&n.getAttribute("aria-hidden");if(n.hasAttribute&&n.hasAttribute("hidden")||o==="true"){const a=n.id;if(a){const i=document.querySelector(`[aria-controls="${dt(a)}"]`);i&&typeof i.click=="function"&&(i.click(),e=!0)}}n=n.parentElement}return e}function ue(t,e){if(!t||t.nodeType!==1)return!1;const n=t.dataset.uxnoteIds?t.dataset.uxnoteIds.split(",").filter(Boolean):[],o=new Set(n);return o.add(e),t.dataset.uxnoteIds=Array.from(o).join(","),t.classList.add("uxnote-annotated"),r.elementTargets[e]=t,!0}function me(t){const e=r.elementTargets[t];if(!e||e.nodeType!==1){delete r.elementTargets[t],Array.from(document.querySelectorAll("[data-uxnote-ids]")).forEach(i=>{const s=i.dataset.uxnoteIds?i.dataset.uxnoteIds.split(",").filter(Boolean):[];if(!s.includes(t))return;const l=s.filter(c=>c!==t);l.length?i.dataset.uxnoteIds=l.join(","):(delete i.dataset.uxnoteIds,i.classList.remove("uxnote-annotated"))});return}const o=(e.dataset.uxnoteIds?e.dataset.uxnoteIds.split(",").filter(Boolean):[]).filter(a=>a!==t);o.length?e.dataset.uxnoteIds=o.join(","):(delete e.dataset.uxnoteIds,e.classList.remove("uxnote-annotated")),delete r.elementTargets[t]}function St(t){if(t===document.body)return"/html/body";const e=[];for(;t&&t!==document;){let n=1,o=t.previousSibling;for(;o;)o.nodeType===t.nodeType&&o.nodeName===t.nodeName&&n++,o=o.previousSibling;const a=t.nodeType===3?"text()":t.nodeName.toLowerCase();if(e.unshift(`${a}[${n}]`),t=t.parentNode,!t||t.nodeType!==1)break}return"/"+e.join("/")}function dt(t){return window.CSS&&typeof window.CSS.escape=="function"?window.CSS.escape(t):String(t).replace(/[^a-zA-Z0-9_-]/g,"\\$&")}function Bn(t){if(!t||t.nodeType!==1)return"";if(t.id)return`#${dt(t.id)}`;const e=[];let n=t,o=0;for(;n&&n.nodeType===1&&o<4;){let a=n.tagName.toLowerCase();const i=Array.from(n.classList||[]).filter(s=>s&&!s.startsWith("wn-")&&!s.startsWith("uxnote-"));if(i.length&&(a+=`.${i.slice(0,2).map(dt).join(".")}`),e.unshift(a),n.parentElement&&n.parentElement.id){e.unshift(`#${dt(n.parentElement.id)}`);break}n=n.parentElement,o+=1}return e.join(" > ")}function Y(t){try{const e=document;return e.evaluate(t,e,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue}catch(e){return null}}function V(){r.annotations.forEach(t=>{t.pageKey===T(window.location.href)&&Fn(t)}),A()}function Fn(t){const e=J(t);if(!e){t.status="missing",fe();return}t.status="active",Mt(t,e)}function Mt(t,e){if(e){if(e.type==="screenshot"){U(t,null);return}if(e.type==="text"&&e.range){const n=ct(e.range,t.id);U(t,n);return}e.type==="element"&&e.el&&(ue(e.el,t.id),U(t,e.el))}}function Hn(t){if(!t)return null;const e=Y(t.startXPath),n=Y(t.endXPath);if(!e||!n)return null;try{const o=document.createRange();return o.setStart(e,t.startOffset),o.setEnd(n,t.endOffset),o}catch(o){return null}}function J(t){return t?t.type==="screenshot"?t.rect?{type:"screenshot"}:null:t.target?t.type==="text"?Un(t):t.type==="element"?jn(t):null:null:null}function Un(t){const e=t.target||{},n=Hn(e);if(n)return{type:"text",range:n};const o=e.quote||t.snippet||"";if(!o)return null;const a=Dn(o);return a?{type:"text",range:a}:null}function Dn(t){const e=String(t||"").trim();if(!e||e.length<4)return null;const n=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();){if(!o.nodeValue||!o.nodeValue.trim()||!H(o))continue;const a=o.nodeValue.indexOf(e);if(a===-1)continue;const i=document.createRange();return i.setStart(o,a),i.setEnd(o,a+e.length),i}return null}function jn(t){const e=t.target||{};if(e.xpath){const a=Y(e.xpath);if(a&&a.nodeType===1)return{type:"element",el:a}}if(e.css)try{const a=document.querySelector(e.css);if(a&&a.nodeType===1)return{type:"element",el:a}}catch(a){}const n=e.tag,o=(t.snippet||"").trim();if(n&&o){const a=document.querySelectorAll(n);for(const i of a)if(!(!i||i.nodeType!==1)&&(i.textContent||"").includes(o))return{type:"element",el:i}}return null}function Kn(){r.missingRetryTimer&&clearTimeout(r.missingRetryTimer),r.missingRetryTimer=setTimeout(()=>{Nt()},300)}function fe(){r.missingObserver||!window.MutationObserver||(r.missingObserver=new MutationObserver(()=>{r.annotations.some(t=>t.status==="missing")&&Kn()}),r.missingObserver.observe(document.body,{childList:!0,subtree:!0}))}function Xn(){r.missingObserver&&(r.missingObserver.disconnect(),r.missingObserver=null)}function Nt(){let t=!1;r.annotations.forEach(e=>{if(e.status!=="missing"||e.pageKey!==T(window.location.href))return;const n=J(e);n&&(e.status="active",Mt(e,n),t=!0)}),t&&(M(),A(),$()),r.annotations.some(e=>e.status==="missing")||Xn()}function qn(){let t=!1;r.annotations.forEach(e=>{if(e.type!=="text"||e.pageKey!==T(window.location.href))return;const n=X(e.id).filter(le);if(n.length){r.highlightSpans[e.id]=n,e.status==="missing"&&(e.status="active",t=!0);return}const o=J(e);if(o&&o.range){ct(o.range,e.id),e.status="active",t=!0;return}e.status!=="missing"&&(e.status="missing",t=!0)}),t&&(M(),A(),$())}function Yn(){r.layoutTimer&&clearTimeout(r.layoutTimer),r.layoutTimer=setTimeout(()=>{$(),qn(),r.annotations.some(t=>t.status==="missing")&&Nt()},120)}function Vn(){r.layoutObserver||!window.MutationObserver||(r.layoutObserver=new MutationObserver(t=>{t.some(n=>{const o=n.target;return!(!o||o.classList&&o.classList.contains("wn-annotator")||o.closest&&o.closest(".wn-annotator"))})&&Yn()}),r.layoutObserver.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class","open","hidden","aria-hidden"]}))}function U(t,e){if(t.pageKey!==T(window.location.href)||!r.markerLayer)return;const n=r.markers[t.id];n&&n.el&&n.el.parentNode&&n.el.parentNode.removeChild(n.el);const o=document.createElement("div");o.className="wn-annot-marker wn-annotator",o.textContent=r.annotations.findIndex(c=>c.id===t.id)+1,o.dataset.wnAnnotId=t.id;const a=I(t);ne(o,a),o.addEventListener("click",()=>_(t.id));const i=ge(t,e),s=he(t,i),l=de(i&&i.anchor?i.anchor:e);if(o.parentNode!==l&&l.appendChild(o),o.style.zIndex=pe(l)?"":"9999",!i){o.style.display="none",r.markers[t.id]={el:o,rect:null,frame:s};return}o.style.display="",we(o,i,t),r.markers[t.id]={el:o,rect:i,frame:s}}function he(t,e){const n=r.markers[t.id];let o=n?n.frame:null;if(t.type!=="screenshot"||!e)return o&&o.parentNode&&o.parentNode.removeChild(o),null;o||(o=document.createElement("div"),o.className="wn-annot-shot-frame wn-annotator");const a=r.markerLayer||document.body;return o.parentNode!==a&&a.appendChild(o),o.style.setProperty("--wn-shot-frame",I(t).base),o.style.left=`${e.x}px`,o.style.top=`${e.y}px`,o.style.width=`${e.w}px`,o.style.height=`${e.h}px`,o}function ge(t,e){var n;if(t.type==="text"){const a=(e?[e]:X(t.id))[0]||document.querySelector(`.uxnote-textmark[data-uxnote-id="${t.id}"]`);if(!a)return null;const i=ce(a);return i?{x:i.x,y:i.y,w:i.width,h:i.height,anchor:a}:null}if(t.type==="element"){const o=(e&&e.nodeType===1?e:null)||r.elementTargets[t.id]||((n=t.target)!=null&&n.xpath?Y(t.target.xpath):null);if(!o)return null;const a=ce(o);return a?{x:a.x,y:a.y,w:a.width,h:a.height,anchor:o}:null}if(t.type==="screenshot"){const o=t.rect;return o?{x:o.x-window.scrollX,y:o.y-window.scrollY,w:o.w,h:o.h,anchor:null}:null}return null}function we(t,e,n){const o=Jn(n),i=(t.offsetParent||document.body).getBoundingClientRect(),s=i.x+window.scrollX,l=i.y+window.scrollY,c=e.x+window.scrollX,p=e.y+window.scrollY;t.style.left=`${c-s+e.w+o.x+4}px`,t.style.top=`${p-l+o.y-4}px`}function Jn(t){if(t.type!=="element")return{x:0,y:0};const e=t.target&&t.target.xpath;if(!e)return{x:0,y:0};const n=r.annotations.filter(i=>i.type==="element"&&i.pageKey===t.pageKey&&i.target&&i.target.xpath===e);if(n.length<=1)return{x:0,y:0};const o=n.findIndex(i=>i.id===t.id);return o<=0?{x:0,y:0}:{x:-o*24,y:0}}function $(){Object.entries(r.markers).forEach(([t,e])=>{const n=r.annotations.find(i=>i.id===t);if(!n)return;const o=n.status==="missing"?null:ge(n);if(e.frame=he(n,o),!o){e.el.style.display="none",e.rect=null;return}e.el.style.display="",e.rect=o;const a=de(o.anchor);e.el.parentNode!==a&&a.appendChild(e.el),e.el.style.zIndex=pe(a)?"":"9999",we(e.el,o,n),ne(e.el,I(n))})}function _n(){if(!r.panel)return;r.panel.style.display==="none"&&(r.panel.style.display="",at())}function Wn(t){if(!r.panel)return;_n();const e=r.panel.querySelector(".wn-annot-list");if(!e)return;e.querySelectorAll(".wn-annot-item").forEach(a=>a.classList.remove("is-focused"));const o=e.querySelector(`.wn-annot-item[data-id="${t}"]`);o&&(o.classList.add("is-focused"),o.scrollIntoView({behavior:"smooth",block:"nearest"}))}function _(t,e=!1,n,o){var l;const a=r.annotations.find(c=>c.id===t);if(!a)return;if(Wn(t),a.status==="missing"){const c=J(a);if(c)a.status="active",Mt(a,c),A();else{B("Annotation introuvable sur cette page.");return}}const i=J(a);if(i){const c=i.type==="element"?i.el:i.range&&i.range.commonAncestorContainer?i.range.commonAncestorContainer.parentElement:null;c&&On(c)&&setTimeout(()=>{$()},160)}if(!((o||a.pageKey)===T(window.location.href))&&e){try{localStorage.setItem(bt,JSON.stringify({id:a.id,pageKey:a.pageKey,pageUrl:n||a.pageUrl}))}catch(c){}window.location.href=n||a.pageUrl||window.location.href;return}if(a.type==="text"){const p=(X(t)||Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)))[0];p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),$t(p,I(a).base))}else if(a.type==="element"){const c=i&&i.el?i.el:(l=a.target)!=null&&l.xpath?Y(a.target.xpath):null;c&&c.scrollIntoView&&(c.scrollIntoView({behavior:"smooth",block:"center"}),$t(c,I(a).base))}else if(a.type==="screenshot"&&a.rect){window.scrollTo({top:Math.max(0,a.rect.y+a.rect.h/2-window.innerHeight/2),behavior:"smooth"});const c=r.markers[a.id];c&&c.frame&&$t(c.frame,I(a).base)}}function $t(t,e){var i,s;t.style.transition="box-shadow 0.2s ease";const n=t.style.boxShadow,o=e||((s=(i=r.colors)==null?void 0:i.element)==null?void 0:s.base)||"#4e9cf6",a=S(o,.6,"rgba(78,156,246,0.6)");t.style.boxShadow=`0 0 0 3px ${a}`,setTimeout(()=>{t.style.boxShadow=n},800)}function xe(){if(!r.panel)return null;let t=r.panel.querySelector(".wn-annot-footer");if(!t){t=document.createElement("div"),t.className="wn-annot-footer wn-annotator";const e=document.createElement("a");e.href="https://uxnote.ninefortyone.studio",e.target="_blank",e.rel="noreferrer noopener",e.textContent="\xA9 UxNote \u2013 by NineFortyOne.Studio",t.appendChild(e),r.panel.appendChild(t)}return t}function A(){const t=r.panel.querySelector(".wn-annot-list"),e=r.panel.querySelector("h3");if(t.innerHTML="",!r.annotations.length){const o=document.createElement("div");o.className="wn-annot-empty",o.textContent="No annotations yet.",t.appendChild(o),e&&(e.textContent="Annotations (0)");const a=xe();return}const n=r.annotations.slice().sort((o,a)=>o.createdAt-a.createdAt).filter(o=>{const a=r.filters.query,i=`${o.comment||""} ${o.snippet||""}`.toLowerCase();return!a||i.includes(a)});e&&(e.textContent=`Annotations (${n.length})`),n.forEach((o,a)=>{const i=document.createElement("div");i.className="wn-annot-item",i.dataset.id=o.id,yn(i,I(o));const s=document.createElement("div");s.className="wn-annot-card-top";const l=document.createElement("div");l.className="wn-annot-card-top-left";const c=document.createElement("div");if(c.className="wn-annot-number",c.textContent=`#${a+1}`,l.appendChild(c),o.status==="missing"){const x=document.createElement("div");x.className="wn-annot-missing",x.textContent="Missing",l.appendChild(x)}const p=document.createElement("div");p.className="wn-annot-card-top-right";const m=document.createElement("button");m.type="button",m.className="wn-annot-edit wn-annotator",m.setAttribute("aria-label","Edit this annotation"),m.innerHTML=co(),m.addEventListener("click",async x=>{x.stopPropagation(),await Gn(o.id)}),p.appendChild(m);const y=document.createElement("button");y.type="button",y.className="wn-annot-delete wn-annotator",y.setAttribute("aria-label","Delete this annotation"),y.innerHTML=ke(),y.addEventListener("click",x=>{x.stopPropagation(),Zn(o.id)}),p.appendChild(y),s.appendChild(l),s.appendChild(p);const f=document.createElement("div");f.className="wn-annot-comment";const b=o.comment||"\u2014";f.textContent=b;const g=document.createElement("div");g.className="wn-annot-meta";const u=new Date(o.createdAt),w=u.toLocaleDateString(void 0,{year:"numeric",month:"2-digit",day:"2-digit"}),L=u.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});g.textContent=`${w} \u2022 ${L}`,l.appendChild(g);const N=document.createElement("button");N.type="button",N.className="wn-annot-showmore wn-annotator",N.textContent="See more",N.addEventListener("click",x=>{x.stopPropagation();const v=f.classList.toggle("expanded");N.textContent=v?"See less":"See more"}),b.length<160&&(N.style.display="none"),i.appendChild(s),i.appendChild(f);const Z=Eo(o);if(Z){const x=document.createElement("div");x.className="wn-annot-shot";const v=document.createElement("img");v.src=Z,v.alt="The screenshot of this annotation",v.addEventListener("click",ht=>{ht.stopPropagation(),Lo(Z)}),x.appendChild(v),i.appendChild(x)}i.appendChild(N),i.addEventListener("click",()=>{_(o.id,!0,o.pageUrl,o.pageKey),Q()&&r.panel&&(r.panel.style.display="none",at())}),t.appendChild(i)}),xe()}function Zn(t){const e=r.annotations.findIndex(n=>n.id===t);e!==-1&&(r.annotations.splice(e,1),M(),Mn(t),A(),F(),$())}async function Gn(t){const e=r.annotations.find(a=>a.id===t);if(!e)return;const n=await Wt("Edit this annotation",e.comment||"");if(!n)return;const{comment:o}=n;e.comment=o.trim(),M(),A()}async function Qn(){!r.annotations.length||!await dn("Delete all annotations?","Delete")||(r.annotations=[],E?wo():M(),q(),A(),F())}function to(){const t=be(),e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),o=document.createElement("a");o.href=n,o.download=ve(),o.click(),URL.revokeObjectURL(n)}function be(t=r.annotations){return{pageUrl:window.location.href,createdAt:Date.now(),annotations:t}}async function eo(){no(r.annotations)}function no(t){const e=be(t),n=JSON.stringify(e,null,2),o=encodeURIComponent(ve()),a=encodeURIComponent(n),i=(Fe||"").trim(),s=i?encodeURIComponent(i):"",l="?";window.location.href=`mailto:${s}${l}subject=${o}&body=${a}`}function pt(){return"wn-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function ye(){return"imp-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function ve(){const t=new Date,e=l=>String(l).padStart(2,"0"),n=`${e(t.getDate())}-${e(t.getMonth()+1)}-${t.getFullYear()}`,o=`${e(t.getHours())}-${e(t.getMinutes())}`,a=(document.title||"").trim(),i=l=>l.toLowerCase().replace(/[^a-z0-9]+/gi,"-").replace(/^-+|-+$/g,"")||"annotations";let s;return a?s=`${i(a)}-annotations`:window.location&&window.location.hostname?s=`${i(window.location.hostname)}-annotations`:s="annotations",`${s}_${n}_${o}.json`}const z=t=>`
  ...
  `;function oo(){return`
    ...
    `)}function co(){return Ce()}function ke(){return`
    ...
    `)}function Le(){return z(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function uo(){return k==="top"?Ee():Le()}function Ae(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function T(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Te(){try{const t=localStorage.getItem(bt);if(!t)return;const e=JSON.parse(t);e.pageKey===T(window.location.href)&&_(e.id,!1),localStorage.removeItem(bt)}catch(t){}}let D=new Map,zt=Promise.resolve(),j=!1;function Se(){return`${E.url}/annotations?site=${encodeURIComponent(C)}`}function Me(t){return`${E.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function fo(t){return`${E.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function W(t){const e=Object.assign({},t);return E.apiKey&&(e["X-Uxnote-Key"]=E.apiKey),e}function Ne(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function ut(t,e){console.warn("Uxnote sync:",t,e),!j&&(j=!0,B(t))}function mt(t){return zt=zt.then(t,t),zt}async function It(){if(E)try{const t=await fetch(Se(),{headers:W({Accept:"application/json"})});if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=await t.json();r.annotations=(e&&e.annotations||[]).filter(Lt),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=T(n.pageUrl||window.location.href))}),D=Ne(r.annotations),j=!1,q(),V(),F(),A(),Te()}catch(t){ut("Uxnote: could not read the annotations from the server",t)}}function $e(){if(!E)return;const t=Ne(r.annotations);t.forEach((e,n)=>{D.get(n)!==e&&mt(()=>ho(n,e))}),D.forEach((e,n)=>{t.has(n)||mt(()=>go(n))})}async function ho(t,e){try{const n=await fetch(Me(t),{method:"PUT",headers:W({"Content-Type":"application/json"}),body:e});if(!n.ok)throw new Error(`HTTP ${n.status}`);D.set(t,e),j=!1}catch(n){ut("Uxnote: could not save this annotation on the server",n)}}async function go(t){try{const e=await fetch(Me(t),{method:"DELETE",headers:W()});if(!e.ok)throw new Error(`HTTP ${e.status}`);D.delete(t),j=!1}catch(e){ut("Uxnote: could not delete this annotation on the server",e)}}function wo(){E&&mt(async()=>{try{const t=await fetch(Se(),{method:"DELETE",headers:W()});if(!t.ok)throw new Error(`HTTP ${t.status}`);D=new Map,j=!1}catch(t){ut("Uxnote: could not delete the annotations on the server",t)}})}let ft=null,ze=T(window.location.href);function xo(){ft=null;const t=T(window.location.href);t!==ze&&(ze=t,q(),V(),F(),A(),mt(It))}function Ie(){ft&&clearTimeout(ft),ft=setTimeout(xo,120)}function bo(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const a=e.apply(this,o);return Ie(),a})}),window.addEventListener("popstate",Ie)}function Re(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function yo(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const a=document.createElement("span");a.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(a),o.appendChild(i);const s=u=>{const w=!!u&&u.w>=4&&u.h>=4;n.style.display=w?"block":"none",w&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};s(null);const l=u=>({x:Math.min(Math.max(u.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(u.clientY,0),document.documentElement.clientHeight)}),c=(u,w)=>({x:Math.min(u.x,w.x),y:Math.min(u.y,w.y),w:Math.abs(w.x-u.x),h:Math.abs(w.y-u.y)});let p=null;const m=u=>{u.preventDefault(),p=l(u),s(null)},y=u=>{p&&(u.preventDefault(),s(c(p,l(u))))},f=u=>{if(!p)return;const w=c(p,l(u));if(p=null,w.w<4||w.h<4){s(null);return}b({x:w.x+window.scrollX,y:w.y+window.scrollY,w:w.w,h:w.h})},b=u=>{document.removeEventListener("keydown",g,!0),document.removeEventListener("mousemove",y,!0),document.removeEventListener("mouseup",f,!0),e.remove(),o.remove(),t(u)},g=u=>{u.key==="Escape"&&(u.preventDefault(),b(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",y,!0),document.addEventListener("mouseup",f,!0),document.addEventListener("keydown",g,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function vo(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,a=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-a)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const m=document.createElement("canvas");return m.width=c,m.height=p,m.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:m,w:c,h:p}}async function Co(){if(!(!Re()||r.mode==="screenshot")){O("screenshot");try{const t=await yo();if(!t)return;const e=vo(t).catch(c=>(console.warn("Uxnote screenshot:",c),null)),n=await vt("Comment for this region?");if(!n)return;const o=await e;if(!o){B("Uxnote: could not capture that region");return}const{comment:a}=n,i=pt();let s=null;if(E){const c=await new Promise(m=>o.canvas.toBlob(m,"image/png")),p=c?await ko(c,i):null;if(!p){B("Uxnote: could not send the screenshot to the server");return}s={url:p.url,w:o.w,h:o.h,capturedAt:Date.now()}}else s={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};const l={id:i,type:"screenshot",comment:a.trim(),snippet:"",pageUrl:window.location.href,pageKey:T(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:s,createdAt:Date.now(),status:"active"};r.annotations.push(l),M(),U(l,null),A()}finally{O(null)}}}async function ko(t,e){try{const n=await fetch(fo(e),{method:"PUT",headers:W({"Content-Type":"image/png"}),body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);const o=await n.json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function Eo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=E?new URL(`${E.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Lo(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",a,!0),e.remove()},a=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",a,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Yt):Yt(),window.Uxnote={refresh:$,setHidden:t=>ot(!!t),toggleVisibility:()=>ot(!r.hidden),isHidden:()=>!!r.hidden,sync:{pull:It,push:$e,url:()=>E?E.url:null}}})();})();
