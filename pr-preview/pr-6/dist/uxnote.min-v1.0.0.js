(()=>{var Lo=Object.defineProperty,Ao=Object.defineProperties;var To=Object.getOwnPropertyDescriptors;var Re=Object.getOwnPropertySymbols;var So=Object.prototype.hasOwnProperty,Mo=Object.prototype.propertyIsEnumerable;var Oe=(d,x,v)=>x in d?Lo(d,x,{enumerable:!0,configurable:!0,writable:!0,value:v}):d[x]=v,Pt=(d,x)=>{for(var v in x||(x={}))So.call(x,v)&&Oe(d,v,x[v]);if(Re)for(var v of Re(x))Mo.call(x,v)&&Oe(d,v,x[v]);return d},Be=(d,x)=>Ao(d,To(x));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),x=t=>d?d.getAttribute(t):null,v=`${location.protocol}//${location.host}`,Fe=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",gt=x("isToolVisibleAtFirstLaunch")||x("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),wt=x("isToolOnTopAtLaunch")||x("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),He=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Ue=x("colorForHighlight")||x("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Rt=x("colorForTextHighligh")||x("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Ot=x("colorForElementHighlight")||x("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Bt="#4e9cf6",q=nt(Ue||Ot||Rt||Bt,Bt),De=nt(Rt||q,q),je=nt(Ot||q,q),bt={text:kt(De,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:kt(je,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:kt(q,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let C=wt!=null?F(wt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const Ft="wn-toolbar-pos",G=d&&(d.dataset.dock||d.dataset.layout)||"",Ht=`uxnote:site:${v}`,Ut=`uxnote:import-files:${v}`,Dt=`uxnote:hidden:${v}`,xt=`uxnote:pending:${v}`,jt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),k=jt?{url:jt,apiKey:d&&d.dataset.serverApiKey||""}:null,Kt=F(d&&d.dataset.jsonExport,!0),yt=F(d&&d.dataset.jsonImport,!0),Ke=x("isBackdropVisible")||x("isbackdropvisible")||x("backdropVisible")||x("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),qe=.2,qt=F(Ke,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:bt,customPosition:!1,dimEnabled:qt,dimOpacity:qt?qe:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Xt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function Q(){return Xt?Xt.matches:window.innerWidth<=640}function Yt(){const t=fn();t&&(C=t);const e=hn(),n=gt!=null?!F(gt,!0):null;r.hidden=e!==null?e:n!==null?n:F(He,!1),yt&&(r.importFiles=yn()),Vt(),wn(),Xe(),Ye(),Ve(),ot(r.hidden),k?It():vn(),J(),Nt(),fe(),Yn(),k||Te(),dn()}function Vt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Xe(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function no(){return`
    ...
    `)}function Le(){return $(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function co(){return C==="top"?Ee():Le()}function Ae(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
