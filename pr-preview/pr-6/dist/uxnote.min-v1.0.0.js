(()=>{var Eo=Object.defineProperty,Lo=Object.defineProperties;var Ao=Object.getOwnPropertyDescriptors;var Re=Object.getOwnPropertySymbols;var To=Object.prototype.hasOwnProperty,So=Object.prototype.propertyIsEnumerable;var Oe=(p,g,C)=>g in p?Eo(p,g,{enumerable:!0,configurable:!0,writable:!0,value:C}):p[g]=C,Pt=(p,g)=>{for(var C in g||(g={}))To.call(g,C)&&Oe(p,C,g[C]);if(Re)for(var C of Re(g))So.call(g,C)&&Oe(p,C,g[C]);return p},Be=(p,g)=>Lo(p,Ao(g));(()=>{if(window.Uxnote)return;const p=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),g=t=>p?p.getAttribute(t):null,C=`${location.protocol}//${location.host}`,Fe=p&&(p.dataset.mailto||p.dataset.email||p.dataset.to)||"",gt=g("isToolVisibleAtFirstLaunch")||g("istoolvisibleatfirstlaunch")||p&&(p.dataset.isToolVisibleAtFirstLaunch||p.dataset.istoolvisibleatfirstlaunch),wt=g("isToolOnTopAtLaunch")||g("istoolontopatlaunch")||p&&(p.dataset.isToolOnTopAtLaunch||p.dataset.istoolontopatlaunch),He=p&&(p.dataset.hiddentoolbydefault||p.dataset.hidden||p.dataset.collapsed||p.dataset.startHidden||""),Ue=g("colorForHighlight")||g("colorForHighligh")||p&&(p.dataset.colorForHighlight||p.dataset.colorForHighligh),Rt=g("colorForTextHighligh")||g("colorForTextHighlight")||p&&(p.dataset.colorForTextHighligh||p.dataset.colorForTextHighlight),Ot=g("colorForElementHighlight")||g("colorForElementHighligh")||p&&(p.dataset.colorForElementHighlight||p.dataset.colorForElementHighligh),Bt="#4e9cf6",K=nt(Ue||Ot||Rt||Bt,Bt),De=nt(Rt||K,K),je=nt(Ot||K,K),bt={text:kt(De,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:kt(je,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:kt(K,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=wt!=null?B(wt,!1)?"top":"bottom":p&&p.dataset.position||"bottom";const Ft="wn-toolbar-pos",G=p&&(p.dataset.dock||p.dataset.layout)||"",Ht=`uxnote:site:${C}`,Ut=`uxnote:import-files:${C}`,Dt=`uxnote:hidden:${C}`,xt=`uxnote:pending:${C}`,jt=(p&&p.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=jt?{url:jt,apiKey:p&&p.dataset.serverApiKey||""}:null,Kt=B(p&&p.dataset.jsonExport,!0),yt=B(p&&p.dataset.jsonImport,!0),Ke=g("isBackdropVisible")||g("isbackdropvisible")||g("backdropVisible")||g("backdropvisible")||p&&(p.dataset.isBackdropVisible||p.dataset.isbackdropvisible||p.dataset.backdropVisible||p.dataset.backdropvisible||p.dataset.dim||p.dataset.dimpage||p.dataset.dimmer||p.dataset.overlay||p.dataset.dimLevel||p.dataset.dimlevel||p.dataset.dimstrength),qe=.2,qt=B(Ke,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:bt,customPosition:!1,dimEnabled:qt,dimOpacity:qt?qe:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Xt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function Q(){return Xt?Xt.matches:window.innerWidth<=640}function Yt(){const t=fn();t&&(k=t);const e=hn(),n=gt!=null?!B(gt,!0):null;r.hidden=e!==null?e:n!==null?n:B(He,!1),yt&&(r.importFiles=yn()),Vt(),wn(),Xe(),Ye(),Ve(),ot(r.hidden),E?It():vn(),V(),Nt(),fe(),Yn(),E||Te(),dn()}function Vt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Xe(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
