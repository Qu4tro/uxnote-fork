(()=>{var Za=Object.defineProperty,Ga=Object.defineProperties;var tr=Object.getOwnPropertyDescriptors;var Pn=Object.getOwnPropertySymbols;var er=Object.prototype.hasOwnProperty,nr=Object.prototype.propertyIsEnumerable;var Hn=(d,w,E)=>w in d?Za(d,w,{enumerable:!0,configurable:!0,writable:!0,value:E}):d[w]=E,xe=(d,w)=>{for(var E in w||(w={}))er.call(w,E)&&Hn(d,E,w[E]);if(Pn)for(var E of Pn(w))nr.call(w,E)&&Hn(d,E,w[E]);return d},On=(d,w)=>Ga(d,tr(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,E=`${location.protocol}//${location.host}`,Rn=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Pt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Ht=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),zn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Bn=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Un=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Fn=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Dn=w("colorForRegionHighlight")||d&&d.dataset.colorForRegionHighlight,jn="#4e9cf6",Vn="#8b5cf6",Kn="#f59f00",Ot=bt(Bn),be=Ot||jn,ye=Ot||Vn,Xn=xt(Un||be,be),Yn=xt(Fn||ye,ye),ve=Ot||Kn,qn=xt(Dn||ve,ve),Rt={text:Jt(Xn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Jt(Yn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Jt(qn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=Ht!=null?F(Ht,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const ke="wn-toolbar-pos",mt=d&&(d.dataset.dock||d.dataset.layout)||"",zt=`uxnote:site:${E}`,Ee=`${zt}:synced`,Ce=`uxnote:import-files:${E}`,Te=`uxnote:hidden:${E}`,Bt=`uxnote:pending:${E}`,Le=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),b=Le?{url:Le,apiKey:d&&d.dataset.serverApiKey||""}:null,Ut=F(d&&d.dataset.jsonExport,!0),Ft=F(d&&d.dataset.jsonImport,!0),_n=F(d&&d.dataset.mailExport,!0),ft=(d&&d.dataset.theme||"").trim().toLowerCase(),W=ft==="light"||ft==="dark"||ft==="reverse-auto"?ft:"auto",Wn=W==="auto"||W==="reverse-auto",Dt=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,jt=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,Vt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function j(){return jt?jt.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return Vt?Vt.matches:window.innerWidth<=640||window.innerHeight<=480}function Kt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const Jn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Zn=.2,Se=F(Jn,!j()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Rt,customPosition:!1,dimEnabled:Se,dimOpacity:Se?Zn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function Ae(){const t=Eo();t&&(k=t);const e=Co(),n=Pt!=null?!F(Pt,!0):null;a.hidden=e!==null?e:n!==null?n:F(zn,!1),Ft&&(a.importFiles=Qo()),Qe(),Lo(),Be(),Gn(),oo(),ao(),vt(a.hidden),Mo(),b&&!Oa()&&(a.annotations=[]),lt(),pe(),on(),ua(),b||fe(),b&&(R(Mt),za()),bo()}function Qe(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Gn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function ka(){return`
    ...
    `)}function Sa(){return pn()}function hn(){return`
    ...
    `)}function wn(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Qa(){return k==="top"?fn():wn()}function gn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
