(()=>{var Ko=Object.defineProperty,Xo=Object.defineProperties;var Vo=Object.getOwnPropertyDescriptors;var Ze=Object.getOwnPropertySymbols;var Yo=Object.prototype.hasOwnProperty,_o=Object.prototype.propertyIsEnumerable;var Ge=(m,y,C)=>y in m?Ko(m,y,{enumerable:!0,configurable:!0,writable:!0,value:C}):m[y]=C,Vt=(m,y)=>{for(var C in y||(y={}))Yo.call(y,C)&&Ge(m,C,y[C]);if(Ze)for(var C of Ze(y))_o.call(y,C)&&Ge(m,C,y[C]);return m},Qe=(m,y)=>Xo(m,Vo(y));(()=>{if(window.Uxnote)return;const m=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>m?m.getAttribute(t):null,C=`${location.protocol}//${location.host}`,tn=m&&(m.dataset.mailto||m.dataset.email||m.dataset.to)||"",Lt=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||m&&(m.dataset.isToolVisibleAtFirstLaunch||m.dataset.istoolvisibleatfirstlaunch),At=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||m&&(m.dataset.isToolOnTopAtLaunch||m.dataset.istoolontopatlaunch),en=m&&(m.dataset.hiddentoolbydefault||m.dataset.hidden||m.dataset.collapsed||m.dataset.startHidden||""),nn=y("colorForHighlight")||y("colorForHighligh")||m&&(m.dataset.colorForHighlight||m.dataset.colorForHighligh),Yt=y("colorForTextHighligh")||y("colorForTextHighlight")||m&&(m.dataset.colorForTextHighligh||m.dataset.colorForTextHighlight),_t=y("colorForElementHighlight")||y("colorForElementHighligh")||m&&(m.dataset.colorForElementHighlight||m.dataset.colorForElementHighligh),Jt="#4e9cf6",G=ct(nn||_t||Yt||Jt,Jt),on=ct(Yt||G,G),an=ct(_t||G,G),Nt={text:It(on,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:It(an,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:It(G,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let E=At!=null?dt(At,!1)?"top":"bottom":m&&m.dataset.position||"bottom";const Wt="wn-toolbar-pos",it=m&&(m.dataset.dock||m.dataset.layout)||"",Zt=`uxnote:site:${C}`,Gt=`uxnote:annotator:${C}`,Qt=`uxnote:annotators:${C}`,te=`uxnote:import-files:${C}`,ee=`uxnote:hidden:${C}`,St=`uxnote:pending:${C}`,ne=(m&&m.dataset.serverUrl||"").trim().replace(/\/+$/,""),L=ne?{url:ne,apiKey:m&&m.dataset.serverApiKey||""}:null,rn=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||m&&(m.dataset.isBackdropVisible||m.dataset.isbackdropvisible||m.dataset.backdropVisible||m.dataset.backdropvisible||m.dataset.dim||m.dataset.dimpage||m.dataset.dimmer||m.dataset.overlay||m.dataset.dimLevel||m.dataset.dimlevel||m.dataset.dimstrength),sn=.2,oe=dt(rn,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:Nt,customPosition:!1,dimEnabled:oe,dimOpacity:oe?sn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},ae=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function Q(){return ae?ae.matches:window.innerWidth<=640}function re(){const t=In();t&&(E=t);const e=On(),n=Lt!=null?!dt(Lt,!0):null;a.hidden=e!==null?e:n!==null?n:dt(en,!1),a.annotatorName=we(),a.annotatorNames=Un(),a.importFiles=jn(),ie(),Pn(),ln(),cn(),dn(),ut(a.hidden),L?Ve():qn(),pt(),vt(),Ut(),Me(),ho(),L||je(),Tn()}function ie(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function ln(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function cn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${E}`;const e=h=>{const g=document.createElement("button");return g.className="wn-annot-btn wn-annotator",g.setAttribute("data-action",h.action),h.mode&&g.setAttribute("data-mode",h.mode),g.setAttribute("data-tip",h.tip),g.innerHTML=h.icon,g},n=h=>{const g=document.createElement("div");return g.className="wn-annot-group wn-annotator",h.forEach(p=>g.appendChild(e(p))),g},o=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},r=document.createDocumentFragment(),i=document.createElement("div");i.className="wn-annot-logo wn-annotator",i.innerHTML=Eo(),r.appendChild(i);const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:Be()},{action:"mode",mode:"element",tip:"Annotate an element",icon:Lo()}];_e()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:So()});const c=[{action:"import",tip:"Import JSON",icon:No()},{action:"export",tip:"Export JSON",icon:Ao()}],l=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:$o()},{action:"toggle-panel",tip:"Show / hide annotations",icon:Mo()}];r.appendChild(o()),r.appendChild(n(s)),r.appendChild(o()),r.appendChild(n(c)),r.appendChild(o()),r.appendChild(n(l)),t.appendChild(r),document.body.appendChild(t),a.toolbar=t;const d=document.createElement("div");d.className="wn-annot-panel wn-annotator",d.innerHTML=`
  ...
  `;function Eo(){return`
    ...
    `}function O(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function je(){try{const t=localStorage.getItem(St);if(!t)return;const e=JSON.parse(t);e.pageKey===O(window.location.href)&&at(e.id,!1),localStorage.removeItem(St)}catch(t){}}let W=new Map,Kt=Promise.resolve(),Z=!1;function qe(){return`${L.url}/annotations?site=${encodeURIComponent(C)}`}function Ke(t){return`${L.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function Io(t){return`${L.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function rt(t){const e=Object.assign({},t);return L.apiKey&&(e["X-Uxnote-Key"]=L.apiKey),e}function Xe(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function kt(t,e){console.warn("Uxnote sync:",t,e),!Z&&(Z=!0,Y(t))}function Xt(t){return Kt=Kt.then(t,t),Kt}async function Ve(){if(L)try{const t=await fetch(qe(),{headers:rt({Accept:"application/json"})});if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=await t.json();a.annotations=(e&&e.annotations||[]).filter(Rt),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=O(n.pageUrl||window.location.href))}),W=Xe(a.annotations),Z=!1,pt(),wt(),vt(),et(),$(),je()}catch(t){kt("Uxnote: could not read the annotations from the server",t)}}function Ye(){if(!L)return;const t=Xe(a.annotations);t.forEach((e,n)=>{W.get(n)!==e&&Xt(()=>Oo(n,e))}),W.forEach((e,n)=>{t.has(n)||Xt(()=>Ro(n))})}async function Oo(t,e){try{const n=await fetch(Ke(t),{method:"PUT",headers:rt({"Content-Type":"application/json"}),body:e});if(!n.ok)throw new Error(`HTTP ${n.status}`);W.set(t,e),Z=!1}catch(n){kt("Uxnote: could not save this annotation on the server",n)}}async function Ro(t){try{const e=await fetch(Ke(t),{method:"DELETE",headers:rt()});if(!e.ok)throw new Error(`HTTP ${e.status}`);W.delete(t),Z=!1}catch(e){kt("Uxnote: could not delete this annotation on the server",e)}}function Po(){L&&Xt(async()=>{try{const t=await fetch(qe(),{method:"DELETE",headers:rt()});if(!t.ok)throw new Error(`HTTP ${t.status}`);W=new Map,Z=!1}catch(t){kt("Uxnote: could not delete the annotations on the server",t)}})}function _e(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Bo(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Enter captures. Escape stops.";const i=document.createElement("button");i.type="button",i.className="primary",i.textContent="Capture";const s=document.createElement("button");s.type="button",s.textContent="Cancel",o.appendChild(r),o.appendChild(i),o.appendChild(s);let c=null;const l=p=>{c=p;const x=!!p&&p.w>=4&&p.h>=4;n.style.display=x?"block":"none",i.disabled=!x,x&&(n.style.left=`${p.x}px`,n.style.top=`${p.y}px`,n.style.width=`${p.w}px`,n.style.height=`${p.h}px`)};l(null);let d=null;const u=p=>{p.preventDefault(),d={x:p.clientX,y:p.clientY},l({x:p.clientX,y:p.clientY,w:0,h:0})},f=p=>{d&&(p.preventDefault(),l({x:Math.min(d.x,p.clientX),y:Math.min(d.y,p.clientY),w:Math.abs(p.clientX-d.x),h:Math.abs(p.clientY-d.y)}))},w=()=>{d=null},b=p=>{document.removeEventListener("keydown",g,!0),e.remove(),o.remove(),t(p)},h=()=>{!c||c.w<4||c.h<4||b({x:c.x+window.scrollX,y:c.y+window.scrollY,w:c.w,h:c.h})},g=p=>{p.key==="Escape"?(p.preventDefault(),b(null)):p.key==="Enter"&&(p.preventDefault(),h())};e.addEventListener("mousedown",u),e.addEventListener("mousemove",f),e.addEventListener("mouseup",w),i.addEventListener("click",h),s.addEventListener("click",()=>b(null)),document.addEventListener("keydown",g,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Fo(t){const e=document.createElement("style");e.textContent=".wn-annotator, .wn-annot-dimmer { display: none !important; }",document.head.appendChild(e);try{await new Promise(w=>requestAnimationFrame(()=>requestAnimationFrame(w)));const n=await window.snapdom.toCanvas(document.body,{scale:1}),o=document.body.getBoundingClientRect(),r=o.width?n.width/o.width:1,i=o.left+window.scrollX,s=o.top+window.scrollY,c=Math.max(0,Math.round((t.x-i)*r)),l=Math.max(0,Math.round((t.y-s)*r)),d=Math.min(n.width-c,Math.max(1,Math.round(t.w*r))),u=Math.min(n.height-l,Math.max(1,Math.round(t.h*r)));if(d<1||u<1)return null;const f=document.createElement("canvas");return f.width=d,f.height=u,f.getContext("2d").drawImage(n,c,l,d,u,0,0,d,u),{canvas:f,w:d,h:u}}finally{e.remove()}}async function Ho(){if(!_e()||a.mode==="screenshot")return;V("screenshot");let t=null;try{t=await Bo()}finally{V(null)}if(!t)return;let e=null;try{e=await Fo(t)}catch(d){console.warn("Uxnote screenshot:",d)}if(!e){Y("Uxnote: could not capture that region");return}const n=await Tt("Comment for this region?");if(!n)return;const{comment:o,priority:r,author:i}=n,s=Ct();let c=null;if(L){const d=await new Promise(f=>e.canvas.toBlob(f,"image/png")),u=d?await Uo(d,s):null;if(!u){Y("Uxnote: could not send the screenshot to the server");return}c={url:u.url,w:e.w,h:e.h,capturedAt:Date.now()}}else c={dataUrl:e.canvas.toDataURL("image/png"),w:e.w,h:e.h,capturedAt:Date.now()};const l={id:s,type:"screenshot",comment:o.trim(),author:i||a.annotatorName||"",priority:r||"medium",snippet:"",pageUrl:window.location.href,pageKey:O(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:c,createdAt:Date.now(),status:"active"};a.annotations.push(l),P(),J(l,null),$()}async function Uo(t,e){try{const n=await fetch(Io(e),{method:"PUT",headers:rt({"Content-Type":"image/png"}),body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);const o=await n.json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function Do(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=L?new URL(`${L.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function jo(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",r,!0),e.remove()},r=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",r,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",re):re(),window.Uxnote={refresh:F,setHidden:t=>ut(!!t),toggleVisibility:()=>ut(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:Ve,push:Ye,url:()=>L?L.url:null}}})();})();
