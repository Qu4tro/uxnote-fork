(()=>{var Jo=Object.defineProperty,Wo=Object.defineProperties;var Zo=Object.getOwnPropertyDescriptors;var en=Object.getOwnPropertySymbols;var Go=Object.prototype.hasOwnProperty,Qo=Object.prototype.propertyIsEnumerable;var nn=(m,y,C)=>y in m?Jo(m,y,{enumerable:!0,configurable:!0,writable:!0,value:C}):m[y]=C,_t=(m,y)=>{for(var C in y||(y={}))Go.call(y,C)&&nn(m,C,y[C]);if(en)for(var C of en(y))Qo.call(y,C)&&nn(m,C,y[C]);return m},on=(m,y)=>Wo(m,Zo(y));(()=>{if(window.Uxnote)return;const m=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>m?m.getAttribute(t):null,C=`${location.protocol}//${location.host}`,an=m&&(m.dataset.mailto||m.dataset.email||m.dataset.to)||"",Nt=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||m&&(m.dataset.isToolVisibleAtFirstLaunch||m.dataset.istoolvisibleatfirstlaunch),St=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||m&&(m.dataset.isToolOnTopAtLaunch||m.dataset.istoolontopatlaunch),rn=m&&(m.dataset.hiddentoolbydefault||m.dataset.hidden||m.dataset.collapsed||m.dataset.startHidden||""),sn=y("colorForHighlight")||y("colorForHighligh")||m&&(m.dataset.colorForHighlight||m.dataset.colorForHighligh),Jt=y("colorForTextHighligh")||y("colorForTextHighlight")||m&&(m.dataset.colorForTextHighligh||m.dataset.colorForTextHighlight),Wt=y("colorForElementHighlight")||y("colorForElementHighligh")||m&&(m.dataset.colorForElementHighlight||m.dataset.colorForElementHighligh),Zt="#4e9cf6",G=dt(sn||Wt||Jt||Zt,Zt),ln=dt(Jt||G,G),cn=dt(Wt||G,G),Tt={text:Rt(ln,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Rt(cn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Rt(G,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let L=St!=null?pt(St,!1)?"top":"bottom":m&&m.dataset.position||"bottom";const Gt="wn-toolbar-pos",st=m&&(m.dataset.dock||m.dataset.layout)||"",Qt=`uxnote:site:${C}`,te=`uxnote:annotator:${C}`,ee=`uxnote:annotators:${C}`,ne=`uxnote:import-files:${C}`,oe=`uxnote:hidden:${C}`,Mt=`uxnote:pending:${C}`,ae=(m&&m.dataset.serverUrl||"").trim().replace(/\/+$/,""),k=ae?{url:ae,apiKey:m&&m.dataset.serverApiKey||""}:null,dn=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||m&&(m.dataset.isBackdropVisible||m.dataset.isbackdropvisible||m.dataset.backdropVisible||m.dataset.backdropvisible||m.dataset.dim||m.dataset.dimpage||m.dataset.dimmer||m.dataset.overlay||m.dataset.dimLevel||m.dataset.dimlevel||m.dataset.dimstrength),pn=.2,re=pt(dn,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Tt,customPosition:!1,dimEnabled:re,dimOpacity:re?pn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},ie=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function Q(){return ie?ie.matches:window.innerWidth<=640}function se(){const t=Bn();t&&(L=t);const e=Un(),n=Nt!=null?!pt(Nt,!0):null;a.hidden=e!==null?e:n!==null?n:pt(rn,!1),a.annotatorName=xe(),a.annotatorNames=Kn(),a.importFiles=Xn(),le(),Hn(),un(),mn(),fn(),mt(a.hidden),k?Je():Yn(),ut(),Ct(),jt(),$e(),xo(),k||Ke(),In()}function le(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function un(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function mn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${L}`;const e=f=>{const p=document.createElement("button");return p.className="wn-annot-btn wn-annotator",p.setAttribute("data-action",f.action),f.mode&&p.setAttribute("data-mode",f.mode),p.setAttribute("data-tip",f.tip),p.innerHTML=f.icon,p},n=f=>{const p=document.createElement("div");return p.className="wn-annot-group wn-annotator",f.forEach(w=>p.appendChild(e(w))),p},o=()=>{const f=document.createElement("div");return f.className="wn-annot-spacer wn-annotator",f},r=document.createDocumentFragment(),i=document.createElement("div");if(i.className="wn-annot-logo wn-annotator",i.innerHTML=So(),r.appendChild(i),k){const f=document.createElement("div");f.className="wn-annot-sync-dot wn-annotator",f.setAttribute("role","status"),r.appendChild(f),a.syncDot=f,Ve()}const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:Fe()},{action:"mode",mode:"element",tip:"Annotate an element",icon:To()}];Ze()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:$o()});const d=[{action:"import",tip:"Import JSON",icon:zo()},{action:"export",tip:"Export JSON",icon:Mo()}],l=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:Ro()},{action:"toggle-panel",tip:"Show / hide annotations",icon:Oo()}];r.appendChild(o()),r.appendChild(n(s)),r.appendChild(o()),r.appendChild(n(d)),r.appendChild(o()),r.appendChild(n(l)),t.appendChild(r),document.body.appendChild(t),a.toolbar=t;const c=document.createElement("div");c.className="wn-annot-panel wn-annotator",c.innerHTML=`
  ...
  `;function So(){return`
    ...
    `)}function je(){return F(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Ro(){return L==="top"?De():je()}function qe(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
