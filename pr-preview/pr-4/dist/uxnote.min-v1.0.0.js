(()=>{var Vo=Object.defineProperty,Yo=Object.defineProperties;var _o=Object.getOwnPropertyDescriptors;var Qe=Object.getOwnPropertySymbols;var Jo=Object.prototype.hasOwnProperty,Wo=Object.prototype.propertyIsEnumerable;var tn=(p,y,C)=>y in p?Vo(p,y,{enumerable:!0,configurable:!0,writable:!0,value:C}):p[y]=C,Yt=(p,y)=>{for(var C in y||(y={}))Jo.call(y,C)&&tn(p,C,y[C]);if(Qe)for(var C of Qe(y))Wo.call(y,C)&&tn(p,C,y[C]);return p},en=(p,y)=>Yo(p,_o(y));(()=>{if(window.Uxnote)return;const p=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>p?p.getAttribute(t):null,C=`${location.protocol}//${location.host}`,nn=p&&(p.dataset.mailto||p.dataset.email||p.dataset.to)||"",Lt=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||p&&(p.dataset.isToolVisibleAtFirstLaunch||p.dataset.istoolvisibleatfirstlaunch),At=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||p&&(p.dataset.isToolOnTopAtLaunch||p.dataset.istoolontopatlaunch),on=p&&(p.dataset.hiddentoolbydefault||p.dataset.hidden||p.dataset.collapsed||p.dataset.startHidden||""),an=y("colorForHighlight")||y("colorForHighligh")||p&&(p.dataset.colorForHighlight||p.dataset.colorForHighligh),_t=y("colorForTextHighligh")||y("colorForTextHighlight")||p&&(p.dataset.colorForTextHighligh||p.dataset.colorForTextHighlight),Jt=y("colorForElementHighlight")||y("colorForElementHighligh")||p&&(p.dataset.colorForElementHighlight||p.dataset.colorForElementHighligh),Wt="#4e9cf6",Q=dt(an||Jt||_t||Wt,Wt),rn=dt(_t||Q,Q),sn=dt(Jt||Q,Q),Nt={text:Ot(rn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Ot(sn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Ot(Q,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let E=At!=null?_(At,!1)?"top":"bottom":p&&p.dataset.position||"bottom";const Zt="wn-toolbar-pos",st=p&&(p.dataset.dock||p.dataset.layout)||"",Gt=`uxnote:site:${C}`,Qt=`uxnote:annotator:${C}`,te=`uxnote:annotators:${C}`,ee=`uxnote:import-files:${C}`,ne=`uxnote:hidden:${C}`,St=`uxnote:pending:${C}`,oe=(p&&p.dataset.serverUrl||"").trim().replace(/\/+$/,""),L=oe?{url:oe,apiKey:p&&p.dataset.serverApiKey||""}:null,ae=_(p&&p.dataset.jsonExport,!0),Tt=_(p&&p.dataset.jsonImport,!0),ln=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||p&&(p.dataset.isBackdropVisible||p.dataset.isbackdropvisible||p.dataset.backdropVisible||p.dataset.backdropvisible||p.dataset.dim||p.dataset.dimpage||p.dataset.dimmer||p.dataset.overlay||p.dataset.dimLevel||p.dataset.dimlevel||p.dataset.dimstrength),cn=.2,re=_(ln,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:Nt,customPosition:!1,dimEnabled:re,dimOpacity:re?cn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},ie=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function tt(){return ie?ie.matches:window.innerWidth<=640}function se(){const t=Rn();t&&(E=t);const e=Pn(),n=Lt!=null?!_(Lt,!0):null;a.hidden=e!==null?e:n!==null?n:_(on,!1),a.annotatorName=xe(),a.annotatorNames=jn(),Tt&&(a.importFiles=Kn()),le(),Fn(),dn(),pn(),un(),ut(a.hidden),L?_e():Xn(),pt(),vt(),Dt(),ze(),wo(),L||Ke(),$n()}function le(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function dn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function pn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${E}`;const e=h=>{const g=document.createElement("button");return g.className="wn-annot-btn wn-annotator",g.setAttribute("data-action",h.action),h.mode&&g.setAttribute("data-mode",h.mode),g.setAttribute("data-tip",h.tip),g.innerHTML=h.icon,g},n=h=>{const g=document.createElement("div");return g.className="wn-annot-group wn-annotator",h.forEach(u=>g.appendChild(e(u))),g},o=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},r=document.createDocumentFragment(),i=document.createElement("div");i.className="wn-annot-logo wn-annotator",i.innerHTML=Ao(),r.appendChild(i);const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:He()},{action:"mode",mode:"element",tip:"Annotate an element",icon:No()}];We()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:Mo()});const c=[];Tt&&c.push({action:"import",tip:"Import JSON",icon:To()}),ae&&c.push({action:"export",tip:"Export JSON",icon:So()});const l=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:Io()},{action:"toggle-panel",tip:"Show / hide annotations",icon:zo()}];r.appendChild(o()),r.appendChild(n(s)),c.length&&(r.appendChild(o()),r.appendChild(n(c))),r.appendChild(o()),r.appendChild(n(l)),t.appendChild(r),document.body.appendChild(t),a.toolbar=t;const d=document.createElement("div");d.className="wn-annot-panel wn-annotator",d.innerHTML=`
  ...
  `;function Ao(){return`
    ...
    `)}function $o(){return He()}function Ue(){return`
    ...
    `}function O(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Ke(){try{const t=localStorage.getItem(St);if(!t)return;const e=JSON.parse(t);e.pageKey===O(window.location.href)&&rt(e.id,!1),localStorage.removeItem(St)}catch(t){}}let Z=new Map,Xt=Promise.resolve(),G=!1;function Xe(){return`${L.url}/annotations?site=${encodeURIComponent(C)}`}function Ve(t){return`${L.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function Ro(t){return`${L.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function it(t){const e=Object.assign({},t);return L.apiKey&&(e["X-Uxnote-Key"]=L.apiKey),e}function Ye(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function kt(t,e){console.warn("Uxnote sync:",t,e),!G&&(G=!0,Y(t))}function Vt(t){return Xt=Xt.then(t,t),Xt}async function _e(){if(L)try{const t=await fetch(Xe(),{headers:it({Accept:"application/json"})});if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=await t.json();a.annotations=(e&&e.annotations||[]).filter(Pt),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=O(n.pageUrl||window.location.href))}),Z=Ye(a.annotations),G=!1,pt(),wt(),vt(),nt(),$(),Ke()}catch(t){kt("Uxnote: could not read the annotations from the server",t)}}function Je(){if(!L)return;const t=Ye(a.annotations);t.forEach((e,n)=>{Z.get(n)!==e&&Vt(()=>Po(n,e))}),Z.forEach((e,n)=>{t.has(n)||Vt(()=>Bo(n))})}async function Po(t,e){try{const n=await fetch(Ve(t),{method:"PUT",headers:it({"Content-Type":"application/json"}),body:e});if(!n.ok)throw new Error(`HTTP ${n.status}`);Z.set(t,e),G=!1}catch(n){kt("Uxnote: could not save this annotation on the server",n)}}async function Bo(t){try{const e=await fetch(Ve(t),{method:"DELETE",headers:it()});if(!e.ok)throw new Error(`HTTP ${e.status}`);Z.delete(t),G=!1}catch(e){kt("Uxnote: could not delete this annotation on the server",e)}}function Fo(){L&&Vt(async()=>{try{const t=await fetch(Xe(),{method:"DELETE",headers:it()});if(!t.ok)throw new Error(`HTTP ${t.status}`);Z=new Map,G=!1}catch(t){kt("Uxnote: could not delete the annotations on the server",t)}})}function We(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Ho(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Enter captures. Escape stops.";const i=document.createElement("button");i.type="button",i.className="primary",i.textContent="Capture";const s=document.createElement("button");s.type="button",s.textContent="Cancel",o.appendChild(r),o.appendChild(i),o.appendChild(s);let c=null;const l=u=>{c=u;const x=!!u&&u.w>=4&&u.h>=4;n.style.display=x?"block":"none",i.disabled=!x,x&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};l(null);let d=null;const m=u=>{u.preventDefault(),d={x:u.clientX,y:u.clientY},l({x:u.clientX,y:u.clientY,w:0,h:0})},f=u=>{d&&(u.preventDefault(),l({x:Math.min(d.x,u.clientX),y:Math.min(d.y,u.clientY),w:Math.abs(u.clientX-d.x),h:Math.abs(u.clientY-d.y)}))},w=()=>{d=null},b=u=>{document.removeEventListener("keydown",g,!0),e.remove(),o.remove(),t(u)},h=()=>{!c||c.w<4||c.h<4||b({x:c.x+window.scrollX,y:c.y+window.scrollY,w:c.w,h:c.h})},g=u=>{u.key==="Escape"?(u.preventDefault(),b(null)):u.key==="Enter"&&(u.preventDefault(),h())};e.addEventListener("mousedown",m),e.addEventListener("mousemove",f),e.addEventListener("mouseup",w),i.addEventListener("click",h),s.addEventListener("click",()=>b(null)),document.addEventListener("keydown",g,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Uo(t){const e=document.createElement("style");e.textContent=".wn-annotator, .wn-annot-dimmer { display: none !important; }",document.head.appendChild(e);try{await new Promise(w=>requestAnimationFrame(()=>requestAnimationFrame(w)));const n=await window.snapdom.toCanvas(document.body,{scale:1}),o=document.body.getBoundingClientRect(),r=o.width?n.width/o.width:1,i=o.left+window.scrollX,s=o.top+window.scrollY,c=Math.max(0,Math.round((t.x-i)*r)),l=Math.max(0,Math.round((t.y-s)*r)),d=Math.min(n.width-c,Math.max(1,Math.round(t.w*r))),m=Math.min(n.height-l,Math.max(1,Math.round(t.h*r)));if(d<1||m<1)return null;const f=document.createElement("canvas");return f.width=d,f.height=m,f.getContext("2d").drawImage(n,c,l,d,m,0,0,d,m),{canvas:f,w:d,h:m}}finally{e.remove()}}async function Do(){if(!We()||a.mode==="screenshot")return;V("screenshot");let t=null;try{t=await Ho()}finally{V(null)}if(!t)return;let e=null;try{e=await Uo(t)}catch(d){console.warn("Uxnote screenshot:",d)}if(!e){Y("Uxnote: could not capture that region");return}const n=await Mt("Comment for this region?");if(!n)return;const{comment:o,priority:r,author:i}=n,s=Ct();let c=null;if(L){const d=await new Promise(f=>e.canvas.toBlob(f,"image/png")),m=d?await jo(d,s):null;if(!m){Y("Uxnote: could not send the screenshot to the server");return}c={url:m.url,w:e.w,h:e.h,capturedAt:Date.now()}}else c={dataUrl:e.canvas.toDataURL("image/png"),w:e.w,h:e.h,capturedAt:Date.now()};const l={id:s,type:"screenshot",comment:o.trim(),author:i||a.annotatorName||"",priority:r||"medium",snippet:"",pageUrl:window.location.href,pageKey:O(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:c,createdAt:Date.now(),status:"active"};a.annotations.push(l),P(),W(l,null),$()}async function jo(t,e){try{const n=await fetch(Ro(e),{method:"PUT",headers:it({"Content-Type":"image/png"}),body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);const o=await n.json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function qo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=L?new URL(`${L.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Ko(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",r,!0),e.remove()},r=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",r,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",se):se(),window.Uxnote={refresh:F,setHidden:t=>ut(!!t),toggleVisibility:()=>ut(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:_e,push:Je,url:()=>L?L.url:null}}})();})();
