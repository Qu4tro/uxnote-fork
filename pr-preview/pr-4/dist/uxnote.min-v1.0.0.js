(()=>{var Qo=Object.defineProperty,ta=Object.defineProperties;var ea=Object.getOwnPropertyDescriptors;var nn=Object.getOwnPropertySymbols;var na=Object.prototype.hasOwnProperty,oa=Object.prototype.propertyIsEnumerable;var on=(u,y,k)=>y in u?Qo(u,y,{enumerable:!0,configurable:!0,writable:!0,value:k}):u[y]=k,_t=(u,y)=>{for(var k in y||(y={}))na.call(y,k)&&on(u,k,y[k]);if(nn)for(var k of nn(y))oa.call(y,k)&&on(u,k,y[k]);return u},an=(u,y)=>ta(u,ea(y));(()=>{if(window.Uxnote)return;const u=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>u?u.getAttribute(t):null,k=`${location.protocol}//${location.host}`,rn=u&&(u.dataset.mailto||u.dataset.email||u.dataset.to)||"",At=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||u&&(u.dataset.isToolVisibleAtFirstLaunch||u.dataset.istoolvisibleatfirstlaunch),Nt=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||u&&(u.dataset.isToolOnTopAtLaunch||u.dataset.istoolontopatlaunch),sn=u&&(u.dataset.hiddentoolbydefault||u.dataset.hidden||u.dataset.collapsed||u.dataset.startHidden||""),ln=y("colorForHighlight")||y("colorForHighligh")||u&&(u.dataset.colorForHighlight||u.dataset.colorForHighligh),Jt=y("colorForTextHighligh")||y("colorForTextHighlight")||u&&(u.dataset.colorForTextHighligh||u.dataset.colorForTextHighlight),Wt=y("colorForElementHighlight")||y("colorForElementHighligh")||u&&(u.dataset.colorForElementHighlight||u.dataset.colorForElementHighligh),Zt="#4e9cf6",Q=dt(ln||Wt||Jt||Zt,Zt),cn=dt(Jt||Q,Q),dn=dt(Wt||Q,Q),St={text:Rt(cn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Rt(dn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Rt(Q,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let L=Nt!=null?q(Nt,!1)?"top":"bottom":u&&u.dataset.position||"bottom";const Gt="wn-toolbar-pos",lt=u&&(u.dataset.dock||u.dataset.layout)||"",Qt=`uxnote:site:${k}`,te=`uxnote:annotator:${k}`,ee=`uxnote:annotators:${k}`,ne=`uxnote:import-files:${k}`,oe=`uxnote:hidden:${k}`,Tt=`uxnote:pending:${k}`,ae=(u&&u.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=ae?{url:ae,apiKey:u&&u.dataset.serverApiKey||""}:null,re=q(u&&u.dataset.jsonExport,!0),Mt=q(u&&u.dataset.jsonImport,!0),pn=q(u&&u.dataset.mailExport,!0),un=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||u&&(u.dataset.isBackdropVisible||u.dataset.isbackdropvisible||u.dataset.backdropVisible||u.dataset.backdropvisible||u.dataset.dim||u.dataset.dimpage||u.dataset.dimmer||u.dataset.overlay||u.dataset.dimLevel||u.dataset.dimlevel||u.dataset.dimstrength),mn=.2,ie=q(un,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:St,customPosition:!1,dimEnabled:ie,dimOpacity:ie?mn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},se=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function tt(){return se?se.matches:window.innerWidth<=640}function le(){const t=Fn();t&&(L=t);const e=Hn(),n=At!=null?!q(At,!0):null;a.hidden=e!==null?e:n!==null?n:q(sn,!1),a.annotatorName=ve(),a.annotatorNames=Vn(),Mt&&(a.importFiles=_n()),ce(),jn(),fn(),hn(),gn(),ut(a.hidden),E?We():Jn(),pt(),vt(),jt(),Oe(),vo(),E||Xe(),Rn()}function ce(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function fn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function hn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${L}`;const e=f=>{const p=document.createElement("button");return p.className="wn-annot-btn wn-annotator",p.setAttribute("data-action",f.action),f.mode&&p.setAttribute("data-mode",f.mode),p.setAttribute("data-tip",f.tip),p.innerHTML=f.icon,p},n=f=>{const p=document.createElement("div");return p.className="wn-annot-group wn-annotator",f.forEach(w=>p.appendChild(e(w))),p},o=()=>{const f=document.createElement("div");return f.className="wn-annot-spacer wn-annotator",f},r=document.createDocumentFragment(),i=document.createElement("div");if(i.className="wn-annot-logo wn-annotator",i.innerHTML=zo(),r.appendChild(i),E){const f=document.createElement("div");f.className="wn-annot-sync-dot wn-annotator",f.setAttribute("role","status"),r.appendChild(f),a.syncDot=f,Ve()}const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:He()},{action:"mode",mode:"element",tip:"Annotate an element",icon:$o()}];Ge()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:Po()});const c=[];Mt&&c.push({action:"import",tip:"Import JSON",icon:Oo()}),re&&c.push({action:"export",tip:"Export JSON",icon:Io()}),pn&&c.push({action:"mail",tip:"Send by mail",icon:Ro()});const l=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:Fo()},{action:"toggle-panel",tip:"Show / hide annotations",icon:Uo()}];r.appendChild(o()),r.appendChild(n(s)),c.length&&(r.appendChild(o()),r.appendChild(n(c))),r.appendChild(o()),r.appendChild(n(l)),t.appendChild(r),document.body.appendChild(t),a.toolbar=t;const d=document.createElement("div");d.className="wn-annot-panel wn-annotator",d.innerHTML=`
  ...
  `;function zo(){return`
    ...
    `)}function Bo(){return He()}function De(){return`
    ...
    `)}function qe(){return U(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Fo(){return L==="top"?je():qe()}function Ke(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
