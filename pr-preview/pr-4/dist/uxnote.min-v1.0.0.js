(()=>{var _o=Object.defineProperty,Jo=Object.defineProperties;var Wo=Object.getOwnPropertyDescriptors;var Ge=Object.getOwnPropertySymbols;var Zo=Object.prototype.hasOwnProperty,Go=Object.prototype.propertyIsEnumerable;var Qe=(u,y,k)=>y in u?_o(u,y,{enumerable:!0,configurable:!0,writable:!0,value:k}):u[y]=k,Vt=(u,y)=>{for(var k in y||(y={}))Zo.call(y,k)&&Qe(u,k,y[k]);if(Ge)for(var k of Ge(y))Go.call(y,k)&&Qe(u,k,y[k]);return u},tn=(u,y)=>Jo(u,Wo(y));(()=>{if(window.Uxnote)return;const u=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>u?u.getAttribute(t):null,k=`${location.protocol}//${location.host}`,en=u&&(u.dataset.mailto||u.dataset.email||u.dataset.to)||"",Et=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||u&&(u.dataset.isToolVisibleAtFirstLaunch||u.dataset.istoolvisibleatfirstlaunch),Lt=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||u&&(u.dataset.isToolOnTopAtLaunch||u.dataset.istoolontopatlaunch),nn=u&&(u.dataset.hiddentoolbydefault||u.dataset.hidden||u.dataset.collapsed||u.dataset.startHidden||""),on=y("colorForHighlight")||y("colorForHighligh")||u&&(u.dataset.colorForHighlight||u.dataset.colorForHighligh),Yt=y("colorForTextHighligh")||y("colorForTextHighlight")||u&&(u.dataset.colorForTextHighligh||u.dataset.colorForTextHighlight),_t=y("colorForElementHighlight")||y("colorForElementHighligh")||u&&(u.dataset.colorForElementHighlight||u.dataset.colorForElementHighligh),Jt="#4e9cf6",Q=ct(on||_t||Yt||Jt,Jt),an=ct(Yt||Q,Q),rn=ct(_t||Q,Q),At={text:It(an,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:It(rn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:It(Q,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let E=Lt!=null?q(Lt,!1)?"top":"bottom":u&&u.dataset.position||"bottom";const Wt="wn-toolbar-pos",st=u&&(u.dataset.dock||u.dataset.layout)||"",Zt=`uxnote:site:${k}`,Gt=`uxnote:annotator:${k}`,Qt=`uxnote:annotators:${k}`,te=`uxnote:import-files:${k}`,ee=`uxnote:hidden:${k}`,Nt=`uxnote:pending:${k}`,ne=(u&&u.dataset.serverUrl||"").trim().replace(/\/+$/,""),L=ne?{url:ne,apiKey:u&&u.dataset.serverApiKey||""}:null,oe=q(u&&u.dataset.jsonExport,!0),St=q(u&&u.dataset.jsonImport,!0),sn=q(u&&u.dataset.mailExport,!0),ln=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||u&&(u.dataset.isBackdropVisible||u.dataset.isbackdropvisible||u.dataset.backdropVisible||u.dataset.backdropvisible||u.dataset.dim||u.dataset.dimpage||u.dataset.dimmer||u.dataset.overlay||u.dataset.dimLevel||u.dataset.dimlevel||u.dataset.dimstrength),cn=.2,ae=q(ln,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:At,customPosition:!1,dimEnabled:ae,dimOpacity:ae?cn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},re=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function tt(){return re?re.matches:window.innerWidth<=640}function ie(){const t=On();t&&(E=t);const e=Pn(),n=Et!=null?!q(Et,!0):null;a.hidden=e!==null?e:n!==null?n:q(nn,!1),a.annotatorName=be(),a.annotatorNames=jn(),St&&(a.importFiles=Kn()),se(),Hn(),dn(),pn(),un(),pt(a.hidden),L?Ye():Xn(),dt(),yt(),Ft(),ze(),wo(),L||qe(),$n()}function se(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function dn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function pn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${E}`;const e=h=>{const p=document.createElement("button");return p.className="wn-annot-btn wn-annotator",p.setAttribute("data-action",h.action),h.mode&&p.setAttribute("data-mode",h.mode),p.setAttribute("data-tip",h.tip),p.innerHTML=h.icon,p},n=h=>{const p=document.createElement("div");return p.className="wn-annot-group wn-annotator",h.forEach(w=>p.appendChild(e(w))),p},o=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},r=document.createDocumentFragment(),i=document.createElement("div");i.className="wn-annot-logo wn-annotator",i.innerHTML=No(),r.appendChild(i);const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:He()},{action:"mode",mode:"element",tip:"Annotate an element",icon:So()}];Je()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:zo()});const c=[];St&&c.push({action:"import",tip:"Import JSON",icon:Mo()}),oe&&c.push({action:"export",tip:"Export JSON",icon:To()}),sn&&c.push({action:"mail",tip:"Send by mail",icon:$o()});const l=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:Oo()},{action:"toggle-panel",tip:"Show / hide annotations",icon:Ro()}];r.appendChild(o()),r.appendChild(n(s)),c.length&&(r.appendChild(o()),r.appendChild(n(c))),r.appendChild(o()),r.appendChild(n(l)),t.appendChild(r),document.body.appendChild(t),a.toolbar=t;const d=document.createElement("div");d.className="wn-annot-panel wn-annotator",d.innerHTML=`
    ...
    `,E==="left"&&(d.style.left="18px",d.style.right="auto"),document.body.appendChild(d),a.panel=d,tt()&&(d.style.display="none");const m=d.querySelector(".wn-annot-delete-all");m&&m.addEventListener("click",async h=>{h.stopPropagation(),await ko()});const f=document.createElement("div");f.className="wn-annot-marker-layer wn-annotator",document.body.appendChild(f),a.markerLayer=f;const g=document.createElement("div");g.className="wn-annot-outline wn-annotator",g.style.display="none",document.body.appendChild(g),a.outlineBox=g;const x=document.createElement("div");x.className="wn-annot-tip wn-annotator",x.textContent="Active mode",document.body.appendChild(x),a.tip=x,t.addEventListener("click",Vn),M(),ht(),ft(),K(),mt(),zn(),mn()}function le(){a.dimOverlay&&a.dimOverlay.classList.toggle("is-visible",!a.hidden)}function un(){if(!a.dimEnabled||a.dimOverlay)return;const t=document.createElement("div");t.className="wn-annot-dimmer",t.setAttribute("aria-hidden","true"),t.style.setProperty("--wn-dim-opacity",String(a.dimOpacity));const e=document.body.firstChild;e?document.body.insertBefore(t,e):document.body.appendChild(t),a.dimOverlay=t,le()}function ce(){if(!a.visibilityToggle)return;const t=a.visibilityToggle,n=tt()&&a.toolbar&&!a.hidden?a.toolbar:document.body;t.parentNode!==n&&(t.parentNode&&t.parentNode.removeChild(t),n===a.toolbar?a.toolbar.insertBefore(t,a.toolbar.firstChild):document.body.appendChild(t))}function mn(){if(a.visibilityToggle)return;const t=document.createElement("button");t.type="button",t.className="wn-annot-visibility-btn wn-annotator",t.setAttribute("aria-label","Masquer Uxnote"),t.setAttribute("data-tip","Masquer Uxnote"),t.innerHTML=je(),t.addEventListener("click",_n),a.visibilityToggle=t,ce(),ut(),Ce()}function fn(){if(a.commentModal)return a.commentModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator";const n=document.createElement("h4");n.textContent="Add a comment";const o=document.createElement("div");o.className="wn-annot-name-row wn-annotator";const r=document.createElement("label");r.textContent="Reviewer name";const i=document.createElement("div");i.className="wn-annot-name-inputs wn-annotator";const s=document.createElement("input");s.type="text",s.className="wn-annotator",s.placeholder="Reviewer name",i.appendChild(s),o.appendChild(r),o.appendChild(i);const c=document.createElement("textarea");c.className="wn-annotator",c.placeholder="Your comment...";const l=document.createElement("div");l.className="wn-annot-prio wn-annotator";const d=document.createElement("label");d.textContent="Priority";const m=document.createElement("div");m.className="wn-annot-prio-options wn-annotator";const f=(w,b)=>{const C=document.createElement("button");return C.type="button",C.className="wn-annot-prio-btn wn-annotator",C.setAttribute("data-priority",w),C.innerHTML=`<span class="dot wn-annotator"></span><span class="wn-annotator">${b}</span>`,C},g=[f("low","Low"),f("medium","Medium"),f("high","High")];g.forEach(w=>m.appendChild(w)),l.appendChild(d),l.appendChild(m);const x=document.createElement("div");x.className="wn-annot-actions wn-annotator";const h=document.createElement("button");h.type="button",h.className="wn-annot-pill cancel wn-annotator",h.textContent="Cancel";const p=document.createElement("button");return p.type="button",p.className="wn-annot-pill primary wn-annotator",p.textContent="Save",x.appendChild(h),x.appendChild(p),e.appendChild(n),e.appendChild(o),e.appendChild(c),e.appendChild(l),e.appendChild(x),t.appendChild(e),document.body.appendChild(t),a.commentModal={backdrop:t,modal:e,textarea:c,title:n,okBtn:p,cancelBtn:h,prioButtons:g,nameInput:s},a.commentModal}function de(t,e="",n="medium",o=""){return new Promise(r=>{const i=fn(),{backdrop:s,textarea:c,title:l,okBtn:d,cancelBtn:m,prioButtons:f,nameInput:g}=i;l.textContent=t||"Add a comment",c.value=e||"",c.placeholder="Your comment...",f.forEach(v=>v.classList.toggle("active",v.getAttribute("data-priority")===n));const x=v=>{f.forEach(T=>T.classList.remove("active")),v.classList.add("active")},h=f.map(v=>T=>x(v));f.forEach((v,T)=>v.addEventListener("click",h[T]));const p=a.annotatorNames||[],w=o||a.annotatorName||p[0]||"";g.value=w||"",g.disabled=!1,g.placeholder="Reviewer name",s.classList.add("show"),w?(c.focus(),c.select()):(g.focus(),g.select());const b=v=>{s.classList.remove("show"),d.removeEventListener("click",C),m.removeEventListener("click",O),s.removeEventListener("click",U),document.removeEventListener("keydown",D),f.forEach((T,N)=>T.removeEventListener("click",h[N])),r(v)},C=async()=>{const v=f.find(F=>F.classList.contains("active")),T=v?v.getAttribute("data-priority"):n,N=g.value.trim();if(!N){await Mt("Please enter a reviewer name.","Reviewer name required");return}ve(N),b({comment:c.value.trim(),priority:T,author:N})},O=()=>b(null),U=v=>{v.target===s&&b(null)},D=v=>{v.key==="Escape"&&b(null),v.key==="Enter"&&!(v.shiftKey||v.altKey)&&(v.preventDefault(),C())};d.textContent="Save",m.textContent="Cancel",d.addEventListener("click",C),m.addEventListener("click",O),s.addEventListener("click",U),document.addEventListener("keydown",D)})}async function Tt(t){const e=await de(t);return e||null}function hn(){if(a.exportModal)return a.exportModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-export-modal";const n=document.createElement("h4");n.textContent="Export annotations";const o=document.createElement("div");o.className="wn-annot-export-grid wn-annotator";const r=document.createElement("div");r.className="wn-annot-export-panel wn-annotator";const i=document.createElement("h5");i.textContent="Reviewers";const s=document.createElement("p");s.textContent="Choose reviewers to include.";const c=document.createElement("div");c.className="wn-annot-export-list wn-annotator",r.appendChild(i),r.appendChild(s),r.appendChild(c);const l=document.createElement("div");l.className="wn-annot-export-panel wn-annotator";const d=document.createElement("h5");d.textContent="Criticality";const m=document.createElement("p");m.textContent="Select priority levels.";const f=document.createElement("div");f.className="wn-annot-export-list wn-annotator",l.appendChild(d),l.appendChild(m),l.appendChild(f),o.appendChild(r),o.appendChild(l);const g=document.createElement("div");g.className="wn-annot-actions wn-annotator";const x=document.createElement("button");x.type="button",x.className="wn-annot-pill cancel wn-annotator",x.textContent="Cancel";const h=document.createElement("button");h.type="button",h.className="wn-annot-pill primary wn-annotator",h.textContent="Export file",g.appendChild(x),g.appendChild(h),e.appendChild(n),e.appendChild(o),e.appendChild(g),t.appendChild(e),document.body.appendChild(t);const p=()=>{t.classList.remove("show"),document.removeEventListener("keydown",w)},w=C=>{C.key==="Escape"&&p()},b=C=>{C.target===t&&p()};return x.addEventListener("click",p),t.addEventListener("click",b),h.addEventListener("click",()=>{const C=ue(c),O=ue(f);Eo({reviewers:C,priorities:O}),p()}),a.exportModal={backdrop:t,reviewerList:c,prioList:f,onKey:w},a.exportModal}function gn(){if(!oe)return;const t=hn();wn(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function wn(){if(!a.exportModal)return;const{reviewerList:t,prioList:e}=a.exportModal;t.innerHTML="",xn().forEach(n=>{t.appendChild(pe(n.value,n.label,!0))}),e.innerHTML="",bn().forEach(n=>{e.appendChild(pe(n.value,n.label,!0))})}function xn(){return Array.from(new Set(a.annotations.map(e=>(e.author||"").trim()||"__unknown"))).filter(Boolean).sort((e,n)=>V(e).localeCompare(V(n))).map(e=>({value:e,label:V(e)}))}function bn(){return[{value:"high",label:"High"},{value:"medium",label:"Medium"},{value:"low",label:"Low"}]}function pe(t,e,n){const o=document.createElement("label");o.className="wn-annot-export-item wn-annotator";const r=document.createElement("input");r.type="checkbox",r.value=t,r.checked=n,r.className="wn-annotator";const i=document.createElement("span");return i.textContent=e,o.appendChild(r),o.appendChild(i),o}function ue(t){return Array.from(t.querySelectorAll('input[type="checkbox"]')).filter(e=>e.checked).map(e=>e.value)}function yn(){if(a.importModal)return a.importModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-import-modal";const n=document.createElement("h4");n.textContent="Import JSON files";const o=document.createElement("div");o.className="wn-annot-import-body wn-annotator";const r=document.createElement("label");r.className="wn-annot-import-drop wn-annotator";const i=document.createElement("input");i.type="file",i.accept="application/json",i.multiple=!0,i.className="wn-annotator";const s=document.createElement("div"),c=document.createElement("div");c.className="wn-annot-import-drop-title wn-annotator",c.textContent="Drop JSON files here";const l=document.createElement("div");l.className="wn-annot-import-drop-sub wn-annotator",l.textContent="or click to select files",s.appendChild(c),s.appendChild(l),r.appendChild(i),r.appendChild(s);const d=document.createElement("div");d.className="wn-annot-import-grid wn-annotator";const m=document.createElement("div");m.className="wn-annot-import-panel wn-annotator";const f=document.createElement("div");f.className="wn-annot-import-title-row wn-annotator";const g=document.createElement("h5");g.textContent="Loaded files";const x=document.createElement("span");x.className="wn-annot-import-count wn-annotator",x.textContent="0";const h=document.createElement("p");h.textContent="Files are saved automatically.";const p=document.createElement("div");p.className="wn-annot-import-list wn-annotator",f.appendChild(g),f.appendChild(x),m.appendChild(f),m.appendChild(h),m.appendChild(p);const w=document.createElement("div");w.className="wn-annot-import-panel wn-annotator";const b=document.createElement("h5");b.textContent="Reviewer summary";const C=document.createElement("p");C.textContent="Counts based on imported files.";const O=document.createElement("div");O.className="wn-annot-import-stats wn-annotator";const U=document.createElement("div");U.className="wn-annot-import-stat wn-annotator";const D=document.createElement("span");D.textContent="Reviewers";const v=document.createElement("span");v.textContent="0",U.appendChild(D),U.appendChild(v);const T=document.createElement("div");T.className="wn-annot-import-stat wn-annotator";const N=document.createElement("span");N.textContent="Comments";const F=document.createElement("span");F.textContent="0",T.appendChild(N),T.appendChild(F),O.appendChild(U),O.appendChild(T);const A=document.createElement("div");A.className="wn-annot-import-list wn-annotator",w.appendChild(b),w.appendChild(C),w.appendChild(O),w.appendChild(A),d.appendChild(m),d.appendChild(w);const P=document.createElement("div");P.className="wn-annot-actions wn-annotator";const X=document.createElement("button");X.type="button",X.className="wn-annot-pill cancel wn-annotator",X.textContent="Close",P.appendChild(X),o.appendChild(r),o.appendChild(d),e.appendChild(n),e.appendChild(o),e.appendChild(P),t.appendChild(e),document.body.appendChild(t);const kt=()=>{t.classList.remove("show"),document.removeEventListener("keydown",We)},We=$=>{$.key==="Escape"&&kt()},Yo=$=>{$.target===t&&kt()};return X.addEventListener("click",kt),t.addEventListener("click",Yo),["dragenter","dragover"].forEach($=>{r.addEventListener($,S=>{S.preventDefault(),S.stopPropagation(),r.classList.add("dragover")})}),["dragleave","drop"].forEach($=>{r.addEventListener($,S=>{S.preventDefault(),S.stopPropagation(),r.classList.remove("dragover")})}),r.addEventListener("drop",$=>{var Ze;const S=(Ze=$.dataTransfer)==null?void 0:Ze.files;S&&S.length&&me(Array.from(S))}),i.addEventListener("change",$=>{const S=$.target.files;S&&S.length&&me(Array.from(S)),i.value=""}),p.addEventListener("click",$=>{const S=$.target.closest("[data-import-remove]");S&&An(S.dataset.importRemove)}),a.importModal={backdrop:t,modal:e,fileInput:i,fileList:p,reviewerList:A,filesCount:x,statReviewersValue:v,statCommentsValue:F,onKey:We,close:kt},a.importModal}function vn(){if(!St)return;const t=yn();lt(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function lt(){if(!a.importModal)return;const{fileList:t,reviewerList:e,filesCount:n,statReviewersValue:o,statCommentsValue:r}=a.importModal,{fileCounts:i,reviewerCounts:s,totalComments:c}=Cn();if(t.innerHTML="",a.importFiles.length)a.importFiles.forEach(l=>{const d=document.createElement("div");d.className="wn-annot-import-card wn-annotator";const m=document.createElement("div");m.className="wn-annot-import-meta wn-annotator";const f=document.createElement("div");f.className="wn-annot-import-name wn-annotator",f.textContent=l.name;const g=document.createElement("div");g.className="wn-annot-import-sub wn-annotator";const x=i.get(l.id)||0,h=l.pageUrl?` | ${Sn(l.pageUrl,36)}`:"";g.textContent=`${x} comments | ${Nn(l.size)}${h}`,m.appendChild(f),m.appendChild(g);const p=document.createElement("div");p.className="wn-annot-import-actions wn-annotator";const w=document.createElement("div");w.className="wn-annot-import-badge wn-annotator",w.textContent=String(x);const b=document.createElement("button");b.type="button",b.className="wn-annot-import-remove wn-annotator",b.dataset.importRemove=l.id,b.textContent="x",p.appendChild(w),p.appendChild(b),d.appendChild(m),d.appendChild(p),t.appendChild(d)});else{const l=document.createElement("div");l.className="wn-annot-import-empty wn-annotator",l.textContent="No imported files yet.",t.appendChild(l)}if(e.innerHTML="",s.size)Array.from(s.entries()).sort((l,d)=>d[1]-l[1]||l[0].localeCompare(d[0])).forEach(([l,d])=>{const m=document.createElement("div");m.className="wn-annot-import-card wn-annotator";const f=document.createElement("div");f.className="wn-annot-import-meta wn-annotator";const g=document.createElement("div");g.className="wn-annot-import-name wn-annotator",g.textContent=l;const x=document.createElement("div");x.className="wn-annot-import-sub wn-annotator",x.textContent=`${d} comments`,f.appendChild(g),f.appendChild(x);const h=document.createElement("div");h.className="wn-annot-import-badge wn-annotator",h.textContent=String(d),m.appendChild(f),m.appendChild(h),e.appendChild(m)});else{const l=document.createElement("div");l.className="wn-annot-import-empty wn-annotator",l.textContent="No reviewers yet.",e.appendChild(l)}n.textContent=String(a.importFiles.length),o.textContent=String(s.size),r.textContent=String(c)}function Cn(){const t=new Map,e=new Map,n=a.annotations.filter(o=>o.importFileId);return n.forEach(o=>{o.importFileId&&t.set(o.importFileId,(t.get(o.importFileId)||0)+1);const r=(o.author||"").trim()||"Unknown reviewer";e.set(r,(e.get(r)||0)+1)}),{fileCounts:t,reviewerCounts:e,totalComments:n.length}}async function me(t){if(!t||!t.length)return;const e=new Set(a.annotations.map(o=>o.id));let n=0;for(const o of t){const r=await kn(o,e);if(!r)continue;const{fileMeta:i,annotations:s}=r;s.length&&(a.importFiles.push(i),a.annotations.push(...s),n+=s.length)}if(!n){lt();return}R(),ye(),dt(),gt(),yt(),nt(),lt()}async function kn(t,e){let n;try{const d=await t.text();n=JSON.parse(d)}catch(d){return await Mt(`Invalid JSON in ${t.name}.`,"Import error"),null}const o=Array.isArray(n)?n:n.annotations;if(!Array.isArray(o))return await Mt(`Unsupported JSON format in ${t.name}.`,"Import error"),null;const r=Array.isArray(n)?"":n.exportedBy||n.annotator||n.author||"",i=Array.isArray(n)?t.lastModified:n.createdAt,s=Array.isArray(n)?"":n.pageUrl||"",c=Be(),l=o.filter(Ot).map(d=>En(d,{fallbackAuthor:r,createdAt:i,pageUrl:s,fileId:c,existingIds:e}));return{fileMeta:{id:c,name:t.name,size:t.size,pageUrl:s,importedAt:Date.now()},annotations:l}}function En(t,e){const n=t&&typeof t=="object"?t:{},o=(n.author||e.fallbackAuthor||"").trim(),r=n.pageUrl||e.pageUrl||window.location.href,i=Ln(n.id,e.existingIds),s=tn(Vt({},n),{id:i,createdAt:n.createdAt||e.createdAt||Date.now(),priority:n.priority||"medium",author:o,pageUrl:r,importFileId:e.fileId});return s.pageKey||(s.pageKey=z(r)),s}function Ln(t,e){if(t&&!e.has(t))return e.add(t),t;let n;do n=vt();while(e.has(n));return e.add(n),n}function An(t){const e=a.importFiles.filter(n=>n.id!==t);e.length!==a.importFiles.length&&(a.importFiles=e,a.annotations=a.annotations.filter(n=>n.importFileId!==t),R(),ye(),dt(),gt(),yt(),nt(),lt())}function Nn(t){if(!t)return"0 B";const e=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),e.length-1),o=t/Math.pow(1024,n);return`${o.toFixed(o<10&&n>0?1:0)} ${e[n]}`}function Sn(t,e){return typeof t!="string"?"":t.length<=e?t:t.slice(0,e-3)+"..."}function Tn(){if(a.dialogModal)return a.dialogModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator";const n=document.createElement("h4");n.className="wn-annotator";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator";const r=document.createElement("div");r.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",r.appendChild(i),r.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(r),t.appendChild(e),document.body.appendChild(t),a.dialogModal={backdrop:t,modal:e,title:n,message:o,okBtn:s,cancelBtn:i},a.dialogModal}function fe({title:t="Information",message:e="",okLabel:n="OK",cancelLabel:o="Cancel",dismissOnBackdrop:r=!0}){return new Promise(i=>{const{backdrop:s,title:c,message:l,okBtn:d,cancelBtn:m}=Tn();c.textContent=t,l.textContent=e,d.textContent=n;const f=!!o;m.style.display=f?"inline-flex":"none",m.textContent=o||"";const g=b=>{s.classList.remove("show"),d.removeEventListener("click",x),m.removeEventListener("click",h),s.removeEventListener("click",p),document.removeEventListener("keydown",w),i(b)},x=()=>g(!0),h=()=>g(!1),p=b=>{b.target===s&&r&&g(!1)},w=b=>{b.key==="Escape"&&g(!1),(b.metaKey||b.ctrlKey)&&b.key==="Enter"&&x()};d.addEventListener("click",x),m.addEventListener("click",h),s.addEventListener("click",p),document.addEventListener("keydown",w),s.classList.add("show"),d.focus()})}async function Mn(t,e="Confirmation"){return fe({title:e,message:t,okLabel:"Confirm",cancelLabel:"Cancel"})}async function Mt(t,e="Information"){await fe({title:e,message:t,okLabel:"OK",cancelLabel:null})}function $n(){document.addEventListener("mouseup",Pt),document.addEventListener("touchend",Pt),document.addEventListener("pointerup",Pt),document.addEventListener("mousemove",Wn),document.addEventListener("click",Zn,!0),window.addEventListener("resize",B),window.addEventListener("resize",ht),window.addEventListener("resize",ft),window.addEventListener("resize",K),window.addEventListener("resize",ut),window.addEventListener("scroll",B,{passive:!0})}function V(t){return t==="__unknown"?"Unknown":t}function $t(){if(!a.panel)return;const t=a.panel.querySelector("#wn-filter-priority"),e=a.panel.querySelector("#wn-filter-author"),n=a.panel.querySelector('[data-filter-clear="priority"]'),o=a.panel.querySelector('[data-filter-clear="author"]');n&&t&&(n.style.display=t.value==="all"?"none":"inline-flex"),o&&e&&(o.style.display=e.value==="all"?"none":"inline-flex")}function he(){if(!a.panel)return;const t=a.panel.querySelector("#wn-filter-author");if(!t)return;const e=a.filters.author||"all",n=Array.from(new Set(a.annotations.map(i=>(i.author||"").trim()||"__unknown"))).filter(i=>i);t.innerHTML="";const o=document.createElement("option");o.value="all",o.textContent="All",t.appendChild(o),n.sort((i,s)=>V(i).localeCompare(V(s))).forEach(i=>{const s=document.createElement("option");s.value=i,s.textContent=V(i),t.appendChild(s)});const r=["all",...n];t.value=r.includes(e)?e:"all",a.filters.author=t.value,$t()}function zn(){if(!a.panel)return;const t=a.panel.querySelector("#wn-filter-priority"),e=a.panel.querySelector("#wn-filter-author"),n=a.panel.querySelector("#wn-filter-search"),o=a.panel.querySelector('[data-filter-clear="priority"]'),r=a.panel.querySelector('[data-filter-clear="author"]');if(!t||!e||!n)return;t.value=a.filters.priority,e.value=a.filters.author,n.value=a.filters.query;const i=()=>{a.filters.priority=t.value,a.filters.author=e.value,a.filters.query=n.value.trim().toLowerCase(),M(),$t()};t.addEventListener("change",i),e.addEventListener("change",i),n.addEventListener("input",i),o&&o.addEventListener("click",()=>{t.value="all",i()}),r&&r.addEventListener("click",()=>{e.value="all",i()}),he(),$t()}function Y(t,e={}){const n=e.keepOutline;if(a.mode===t){a.mode=null,ge(),zt(),n||wt();return}a.mode=t,ge(),In(t),t!=="element"&&wt()}function ge(){a.toolbar.querySelectorAll('button[data-action="mode"]').forEach(e=>{e.getAttribute("data-mode")===a.mode?e.classList.add("active"):e.classList.remove("active")})}function In(t){let e="";if(t==="text"?e="Select text then release to add a note.":t==="element"&&(e="Hover an element, click to annotate."),!e)return zt();a.tip.textContent=e,a.tip.classList.add("show"),K(),requestAnimationFrame(K),requestAnimationFrame(K)}function zt(){a.tip.classList.remove("show")}function Rn(){if(a.toast)return a.toast;const t=document.createElement("div");return t.className="wn-annot-toast wn-annotator",t.setAttribute("aria-live","polite"),document.body.appendChild(t),a.toast=t,t}function _(t){if(!t)return;const e=Rn();e.textContent=t,e.classList.add("show"),a.toastTimer&&clearTimeout(a.toastTimer),a.toastTimer=setTimeout(()=>{e.classList.remove("show")},2200)}function On(){try{const t=localStorage.getItem(Wt);if(t==="top"||t==="bottom")return t}catch(t){}return null}function Pn(){try{const t=localStorage.getItem(ee);return t==null?null:t==="true"}catch(t){return null}}function Bn(t){try{localStorage.setItem(ee,t?"true":"false")}catch(e){}}function Hn(){if(!document||!document.documentElement)return;const t=document.documentElement,e=a.colors||At,n=(i,s)=>{s&&t.style.setProperty(i,s)},o=e.text,r=e.element;n("--wn-text-highlight",o.base),n("--wn-text-highlight-overlay",o.overlay),n("--wn-text-highlight-soft",o.soft),n("--wn-element-highlight",r.base),n("--wn-element-highlight-soft",r.soft),n("--wn-element-highlight-soft-end",r.softer),n("--wn-element-highlight-strong",r.strong),n("--wn-element-highlight-shadow",r.shadow),n("--wn-marker-text",r.text)}function It(t,e={}){var s,c,l;const n=ct(t,"#000000"),o=(s=e.softAlpha)!=null?s:.12,r=(c=e.softerAlpha)!=null?c:.04,i=(l=e.overlayAlpha)!=null?l:.7;return{base:n,overlay:I(n,i,I("#000000",i)),soft:I(n,o,I("#000000",o)),softer:I(n,r,I("#000000",r)),strong:I(n,.9,n),shadow:I(n,.24,"rgba(0,0,0,0.24)"),pill:I(n,.16,"rgba(0,0,0,0.16)"),pillBorder:I(n,.28,"rgba(0,0,0,0.28)"),text:Un(n)}}function ct(t,e){const n=Rt(t);return n||Rt(e)||"#000000"}function Rt(t){if(!t||typeof t!="string")return null;const n=t.trim().match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i);if(!n)return null;const o=n[1];return`#${(o.length===3?o.split("").map(i=>i+i).join(""):o).toLowerCase()}`}function we(t){const e=Rt(t);if(!e)return null;const n=parseInt(e.slice(1),16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function I(t,e=1,n=""){const o=we(t);if(!o)return n||"";const r=typeof e=="number"&&e>=0&&e<=1?e:1;return`rgba(${o.r}, ${o.g}, ${o.b}, ${r})`}function Un(t){const e=we(t);return e?.299*e.r+.587*e.g+.114*e.b>160?"#0b1622":"#ffffff":"#0b1622"}function j(t){const e=a.colors||At,n=t&&t.type;return n==="text"?e.text:n==="screenshot"?e.screenshot:e.element}function xe(t,e){!t||!e||(t.style.setProperty("--wn-marker-bg",e.base),t.style.setProperty("--wn-marker-text",e.text),t.style.setProperty("--wn-marker-shadow",e.shadow))}function Fn(t,e){!t||!e||(t.style.setProperty("--wn-item-accent",e.base),t.style.setProperty("--wn-item-accent-strong",e.strong),t.style.setProperty("--wn-item-accent-shadow",e.shadow),t.style.setProperty("--wn-item-accent-soft",e.soft),t.style.setProperty("--wn-item-accent-soft-end",e.softer),t.style.setProperty("--wn-item-number-bg",e.pill),t.style.setProperty("--wn-item-number-border",e.pillBorder),t.style.setProperty("--wn-item-number-text","#000000"))}function q(t,e=!1){if(t==null||t==="")return e;const n=String(t).toLowerCase();return n==="true"||n==="1"||n==="yes"||n==="on"?!0:n==="false"||n==="0"||n==="no"||n==="off"?!1:e}function be(){try{return localStorage.getItem(Gt)||""}catch(t){return""}}function Dn(t){try{localStorage.setItem(Gt,t)}catch(e){}}function jn(){try{const t=localStorage.getItem(Qt),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>typeof n=="string"&&n.trim()).map(n=>n.trim()):[]}catch(t){return[]}}function qn(t){try{localStorage.setItem(Qt,JSON.stringify(t||[]))}catch(e){}}function Kn(){try{const t=localStorage.getItem(te),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>n&&typeof n=="object").map(n=>({id:n.id||Be(),name:String(n.name||"Imported file"),size:Number(n.size||0),pageUrl:typeof n.pageUrl=="string"?n.pageUrl:"",importedAt:Number(n.importedAt||0)})):[]}catch(t){return[]}}function ye(){try{localStorage.setItem(te,JSON.stringify(a.importFiles||[]))}catch(t){}}function ve(t){const e=(t||"").trim();if(!e)return;a.annotatorName=e;const n=[e,...a.annotatorNames.filter(o=>o!==e)];a.annotatorNames=n,Dn(e),qn(n)}function dt(){const t=Array.from(new Set((a.annotations||[]).map(n=>(n.author||"").trim()).filter(Boolean))),e=Array.from(new Set([...a.annotatorNames||[],...t]));a.annotatorNames=e,a.annotatorName||(a.annotatorName=be()||e[0]||"")}function ea(t,e={}){if(!t)return!1;const n=e.force||!1;let o=!1;return a.annotations.forEach(r=>{!n&&r.author||(r.author!==t&&(o=!0),r.author=t)}),o&&R(),o}function K(){if(!a.tip||!a.toolbar)return;const t=a.toolbar.getBoundingClientRect(),e=a.tip,n=10,o=t.left+t.width/2,r=E==="bottom";e.style.left=`${o}px`,e.style.right="",e.style.transform="translateX(-50%)",e.style.top="",e.style.bottom="";const i=e.getBoundingClientRect();if(r){const s=Math.max(8,t.top-n-i.height);e.style.top=`${s}px`}else{const s=t.bottom+n;e.style.top=`${s}px`}}function Ot(t){return!!t&&(t.type==="text"||t.type==="element"||t.type==="screenshot")}function Xn(){try{const t=localStorage.getItem(Zt),e=t?JSON.parse(t):[];a.annotations=(e||[]).filter(Ot),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=z(n.pageUrl||window.location.href))})}catch(t){console.warn("Annotator storage error",t),a.annotations=[]}}function R(){if(L){_e();return}try{localStorage.setItem(Zt,JSON.stringify(a.annotations))}catch(t){console.warn("Annotator storage save error",t)}}async function Vn(t){const e=t.target.closest("button");if(!e||!e.classList.contains("wn-annotator"))return;const n=e.getAttribute("data-action");if(n){if(n==="mode"){const o=e.getAttribute("data-mode");if(o==="screenshot"){await qo();return}Y(o);return}if(n==="export"){gn();return}if(n==="import"){vn();return}if(n==="mail"){await Lo();return}if(n==="toggle-panel"){Yn();return}if(n==="toggle-pos"){Jn(E==="bottom"?"top":"bottom"),ke();return}}}function Yn(){const t=a.panel.style.display==="none";a.panel.style.display=t?"":"none",mt()}function _n(){pt(!a.hidden)}function pt(t){a.hidden=t,Bn(t),document.body.classList.toggle("wn-annot-hidden",t),t&&(Y(null),zt(),wt()),Ce(),le(),ut(),ht(),t||(B(),ft(),K()),document.dispatchEvent(new CustomEvent("uxnote:visibility",{detail:{hidden:t}}))}function Ce(){if(!a.visibilityToggle)return;const t=a.hidden?"Show Uxnote":"Hide Uxnote";a.visibilityToggle.classList.toggle("is-muted",a.hidden),a.visibilityToggle.innerHTML=a.hidden?Po():je(),a.visibilityToggle.setAttribute("aria-label",t),a.visibilityToggle.setAttribute("aria-pressed",a.hidden?"true":"false"),a.visibilityToggle.setAttribute("data-tip",t)}function ut(){const t=a.visibilityToggle;if(!t)return;ce();const e=18;if(tt()){a.hidden?(t.style.bottom=`${e}px`,t.style.left=`${e}px`,t.style.top="",t.style.right=""):(t.style.top="",t.style.right="",t.style.bottom="",t.style.left="");return}t.style.left="",t.style.right="",E==="top"?(t.style.top=`${e}px`,t.style.bottom=""):(t.style.bottom=`${e}px`,t.style.top="")}function mt(){if(!a.panel||!a.toolbar)return;const t=a.toolbar.querySelector('button[data-action="toggle-panel"]');if(!t)return;const e=a.panel.style.display==="none";t.classList.toggle("active",!e)}function ft(){if(!a.panel||!a.toolbar)return;const t=a.panel,e=18,n=a.toolbar.getBoundingClientRect();if(tt()){t.style.width="100vw",t.style.maxHeight="100vh",t.style.height="100vh",t.style.left="0",t.style.right="0",t.style.top="0",t.style.bottom="0",t.style.borderRadius="0";return}t.style.width=`min(360px, calc(100vw - ${e*2}px))`,t.style.maxHeight=`calc(100vh - ${e*2}px)`,t.style.left="auto",t.style.right=`${e}px`,t.style.top=`${e}px`,t.style.bottom=`${e}px`,t.style.height="",t.style.borderRadius="",E==="left"?(t.style.left=`${n.width+e}px`,t.style.right=`${e}px`):E==="right"&&(t.style.right=`${n.width+e}px`,t.style.left=`${e}px`)}function Jn(t){E=t==="top"?"top":"bottom";const e=a.toolbar;e&&(e.classList.remove("wn-pos-top","wn-pos-bottom","wn-pos-left","wn-pos-right"),e.classList.add(`wn-pos-${E}`));try{localStorage.setItem(Wt,E)}catch(n){}ke(),ut(),K(),ft(),ht()}function ke(){if(!a.toolbar)return;const t=a.toolbar.querySelector('button[data-action="toggle-pos"]');t&&(t.innerHTML=E==="top"?Fe():De())}function ht(){if(!a.toolbar||a.customPosition||!(st==="push"||st==="dock"||st==="pad"||st==="true"))return;const t=document.body;a.basePadding||se();const e=a.basePadding;if(a.hidden){t.style.paddingTop=`${e.top}px`,t.style.paddingRight=`${e.right}px`,t.style.paddingBottom=`${e.bottom}px`,t.style.paddingLeft=`${e.left}px`;return}const n=a.toolbar.getBoundingClientRect(),o=Vt({},e);E==="top"?o.top=e.top+n.height:E==="bottom"?o.bottom=e.bottom+n.height:E==="left"?o.left=e.left+n.width:E==="right"&&(o.right=e.right+n.width),t.style.paddingTop=`${o.top}px`,t.style.paddingRight=`${o.right}px`,t.style.paddingBottom=`${o.bottom}px`,t.style.paddingLeft=`${o.left}px`}async function Pt(){if(a.mode!=="text")return;const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return;const e=t.getRangeAt(0);if(!e)return;if(!(J(e.commonAncestorContainer)&&J(e.startContainer)&&J(e.endContainer))){t.removeAllRanges(),_("Cette zone est une popup/overlay, annotation bloqu\xE9e.");return}const o=t.toString().trim();if(!o)return;const r=await Tt("Comment for this highlight?");if(!r)return;const{comment:i,priority:s,author:c}=r,l=vt(),d=to(e,o),m=xt(e,l);t.removeAllRanges();const f={id:l,type:"text",target:d,comment:i.trim(),author:c||a.annotatorName||"",priority:s||"medium",snippet:o.slice(0,180),pageUrl:window.location.href,pageKey:z(window.location.href),createdAt:Date.now(),status:"active"};a.annotations.push(f),R(),W(f,m),M(),Y(null,{keepOutline:!0})}function Wn(t){if(a.mode!=="element")return;const e=t.target;if(!e||!J(e)){wt();return}const n=e.getBoundingClientRect();Qn(n)}async function Zn(t){if(a.mode!=="element")return;const e=t.target;if(!e||!J(e)){_("Cette zone est une popup/overlay, annotation bloqu\xE9e.");return}t.preventDefault(),t.stopPropagation();const n=await Tt("Comment for this element?");if(!n)return;const{comment:o,priority:r,author:i}=n,s=vt(),c=Ht(e),l=io(e),d=e.getBoundingClientRect(),m={id:s,type:"element",target:{xpath:c,css:l,tag:e.tagName.toLowerCase()},comment:o.trim(),author:i||a.annotatorName||"",priority:r||"medium",snippet:e.innerText?e.innerText.trim().slice(0,120):e.tagName,pageUrl:window.location.href,pageKey:z(window.location.href),rect:{x:d.x+window.scrollX,y:d.y+window.scrollY,w:d.width,h:d.height},createdAt:Date.now(),status:"active"};a.annotations.push(m),R(),W(m,e),Me(e,s),M(),Y(null,{keepOutline:!0})}function Bt(t){const e=t&&t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}}function et(t){const e=a.highlightSpans[t];return e?Array.isArray(e)?e:[e]:Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`))}function gt(){Object.keys(a.highlightSpans||{}).forEach(t=>{et(t).forEach(e=>{e&&e.parentNode&&Bt(e)})}),a.highlightSpans={},Array.from(document.querySelectorAll(".uxnote-textmark[data-uxnote-id], .wn-annot-highlight[data-wn-annot-id]")).forEach(t=>{t&&t.parentNode&&Bt(t)}),Object.values(a.markers||{}).forEach(t=>{t&&t.el&&t.el.parentNode&&t.el.parentNode.removeChild(t.el)}),a.markerLayer&&(a.markerLayer.innerHTML=""),a.markers={},Object.keys(a.elementTargets||{}).forEach(t=>{$e(t)}),a.elementTargets={},Array.from(document.querySelectorAll(".uxnote-annotated[data-uxnote-ids]")).forEach(t=>{delete t.dataset.uxnoteIds,t.classList.remove("uxnote-annotated")})}function Gn(t){const e=a.markers[t];e&&e.el&&e.el.parentNode&&e.el.parentNode.removeChild(e.el),e&&e.frame&&e.frame.parentNode&&e.frame.parentNode.removeChild(e.frame),delete a.markers[t],$e(t);let n=et(t);n.length||(n=Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)),n.length||(n=Array.from(document.querySelectorAll(`.wn-annot-highlight[data-wn-annot-id="${t}"]`)))),n.forEach(o=>{o&&Bt(o)}),delete a.highlightSpans[t]}function nt(){Object.entries(a.markers).forEach(([t,e])=>{const n=a.annotations.findIndex(o=>o.id===t);n!==-1&&(e.el.textContent=n+1)})}function Qn(t){const e=a.outlineBox;e.style.display="block",e.style.left=`${t.x+window.scrollX}px`,e.style.top=`${t.y+window.scrollY}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`}function wt(){a.outlineBox.style.display="none"}function Ee(t){return t?t.classList&&t.classList.contains("wn-annotator")||t.parentElement&&Ee(t.parentElement):!1}function J(t){if(!t)return!1;const e=t.nodeType===Node.ELEMENT_NODE?t:t.nodeType===Node.DOCUMENT_NODE?document.body:t.parentElement;if(!e||Ee(e))return!1;if(e.closest){if(e.closest("[data-uxnote-ignore]"))return!1;if(e.closest("[data-uxnote-allow]"))return!0;if(e.closest('#uxnote-root, .wn-annotator, dialog, [popover], [role="dialog"], [role="menu"], [role="tooltip"], [aria-modal="true"]'))return!1}return!0}function to(t,e){return{startXPath:Ht(t.startContainer),startOffset:t.startOffset,endXPath:Ht(t.endContainer),endOffset:t.endOffset,quote:e?String(e).slice(0,200):""}}function xt(t,e){let n=[];const o=t.cloneRange();if(eo(o).forEach(i=>{const s=no(i,{start:i===o.startContainer?o.startOffset:0,end:i===o.endContainer?o.endOffset:i.length},e);s&&n.push(s)}),!n.length){const i=document.createElement("span");i.className="uxnote-textmark",i.dataset.uxnoteId=e,i.addEventListener("click",c=>{c.stopPropagation(),rt(e)});const s=o.extractContents();i.appendChild(s),o.insertNode(i),n=[i]}return a.highlightSpans[e]=n,n[0]}function na(t,e){return xt(t,e)}function Le(t,e){const n=document.createRange();return n.selectNodeContents(e),t.compareBoundaryPoints(Range.END_TO_START,n)>0&&t.compareBoundaryPoints(Range.START_TO_END,n)<0}function eo(t){const e=[],n=document.createTreeWalker(t.commonAncestorContainer,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();)if(!(!o.nodeValue||!o.nodeValue.trim())){try{if(t.intersectsNode){if(!t.intersectsNode(o))continue}else if(!Le(t,o))continue}catch(r){if(!Le(t,o))continue}e.push(o)}return e}function no(t,e,n){if(!t||!t.parentNode)return null;const{start:o,end:r}=e;let i=t,s=r;if(o>0&&(i=i.splitText(o),s=r-o),s<i.length&&i.splitText(s),!i.parentNode)return null;const c=document.createElement("span");return c.className="uxnote-textmark",c.dataset.uxnoteId=n,c.addEventListener("click",l=>{l.stopPropagation(),rt(n)}),i.parentNode.insertBefore(c,i),c.appendChild(i),c}function Ae(t){return t?typeof t.isConnected=="boolean"?t.isConnected:document.body&&document.body.contains(t):!1}function oo(t,e){if(!t||!e)return null;const n=Math.max(t.x,e.x),o=Math.max(t.y,e.y),r=Math.min(t.x+t.width,e.x+e.width),i=Math.min(t.y+t.height,e.y+e.height),s=r-n,c=i-o;return s<=0||c<=0?null:{x:n,y:o,width:s,height:c}}function Ne(t){if(!t||!Ae(t)||!t.getBoundingClientRect)return null;let e=t.getBoundingClientRect();if(!e.width||!e.height)return null;let n=t;for(;n&&n.nodeType===1;){if(n.tagName==="DETAILS"&&!n.open){const d=n.querySelector("summary");if(d&&!d.contains(t))return null}if(n.hasAttribute&&n.hasAttribute("hidden")||(n.getAttribute&&n.getAttribute("aria-hidden"))==="true")return null;const r=window.getComputedStyle(n);if(r.display==="none"||r.visibility==="hidden"||r.visibility==="collapse"||r.opacity==="0")return null;const i=r.overflowX||r.overflow,s=r.overflowY||r.overflow;if(i&&i!=="visible"||s&&s!=="visible"){const d=n.getBoundingClientRect(),m=oo(e,d);if(!m)return null;e=m}n=n.parentElement}return e}function ao(t){let e=t&&t.nodeType===1?t:null;for(;e&&e.nodeType===1&&e!==document.body;){const n=window.getComputedStyle(e),o=n.zIndex;if(n.position!=="static"&&o!=="auto"||n.opacity!=="1"||n.transform!=="none"||n.filter!=="none"||n.perspective!=="none"||n.mixBlendMode!=="normal"||n.isolation==="isolate"||n.willChange&&n.willChange!=="auto"||n.contain&&n.contain!=="none")return e;e=e.parentElement}return document.body}function Se(t){if(!t||t.nodeType!==1)return a.markerLayer||document.body;const e=t.offsetParent;return e&&e.nodeType===1?e:ao(t)||a.markerLayer||document.body}function Te(t){return t===document.body||t===a.markerLayer||t===document.documentElement}function ro(t){if(!t||t.nodeType!==1)return!1;let e=!1,n=t;for(;n&&n.nodeType===1&&n!==document.body;){if(n.tagName==="DETAILS"&&!n.open&&(n.open=!0,e=!0),n.tagName==="DIALOG"&&!n.open)try{typeof n.showModal=="function"?n.showModal():typeof n.show=="function"&&n.show(),e=!0}catch(r){}if(n.hasAttribute&&n.hasAttribute("popover"))try{typeof n.showPopover=="function"&&(n.showPopover(),e=!0)}catch(r){}if(n.hasAttribute&&n.hasAttribute("data-uxnote-open")){const r=n.getAttribute("data-uxnote-open");if(r){const i=document.querySelector(r);i&&typeof i.click=="function"&&(i.click(),e=!0)}}const o=n.getAttribute&&n.getAttribute("aria-hidden");if(n.hasAttribute&&n.hasAttribute("hidden")||o==="true"){const r=n.id;if(r){const i=document.querySelector(`[aria-controls="${bt(r)}"]`);i&&typeof i.click=="function"&&(i.click(),e=!0)}}n=n.parentElement}return e}function Me(t,e){if(!t||t.nodeType!==1)return!1;const n=t.dataset.uxnoteIds?t.dataset.uxnoteIds.split(",").filter(Boolean):[],o=new Set(n);return o.add(e),t.dataset.uxnoteIds=Array.from(o).join(","),t.classList.add("uxnote-annotated"),a.elementTargets[e]=t,!0}function $e(t){const e=a.elementTargets[t];if(!e||e.nodeType!==1){delete a.elementTargets[t],Array.from(document.querySelectorAll("[data-uxnote-ids]")).forEach(i=>{const s=i.dataset.uxnoteIds?i.dataset.uxnoteIds.split(",").filter(Boolean):[];if(!s.includes(t))return;const c=s.filter(l=>l!==t);c.length?i.dataset.uxnoteIds=c.join(","):(delete i.dataset.uxnoteIds,i.classList.remove("uxnote-annotated"))});return}const o=(e.dataset.uxnoteIds?e.dataset.uxnoteIds.split(",").filter(Boolean):[]).filter(r=>r!==t);o.length?e.dataset.uxnoteIds=o.join(","):(delete e.dataset.uxnoteIds,e.classList.remove("uxnote-annotated")),delete a.elementTargets[t]}function Ht(t){if(t===document.body)return"/html/body";const e=[];for(;t&&t!==document;){let n=1,o=t.previousSibling;for(;o;)o.nodeType===t.nodeType&&o.nodeName===t.nodeName&&n++,o=o.previousSibling;const r=t.nodeType===3?"text()":t.nodeName.toLowerCase();if(e.unshift(`${r}[${n}]`),t=t.parentNode,!t||t.nodeType!==1)break}return"/"+e.join("/")}function bt(t){return window.CSS&&typeof window.CSS.escape=="function"?window.CSS.escape(t):String(t).replace(/[^a-zA-Z0-9_-]/g,"\\$&")}function io(t){if(!t||t.nodeType!==1)return"";if(t.id)return`#${bt(t.id)}`;const e=[];let n=t,o=0;for(;n&&n.nodeType===1&&o<4;){let r=n.tagName.toLowerCase();const i=Array.from(n.classList||[]).filter(s=>s&&!s.startsWith("wn-")&&!s.startsWith("uxnote-"));if(i.length&&(r+=`.${i.slice(0,2).map(bt).join(".")}`),e.unshift(r),n.parentElement&&n.parentElement.id){e.unshift(`#${bt(n.parentElement.id)}`);break}n=n.parentElement,o+=1}return e.join(" > ")}function ot(t){try{const e=document;return e.evaluate(t,e,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue}catch(e){return null}}function yt(){a.annotations.forEach(t=>{t.pageKey===z(window.location.href)&&so(t)}),M()}function so(t){const e=at(t);if(!e){t.status="missing",ze();return}t.status="active",Ut(t,e)}function Ut(t,e){if(e){if(e.type==="screenshot"){W(t,null);return}if(e.type==="text"&&e.range){const n=xt(e.range,t.id);W(t,n);return}e.type==="element"&&e.el&&(Me(e.el,t.id),W(t,e.el))}}function lo(t){if(!t)return null;const e=ot(t.startXPath),n=ot(t.endXPath);if(!e||!n)return null;try{const o=document.createRange();return o.setStart(e,t.startOffset),o.setEnd(n,t.endOffset),o}catch(o){return null}}function at(t){return t?t.type==="screenshot"?t.rect?{type:"screenshot"}:null:t.target?t.type==="text"?co(t):t.type==="element"?uo(t):null:null:null}function co(t){const e=t.target||{},n=lo(e);if(n)return{type:"text",range:n};const o=e.quote||t.snippet||"";if(!o)return null;const r=po(o);return r?{type:"text",range:r}:null}function po(t){const e=String(t||"").trim();if(!e||e.length<4)return null;const n=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();){if(!o.nodeValue||!o.nodeValue.trim()||!J(o))continue;const r=o.nodeValue.indexOf(e);if(r===-1)continue;const i=document.createRange();return i.setStart(o,r),i.setEnd(o,r+e.length),i}return null}function uo(t){const e=t.target||{};if(e.xpath){const r=ot(e.xpath);if(r&&r.nodeType===1)return{type:"element",el:r}}if(e.css)try{const r=document.querySelector(e.css);if(r&&r.nodeType===1)return{type:"element",el:r}}catch(r){}const n=e.tag,o=(t.snippet||"").trim();if(n&&o){const r=document.querySelectorAll(n);for(const i of r)if(!(!i||i.nodeType!==1)&&(i.textContent||"").includes(o))return{type:"element",el:i}}return null}function mo(){a.missingRetryTimer&&clearTimeout(a.missingRetryTimer),a.missingRetryTimer=setTimeout(()=>{Ft()},300)}function ze(){a.missingObserver||!window.MutationObserver||(a.missingObserver=new MutationObserver(()=>{a.annotations.some(t=>t.status==="missing")&&mo()}),a.missingObserver.observe(document.body,{childList:!0,subtree:!0}))}function fo(){a.missingObserver&&(a.missingObserver.disconnect(),a.missingObserver=null)}function Ft(){let t=!1;a.annotations.forEach(e=>{if(e.status!=="missing"||e.pageKey!==z(window.location.href))return;const n=at(e);n&&(e.status="active",Ut(e,n),t=!0)}),t&&(R(),M(),B()),a.annotations.some(e=>e.status==="missing")||fo()}function ho(){let t=!1;a.annotations.forEach(e=>{if(e.type!=="text"||e.pageKey!==z(window.location.href))return;const n=et(e.id).filter(Ae);if(n.length){a.highlightSpans[e.id]=n,e.status==="missing"&&(e.status="active",t=!0);return}const o=at(e);if(o&&o.range){xt(o.range,e.id),e.status="active",t=!0;return}e.status!=="missing"&&(e.status="missing",t=!0)}),t&&(R(),M(),B())}function go(){a.layoutTimer&&clearTimeout(a.layoutTimer),a.layoutTimer=setTimeout(()=>{B(),ho(),a.annotations.some(t=>t.status==="missing")&&Ft()},120)}function wo(){a.layoutObserver||!window.MutationObserver||(a.layoutObserver=new MutationObserver(t=>{t.some(n=>{const o=n.target;return!(!o||o.classList&&o.classList.contains("wn-annotator")||o.closest&&o.closest(".wn-annotator"))})&&go()}),a.layoutObserver.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class","open","hidden","aria-hidden"]}))}function W(t,e){if(t.pageKey!==z(window.location.href)||!a.markerLayer)return;const n=a.markers[t.id];n&&n.el&&n.el.parentNode&&n.el.parentNode.removeChild(n.el);const o=document.createElement("div");o.className="wn-annot-marker wn-annotator",o.textContent=a.annotations.findIndex(l=>l.id===t.id)+1,o.dataset.wnAnnotId=t.id;const r=j(t);xe(o,r),o.addEventListener("click",()=>rt(t.id));const i=Re(t,e),s=Ie(t,i),c=Se(i&&i.anchor?i.anchor:e);if(o.parentNode!==c&&c.appendChild(o),o.style.zIndex=Te(c)?"":"9999",!i){o.style.display="none",a.markers[t.id]={el:o,rect:null,frame:s};return}o.style.display="",Oe(o,i,t),a.markers[t.id]={el:o,rect:i,frame:s}}function Ie(t,e){const n=a.markers[t.id];let o=n?n.frame:null;if(t.type!=="screenshot"||!e)return o&&o.parentNode&&o.parentNode.removeChild(o),null;o||(o=document.createElement("div"),o.className="wn-annot-shot-frame wn-annotator");const r=a.markerLayer||document.body;return o.parentNode!==r&&r.appendChild(o),o.style.setProperty("--wn-shot-frame",j(t).base),o.style.left=`${e.x}px`,o.style.top=`${e.y}px`,o.style.width=`${e.w}px`,o.style.height=`${e.h}px`,o}function Re(t,e){var n;if(t.type==="text"){const r=(e?[e]:et(t.id))[0]||document.querySelector(`.uxnote-textmark[data-uxnote-id="${t.id}"]`);if(!r)return null;const i=Ne(r);return i?{x:i.x,y:i.y,w:i.width,h:i.height,anchor:r}:null}if(t.type==="element"){const o=(e&&e.nodeType===1?e:null)||a.elementTargets[t.id]||((n=t.target)!=null&&n.xpath?ot(t.target.xpath):null);if(!o)return null;const r=Ne(o);return r?{x:r.x,y:r.y,w:r.width,h:r.height,anchor:o}:null}if(t.type==="screenshot"){const o=t.rect;return o?{x:o.x-window.scrollX,y:o.y-window.scrollY,w:o.w,h:o.h,anchor:null}:null}return null}function Oe(t,e,n){const o=xo(n),i=(t.offsetParent||document.body).getBoundingClientRect(),s=i.x+window.scrollX,c=i.y+window.scrollY,l=e.x+window.scrollX,d=e.y+window.scrollY;t.style.left=`${l-s+e.w+o.x+4}px`,t.style.top=`${d-c+o.y-4}px`}function xo(t){if(t.type!=="element")return{x:0,y:0};const e=t.target&&t.target.xpath;if(!e)return{x:0,y:0};const n=a.annotations.filter(i=>i.type==="element"&&i.pageKey===t.pageKey&&i.target&&i.target.xpath===e);if(n.length<=1)return{x:0,y:0};const o=n.findIndex(i=>i.id===t.id);return o<=0?{x:0,y:0}:{x:-o*24,y:0}}function B(){Object.entries(a.markers).forEach(([t,e])=>{const n=a.annotations.find(i=>i.id===t);if(!n)return;const o=n.status==="missing"?null:Re(n);if(e.frame=Ie(n,o),!o){e.el.style.display="none",e.rect=null;return}e.el.style.display="",e.rect=o;const r=Se(o.anchor);e.el.parentNode!==r&&r.appendChild(e.el),e.el.style.zIndex=Te(r)?"":"9999",Oe(e.el,o,n),xe(e.el,j(n))})}function bo(){if(!a.panel)return;a.panel.style.display==="none"&&(a.panel.style.display="",mt())}function yo(t){if(!a.panel)return;bo();const e=a.panel.querySelector(".wn-annot-list");if(!e)return;e.querySelectorAll(".wn-annot-item").forEach(r=>r.classList.remove("is-focused"));const o=e.querySelector(`.wn-annot-item[data-id="${t}"]`);o&&(o.classList.add("is-focused"),o.scrollIntoView({behavior:"smooth",block:"nearest"}))}function rt(t,e=!1,n,o){var c;const r=a.annotations.find(l=>l.id===t);if(!r)return;if(yo(t),r.status==="missing"){const l=at(r);if(l)r.status="active",Ut(r,l),M();else{_("Annotation introuvable sur cette page.");return}}const i=at(r);if(i){const l=i.type==="element"?i.el:i.range&&i.range.commonAncestorContainer?i.range.commonAncestorContainer.parentElement:null;l&&ro(l)&&setTimeout(()=>{B()},160)}if(!((o||r.pageKey)===z(window.location.href))&&e){try{localStorage.setItem(Nt,JSON.stringify({id:r.id,pageKey:r.pageKey,pageUrl:n||r.pageUrl}))}catch(l){}window.location.href=n||r.pageUrl||window.location.href;return}if(r.type==="text"){const d=(et(t)||Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)))[0];d&&(d.scrollIntoView({behavior:"smooth",block:"center"}),Dt(d,j(r).base))}else if(r.type==="element"){const l=i&&i.el?i.el:(c=r.target)!=null&&c.xpath?ot(r.target.xpath):null;l&&l.scrollIntoView&&(l.scrollIntoView({behavior:"smooth",block:"center"}),Dt(l,j(r).base))}else if(r.type==="screenshot"&&r.rect){window.scrollTo({top:Math.max(0,r.rect.y+r.rect.h/2-window.innerHeight/2),behavior:"smooth"});const l=a.markers[r.id];l&&l.frame&&Dt(l.frame,j(r).base)}}function Dt(t,e){var i,s;t.style.transition="box-shadow 0.2s ease";const n=t.style.boxShadow,o=e||((s=(i=a.colors)==null?void 0:i.element)==null?void 0:s.base)||"#4e9cf6",r=I(o,.6,"rgba(78,156,246,0.6)");t.style.boxShadow=`0 0 0 3px ${r}`,setTimeout(()=>{t.style.boxShadow=n},800)}function Pe(){if(!a.panel)return null;let t=a.panel.querySelector(".wn-annot-footer");if(!t){t=document.createElement("div"),t.className="wn-annot-footer wn-annotator";const e=document.createElement("a");e.href="https://uxnote.ninefortyone.studio",e.target="_blank",e.rel="noreferrer noopener",e.textContent="\xA9 UxNote \u2013 by NineFortyOne.Studio",t.appendChild(e),a.panel.appendChild(t)}return t}function M(){const t=a.panel.querySelector(".wn-annot-list"),e=a.panel.querySelector("h3");if(t.innerHTML="",he(),!a.annotations.length){const o=document.createElement("div");o.className="wn-annot-empty",o.textContent="No annotations yet.",t.appendChild(o),e&&(e.textContent="Annotations (0)");const r=Pe();return}const n=a.annotations.slice().sort((o,r)=>o.createdAt-r.createdAt).filter(o=>{const r=a.filters.priority==="all"||(o.priority||"medium")===a.filters.priority,i=a.filters.query,s=`${o.comment||""} ${o.snippet||""} ${o.author||""}`.toLowerCase(),c=!i||s.includes(i),l=a.filters.author||"all",d=(o.author||"").trim()||"__unknown";return r&&c&&(l==="all"||d===l)});e&&(e.textContent=`Annotations (${n.length})`),n.forEach((o,r)=>{const i=document.createElement("div");i.className="wn-annot-item",i.dataset.id=o.id,Fn(i,j(o));const s=o.priority||"medium",c=s==="high"?"High":s==="low"?"Low":"Medium",l=document.createElement("div");l.className="wn-annot-card-top";const d=document.createElement("div");d.className="wn-annot-card-top-left";const m=document.createElement("div");m.className="wn-annot-number",m.textContent=`#${r+1}`;const f=document.createElement("div");if(f.className=`wn-annot-priority ${s}`,f.innerHTML=`<span class="dot"></span><span>${c}</span>`,d.appendChild(m),d.appendChild(f),o.status==="missing"){const A=document.createElement("div");A.className="wn-annot-missing",A.textContent="Missing",d.appendChild(A)}const g=document.createElement("div");g.className="wn-annot-meta-bottom";const x=document.createElement("div");x.className="wn-annot-card-top-right";const h=document.createElement("button");h.type="button",h.className="wn-annot-edit wn-annotator",h.setAttribute("aria-label","Edit this annotation"),h.innerHTML=Io(),h.addEventListener("click",async A=>{A.stopPropagation(),await Co(o.id)}),x.appendChild(h);const p=document.createElement("button");p.type="button",p.className="wn-annot-delete wn-annotator",p.setAttribute("aria-label","Delete this annotation"),p.innerHTML=Ue(),p.addEventListener("click",A=>{A.stopPropagation(),vo(o.id)}),x.appendChild(p),l.appendChild(d),l.appendChild(x);const w=document.createElement("div");w.className="wn-annot-comment";const b=o.comment||"\u2014";w.textContent=b;const C=document.createElement("div");C.className="wn-annot-meta";const U=((o.author||"").trim()||"Unknown reviewer").toUpperCase(),D=new Date(o.createdAt),v=D.toLocaleDateString(void 0,{year:"numeric",month:"2-digit",day:"2-digit"}),T=D.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});C.textContent=`${U} \u2022 ${v} \u2022 ${T}`,g.appendChild(C);const N=document.createElement("button");N.type="button",N.className="wn-annot-showmore wn-annotator",N.textContent="See more",N.addEventListener("click",A=>{A.stopPropagation();const P=w.classList.toggle("expanded");N.textContent=P?"See less":"See more"}),b.length<160&&(N.style.display="none"),i.appendChild(l),i.appendChild(w);const F=Xo(o);if(F){const A=document.createElement("div");A.className="wn-annot-shot";const P=document.createElement("img");P.src=F,P.alt="The screenshot of this annotation",P.addEventListener("click",X=>{X.stopPropagation(),Vo(F)}),A.appendChild(P),i.appendChild(A)}i.appendChild(N),i.appendChild(g),i.addEventListener("click",()=>{rt(o.id,!0,o.pageUrl,o.pageKey),tt()&&a.panel&&(a.panel.style.display="none",mt())}),t.appendChild(i)}),Pe()}function vo(t){const e=a.annotations.findIndex(n=>n.id===t);e!==-1&&(a.annotations.splice(e,1),R(),Gn(t),M(),nt(),B())}async function Co(t){const e=a.annotations.find(s=>s.id===t);if(!e)return;const n=await de("Edit this annotation",e.comment||"",e.priority||"medium",e.author||a.annotatorName||"");if(!n)return;const{comment:o,priority:r,author:i}=n;e.comment=o.trim(),e.priority=r||"medium",e.author=i||e.author||a.annotatorName||"",ve(e.author),R(),M()}async function ko(){!a.annotations.length||!await Mn("Delete all annotations?","Delete")||(a.annotations=[],L?Fo():R(),gt(),M(),nt())}function oa(){const t=jt(),e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),o=document.createElement("a");o.href=n,o.download=qt(),o.click(),URL.revokeObjectURL(n)}function Eo(t){const e=new Set(t&&t.reviewers||[]),n=new Set(t&&t.priorities||[]),o=a.annotations.filter(l=>{const d=(l.author||"").trim()||"__unknown",m=l.priority||"medium",f=!e.size||e.has(d),g=!n.size||n.has(m);return f&&g}),r=jt(o),i=new Blob([JSON.stringify(r,null,2)],{type:"application/json"}),s=URL.createObjectURL(i),c=document.createElement("a");c.href=s,c.download=qt(),c.click(),URL.revokeObjectURL(s)}function jt(t=a.annotations){return{pageUrl:window.location.href,createdAt:Date.now(),annotations:t}}async function Lo(){Ao(a.annotations)}function Ao(t){const e=jt(t),n=JSON.stringify(e,null,2),o=encodeURIComponent(qt()),r=encodeURIComponent(n),i=(en||"").trim(),s=i?encodeURIComponent(i):"",c="?";window.location.href=`mailto:${s}${c}subject=${o}&body=${r}`}function vt(){return"wn-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function Be(){return"imp-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function qt(){const t=new Date,e=c=>String(c).padStart(2,"0"),n=`${e(t.getDate())}-${e(t.getMonth()+1)}-${t.getFullYear()}`,o=`${e(t.getHours())}-${e(t.getMinutes())}`,r=(document.title||"").trim(),i=c=>c.toLowerCase().replace(/[^a-z0-9]+/gi,"-").replace(/^-+|-+$/g,"")||"annotations";let s;return r?s=`${i(r)}-annotations`:window.location&&window.location.hostname?s=`${i(window.location.hostname)}-annotations`:s="annotations",`${s}_${n}_${o}.json`}const H=t=>`
  ...
  `;function No(){return`
    ...
    `)}function Io(){return He()}function Ue(){return`
    ...
    `}function z(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function qe(){try{const t=localStorage.getItem(Nt);if(!t)return;const e=JSON.parse(t);e.pageKey===z(window.location.href)&&rt(e.id,!1),localStorage.removeItem(Nt)}catch(t){}}let Z=new Map,Kt=Promise.resolve(),G=!1;function Ke(){return`${L.url}/annotations?site=${encodeURIComponent(k)}`}function Xe(t){return`${L.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function Bo(t){return`${L.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function it(t){const e=Object.assign({},t);return L.apiKey&&(e["X-Uxnote-Key"]=L.apiKey),e}function Ve(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function Ct(t,e){console.warn("Uxnote sync:",t,e),!G&&(G=!0,_(t))}function Xt(t){return Kt=Kt.then(t,t),Kt}async function Ye(){if(L)try{const t=await fetch(Ke(),{headers:it({Accept:"application/json"})});if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=await t.json();a.annotations=(e&&e.annotations||[]).filter(Ot),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=z(n.pageUrl||window.location.href))}),Z=Ve(a.annotations),G=!1,dt(),gt(),yt(),nt(),M(),qe()}catch(t){Ct("Uxnote: could not read the annotations from the server",t)}}function _e(){if(!L)return;const t=Ve(a.annotations);t.forEach((e,n)=>{Z.get(n)!==e&&Xt(()=>Ho(n,e))}),Z.forEach((e,n)=>{t.has(n)||Xt(()=>Uo(n))})}async function Ho(t,e){try{const n=await fetch(Xe(t),{method:"PUT",headers:it({"Content-Type":"application/json"}),body:e});if(!n.ok)throw new Error(`HTTP ${n.status}`);Z.set(t,e),G=!1}catch(n){Ct("Uxnote: could not save this annotation on the server",n)}}async function Uo(t){try{const e=await fetch(Xe(t),{method:"DELETE",headers:it()});if(!e.ok)throw new Error(`HTTP ${e.status}`);Z.delete(t),G=!1}catch(e){Ct("Uxnote: could not delete this annotation on the server",e)}}function Fo(){L&&Xt(async()=>{try{const t=await fetch(Ke(),{method:"DELETE",headers:it()});if(!t.ok)throw new Error(`HTTP ${t.status}`);Z=new Map,G=!1}catch(t){Ct("Uxnote: could not delete the annotations on the server",t)}})}function Je(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Do(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=p=>{const w=!!p&&p.w>=4&&p.h>=4;n.style.display=w?"block":"none",w&&(n.style.left=`${p.x}px`,n.style.top=`${p.y}px`,n.style.width=`${p.w}px`,n.style.height=`${p.h}px`)};s(null);const c=p=>({x:Math.min(Math.max(p.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(p.clientY,0),document.documentElement.clientHeight)}),l=(p,w)=>({x:Math.min(p.x,w.x),y:Math.min(p.y,w.y),w:Math.abs(w.x-p.x),h:Math.abs(w.y-p.y)});let d=null;const m=p=>{p.preventDefault(),d=c(p),s(null)},f=p=>{d&&(p.preventDefault(),s(l(d,c(p))))},g=p=>{if(!d)return;const w=l(d,c(p));if(d=null,w.w<4||w.h<4){s(null);return}x({x:w.x+window.scrollX,y:w.y+window.scrollY,w:w.w,h:w.h})},x=p=>{document.removeEventListener("keydown",h,!0),document.removeEventListener("mousemove",f,!0),document.removeEventListener("mouseup",g,!0),e.remove(),o.remove(),t(p)},h=p=>{p.key==="Escape"&&(p.preventDefault(),x(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>x(null)),document.addEventListener("mousemove",f,!0),document.addEventListener("mouseup",g,!0),document.addEventListener("keydown",h,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function jo(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),c=Math.max(0,Math.round((t.y-i)*o)),l=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),d=Math.min(e.height-c,Math.max(1,Math.round(t.h*o)));if(l<1||d<1)return null;const m=document.createElement("canvas");return m.width=l,m.height=d,m.getContext("2d").drawImage(e,s,c,l,d,0,0,l,d),{canvas:m,w:l,h:d}}async function qo(){if(!(!Je()||a.mode==="screenshot")){Y("screenshot");try{const t=await Do();if(!t)return;const e=jo(t).catch(m=>(console.warn("Uxnote screenshot:",m),null)),n=await Tt("Comment for this region?");if(!n)return;const o=await e;if(!o){_("Uxnote: could not capture that region");return}const{comment:r,priority:i,author:s}=n,c=vt();let l=null;if(L){const m=await new Promise(g=>o.canvas.toBlob(g,"image/png")),f=m?await Ko(m,c):null;if(!f){_("Uxnote: could not send the screenshot to the server");return}l={url:f.url,w:o.w,h:o.h,capturedAt:Date.now()}}else l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};const d={id:c,type:"screenshot",comment:r.trim(),author:s||a.annotatorName||"",priority:i||"medium",snippet:"",pageUrl:window.location.href,pageKey:z(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(d),R(),W(d,null),M()}finally{Y(null)}}}async function Ko(t,e){try{const n=await fetch(Bo(e),{method:"PUT",headers:it({"Content-Type":"image/png"}),body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);const o=await n.json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function Xo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=L?new URL(`${L.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Vo(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",r,!0),e.remove()},r=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",r,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ie):ie(),window.Uxnote={refresh:B,setHidden:t=>pt(!!t),toggleVisibility:()=>pt(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:Ye,push:_e,url:()=>L?L.url:null}}})();})();
