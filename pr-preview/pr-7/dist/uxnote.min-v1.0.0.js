(()=>{var So=Object.defineProperty,Mo=Object.defineProperties;var No=Object.getOwnPropertyDescriptors;var He=Object.getOwnPropertySymbols;var $o=Object.prototype.hasOwnProperty,zo=Object.prototype.propertyIsEnumerable;var Ue=(d,w,C)=>w in d?So(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,Ft=(d,w)=>{for(var C in w||(w={}))$o.call(w,C)&&Ue(d,C,w[C]);if(He)for(var C of He(w))zo.call(w,C)&&Ue(d,C,w[C]);return d},De=(d,w)=>Mo(d,No(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,je=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",gt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),xt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Ke=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Xe=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Ht=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Ut=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Dt="#4e9cf6",X=ot(Xe||Ut||Ht||Dt,Dt),qe=ot(Ht||X,X),Ye=ot(Ut||X,X),bt={text:Tt(qe,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Tt(Ye,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Tt(X,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=xt!=null?F(xt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const jt="wn-toolbar-pos",Q=d&&(d.dataset.dock||d.dataset.layout)||"",Kt=`uxnote:site:${C}`,Xt=`uxnote:import-files:${C}`,qt=`uxnote:hidden:${C}`,yt=`uxnote:pending:${C}`,Yt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=Yt?{url:Yt,apiKey:d&&d.dataset.serverApiKey||""}:null,Vt=F(d&&d.dataset.jsonExport,!0),vt=F(d&&d.dataset.jsonImport,!0),Ct=(d&&d.dataset.theme||"").trim().toLowerCase(),kt=Ct==="light"||Ct==="dark"?Ct:"auto",I=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Ve=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Je=.2,Jt=F(Ve,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:bt,customPosition:!1,dimEnabled:Jt,dimOpacity:Jt?Je:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},_t=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function tt(){return _t?_t.matches:window.innerWidth<=640}function Wt(){const t=xn();t&&(k=t);const e=bn(),n=gt!=null?!F(gt,!0):null;r.hidden=e!==null?e:n!==null?n:F(Ke,!1),vt&&(r.importFiles=En()),Zt(),vn(),At(),_e(),We(),Ze(),rt(r.hidden),E?Bt():Ln(),J(),Rt(),xe(),Wn(),E||$e(),fn()}function Zt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function _e(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
