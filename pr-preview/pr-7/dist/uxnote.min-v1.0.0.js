(()=>{var Qo=Object.defineProperty,tr=Object.defineProperties;var er=Object.getOwnPropertyDescriptors;var nn=Object.getOwnPropertySymbols;var nr=Object.prototype.hasOwnProperty,or=Object.prototype.propertyIsEnumerable;var on=(d,w,k)=>w in d?Qo(d,w,{enumerable:!0,configurable:!0,writable:!0,value:k}):d[w]=k,Wt=(d,w)=>{for(var k in w||(w={}))nr.call(w,k)&&on(d,k,w[k]);if(nn)for(var k of nn(w))or.call(w,k)&&on(d,k,w[k]);return d},rn=(d,w)=>tr(d,er(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,k=`${location.protocol}//${location.host}`,an=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Tt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Mt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),sn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),ln=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Zt=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Gt=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Qt="#4e9cf6",V=lt(ln||Gt||Zt||Qt,Qt),cn=lt(Zt||V,V),dn=lt(Gt||V,V),Nt={text:Ut(cn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Ut(dn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Ut(V,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let E=Mt!=null?F(Mt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const te="wn-toolbar-pos",ot=d&&(d.dataset.dock||d.dataset.layout)||"",$t=`uxnote:site:${k}`,ee=`${$t}:synced`,ne=`uxnote:import-files:${k}`,oe=`uxnote:hidden:${k}`,It=`uxnote:pending:${k}`,re=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),v=re?{url:re,apiKey:d&&d.dataset.serverApiKey||""}:null,ae=F(d&&d.dataset.jsonExport,!0),zt=F(d&&d.dataset.jsonImport,!0),pn=F(d&&d.dataset.mailExport,!0),rt=(d&&d.dataset.theme||"").trim().toLowerCase(),_=rt==="light"||rt==="dark"||rt==="reverse-auto"?rt:"auto",un=_==="auto"||_==="reverse-auto",R=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,mn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),fn=.2,ie=F(mn,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Nt,customPosition:!1,dimEnabled:ie,dimOpacity:ie?fn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},se=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function at(){return se?se.matches:window.innerWidth<=640}function le(){const t=Rn();t&&(E=t);const e=Pn(),n=Tt!=null?!F(Tt,!0):null;r.hidden=e!==null?e:n!==null?n:F(sn,!1),zt&&(r.importFiles=Dn()),ce(),Fn(),Pt(),hn(),wn(),gn(),dt(r.hidden),jn(),v&&!Ho()&&(r.annotations=[]),G(),Xt(),Ne(),fo(),v||Yt(),v&&(O(Lt),Do()),$n()}function ce(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function hn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function wn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${E}`;const e=f=>{const u=document.createElement("button");return u.className="wn-annot-btn wn-annotator",u.setAttribute("data-action",f.action),f.mode&&u.setAttribute("data-mode",f.mode),u.setAttribute("data-tip",f.tip),u.innerHTML=f.icon,u},n=f=>{const u=document.createElement("div");return u.className="wn-annot-group wn-annotator",f.forEach(g=>u.appendChild(e(g))),u},o=()=>{const f=document.createElement("div");return f.className="wn-annot-spacer wn-annotator",f},a=document.createDocumentFragment(),i=document.createElement("div");if(i.className="wn-annot-logo wn-annotator",i.innerHTML=Eo(),a.appendChild(i),v){const f=document.createElement("div");f.className="wn-annot-sync-dot wn-annotator",f.setAttribute("role","status"),a.appendChild(f),r.syncDot=f,Ye()}const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:Fe()},{action:"mode",mode:"element",tip:"Annotate an element",icon:Lo()}];tn()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:Mo()});const l=[];zt&&l.push({action:"import",tip:"Import JSON",icon:So()}),ae&&l.push({action:"export",tip:"Export JSON",icon:Ao()}),pn&&l.push({action:"mail",tip:"Send by mail",icon:To()});const c=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:Io()},{action:"toggle-panel",tip:"Show / hide annotations",icon:$o()}];a.appendChild(o()),a.appendChild(n(s)),l.length&&(a.appendChild(o()),a.appendChild(n(l))),a.appendChild(o()),a.appendChild(n(c)),t.appendChild(a),document.body.appendChild(t),r.toolbar=t;const p=document.createElement("div");p.className="wn-annot-panel wn-annotator",p.innerHTML=`
    ...
    `,E==="left"&&(p.style.left="18px",p.style.right="auto"),document.body.appendChild(p),r.panel=p,p.style.display="none";const m=p.querySelector(".wn-annot-delete-all");m&&m.addEventListener("click",async f=>{f.stopPropagation(),await yo()});const y=document.createElement("div");y.className="wn-annot-marker-layer wn-annotator",document.body.appendChild(y),r.markerLayer=y;const h=document.createElement("div");h.className="wn-annot-outline wn-annotator",h.style.display="none",document.body.appendChild(h),r.outlineBox=h;const b=document.createElement("div");b.className="wn-annot-tip wn-annotator",b.textContent="Active mode",document.body.appendChild(b),r.tip=b,t.addEventListener("click",Kn),A(),ft(),mt(),H(),ut(),In(),xn()}function de(){r.dimOverlay&&r.dimOverlay.classList.toggle("is-visible",!r.hidden)}function gn(){if(!r.dimEnabled||r.dimOverlay)return;const t=document.createElement("div");t.className="wn-annot-dimmer",t.setAttribute("aria-hidden","true"),t.style.setProperty("--wn-dim-opacity",String(r.dimOpacity));const e=document.body.firstChild;e?document.body.insertBefore(t,e):document.body.appendChild(t),r.dimOverlay=t,de()}function pe(){if(!r.visibilityToggle)return;const t=r.visibilityToggle,n=at()&&r.toolbar&&!r.hidden?r.toolbar:document.body;t.parentNode!==n&&(t.parentNode&&t.parentNode.removeChild(t),n===r.toolbar?r.toolbar.insertBefore(t,r.toolbar.firstChild):document.body.appendChild(t))}function xn(){if(r.visibilityToggle)return;const t=document.createElement("button");t.type="button",t.className="wn-annot-visibility-btn wn-annotator",t.setAttribute("aria-label","Masquer Uxnote"),t.setAttribute("data-tip","Masquer Uxnote"),t.innerHTML=je(),t.addEventListener("click",qn),r.visibilityToggle=t,pe(),pt(),ye()}function bn(){if(r.commentModal)return r.commentModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-comment-card wn-annotator";const n=document.createElement("h4");n.textContent="Add a comment";const o=document.createElement("textarea");o.className="wn-annotator",o.placeholder="Your comment...";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator",i.textContent="Cancel";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",s.textContent="Save",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t),r.commentModal={backdrop:t,modal:e,textarea:o,title:n,okBtn:s,cancelBtn:i},r.commentModal}function it(){const t=r.commentModal;if(!t||!r.toolbar||!t.backdrop.classList.contains("show"))return;const e=t.modal,n=r.toolbar.getBoundingClientRect(),o=.75*(parseFloat(getComputedStyle(e).fontSize)||16);e.style.left=`${n.left+n.width/2}px`,E==="top"?(e.style.top=`${n.bottom+o}px`,e.style.bottom=""):(e.style.top="",e.style.bottom=`${window.innerHeight-n.top+o}px`)}function ue(t,e=""){return new Promise(n=>{const o=bn(),{backdrop:a,textarea:i,title:s,okBtn:l,cancelBtn:c}=o;s.textContent=t||"Add a comment",i.value=e||"",i.placeholder="Your comment...",a.classList.add("show"),it(),i.focus(),i.select();const p=b=>{a.classList.remove("show"),l.removeEventListener("click",m),c.removeEventListener("click",y),document.removeEventListener("keydown",h),window.removeEventListener("resize",it),n(b)},m=()=>{p({comment:i.value.trim()})},y=()=>p(null),h=b=>{b.key==="Escape"&&p(null),b.key==="Enter"&&!(b.shiftKey||b.altKey)&&(b.preventDefault(),m())};l.textContent="Save",c.textContent="Cancel",l.addEventListener("click",m),c.addEventListener("click",y),document.addEventListener("keydown",h),window.addEventListener("resize",it)})}async function Ot(t){const e=await ue(t);return e||null}function yn(){if(r.importModal)return r.importModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-import-modal";const n=document.createElement("h4");n.textContent="Import JSON files";const o=document.createElement("div");o.className="wn-annot-import-body wn-annotator";const a=document.createElement("label");a.className="wn-annot-import-drop wn-annotator";const i=document.createElement("input");i.type="file",i.accept="application/json",i.multiple=!0,i.className="wn-annotator";const s=document.createElement("div"),l=document.createElement("div");l.className="wn-annot-import-drop-title wn-annotator",l.textContent="Drop JSON files here";const c=document.createElement("div");c.className="wn-annot-import-drop-sub wn-annotator",c.textContent="or click to select files",s.appendChild(l),s.appendChild(c),a.appendChild(i),a.appendChild(s);const p=document.createElement("div");p.className="wn-annot-import-panel wn-annotator";const m=document.createElement("div");m.className="wn-annot-import-title-row wn-annotator";const y=document.createElement("h5");y.textContent="Loaded files";const h=document.createElement("span");h.className="wn-annot-import-count wn-annotator",h.textContent="0";const b=document.createElement("p");b.textContent="Files are saved automatically.";const f=document.createElement("div");f.className="wn-annot-import-list wn-annotator",m.appendChild(y),m.appendChild(h),p.appendChild(m),p.appendChild(b),p.appendChild(f);const u=document.createElement("div");u.className="wn-annot-actions wn-annotator";const g=document.createElement("button");g.type="button",g.className="wn-annot-pill cancel wn-annotator",g.textContent="Close",u.appendChild(g),o.appendChild(a),o.appendChild(p),e.appendChild(n),e.appendChild(o),e.appendChild(u),t.appendChild(e),document.body.appendChild(t);const L=()=>{t.classList.remove("show"),document.removeEventListener("keydown",N)},N=x=>{x.key==="Escape"&&L()},nt=x=>{x.target===t&&L()};return g.addEventListener("click",L),t.addEventListener("click",nt),["dragenter","dragover"].forEach(x=>{a.addEventListener(x,C=>{C.preventDefault(),C.stopPropagation(),a.classList.add("dragover")})}),["dragleave","drop"].forEach(x=>{a.addEventListener(x,C=>{C.preventDefault(),C.stopPropagation(),a.classList.remove("dragover")})}),a.addEventListener("drop",x=>{var St;const C=(St=x.dataTransfer)==null?void 0:St.files;C&&C.length&&me(Array.from(C))}),i.addEventListener("change",x=>{const C=x.target.files;C&&C.length&&me(Array.from(C)),i.value=""}),f.addEventListener("click",x=>{const C=x.target.closest("[data-import-remove]");C&&An(C.dataset.importRemove)}),r.importModal={backdrop:t,modal:e,fileInput:i,fileList:f,filesCount:h,onKey:N,close:L},r.importModal}function vn(){if(!zt)return;const t=yn();st(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function st(){if(!r.importModal)return;const{fileList:t,filesCount:e}=r.importModal,{fileCounts:n}=Cn();if(t.innerHTML="",r.importFiles.length)r.importFiles.forEach(o=>{const a=document.createElement("div");a.className="wn-annot-import-card wn-annotator";const i=document.createElement("div");i.className="wn-annot-import-meta wn-annotator";const s=document.createElement("div");s.className="wn-annot-import-name wn-annotator",s.textContent=o.name;const l=document.createElement("div");l.className="wn-annot-import-sub wn-annotator";const c=n.get(o.id)||0,p=o.pageUrl?` | ${Tn(o.pageUrl,36)}`:"";l.textContent=`${c} comments | ${Sn(o.size)}${p}`,i.appendChild(s),i.appendChild(l);const m=document.createElement("div");m.className="wn-annot-import-actions wn-annotator";const y=document.createElement("div");y.className="wn-annot-import-badge wn-annotator",y.textContent=String(c);const h=document.createElement("button");h.type="button",h.className="wn-annot-import-remove wn-annotator",h.dataset.importRemove=o.id,h.textContent="x",m.appendChild(y),m.appendChild(h),a.appendChild(i),a.appendChild(m),t.appendChild(a)});else{const o=document.createElement("div");o.className="wn-annot-import-empty wn-annotator",o.textContent="No imported files yet.",t.appendChild(o)}e.textContent=String(r.importFiles.length)}function Cn(){const t=new Map;return r.annotations.forEach(e=>{e.importFileId&&t.set(e.importFileId,(t.get(e.importFileId)||0)+1)}),{fileCounts:t}}async function me(t){if(!t||!t.length)return;const e=new Set(r.annotations.map(o=>o.id));let n=0;for(const o of t){const a=await kn(o,e);if(!a)continue;const{fileMeta:i,annotations:s}=a;s.length&&(r.importFiles.push(i),r.annotations.push(...s),n+=s.length)}if(!n){st();return}$(),be(),W(),G(),D(),st()}async function kn(t,e){let n;try{const c=await t.text();n=JSON.parse(c)}catch(c){return await he(`Invalid JSON in ${t.name}.`,"Import error"),null}const o=Array.isArray(n)?n:n.annotations;if(!Array.isArray(o))return await he(`Unsupported JSON format in ${t.name}.`,"Import error"),null;const a=Array.isArray(n)?t.lastModified:n.createdAt,i=Array.isArray(n)?"":n.pageUrl||"",s=Pe(),l=o.filter(Ht).map(c=>En(c,{createdAt:a,pageUrl:i,fileId:s,existingIds:e}));return{fileMeta:{id:s,name:t.name,size:t.size,pageUrl:i,importedAt:Date.now()},annotations:l}}function En(t,e){const n=t&&typeof t=="object"?t:{},o=n.pageUrl||e.pageUrl||window.location.href,a=Ln(n.id,e.existingIds),i=rn(Wt({},n),{id:a,createdAt:n.createdAt||e.createdAt||Date.now(),pageUrl:o,importFileId:e.fileId});return i.pageKey||(i.pageKey=S(o)),i}function Ln(t,e){if(t&&!e.has(t))return e.add(t),t;let n;do n=xt();while(e.has(n));return e.add(n),n}function An(t){const e=r.importFiles.filter(n=>n.id!==t);e.length!==r.importFiles.length&&(r.importFiles=e,r.annotations=r.annotations.filter(n=>n.importFileId!==t),$(),be(),W(),G(),D(),st())}function Sn(t){if(!t)return"0 B";const e=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),e.length-1),o=t/Math.pow(1024,n);return`${o.toFixed(o<10&&n>0?1:0)} ${e[n]}`}function Tn(t,e){return typeof t!="string"?"":t.length<=e?t:t.slice(0,e-3)+"..."}function Mn(){if(r.dialogModal)return r.dialogModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator";const n=document.createElement("h4");n.className="wn-annotator";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t),r.dialogModal={backdrop:t,modal:e,title:n,message:o,okBtn:s,cancelBtn:i},r.dialogModal}function fe({title:t="Information",message:e="",okLabel:n="OK",cancelLabel:o="Cancel",dismissOnBackdrop:a=!0}){return new Promise(i=>{const{backdrop:s,title:l,message:c,okBtn:p,cancelBtn:m}=Mn();l.textContent=t,c.textContent=e,p.textContent=n;const y=!!o;m.style.display=y?"inline-flex":"none",m.textContent=o||"";const h=L=>{s.classList.remove("show"),p.removeEventListener("click",b),m.removeEventListener("click",f),s.removeEventListener("click",u),document.removeEventListener("keydown",g),i(L)},b=()=>h(!0),f=()=>h(!1),u=L=>{L.target===s&&a&&h(!1)},g=L=>{L.key==="Escape"&&h(!1),(L.metaKey||L.ctrlKey)&&L.key==="Enter"&&b()};p.addEventListener("click",b),m.addEventListener("click",f),s.addEventListener("click",u),document.addEventListener("keydown",g),s.classList.add("show"),p.focus()})}async function Nn(t,e="Confirmation"){return fe({title:e,message:t,okLabel:"Confirm",cancelLabel:"Cancel"})}async function he(t,e="Information"){await fe({title:e,message:t,okLabel:"OK",cancelLabel:null})}function $n(){document.addEventListener("mouseup",Bt),document.addEventListener("touchend",Bt),document.addEventListener("pointerup",Bt),document.addEventListener("mousemove",Vn),document.addEventListener("click",_n,!0),window.addEventListener("resize",I),window.addEventListener("resize",ft),window.addEventListener("resize",mt),window.addEventListener("resize",H),window.addEventListener("resize",pt),window.addEventListener("scroll",I,{passive:!0}),Vo(),un&&R&&(R.addEventListener?R.addEventListener("change",Pt):R.addListener&&R.addListener(Pt))}function In(){if(!r.panel)return;const t=r.panel.querySelector("#wn-filter-search");if(!t)return;t.value=r.filters.query;const e=()=>{r.filters.query=t.value.trim().toLowerCase(),A()};t.addEventListener("input",e)}function B(t,e={}){const n=e.keepOutline;if(r.mode===t){r.mode=null,we(),Rt(),n||ht();return}r.mode=t,we(),zn(t),t!=="element"&&ht()}function we(){r.toolbar.querySelectorAll('button[data-action="mode"]').forEach(e=>{e.getAttribute("data-mode")===r.mode?e.classList.add("active"):e.classList.remove("active")})}function zn(t){let e="";if(t==="text"?e="Select text then release to add a note.":t==="element"&&(e="Hover an element, click to annotate."),!e)return Rt();r.tip.textContent=e,r.tip.classList.add("show"),H(),requestAnimationFrame(H),requestAnimationFrame(H)}function Rt(){r.tip.classList.remove("show")}function On(){if(r.toast)return r.toast;const t=document.createElement("div");return t.className="wn-annot-toast wn-annotator",t.setAttribute("aria-live","polite"),document.body.appendChild(t),r.toast=t,t}function P(t){if(!t)return;const e=On();e.textContent=t,e.classList.add("show"),r.toastTimer&&clearTimeout(r.toastTimer),r.toastTimer=setTimeout(()=>{e.classList.remove("show")},2200)}function Rn(){try{const t=localStorage.getItem(te);if(t==="top"||t==="bottom")return t}catch(t){}return null}function Pn(){try{const t=localStorage.getItem(oe);return t==null?null:t==="true"}catch(t){return null}}function Un(t){try{localStorage.setItem(oe,t?"true":"false")}catch(e){}}function Pt(){const t=!!(R&&R.matches),e=_==="dark"||_==="auto"&&t||_==="reverse-auto"&&!t;document.documentElement.setAttribute("data-wn-theme",e?"dark":"light")}function Fn(){if(!document||!document.documentElement)return;const t=document.documentElement,e=r.colors||Nt,n=(i,s)=>{s&&t.style.setProperty(i,s)},o=e.text,a=e.element;n("--wn-text-highlight",o.base),n("--wn-text-highlight-overlay",o.overlay),n("--wn-text-highlight-soft",o.soft),n("--wn-element-highlight",a.base),n("--wn-element-highlight-soft",a.soft),n("--wn-element-highlight-soft-end",a.softer),n("--wn-element-highlight-strong",a.strong),n("--wn-element-highlight-shadow",a.shadow),n("--wn-marker-text",a.text)}function Ut(t,e={}){var s,l,c;const n=lt(t,"#000000"),o=(s=e.softAlpha)!=null?s:.12,a=(l=e.softerAlpha)!=null?l:.04,i=(c=e.overlayAlpha)!=null?c:.7;return{base:n,overlay:T(n,i,T("#000000",i)),soft:T(n,o,T("#000000",o)),softer:T(n,a,T("#000000",a)),strong:T(n,.9,n),shadow:T(n,.24,"rgba(0,0,0,0.24)"),pill:T(n,.16,"rgba(0,0,0,0.16)"),pillBorder:T(n,.28,"rgba(0,0,0,0.28)"),text:Hn(n)}}function lt(t,e){const n=Ft(t);return n||Ft(e)||"#000000"}function Ft(t){if(!t||typeof t!="string")return null;const n=t.trim().match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i);if(!n)return null;const o=n[1];return`#${(o.length===3?o.split("").map(i=>i+i).join(""):o).toLowerCase()}`}function ge(t){const e=Ft(t);if(!e)return null;const n=parseInt(e.slice(1),16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function T(t,e=1,n=""){const o=ge(t);if(!o)return n||"";const a=typeof e=="number"&&e>=0&&e<=1?e:1;return`rgba(${o.r}, ${o.g}, ${o.b}, ${a})`}function Hn(t){const e=ge(t);return e?.299*e.r+.587*e.g+.114*e.b>160?"#0b1622":"#ffffff":"#0b1622"}function U(t){const e=r.colors||Nt,n=t&&t.type;return n==="text"?e.text:n==="screenshot"?e.screenshot:e.element}function xe(t,e){!t||!e||(t.style.setProperty("--wn-marker-bg",e.base),t.style.setProperty("--wn-marker-text",e.text),t.style.setProperty("--wn-marker-shadow",e.shadow))}function Bn(t,e){!t||!e||(t.style.setProperty("--wn-item-accent",e.base),t.style.setProperty("--wn-item-accent-strong",e.strong),t.style.setProperty("--wn-item-accent-shadow",e.shadow),t.style.setProperty("--wn-item-accent-soft",e.soft),t.style.setProperty("--wn-item-accent-soft-end",e.softer),t.style.setProperty("--wn-item-number-bg",e.pill),t.style.setProperty("--wn-item-number-border",e.pillBorder))}function F(t,e=!1){if(t==null||t==="")return e;const n=String(t).toLowerCase();return n==="true"||n==="1"||n==="yes"||n==="on"?!0:n==="false"||n==="0"||n==="no"||n==="off"?!1:e}function Dn(){try{const t=localStorage.getItem(ne),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>n&&typeof n=="object").map(n=>({id:n.id||Pe(),name:String(n.name||"Imported file"),size:Number(n.size||0),pageUrl:typeof n.pageUrl=="string"?n.pageUrl:"",importedAt:Number(n.importedAt||0)})):[]}catch(t){return[]}}function be(){try{localStorage.setItem(ne,JSON.stringify(r.importFiles||[]))}catch(t){}}function H(){if(!r.tip||!r.toolbar)return;const t=r.toolbar.getBoundingClientRect(),e=r.tip,n=10,o=t.left+t.width/2,a=E==="bottom";e.style.left=`${o}px`,e.style.right="",e.style.transform="translateX(-50%)",e.style.top="",e.style.bottom="";const i=e.getBoundingClientRect();if(a){const s=Math.max(8,t.top-n-i.height);e.style.top=`${s}px`}else{const s=t.bottom+n;e.style.top=`${s}px`}}function Ht(t){return!!t&&(t.type==="text"||t.type==="element"||t.type==="screenshot")}function jn(){try{const t=localStorage.getItem($t),e=t?JSON.parse(t):[];r.annotations=(e||[]).filter(Ht),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=S(n.pageUrl||window.location.href))})}catch(t){console.warn("Annotator storage error",t),r.annotations=[]}}function $(){ct(),v&&Jt()}function ct(){try{localStorage.setItem($t,JSON.stringify(r.annotations)),v&&kt()}catch(t){console.warn("Annotator storage save error",t),v&&_e()}}async function Kn(t){const e=t.target.closest("button");if(!e||!e.classList.contains("wn-annotator"))return;const n=e.getAttribute("data-action");if(n){if(n==="mode"){const o=e.getAttribute("data-mode");if(o==="screenshot"){await Wo();return}B(o);return}if(n==="export"){ae&&vo();return}if(n==="import"){vn();return}if(n==="mail"){await Co();return}if(n==="toggle-panel"){Xn();return}if(n==="toggle-pos"){Yn(E==="bottom"?"top":"bottom"),ve();return}}}function Xn(){const t=r.panel.style.display==="none";r.panel.style.display=t?"":"none",ut()}function qn(){dt(!r.hidden)}function dt(t){r.hidden=t,Un(t),document.body.classList.toggle("wn-annot-hidden",t),t&&(B(null),Rt(),ht()),ye(),de(),pt(),ft(),t||(I(),mt(),H()),document.dispatchEvent(new CustomEvent("uxnote:visibility",{detail:{hidden:t}}))}function ye(){if(!r.visibilityToggle)return;const t=r.hidden?"Show Uxnote":"Hide Uxnote";r.visibilityToggle.classList.toggle("is-muted",r.hidden),r.visibilityToggle.innerHTML=r.hidden?zo():je(),r.visibilityToggle.setAttribute("aria-label",t),r.visibilityToggle.setAttribute("aria-pressed",r.hidden?"true":"false"),r.visibilityToggle.setAttribute("data-tip",t)}function pt(){const t=r.visibilityToggle;if(!t)return;pe();const e=18;if(at()){r.hidden?(t.style.bottom=`${e}px`,t.style.left=`${e}px`,t.style.top="",t.style.right=""):(t.style.top="",t.style.right="",t.style.bottom="",t.style.left="");return}t.style.left="",t.style.right="",E==="top"?(t.style.top=`${e}px`,t.style.bottom=""):(t.style.bottom=`${e}px`,t.style.top="")}function ut(){if(!r.panel||!r.toolbar)return;const t=r.toolbar.querySelector('button[data-action="toggle-panel"]');if(!t)return;const e=r.panel.style.display==="none";t.classList.toggle("active",!e)}function mt(){if(!r.panel||!r.toolbar)return;const t=r.panel,e=18,n=r.toolbar.getBoundingClientRect();if(at()){t.style.width="100vw",t.style.maxHeight="100vh",t.style.height="100vh",t.style.left="0",t.style.right="0",t.style.top="0",t.style.bottom="0",t.style.borderRadius="0";return}t.style.width=`min(360px, calc(100vw - ${e*2}px))`,t.style.maxHeight=`calc(100vh - ${e*2}px)`,t.style.left="auto",t.style.right=`${e}px`,t.style.top=`${e}px`,t.style.bottom=`${e}px`,t.style.height="",t.style.borderRadius="",E==="left"?(t.style.left=`${n.width+e}px`,t.style.right=`${e}px`):E==="right"&&(t.style.right=`${n.width+e}px`,t.style.left=`${e}px`)}function Yn(t){E=t==="top"?"top":"bottom";const e=r.toolbar;e&&(e.classList.remove("wn-pos-top","wn-pos-bottom","wn-pos-left","wn-pos-right"),e.classList.add(`wn-pos-${E}`));try{localStorage.setItem(te,E)}catch(n){}ve(),pt(),H(),it(),mt(),ft()}function ve(){if(!r.toolbar)return;const t=r.toolbar.querySelector('button[data-action="toggle-pos"]');t&&(t.innerHTML=E==="top"?Be():De())}function ft(){if(!r.toolbar||r.customPosition||!(ot==="push"||ot==="dock"||ot==="pad"||ot==="true"))return;const t=document.body;r.basePadding||ce();const e=r.basePadding;if(r.hidden){t.style.paddingTop=`${e.top}px`,t.style.paddingRight=`${e.right}px`,t.style.paddingBottom=`${e.bottom}px`,t.style.paddingLeft=`${e.left}px`;return}const n=r.toolbar.getBoundingClientRect(),o=Wt({},e);E==="top"?o.top=e.top+n.height:E==="bottom"?o.bottom=e.bottom+n.height:E==="left"?o.left=e.left+n.width:E==="right"&&(o.right=e.right+n.width),t.style.paddingTop=`${o.top}px`,t.style.paddingRight=`${o.right}px`,t.style.paddingBottom=`${o.bottom}px`,t.style.paddingLeft=`${o.left}px`}async function Bt(){if(r.mode!=="text")return;const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return;const e=t.getRangeAt(0);if(!e)return;if(!(j(e.commonAncestorContainer)&&j(e.startContainer)&&j(e.endContainer))){t.removeAllRanges(),P("Cette zone est une popup/overlay, annotation bloqu\xE9e.");return}const o=t.toString().trim();if(!o)return;const a=await Ot("Comment for this highlight?");if(!a)return;const{comment:i}=a,s=xt(),l=Zn(e,o),c=wt(e,s);t.removeAllRanges();const p={id:s,type:"text",target:l,comment:i.trim(),snippet:o.slice(0,180),pageUrl:window.location.href,pageKey:S(window.location.href),createdAt:Date.now(),status:"active"};r.annotations.push(p),$(),K(p,c),A(),B(null,{keepOutline:!0})}function Vn(t){if(r.mode!=="element")return;const e=t.target;if(!e||!j(e)){ht();return}const n=e.getBoundingClientRect();Wn(n)}async function _n(t){if(r.mode!=="element")return;const e=t.target;if(!e||!j(e)){P("Cette zone est une popup/overlay, annotation bloqu\xE9e.");return}t.preventDefault(),t.stopPropagation();const n=await Ot("Comment for this element?");if(!n)return;const{comment:o}=n,a=xt(),i=jt(e),s=oo(e),l=e.getBoundingClientRect(),c={id:a,type:"element",target:{xpath:i,css:s,tag:e.tagName.toLowerCase()},comment:o.trim(),snippet:e.innerText?e.innerText.trim().slice(0,120):e.tagName,pageUrl:window.location.href,pageKey:S(window.location.href),rect:{x:l.x+window.scrollX,y:l.y+window.scrollY,w:l.width,h:l.height},createdAt:Date.now(),status:"active"};r.annotations.push(c),$(),K(c,e),Te(e,a),A(),B(null,{keepOutline:!0})}function Dt(t){const e=t&&t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}}function J(t){const e=r.highlightSpans[t];return e?Array.isArray(e)?e:[e]:Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`))}function W(){Object.keys(r.highlightSpans||{}).forEach(t=>{J(t).forEach(e=>{e&&e.parentNode&&Dt(e)})}),r.highlightSpans={},Array.from(document.querySelectorAll(".uxnote-textmark[data-uxnote-id], .wn-annot-highlight[data-wn-annot-id]")).forEach(t=>{t&&t.parentNode&&Dt(t)}),Object.values(r.markers||{}).forEach(t=>{t&&t.el&&t.el.parentNode&&t.el.parentNode.removeChild(t.el)}),r.markerLayer&&(r.markerLayer.innerHTML=""),r.markers={},Object.keys(r.elementTargets||{}).forEach(t=>{Me(t)}),r.elementTargets={},Array.from(document.querySelectorAll(".uxnote-annotated[data-uxnote-ids]")).forEach(t=>{delete t.dataset.uxnoteIds,t.classList.remove("uxnote-annotated")})}function Jn(t){const e=r.markers[t];e&&e.el&&e.el.parentNode&&e.el.parentNode.removeChild(e.el),e&&e.frame&&e.frame.parentNode&&e.frame.parentNode.removeChild(e.frame),delete r.markers[t],Me(t);let n=J(t);n.length||(n=Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)),n.length||(n=Array.from(document.querySelectorAll(`.wn-annot-highlight[data-wn-annot-id="${t}"]`)))),n.forEach(o=>{o&&Dt(o)}),delete r.highlightSpans[t]}function D(){Object.entries(r.markers).forEach(([t,e])=>{const n=r.annotations.findIndex(o=>o.id===t);n!==-1&&(e.el.textContent=n+1)})}function Wn(t){const e=r.outlineBox;e.style.display="block",e.style.left=`${t.x+window.scrollX}px`,e.style.top=`${t.y+window.scrollY}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`}function ht(){r.outlineBox.style.display="none"}function Ce(t){return t?t.classList&&t.classList.contains("wn-annotator")||t.parentElement&&Ce(t.parentElement):!1}function j(t){if(!t)return!1;const e=t.nodeType===Node.ELEMENT_NODE?t:t.nodeType===Node.DOCUMENT_NODE?document.body:t.parentElement;if(!e||Ce(e))return!1;if(e.closest){if(e.closest("[data-uxnote-ignore]"))return!1;if(e.closest("[data-uxnote-allow]"))return!0;if(e.closest('#uxnote-root, .wn-annotator, dialog, [popover], [role="dialog"], [role="menu"], [role="tooltip"], [aria-modal="true"]'))return!1}return!0}function Zn(t,e){return{startXPath:jt(t.startContainer),startOffset:t.startOffset,endXPath:jt(t.endContainer),endOffset:t.endOffset,quote:e?String(e).slice(0,200):""}}function wt(t,e){let n=[];const o=t.cloneRange();if(Gn(o).forEach(i=>{const s=Qn(i,{start:i===o.startContainer?o.startOffset:0,end:i===o.endContainer?o.endOffset:i.length},e);s&&n.push(s)}),!n.length){const i=document.createElement("span");i.className="uxnote-textmark",i.dataset.uxnoteId=e,i.addEventListener("click",l=>{l.stopPropagation(),tt(e)});const s=o.extractContents();i.appendChild(s),o.insertNode(i),n=[i]}return r.highlightSpans[e]=n,n[0]}function ir(t,e){return wt(t,e)}function ke(t,e){const n=document.createRange();return n.selectNodeContents(e),t.compareBoundaryPoints(Range.END_TO_START,n)>0&&t.compareBoundaryPoints(Range.START_TO_END,n)<0}function Gn(t){const e=[],n=document.createTreeWalker(t.commonAncestorContainer,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();)if(!(!o.nodeValue||!o.nodeValue.trim())){try{if(t.intersectsNode){if(!t.intersectsNode(o))continue}else if(!ke(t,o))continue}catch(a){if(!ke(t,o))continue}e.push(o)}return e}function Qn(t,e,n){if(!t||!t.parentNode)return null;const{start:o,end:a}=e;let i=t,s=a;if(o>0&&(i=i.splitText(o),s=a-o),s<i.length&&i.splitText(s),!i.parentNode)return null;const l=document.createElement("span");return l.className="uxnote-textmark",l.dataset.uxnoteId=n,l.addEventListener("click",c=>{c.stopPropagation(),tt(n)}),i.parentNode.insertBefore(l,i),l.appendChild(i),l}function Ee(t){return t?typeof t.isConnected=="boolean"?t.isConnected:document.body&&document.body.contains(t):!1}function to(t,e){if(!t||!e)return null;const n=Math.max(t.x,e.x),o=Math.max(t.y,e.y),a=Math.min(t.x+t.width,e.x+e.width),i=Math.min(t.y+t.height,e.y+e.height),s=a-n,l=i-o;return s<=0||l<=0?null:{x:n,y:o,width:s,height:l}}function Le(t){if(!t||!Ee(t)||!t.getBoundingClientRect)return null;let e=t.getBoundingClientRect();if(!e.width||!e.height)return null;let n=t;for(;n&&n.nodeType===1;){if(n.tagName==="DETAILS"&&!n.open){const p=n.querySelector("summary");if(p&&!p.contains(t))return null}if(n.hasAttribute&&n.hasAttribute("hidden")||(n.getAttribute&&n.getAttribute("aria-hidden"))==="true")return null;const a=window.getComputedStyle(n);if(a.display==="none"||a.visibility==="hidden"||a.visibility==="collapse"||a.opacity==="0")return null;const i=a.overflowX||a.overflow,s=a.overflowY||a.overflow;if(i&&i!=="visible"||s&&s!=="visible"){const p=n.getBoundingClientRect(),m=to(e,p);if(!m)return null;e=m}n=n.parentElement}return e}function eo(t){let e=t&&t.nodeType===1?t:null;for(;e&&e.nodeType===1&&e!==document.body;){const n=window.getComputedStyle(e),o=n.zIndex;if(n.position!=="static"&&o!=="auto"||n.opacity!=="1"||n.transform!=="none"||n.filter!=="none"||n.perspective!=="none"||n.mixBlendMode!=="normal"||n.isolation==="isolate"||n.willChange&&n.willChange!=="auto"||n.contain&&n.contain!=="none")return e;e=e.parentElement}return document.body}function Ae(t){if(!t||t.nodeType!==1)return r.markerLayer||document.body;const e=t.offsetParent;return e&&e.nodeType===1?e:eo(t)||r.markerLayer||document.body}function Se(t){return t===document.body||t===r.markerLayer||t===document.documentElement}function no(t){if(!t||t.nodeType!==1)return!1;let e=!1,n=t;for(;n&&n.nodeType===1&&n!==document.body;){if(n.tagName==="DETAILS"&&!n.open&&(n.open=!0,e=!0),n.tagName==="DIALOG"&&!n.open)try{typeof n.showModal=="function"?n.showModal():typeof n.show=="function"&&n.show(),e=!0}catch(a){}if(n.hasAttribute&&n.hasAttribute("popover"))try{typeof n.showPopover=="function"&&(n.showPopover(),e=!0)}catch(a){}if(n.hasAttribute&&n.hasAttribute("data-uxnote-open")){const a=n.getAttribute("data-uxnote-open");if(a){const i=document.querySelector(a);i&&typeof i.click=="function"&&(i.click(),e=!0)}}const o=n.getAttribute&&n.getAttribute("aria-hidden");if(n.hasAttribute&&n.hasAttribute("hidden")||o==="true"){const a=n.id;if(a){const i=document.querySelector(`[aria-controls="${gt(a)}"]`);i&&typeof i.click=="function"&&(i.click(),e=!0)}}n=n.parentElement}return e}function Te(t,e){if(!t||t.nodeType!==1)return!1;const n=t.dataset.uxnoteIds?t.dataset.uxnoteIds.split(",").filter(Boolean):[],o=new Set(n);return o.add(e),t.dataset.uxnoteIds=Array.from(o).join(","),t.classList.add("uxnote-annotated"),r.elementTargets[e]=t,!0}function Me(t){const e=r.elementTargets[t];if(!e||e.nodeType!==1){delete r.elementTargets[t],Array.from(document.querySelectorAll("[data-uxnote-ids]")).forEach(i=>{const s=i.dataset.uxnoteIds?i.dataset.uxnoteIds.split(",").filter(Boolean):[];if(!s.includes(t))return;const l=s.filter(c=>c!==t);l.length?i.dataset.uxnoteIds=l.join(","):(delete i.dataset.uxnoteIds,i.classList.remove("uxnote-annotated"))});return}const o=(e.dataset.uxnoteIds?e.dataset.uxnoteIds.split(",").filter(Boolean):[]).filter(a=>a!==t);o.length?e.dataset.uxnoteIds=o.join(","):(delete e.dataset.uxnoteIds,e.classList.remove("uxnote-annotated")),delete r.elementTargets[t]}function jt(t){if(t===document.body)return"/html/body";const e=[];for(;t&&t!==document;){let n=1,o=t.previousSibling;for(;o;)o.nodeType===t.nodeType&&o.nodeName===t.nodeName&&n++,o=o.previousSibling;const a=t.nodeType===3?"text()":t.nodeName.toLowerCase();if(e.unshift(`${a}[${n}]`),t=t.parentNode,!t||t.nodeType!==1)break}return"/"+e.join("/")}function gt(t){return window.CSS&&typeof window.CSS.escape=="function"?window.CSS.escape(t):String(t).replace(/[^a-zA-Z0-9_-]/g,"\\$&")}function oo(t){if(!t||t.nodeType!==1)return"";if(t.id)return`#${gt(t.id)}`;const e=[];let n=t,o=0;for(;n&&n.nodeType===1&&o<4;){let a=n.tagName.toLowerCase();const i=Array.from(n.classList||[]).filter(s=>s&&!s.startsWith("wn-")&&!s.startsWith("uxnote-"));if(i.length&&(a+=`.${i.slice(0,2).map(gt).join(".")}`),e.unshift(a),n.parentElement&&n.parentElement.id){e.unshift(`#${gt(n.parentElement.id)}`);break}n=n.parentElement,o+=1}return e.join(" > ")}function Z(t){try{const e=document;return e.evaluate(t,e,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue}catch(e){return null}}function G(){r.annotations.forEach(t=>{t.pageKey===S(window.location.href)&&ro(t)}),A()}function ro(t){const e=Q(t);if(!e){t.status="missing",Ne();return}t.status="active",Kt(t,e)}function Kt(t,e){if(e){if(e.type==="screenshot"){K(t,null);return}if(e.type==="text"&&e.range){const n=wt(e.range,t.id);K(t,n);return}e.type==="element"&&e.el&&(Te(e.el,t.id),K(t,e.el))}}function ao(t){if(!t)return null;const e=Z(t.startXPath),n=Z(t.endXPath);if(!e||!n)return null;try{const o=document.createRange();return o.setStart(e,t.startOffset),o.setEnd(n,t.endOffset),o}catch(o){return null}}function Q(t){return t?t.type==="screenshot"?t.rect?{type:"screenshot"}:null:t.target?t.type==="text"?io(t):t.type==="element"?lo(t):null:null:null}function io(t){const e=t.target||{},n=ao(e);if(n)return{type:"text",range:n};const o=e.quote||t.snippet||"";if(!o)return null;const a=so(o);return a?{type:"text",range:a}:null}function so(t){const e=String(t||"").trim();if(!e||e.length<4)return null;const n=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();){if(!o.nodeValue||!o.nodeValue.trim()||!j(o))continue;const a=o.nodeValue.indexOf(e);if(a===-1)continue;const i=document.createRange();return i.setStart(o,a),i.setEnd(o,a+e.length),i}return null}function lo(t){const e=t.target||{};if(e.xpath){const a=Z(e.xpath);if(a&&a.nodeType===1)return{type:"element",el:a}}if(e.css)try{const a=document.querySelector(e.css);if(a&&a.nodeType===1)return{type:"element",el:a}}catch(a){}const n=e.tag,o=(t.snippet||"").trim();if(n&&o){const a=document.querySelectorAll(n);for(const i of a)if(!(!i||i.nodeType!==1)&&(i.textContent||"").includes(o))return{type:"element",el:i}}return null}function co(){r.missingRetryTimer&&clearTimeout(r.missingRetryTimer),r.missingRetryTimer=setTimeout(()=>{Xt()},300)}function Ne(){r.missingObserver||!window.MutationObserver||(r.missingObserver=new MutationObserver(()=>{r.annotations.some(t=>t.status==="missing")&&co()}),r.missingObserver.observe(document.body,{childList:!0,subtree:!0}))}function po(){r.missingObserver&&(r.missingObserver.disconnect(),r.missingObserver=null)}function Xt(){let t=!1;r.annotations.forEach(e=>{if(e.status!=="missing"||e.pageKey!==S(window.location.href))return;const n=Q(e);n&&(e.status="active",Kt(e,n),t=!0)}),t&&($(),A(),I()),r.annotations.some(e=>e.status==="missing")||po()}function uo(){let t=!1;r.annotations.forEach(e=>{if(e.type!=="text"||e.pageKey!==S(window.location.href))return;const n=J(e.id).filter(Ee);if(n.length){r.highlightSpans[e.id]=n,e.status==="missing"&&(e.status="active",t=!0);return}const o=Q(e);if(o&&o.range){wt(o.range,e.id),e.status="active",t=!0;return}e.status!=="missing"&&(e.status="missing",t=!0)}),t&&($(),A(),I())}function mo(){r.layoutTimer&&clearTimeout(r.layoutTimer),r.layoutTimer=setTimeout(()=>{I(),uo(),r.annotations.some(t=>t.status==="missing")&&Xt()},120)}function fo(){r.layoutObserver||!window.MutationObserver||(r.layoutObserver=new MutationObserver(t=>{t.some(n=>{const o=n.target;return!(!o||o.classList&&o.classList.contains("wn-annotator")||o.closest&&o.closest(".wn-annotator"))})&&mo()}),r.layoutObserver.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class","open","hidden","aria-hidden"]}))}function K(t,e){if(t.pageKey!==S(window.location.href)||!r.markerLayer)return;const n=r.markers[t.id];n&&n.el&&n.el.parentNode&&n.el.parentNode.removeChild(n.el);const o=document.createElement("div");o.className="wn-annot-marker wn-annotator",o.textContent=r.annotations.findIndex(c=>c.id===t.id)+1,o.dataset.wnAnnotId=t.id;const a=U(t);xe(o,a),o.addEventListener("click",()=>tt(t.id));const i=Ie(t,e),s=$e(t,i),l=Ae(i&&i.anchor?i.anchor:e);if(o.parentNode!==l&&l.appendChild(o),o.style.zIndex=Se(l)?"":"9999",!i){o.style.display="none",r.markers[t.id]={el:o,rect:null,frame:s};return}o.style.display="",ze(o,i,t),r.markers[t.id]={el:o,rect:i,frame:s}}function $e(t,e){const n=r.markers[t.id];let o=n?n.frame:null;if(t.type!=="screenshot"||!e)return o&&o.parentNode&&o.parentNode.removeChild(o),null;o||(o=document.createElement("div"),o.className="wn-annot-shot-frame wn-annotator");const a=r.markerLayer||document.body;return o.parentNode!==a&&a.appendChild(o),o.style.setProperty("--wn-shot-frame",U(t).base),o.style.left=`${e.x}px`,o.style.top=`${e.y}px`,o.style.width=`${e.w}px`,o.style.height=`${e.h}px`,o}function Ie(t,e){var n;if(t.type==="text"){const a=(e?[e]:J(t.id))[0]||document.querySelector(`.uxnote-textmark[data-uxnote-id="${t.id}"]`);if(!a)return null;const i=Le(a);return i?{x:i.x,y:i.y,w:i.width,h:i.height,anchor:a}:null}if(t.type==="element"){const o=(e&&e.nodeType===1?e:null)||r.elementTargets[t.id]||((n=t.target)!=null&&n.xpath?Z(t.target.xpath):null);if(!o)return null;const a=Le(o);return a?{x:a.x,y:a.y,w:a.width,h:a.height,anchor:o}:null}if(t.type==="screenshot"){const o=t.rect;return o?{x:o.x-window.scrollX,y:o.y-window.scrollY,w:o.w,h:o.h,anchor:null}:null}return null}function ze(t,e,n){const o=ho(n),i=(t.offsetParent||document.body).getBoundingClientRect(),s=i.x+window.scrollX,l=i.y+window.scrollY,c=e.x+window.scrollX,p=e.y+window.scrollY;t.style.left=`${c-s+e.w+o.x+4}px`,t.style.top=`${p-l+o.y-4}px`}function ho(t){if(t.type!=="element")return{x:0,y:0};const e=t.target&&t.target.xpath;if(!e)return{x:0,y:0};const n=r.annotations.filter(i=>i.type==="element"&&i.pageKey===t.pageKey&&i.target&&i.target.xpath===e);if(n.length<=1)return{x:0,y:0};const o=n.findIndex(i=>i.id===t.id);return o<=0?{x:0,y:0}:{x:-o*24,y:0}}function I(){Object.entries(r.markers).forEach(([t,e])=>{const n=r.annotations.find(i=>i.id===t);if(!n)return;const o=n.status==="missing"?null:Ie(n);if(e.frame=$e(n,o),!o){e.el.style.display="none",e.rect=null;return}e.el.style.display="",e.rect=o;const a=Ae(o.anchor);e.el.parentNode!==a&&a.appendChild(e.el),e.el.style.zIndex=Se(a)?"":"9999",ze(e.el,o,n),xe(e.el,U(n))})}function wo(){if(!r.panel)return;r.panel.style.display==="none"&&(r.panel.style.display="",ut())}function go(t){if(!r.panel)return;wo();const e=r.panel.querySelector(".wn-annot-list");if(!e)return;e.querySelectorAll(".wn-annot-item").forEach(a=>a.classList.remove("is-focused"));const o=e.querySelector(`.wn-annot-item[data-id="${t}"]`);o&&(o.classList.add("is-focused"),o.scrollIntoView({behavior:"smooth",block:"nearest"}))}function tt(t,e=!1,n,o){var l;const a=r.annotations.find(c=>c.id===t);if(!a)return;if(go(t),a.status==="missing"){const c=Q(a);if(c)a.status="active",Kt(a,c),A();else{P("Annotation introuvable sur cette page.");return}}const i=Q(a);if(i){const c=i.type==="element"?i.el:i.range&&i.range.commonAncestorContainer?i.range.commonAncestorContainer.parentElement:null;c&&no(c)&&setTimeout(()=>{I()},160)}if(!((o||a.pageKey)===S(window.location.href))&&e){try{localStorage.setItem(It,JSON.stringify({id:a.id,pageKey:a.pageKey,pageUrl:n||a.pageUrl}))}catch(c){}window.location.href=n||a.pageUrl||window.location.href;return}if(a.type==="text"){const p=(J(t)||Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)))[0];p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),qt(p,U(a).base))}else if(a.type==="element"){const c=i&&i.el?i.el:(l=a.target)!=null&&l.xpath?Z(a.target.xpath):null;c&&c.scrollIntoView&&(c.scrollIntoView({behavior:"smooth",block:"center"}),qt(c,U(a).base))}else if(a.type==="screenshot"&&a.rect){window.scrollTo({top:Math.max(0,a.rect.y+a.rect.h/2-window.innerHeight/2),behavior:"smooth"});const c=r.markers[a.id];c&&c.frame&&qt(c.frame,U(a).base)}}function qt(t,e){var i,s;t.style.transition="box-shadow 0.2s ease";const n=t.style.boxShadow,o=e||((s=(i=r.colors)==null?void 0:i.element)==null?void 0:s.base)||"#4e9cf6",a=T(o,.6,"rgba(78,156,246,0.6)");t.style.boxShadow=`0 0 0 3px ${a}`,setTimeout(()=>{t.style.boxShadow=n},800)}function Oe(){if(!r.panel)return null;let t=r.panel.querySelector(".wn-annot-footer");if(!t){t=document.createElement("div"),t.className="wn-annot-footer wn-annotator";const e=document.createElement("a");e.href="https://uxnote.ninefortyone.studio",e.target="_blank",e.rel="noreferrer noopener",e.textContent="\xA9 UxNote \u2013 by NineFortyOne.Studio",t.appendChild(e),r.panel.appendChild(t)}return t}function A(){const t=r.panel.querySelector(".wn-annot-list"),e=r.panel.querySelector("h3");if(t.innerHTML="",!r.annotations.length){const o=document.createElement("div");o.className="wn-annot-empty",o.textContent="No annotations yet.",t.appendChild(o),e&&(e.textContent="Annotations (0)");const a=Oe();return}const n=r.annotations.slice().sort((o,a)=>o.createdAt-a.createdAt).filter(o=>{const a=r.filters.query,i=`${o.comment||""} ${o.snippet||""}`.toLowerCase();return!a||i.includes(a)});e&&(e.textContent=`Annotations (${n.length})`),n.forEach((o,a)=>{const i=document.createElement("div");i.className="wn-annot-item",i.dataset.id=o.id,Bn(i,U(o));const s=document.createElement("div");s.className="wn-annot-card-top";const l=document.createElement("div");l.className="wn-annot-card-top-left";const c=document.createElement("div");if(c.className="wn-annot-number",c.textContent=`#${a+1}`,l.appendChild(c),o.status==="missing"){const x=document.createElement("div");x.className="wn-annot-missing",x.textContent="Missing",l.appendChild(x)}const p=document.createElement("div");p.className="wn-annot-card-top-right";const m=document.createElement("button");m.type="button",m.className="wn-annot-edit wn-annotator",m.setAttribute("aria-label","Edit this annotation"),m.innerHTML=No(),m.addEventListener("click",async x=>{x.stopPropagation(),await bo(o.id)}),p.appendChild(m);const y=document.createElement("button");y.type="button",y.className="wn-annot-delete wn-annotator",y.setAttribute("aria-label","Delete this annotation"),y.innerHTML=He(),y.addEventListener("click",x=>{x.stopPropagation(),xo(o.id)}),p.appendChild(y),s.appendChild(l),s.appendChild(p);const h=document.createElement("div");h.className="wn-annot-comment";const b=o.comment||"\u2014";h.textContent=b;const f=document.createElement("div");f.className="wn-annot-meta";const u=new Date(o.createdAt),g=u.toLocaleDateString(void 0,{year:"numeric",month:"2-digit",day:"2-digit"}),L=u.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});f.textContent=`${g} \u2022 ${L}`,l.appendChild(f);const N=document.createElement("button");N.type="button",N.className="wn-annot-showmore wn-annotator",N.textContent="See more",N.addEventListener("click",x=>{x.stopPropagation();const C=h.classList.toggle("expanded");N.textContent=C?"See less":"See more"}),b.length<160&&(N.style.display="none"),i.appendChild(s),i.appendChild(h);const nt=Zo(o);if(nt){const x=document.createElement("div");x.className="wn-annot-shot";const C=document.createElement("img");C.src=nt,C.alt="The screenshot of this annotation",C.addEventListener("click",St=>{St.stopPropagation(),Go(nt)}),x.appendChild(C),i.appendChild(x)}i.appendChild(N),i.addEventListener("click",()=>{tt(o.id,!0,o.pageUrl,o.pageKey),at()&&r.panel&&(r.panel.style.display="none",ut())}),t.appendChild(i)}),Oe()}function xo(t){const e=r.annotations.findIndex(n=>n.id===t);e!==-1&&(r.annotations.splice(e,1),$(),Jn(t),A(),D(),I())}async function bo(t){const e=r.annotations.find(a=>a.id===t);if(!e)return;const n=await ue("Edit this annotation",e.comment||"");if(!n)return;const{comment:o}=n;e.comment=o.trim(),$(),A()}async function yo(){!r.annotations.length||!await Nn("Delete all annotations?","Delete")||(r.annotations=[],ct(),v&&qo(),W(),A(),D())}function vo(){const t=Re(),e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),o=document.createElement("a");o.href=n,o.download=Ue(),o.click(),URL.revokeObjectURL(n)}function Re(t=r.annotations){return{pageUrl:window.location.href,createdAt:Date.now(),annotations:t}}async function Co(){ko(r.annotations)}function ko(t){const e=Re(t),n=JSON.stringify(e,null,2),o=encodeURIComponent(Ue()),a=encodeURIComponent(n),i=(an||"").trim(),s=i?encodeURIComponent(i):"",l="?";window.location.href=`mailto:${s}${l}subject=${o}&body=${a}`}function xt(){if(typeof crypto.randomUUID=="function")return crypto.randomUUID();const t=crypto.getRandomValues(new Uint8Array(16));t[6]=t[6]&15|64,t[8]=t[8]&63|128;const e=Array.from(t,n=>n.toString(16).padStart(2,"0")).join("");return`${e.slice(0,8)}-${e.slice(8,12)}-${e.slice(12,16)}-${e.slice(16,20)}-${e.slice(20)}`}function Pe(){return"imp-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function Ue(){const t=new Date,e=l=>String(l).padStart(2,"0"),n=`${e(t.getDate())}-${e(t.getMonth()+1)}-${t.getFullYear()}`,o=`${e(t.getHours())}-${e(t.getMinutes())}`,a=(document.title||"").trim(),i=l=>l.toLowerCase().replace(/[^a-z0-9]+/gi,"-").replace(/^-+|-+$/g,"")||"annotations";let s;return a?s=`${i(a)}-annotations`:window.location&&window.location.hostname?s=`${i(window.location.hostname)}-annotations`:s="annotations",`${s}_${n}_${o}.json`}const z=t=>`
  ...
  `;function Eo(){return`
    ...
    `)}function No(){return Fe()}function He(){return`
    ...
    `}function S(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Yt(){try{const t=localStorage.getItem(It);if(!t)return;const e=JSON.parse(t);e.pageKey===S(window.location.href)&&tt(e.id,!1),localStorage.removeItem(It)}catch(t){}}let M=new Map,Vt=Promise.resolve(),X=!1,Ke=!1;const Xe=3e5,qe=1e4,Oo=Xe;let bt=null,yt=qe,vt="/health";const Ro={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes are held here until it answers"};function Ye(){const t=r.syncDot;if(!t)return;const e=r.syncStatus||"pending",n=Ro[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function et(t){r.syncStatus!==t&&(r.syncStatus=t,Ye())}async function q(t,e){let n;try{n=await fetch(t,e)}catch(o){throw et("unreachable"),o}if(!n.ok){et("refused");const o=new Error(`HTTP ${n.status}`);throw o.status=n.status,o}return et("ok"),n}function _t(){return`${v.url}/annotations?site=${encodeURIComponent(k)}`}function Ve(t){return`${v.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function Po(){return vt?`${v.url}${vt}`:_t()}function Uo(t){return`${v.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function Y(t){const e=Object.assign({},t);return v.apiKey&&(e["X-Uxnote-Key"]=v.apiKey),e}function Fo(t){return new Map(t.map(e=>[e.id,Ct(e)]))}function Ct(t){const e=typeof t=="string"?t:JSON.stringify(t);let n=2166136261;for(let o=0;o<e.length;o+=1)n^=e.charCodeAt(o),n=Math.imul(n,16777619)>>>0;return`${e.length}:${n.toString(36)}`}function kt(){try{localStorage.setItem(ee,JSON.stringify(Array.from(M)))}catch(t){console.warn("Annotator storage save error",t),_e()}}function Ho(){let t=null;try{t=localStorage.getItem(ee);const e=t?JSON.parse(t):[];M=new Map(Array.isArray(e)?e:[])}catch(e){console.warn("Uxnote sync: the stored server snapshot is unreadable",e),M=new Map}return t!==null}function Et(t,e){console.warn("Uxnote sync:",t,e),!X&&(X=!0,P(t))}function _e(){Ke||(Ke=!0,P("Uxnote: this browser has no room left, so notes are not kept for a reload"))}function O(t){return Vt=Vt.then(t,t),Vt}async function Lt(){if(!v)return;let t;try{const n=await q(_t(),{headers:Y({Accept:"application/json"})});try{t=await n.json()}catch(o){throw et("refused"),o}}catch(n){Et("Uxnote: could not read the annotations from the server",n),Yt();return}const e=(t&&t.annotations||[]).filter(Ht);e.forEach(n=>{n.pageKey||(n.pageKey=S(n.pageUrl||window.location.href))}),Bo(e),X=!1,ct(),W(),G(),D(),A(),Jt(),Yt()}function Bo(t){const e=new Map(t.map(a=>[a.id,a])),n=[],o=new Set;r.annotations.forEach(a=>{const i=M.get(a.id);if(i===void 0||i!==Ct(a)){n.push(a),o.add(a.id);return}const s=e.get(a.id);s&&(n.push(s),o.add(a.id))}),t.forEach(a=>{o.has(a.id)||n.push(a)}),r.annotations=n,M=Fo(t)}async function Je(){try{const t=await q(Po(),{headers:Y({Accept:"application/json"})});try{await t.json()}catch(e){return et("refused"),!1}return!0}catch(t){return vt&&t.status===404?(vt="",Je()):!1}}async function We(t){bt=null;const e=r.syncStatus==="ok";if(!await Je()){Ze(yt),yt=Math.min(yt*2,Oo);return}yt=qe,Ze(Xe),!t&&!e&&O(Lt)}function Ze(t){bt&&clearTimeout(bt),bt=setTimeout(()=>O(()=>We(!1)),t)}function Do(){v&&O(()=>We(!0))}function Jt(){if(!v)return;const t=new Map(r.annotations.map(e=>[e.id,JSON.stringify(e)]));t.forEach((e,n)=>{M.get(n)!==Ct(e)&&O(()=>Ko(n,e))}),M.forEach((e,n)=>{t.has(n)||O(()=>Xo(n))})}async function jo(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),a=await en(o,t.id,{rethrow:!0});if(!a)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:a.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}async function Ko(t,e){try{const n=r.annotations.find(a=>a.id===t),o=n&&n.screenshot&&n.screenshot.dataUrl;o&&(await jo(n),e=JSON.stringify(n)),await q(Ve(t),{method:"PUT",headers:Y({"Content-Type":"application/json"}),body:e}),M.set(t,Ct(e)),X=!1,o?ct():kt()}catch(n){Et("Uxnote: could not save this annotation on the server",n)}}async function Xo(t){try{await q(Ve(t),{method:"DELETE",headers:Y()}),M.delete(t),X=!1,kt()}catch(e){Et("Uxnote: could not delete this annotation on the server",e)}}function qo(){v&&O(async()=>{try{await q(_t(),{method:"DELETE",headers:Y()}),M=new Map,X=!1,kt()}catch(t){Et("Uxnote: could not delete the annotations on the server",t)}})}let At=null,Ge=S(window.location.href);function Yo(){At=null;const t=S(window.location.href);t!==Ge&&(Ge=t,W(),G(),D(),A(),O(Lt))}function Qe(){At&&clearTimeout(At),At=setTimeout(Yo,120)}function Vo(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const a=e.apply(this,o);return Qe(),a})}),window.addEventListener("popstate",Qe)}function tn(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function _o(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const a=document.createElement("span");a.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(a),o.appendChild(i);const s=u=>{const g=!!u&&u.w>=4&&u.h>=4;n.style.display=g?"block":"none",g&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};s(null);const l=u=>({x:Math.min(Math.max(u.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(u.clientY,0),document.documentElement.clientHeight)}),c=(u,g)=>({x:Math.min(u.x,g.x),y:Math.min(u.y,g.y),w:Math.abs(g.x-u.x),h:Math.abs(g.y-u.y)});let p=null;const m=u=>{u.preventDefault(),p=l(u),s(null)},y=u=>{p&&(u.preventDefault(),s(c(p,l(u))))},h=u=>{if(!p)return;const g=c(p,l(u));if(p=null,g.w<4||g.h<4){s(null);return}b({x:g.x+window.scrollX,y:g.y+window.scrollY,w:g.w,h:g.h})},b=u=>{document.removeEventListener("keydown",f,!0),document.removeEventListener("mousemove",y,!0),document.removeEventListener("mouseup",h,!0),e.remove(),o.remove(),t(u)},f=u=>{u.key==="Escape"&&(u.preventDefault(),b(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",y,!0),document.addEventListener("mouseup",h,!0),document.addEventListener("keydown",f,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Jo(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,a=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-a)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const m=document.createElement("canvas");return m.width=c,m.height=p,m.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:m,w:c,h:p}}async function Wo(){if(!(!tn()||r.mode==="screenshot")){B("screenshot");try{const t=await _o();if(!t)return;const e=Jo(t).catch(c=>(console.warn("Uxnote screenshot:",c),null)),n=await Ot("Comment for this region?");if(!n)return;const o=await e;if(!o){P("Uxnote: could not capture that region");return}const{comment:a}=n,i=xt();let s={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(v){const c=await new Promise(m=>o.canvas.toBlob(m,"image/png")),p=c?await en(c,i):null;p?s={url:p.url,w:o.w,h:o.h,capturedAt:Date.now()}:P("Uxnote: the picture stays on this device until the server answers")}const l={id:i,type:"screenshot",comment:a.trim(),snippet:"",pageUrl:window.location.href,pageKey:S(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:s,createdAt:Date.now(),status:"active"};r.annotations.push(l),$(),K(l,null),A()}finally{B(null)}}}async function en(t,e,n={}){try{const a=await(await q(Uo(e),{method:"PUT",headers:Y({"Content-Type":"image/png"}),body:t})).json();return a&&a.url?a:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function Zo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=v?new URL(`${v.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Go(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",a,!0),e.remove()},a=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",a,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",le):le(),window.Uxnote={refresh:I,setHidden:t=>dt(!!t),toggleVisibility:()=>dt(!r.hidden),isHidden:()=>!!r.hidden,sync:{pull:Lt,push:Jt,url:()=>v?v.url:null}}})();})();
