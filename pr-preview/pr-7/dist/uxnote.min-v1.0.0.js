(()=>{var Io=Object.defineProperty,Ro=Object.defineProperties;var Oo=Object.getOwnPropertyDescriptors;var Ke=Object.getOwnPropertySymbols;var Po=Object.prototype.hasOwnProperty,Fo=Object.prototype.propertyIsEnumerable;var Xe=(d,w,C)=>w in d?Io(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,Ht=(d,w)=>{for(var C in w||(w={}))Po.call(w,C)&&Xe(d,C,w[C]);if(Ke)for(var C of Ke(w))Fo.call(w,C)&&Xe(d,C,w[C]);return d},qe=(d,w)=>Ro(d,Oo(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,Ye=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",bt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),yt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Ve=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Je=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Dt=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),jt=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Kt="#4e9cf6",X=rt(Je||jt||Dt||Kt,Kt),_e=rt(Dt||X,X),We=rt(jt||X,X),vt={text:Mt(_e,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Mt(We,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Mt(X,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=yt!=null?O(yt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const Xt="wn-toolbar-pos",tt=d&&(d.dataset.dock||d.dataset.layout)||"",qt=`uxnote:site:${C}`,Yt=`uxnote:import-files:${C}`,Vt=`uxnote:hidden:${C}`,Ct=`uxnote:pending:${C}`,Jt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=Jt?{url:Jt,apiKey:d&&d.dataset.serverApiKey||""}:null,_t=O(d&&d.dataset.jsonExport,!0),kt=O(d&&d.dataset.jsonImport,!0),Ze=O(d&&d.dataset.mailExport,!0),Et=(d&&d.dataset.theme||"").trim().toLowerCase(),Lt=Et==="light"||Et==="dark"?Et:"auto",I=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Ge=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Qe=.2,Wt=O(Ge,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:vt,customPosition:!1,dimEnabled:Wt,dimOpacity:Wt?Qe:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Zt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function et(){return Zt?Zt.matches:window.innerWidth<=640}function Gt(){const t=vn();t&&(k=t);const e=Cn(),n=bt!=null?!O(bt,!0):null;r.hidden=e!==null?e:n!==null?n:O(Ve,!1),kt&&(r.importFiles=Sn()),Qt(),En(),Tt(),tn(),en(),nn(),at(r.hidden),E?Bt():Tn(),J(),Pt(),ye(),Qn(),E||Ie(),gn()}function Qt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function tn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function co(){return`
    ...
    `)}function wo(){return Te()}function Me(){return`
    ...
    `)}function $e(){return z(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function xo(){return k==="top"?Ne():$e()}function ze(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function S(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Ie(){try{const t=localStorage.getItem(Ct);if(!t)return;const e=JSON.parse(t);e.pageKey===S(window.location.href)&&W(e.id,!1),localStorage.removeItem(Ct)}catch(t){}}let j=new Map,Ut=Promise.resolve(),K=!1;const yo={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes stay in this browser"};function Re(){const t=r.syncDot;if(!t)return;const e=r.syncStatus||"pending",n=yo[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function ft(t){r.syncStatus!==t&&(r.syncStatus=t,Re())}async function Z(t,e){let n;try{n=await fetch(t,e)}catch(o){throw ft("unreachable"),o}if(!n.ok)throw ft("refused"),new Error(`HTTP ${n.status}`);return ft("ok"),n}function Oe(){return`${E.url}/annotations?site=${encodeURIComponent(C)}`}function Pe(t){return`${E.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function vo(t){return`${E.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function G(t){const e=Object.assign({},t);return E.apiKey&&(e["X-Uxnote-Key"]=E.apiKey),e}function Fe(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function ht(t,e){console.warn("Uxnote sync:",t,e),!K&&(K=!0,U(t))}function wt(t){return Ut=Ut.then(t,t),Ut}async function Bt(){if(E)try{const t=await Z(Oe(),{headers:G({Accept:"application/json"})});let e;try{e=await t.json()}catch(n){throw ft("refused"),n}r.annotations=(e&&e.annotations||[]).filter($t),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=S(n.pageUrl||window.location.href))}),j=Fe(r.annotations),K=!1,Y(),J(),B(),A(),Ie()}catch(t){ht("Uxnote: could not read the annotations from the server",t)}}function Ue(){if(!E)return;const t=Fe(r.annotations);t.forEach((e,n)=>{j.get(n)!==e&&wt(()=>ko(n,e))}),j.forEach((e,n)=>{t.has(n)||wt(()=>Eo(n))})}async function Co(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),a=await je(o,t.id,{rethrow:!0});if(!a)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:a.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}async function ko(t,e){try{const n=r.annotations.find(o=>o.id===t);n&&n.screenshot&&n.screenshot.dataUrl&&(await Co(n),e=JSON.stringify(n)),await Z(Pe(t),{method:"PUT",headers:G({"Content-Type":"application/json"}),body:e}),j.set(t,e),K=!1}catch(n){ht("Uxnote: could not save this annotation on the server",n)}}async function Eo(t){try{await Z(Pe(t),{method:"DELETE",headers:G()}),j.delete(t),K=!1}catch(e){ht("Uxnote: could not delete this annotation on the server",e)}}function Lo(){E&&wt(async()=>{try{await Z(Oe(),{method:"DELETE",headers:G()}),j=new Map,K=!1}catch(t){ht("Uxnote: could not delete the annotations on the server",t)}})}let gt=null,Be=S(window.location.href);function Ao(){gt=null;const t=S(window.location.href);t!==Be&&(Be=t,Y(),J(),B(),A(),wt(Bt))}function He(){gt&&clearTimeout(gt),gt=setTimeout(Ao,120)}function So(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const a=e.apply(this,o);return He(),a})}),window.addEventListener("popstate",He)}function De(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function To(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const a=document.createElement("span");a.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(a),o.appendChild(i);const s=u=>{const g=!!u&&u.w>=4&&u.h>=4;n.style.display=g?"block":"none",g&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};s(null);const l=u=>({x:Math.min(Math.max(u.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(u.clientY,0),document.documentElement.clientHeight)}),c=(u,g)=>({x:Math.min(u.x,g.x),y:Math.min(u.y,g.y),w:Math.abs(g.x-u.x),h:Math.abs(g.y-u.y)});let p=null;const m=u=>{u.preventDefault(),p=l(u),s(null)},y=u=>{p&&(u.preventDefault(),s(c(p,l(u))))},h=u=>{if(!p)return;const g=c(p,l(u));if(p=null,g.w<4||g.h<4){s(null);return}b({x:g.x+window.scrollX,y:g.y+window.scrollY,w:g.w,h:g.h})},b=u=>{document.removeEventListener("keydown",f,!0),document.removeEventListener("mousemove",y,!0),document.removeEventListener("mouseup",h,!0),e.remove(),o.remove(),t(u)},f=u=>{u.key==="Escape"&&(u.preventDefault(),b(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",y,!0),document.addEventListener("mouseup",h,!0),document.addEventListener("keydown",f,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Mo(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,a=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-a)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const m=document.createElement("canvas");return m.width=c,m.height=p,m.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:m,w:c,h:p}}async function No(){if(!(!De()||r.mode==="screenshot")){F("screenshot");try{const t=await To();if(!t)return;const e=Mo(t).catch(c=>(console.warn("Uxnote screenshot:",c),null)),n=await At("Comment for this region?");if(!n)return;const o=await e;if(!o){U("Uxnote: could not capture that region");return}const{comment:a}=n,i=mt();let s={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(E){const c=await new Promise(m=>o.canvas.toBlob(m,"image/png")),p=c?await je(c,i):null;p?s={url:p.url,w:o.w,h:o.h,capturedAt:Date.now()}:U("Uxnote: the picture stays on this device until the server answers")}const l={id:i,type:"screenshot",comment:a.trim(),snippet:"",pageUrl:window.location.href,pageKey:S(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:s,createdAt:Date.now(),status:"active"};r.annotations.push(l),M(),D(l,null),A()}finally{F(null)}}}async function je(t,e,n={}){try{const a=await(await Z(vo(e),{method:"PUT",headers:G({"Content-Type":"image/png"}),body:t})).json();return a&&a.url?a:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function $o(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=E?new URL(`${E.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function zo(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",a,!0),e.remove()},a=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",a,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Gt):Gt(),window.Uxnote={refresh:$,setHidden:t=>at(!!t),toggleVisibility:()=>at(!r.hidden),isHidden:()=>!!r.hidden,sync:{pull:Bt,push:Ue,url:()=>E?E.url:null}}})();})();
