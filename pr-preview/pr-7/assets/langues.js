(() => {
  const translations = {
    en: {
      ...
      builder_json_export_desc: 'JSON export button and dialog. false also removes the email handoff.',
      ...
      install_opt_json_export_body: 'Keeps or removes the JSON export. The export dialog holds the email handoff, so false removes both. Defaults to true.<br> Example:<br> data-json-export="false".',
    ...
    fr: {
      ...
      builder_json_export_desc: 'Bouton et fenêtre d’export JSON. false retire aussi l’envoi par email.',
      ...
      install_opt_json_export_body: 'Conserve ou retire l’export JSON. La fenêtre d’export contient l’envoi par email, donc false retire les deux. Vaut true par défaut.<br> Exemple :<br> data-json-export="false".',
