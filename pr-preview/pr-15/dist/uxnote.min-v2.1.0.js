(()=>{var $a=Object.defineProperty,Ia=Object.defineProperties;var Pa=Object.getOwnPropertyDescriptors;var vn=Object.getOwnPropertySymbols;var za=Object.prototype.hasOwnProperty,Ra=Object.prototype.propertyIsEnumerable;var kn=(d,w,C)=>w in d?$a(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,de=(d,w)=>{for(var C in w||(w={}))za.call(w,C)&&kn(d,C,w[C]);if(vn)for(var C of vn(w))Ra.call(w,C)&&kn(d,C,w[C]);return d},Cn=(d,w)=>Ia(d,Pa(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,En=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Lt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Qt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Tn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Ln=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Qn=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Sn=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),An=w("colorForRegionHighlight")||d&&d.dataset.colorForRegionHighlight,Mn="#4e9cf6",Nn="#8b5cf6",$n="#f59f00",St=wt(Ln),pe=St||Mn,ue=St||Nn,In=ft(Qn||pe,pe),Pn=ft(Sn||ue,ue),he=St||$n,zn=ft(An||he,he),At={text:Dt(In,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Dt(Pn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Dt(zn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let v=Qt!=null?B(Qt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const me="wn-toolbar-pos",pt=d&&(d.dataset.dock||d.dataset.layout)||"",fe=`uxnote:site:${C}`,we=`uxnote:import-files:${C}`,ge=`uxnote:hidden:${C}`,Mt=`uxnote:pending:${C}`,xe=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),k=xe?{url:xe,apiKey:d&&d.dataset.serverApiKey||""}:null,Nt=B(d&&d.dataset.jsonExport,!0),$t=B(d&&d.dataset.jsonImport,!0),Rn=B(d&&d.dataset.mailExport,!0),ut=(d&&d.dataset.theme||"").trim().toLowerCase(),X=ut==="light"||ut==="dark"||ut==="reverse-auto"?ut:"auto",Hn=X==="auto"||X==="reverse-auto",It=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Pt=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,zt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function F(){return Pt?Pt.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return zt?zt.matches:window.innerWidth<=640||window.innerHeight<=480}function Rt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const On=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Bn=.2,be=B(On,!F()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:At,customPosition:!1,dimEnabled:be,dimOpacity:be?Bn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function ye(){const t=lo();t&&(v=t);const e=co(),n=Lt!=null?!B(Lt,!0):null;a.hidden=e!==null?e:n!==null?n:B(Tn,!1),$t&&(a.importFiles=fo()),ve(),uo(),Ne(),Un(),Vn(),Kn(),gt(a.hidden),k?le():wo(),rt(),ne(),We(),Zo(),k||dn(),ro()}function ve(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Un(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}const Fn=["commentModal","dialogModal"];function Ht(t,e){const n=document.createElement("div");n.className="wn-annot-sheet-grip wn-annotator";const o=document.createElement("span");o.className="wn-annot-sheet-handle wn-annotator",o.setAttribute("aria-hidden","true");const r=document.createElement("button");return r.type="button",r.className="wn-annot-sheet-close wn-annotator",r.setAttribute("aria-label",t),r.innerHTML=rn(),r.addEventListener("click",i=>{i.stopPropagation(),e()}),n.appendChild(o),n.appendChild(r),Dn(n,e),n}function Dn(t,e){let n=null,o=0,r=0,i=0;const s=c=>{n&&(i=Math.max(0,c.clientY-o),n.style.transform=`translateY(${i}px)`)},l=()=>{if(!n)return;t.removeEventListener("pointermove",s),t.removeEventListener("pointerup",l),t.removeEventListener("pointercancel",l);const c=n.getBoundingClientRect().height||1,p=i/Math.max(1,Date.now()-r);n.style.transform="",n.style.transition="",n=null,(i>c/3||i>40&&p>.5)&&e()};t.addEventListener("pointerdown",c=>{c.target.closest(".wn-annot-sheet-close")||(n=t.closest(".wn-annot-sheet"),n&&(o=c.clientY,r=Date.now(),i=0,n.style.transition="none",t.setPointerCapture&&t.setPointerCapture(c.pointerId),t.addEventListener("pointermove",s),t.addEventListener("pointerup",l),t.addEventListener("pointercancel",l)))})}function jn(){return a.hidden||!I()?!1:a.panel&&a.panel.style.display!=="none"?!0:Fn.some(t=>{const e=a[t];return e&&e.backdrop.classList.contains("show")})}function H(){const t=jn();if(t===!!a.scrollLocked)return;const e=document.documentElement;a.scrollLocked=t,t?(a.scrollLockPrev=e.style.overflow,e.style.overflow="hidden"):(e.style.overflow=a.scrollLockPrev||"",a.scrollLockPrev="")}function D(){const t=document.documentElement,e=(i,s)=>{t.style.setProperty("--wn-sheet-bottom",`${i}px`),t.style.setProperty("--wn-sheet-top-guard",`${s}px`)};if(!a.toolbar||!I()||a.hidden){e(0,0);return}const n=a.toolbar.getBoundingClientRect(),o=8,r=t.clientHeight;if(v==="top"){e(0,Math.max(0,Math.round(n.bottom+o)));return}e(Math.max(0,Math.round(r-n.top+o)),0)}function ht(t){a.panel&&(a.panel.style.display=t?"":"none",Vt(),H())}function ke(){const t=a.toolbar;if(!t)return;const e=I(),n=h=>{const m=document.createElement("button");return m.className="wn-annot-btn wn-annotator",m.setAttribute("data-action",h.action),h.mode&&m.setAttribute("data-mode",h.mode),m.setAttribute("data-tip",h.tip),m.innerHTML=h.icon,m},o=h=>{const m=document.createElement("div");return m.className="wn-annot-group wn-annotator",h.forEach(b=>m.appendChild(n(b))),m},r=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},i=a.visibilityToggle;i&&i.parentNode===t&&t.removeChild(i),t.innerHTML="";const s=document.createDocumentFragment(),l=document.createElement("div");if(l.className="wn-annot-logo wn-annotator",l.innerHTML=la(),s.appendChild(l),k){const h=document.createElement("div");h.className="wn-annot-sync-dot wn-annotator",h.setAttribute("role","status"),s.appendChild(h),a.syncDot=h,pn()}const c=[{action:"mode",mode:"text",tip:"Highlight text",icon:nn()},{action:"mode",mode:"element",tip:"Annotate an element",icon:ca()}];bn()&&c.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:ua()});const p=[];$t&&!e&&p.push({action:"import",tip:"Import JSON",icon:da()}),Nt&&!e&&p.push({action:"export",tip:"Export JSON",icon:on()}),Rn&&!e&&p.push({action:"mail",tip:"Send by mail",icon:pa()});const u=[];e||u.push({action:"toggle-pos",tip:"Toolbar top / bottom",icon:fa()}),u.push({action:"toggle-panel",tip:"Show / hide annotations",icon:ma()}),s.appendChild(r()),s.appendChild(o(c)),p.length&&(s.appendChild(r()),s.appendChild(o(p))),s.appendChild(r()),s.appendChild(o(u)),t.appendChild(s),Kt(),Ut(),Vt(),Ot()}function Ce(){ke(),_(),J(),z(),q(),Z(),D(),Ue(),H(),M()}function Vn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${v}`,document.body.appendChild(t),a.toolbar=t,ke();const e=document.createElement("div");e.className="wn-annot-panel wn-annot-sheet wn-annotator",e.innerHTML=`
      <div class="wn-annot-panel-head wn-annotator">
        <div class="wn-annot-panel-top wn-annotator">
          ...
          <div class="wn-annot-panel-tools wn-annotator">
            ${Nt?`<button class="wn-annot-panel-export wn-annotator" type="button">${on()}<span>Export</span></button>`:""}
  ...
  `;function la(){return`
    ...
    `)}function ln(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function fa(){return v==="top"?sn():ln()}function cn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function L(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function dn(){try{const t=localStorage.getItem(Mt);if(!t)return;const e=JSON.parse(t);e.pageKey===L(window.location.href)&&st(e.id,!1),localStorage.removeItem(Mt)}catch(t){}}let R=new Map,ie=Promise.resolve(),Y=!1;const ga={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes stay in this browser"};function pn(){const t=a.syncDot;if(!t)return;const e=a.syncStatus||"pending",n=ga[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function vt(t){a.syncStatus!==t&&(a.syncStatus=t,pn())}async function lt(t,e){let n;try{n=await fetch(t,e)}catch(o){throw vt("unreachable"),o}if(!n.ok)throw vt("refused"),new Error(`HTTP ${n.status}`);return vt("ok"),n}function un(){return`${k.url}/annotations?site=${encodeURIComponent(C)}`}function hn(t){return`${k.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function xa(t){return`${k.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function ct(t){const e=Object.assign({},t);return k.apiKey&&(e["X-Uxnote-Key"]=k.apiKey),e}function se(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function kt(t,e){console.warn("Uxnote sync:",t,e),!Y&&(Y=!0,P(t))}function Ct(t){return ie=ie.then(t,t),ie}async function le(){if(k)try{const t=await lt(un(),{headers:ct({Accept:"application/json"})});let e;try{e=await t.json()}catch(n){throw vt("refused"),n}a.annotations=(e&&e.annotations||[]).filter(jt),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))}),R=se(a.annotations),Y=!1,et(),rt(),V(),T(),dn()}catch(t){kt("Uxnote: could not read the annotations from the server",t)}}function ce(){if(!k)return;const t=se(a.annotations);t.forEach((e,n)=>{R.get(n)!==e&&Ct(()=>fn(n,e))}),R.forEach((e,n)=>{t.has(n)||Ct(()=>wn(n))})}async function ba(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),r=await yn(o,t.id,{rethrow:!0});if(!r)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:r.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}function ya(){k&&(window.addEventListener("online",()=>ce()),document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&mn()}),window.addEventListener("pagehide",mn))}function mn(){if(!k)return;const t=se(a.annotations);t.forEach((e,n)=>{R.get(n)!==e&&fn(n,e,{keepalive:!0})}),R.forEach((e,n)=>{t.has(n)||wn(n,{keepalive:!0})})}async function fn(t,e,n={}){try{const o=a.annotations.find(r=>r.id===t);o&&o.screenshot&&o.screenshot.dataUrl&&(await ba(o),e=JSON.stringify(o)),await lt(hn(t),{method:"PUT",headers:ct({"Content-Type":"application/json"}),keepalive:!!n.keepalive,body:e}),R.set(t,e),Y=!1}catch(o){kt("Uxnote: could not save this annotation on the server",o)}}async function wn(t,e={}){try{await lt(hn(t),{method:"DELETE",headers:ct(),keepalive:!!e.keepalive}),R.delete(t),Y=!1}catch(n){kt("Uxnote: could not delete this annotation on the server",n)}}function va(){k&&Ct(async()=>{try{await lt(un(),{method:"DELETE",headers:ct()}),R=new Map,Y=!1}catch(t){kt("Uxnote: could not delete the annotations on the server",t)}})}let Et=null,gn=L(window.location.href);function ka(){Et=null;const t=L(window.location.href);t!==gn&&(gn=t,et(),rt(),V(),T(),Ct(le))}function xn(){Et&&clearTimeout(Et),Et=setTimeout(ka,120)}function Ca(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const r=e.apply(this,o);return xn(),r})}),window.addEventListener("popstate",xn)}function bn(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Ea(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=f=>{const x=!!f&&f.w>=4&&f.h>=4;n.style.display=x?"block":"none",x&&(n.style.left=`${f.x}px`,n.style.top=`${f.y}px`,n.style.width=`${f.w}px`,n.style.height=`${f.h}px`)};s(null);const l=f=>({x:Math.min(Math.max(f.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(f.clientY,0),document.documentElement.clientHeight)}),c=(f,x)=>({x:Math.min(f.x,x.x),y:Math.min(f.y,x.y),w:Math.abs(x.x-f.x),h:Math.abs(x.y-f.y)});let p=null;const u=f=>{f.preventDefault(),p=l(f),s(null)},h=f=>{p&&(f.preventDefault(),s(c(p,l(f))))},m=f=>{if(!p)return;const x=c(p,l(f));if(p=null,x.w<4||x.h<4){s(null);return}b({x:x.x+window.scrollX,y:x.y+window.scrollY,w:x.w,h:x.h})},b=f=>{document.removeEventListener("keydown",Q,!0),document.removeEventListener("mousemove",h,!0),document.removeEventListener("mouseup",m,!0),e.remove(),o.remove(),t(f)},Q=f=>{f.key==="Escape"&&(f.preventDefault(),b(null))};e.addEventListener("mousedown",u),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",h,!0),document.addEventListener("mouseup",m,!0),document.addEventListener("keydown",Q,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Ta(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const u=document.createElement("canvas");return u.width=c,u.height=p,u.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:u,w:c,h:p}}function La(){const t=document.documentElement;return{x:window.scrollX,y:window.scrollY,w:t.clientWidth,h:t.clientHeight}}const Qa=2e4;function Sa(t){const e=Ta(t).then(o=>({shot:o}),o=>(console.warn("Uxnote screenshot:",o),{shot:null})),n=new Promise(o=>{setTimeout(()=>o({shot:null,timedOut:!0}),Qa)});return Promise.race([e,n])}async function Aa(){if(!(!bn()||a.mode==="screenshot")){j("screenshot");try{const t=F()?La():await Ea();if(!t)return;const e=Sa(t),n=await Bt("Comment for this region?");if(!n)return;const{shot:o,timedOut:r}=await e;if(!o){P(r?"Uxnote: the page took too long to capture":"Uxnote: could not capture that region");return}const{comment:i}=n,s=yt();let l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(k){const p=await new Promise(h=>o.canvas.toBlob(h,"image/png")),u=p?await yn(p,s):null;u?l={url:u.url,w:o.w,h:o.h,capturedAt:Date.now()}:P("Uxnote: the picture stays on this device until the server answers")}const c={id:s,type:"screenshot",comment:i.trim(),snippet:"",pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(c),A(),K(c,null),T()}finally{j(null)}}}async function yn(t,e,n={}){try{const r=await(await lt(xa(e),{method:"PUT",headers:ct({"Content-Type":"image/png"}),body:t})).json();return r&&r.url?r:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function Ma(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=k?new URL(`${k.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Na(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=document.createElement("button");o.type="button",o.className="wn-shot-lightbox-close wn-annotator",o.setAttribute("aria-label","Close the screenshot"),o.innerHTML=rn(),e.appendChild(o);const r=()=>{document.removeEventListener("keydown",i,!0),e.remove()},i=s=>{s.key==="Escape"&&(s.preventDefault(),r())};o.addEventListener("click",r),e.addEventListener("click",r),document.addEventListener("keydown",i,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ye):ye(),window.Uxnote={refresh:M,setHidden:t=>gt(!!t),toggleVisibility:()=>gt(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:le,push:ce,url:()=>k?k.url:null}}})();})();
