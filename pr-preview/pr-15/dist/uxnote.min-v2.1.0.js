(()=>{var Ma=Object.defineProperty,Na=Object.defineProperties;var $a=Object.getOwnPropertyDescriptors;var yn=Object.getOwnPropertySymbols;var Ia=Object.prototype.hasOwnProperty,Pa=Object.prototype.propertyIsEnumerable;var vn=(d,w,C)=>w in d?Ma(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,de=(d,w)=>{for(var C in w||(w={}))Ia.call(w,C)&&vn(d,C,w[C]);if(yn)for(var C of yn(w))Pa.call(w,C)&&vn(d,C,w[C]);return d},kn=(d,w)=>Na(d,$a(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,Cn=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Et=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Tt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),En=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Tn=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Ln=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Qn=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Sn=w("colorForRegionHighlight")||d&&d.dataset.colorForRegionHighlight,An="#4e9cf6",Mn="#8b5cf6",Nn="#f59f00",Lt=mt(Tn),pe=Lt||An,ue=Lt||Mn,$n=ht(Ln||pe,pe),In=ht(Qn||ue,ue),he=Lt||Nn,Pn=ht(Sn||he,he),Qt={text:Dt($n,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Dt(In,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Dt(Pn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let v=Tt!=null?B(Tt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const me="wn-toolbar-pos",dt=d&&(d.dataset.dock||d.dataset.layout)||"",fe=`uxnote:site:${C}`,we=`uxnote:import-files:${C}`,ge=`uxnote:hidden:${C}`,St=`uxnote:pending:${C}`,xe=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),k=xe?{url:xe,apiKey:d&&d.dataset.serverApiKey||""}:null,At=B(d&&d.dataset.jsonExport,!0),Mt=B(d&&d.dataset.jsonImport,!0),zn=B(d&&d.dataset.mailExport,!0),Nt=(d&&d.dataset.theme||"").trim().toLowerCase(),$t=Nt==="light"||Nt==="dark"?Nt:"auto",It=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Pt=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,zt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function U(){return Pt?Pt.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return zt?zt.matches:window.innerWidth<=640||window.innerHeight<=480}function Rt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const Rn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Hn=.2,be=B(Rn,!U()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Qt,customPosition:!1,dimEnabled:be,dimOpacity:be?Hn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function ye(){const t=io();t&&(v=t);const e=so(),n=Et!=null?!B(Et,!0):null;a.hidden=e!==null?e:n!==null?n:B(En,!1),Mt&&(a.importFiles=ho()),ve(),co(),Ne(),On(),Dn(),jn(),ft(a.hidden),k?le():mo(),at(),ne(),We(),_o(),k||dn(),oo()}function ve(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function On(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}const Bn=["commentModal","dialogModal"];function Ht(t,e){const n=document.createElement("div");n.className="wn-annot-sheet-grip wn-annotator";const o=document.createElement("span");o.className="wn-annot-sheet-handle wn-annotator",o.setAttribute("aria-hidden","true");const r=document.createElement("button");return r.type="button",r.className="wn-annot-sheet-close wn-annotator",r.setAttribute("aria-label",t),r.innerHTML=rn(),r.addEventListener("click",i=>{i.stopPropagation(),e()}),n.appendChild(o),n.appendChild(r),Fn(n,e),n}function Fn(t,e){let n=null,o=0,r=0,i=0;const s=c=>{n&&(i=Math.max(0,c.clientY-o),n.style.transform=`translateY(${i}px)`)},l=()=>{if(!n)return;t.removeEventListener("pointermove",s),t.removeEventListener("pointerup",l),t.removeEventListener("pointercancel",l);const c=n.getBoundingClientRect().height||1,p=i/Math.max(1,Date.now()-r);n.style.transform="",n.style.transition="",n=null,(i>c/3||i>40&&p>.5)&&e()};t.addEventListener("pointerdown",c=>{c.target.closest(".wn-annot-sheet-close")||(n=t.closest(".wn-annot-sheet"),n&&(o=c.clientY,r=Date.now(),i=0,n.style.transition="none",t.setPointerCapture&&t.setPointerCapture(c.pointerId),t.addEventListener("pointermove",s),t.addEventListener("pointerup",l),t.addEventListener("pointercancel",l)))})}function Un(){return a.hidden||!I()?!1:a.panel&&a.panel.style.display!=="none"?!0:Bn.some(t=>{const e=a[t];return e&&e.backdrop.classList.contains("show")})}function H(){const t=Un();if(t===!!a.scrollLocked)return;const e=document.documentElement;a.scrollLocked=t,t?(a.scrollLockPrev=e.style.overflow,e.style.overflow="hidden"):(e.style.overflow=a.scrollLockPrev||"",a.scrollLockPrev="")}function D(){const t=document.documentElement,e=(i,s)=>{t.style.setProperty("--wn-sheet-bottom",`${i}px`),t.style.setProperty("--wn-sheet-top-guard",`${s}px`)};if(!a.toolbar||!I()||a.hidden){e(0,0);return}const n=a.toolbar.getBoundingClientRect(),o=8,r=t.clientHeight;if(v==="top"){e(0,Math.max(0,Math.round(n.bottom+o)));return}e(Math.max(0,Math.round(r-n.top+o)),0)}function pt(t){a.panel&&(a.panel.style.display=t?"":"none",Vt(),H())}function ke(){const t=a.toolbar;if(!t)return;const e=I(),n=h=>{const m=document.createElement("button");return m.className="wn-annot-btn wn-annotator",m.setAttribute("data-action",h.action),h.mode&&m.setAttribute("data-mode",h.mode),m.setAttribute("data-tip",h.tip),m.innerHTML=h.icon,m},o=h=>{const m=document.createElement("div");return m.className="wn-annot-group wn-annotator",h.forEach(b=>m.appendChild(n(b))),m},r=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},i=a.visibilityToggle;i&&i.parentNode===t&&t.removeChild(i),t.innerHTML="";const s=document.createDocumentFragment(),l=document.createElement("div");if(l.className="wn-annot-logo wn-annotator",l.innerHTML=ia(),s.appendChild(l),k){const h=document.createElement("div");h.className="wn-annot-sync-dot wn-annotator",h.setAttribute("role","status"),s.appendChild(h),a.syncDot=h,pn()}const c=[{action:"mode",mode:"text",tip:"Highlight text",icon:nn()},{action:"mode",mode:"element",tip:"Annotate an element",icon:sa()}];bn()&&c.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:da()});const p=[];Mt&&!e&&p.push({action:"import",tip:"Import JSON",icon:la()}),At&&!e&&p.push({action:"export",tip:"Export JSON",icon:on()}),zn&&!e&&p.push({action:"mail",tip:"Send by mail",icon:ca()});const u=[];e||u.push({action:"toggle-pos",tip:"Toolbar top / bottom",icon:ha()}),u.push({action:"toggle-panel",tip:"Show / hide annotations",icon:ua()}),s.appendChild(r()),s.appendChild(o(c)),p.length&&(s.appendChild(r()),s.appendChild(o(p))),s.appendChild(r()),s.appendChild(o(u)),t.appendChild(s),Kt(),Ft(),Vt(),Ot()}function Ce(){ke(),W(),_(),z(),X(),J(),D(),Fe(),H(),M()}function Dn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${v}`,document.body.appendChild(t),a.toolbar=t,ke();const e=document.createElement("div");e.className="wn-annot-panel wn-annot-sheet wn-annotator",e.innerHTML=`
  ...
  `;function ia(){return`
    ...
    `)}function pa(){return nn()}function an(){return`
    ...
    `)}function ln(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function ha(){return v==="top"?sn():ln()}function cn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
