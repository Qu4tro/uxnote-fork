(()=>{var $o=Object.defineProperty,Io=Object.defineProperties;var zo=Object.getOwnPropertyDescriptors;var De=Object.getOwnPropertySymbols;var Ro=Object.prototype.hasOwnProperty,Ho=Object.prototype.propertyIsEnumerable;var je=(d,w,k)=>w in d?$o(d,w,{enumerable:!0,configurable:!0,writable:!0,value:k}):d[w]=k,Ut=(d,w)=>{for(var k in w||(w={}))Ro.call(w,k)&&je(d,k,w[k]);if(De)for(var k of De(w))Ho.call(w,k)&&je(d,k,w[k]);return d},Ve=(d,w)=>Io(d,zo(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,k=`${location.protocol}//${location.host}`,Ke=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",bt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),yt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Xe=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),qe=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Ft=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Dt=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),jt="#4e9cf6",V=rt(qe||Dt||Ft||jt,jt),Ye=rt(Ft||V,V),_e=rt(Dt||V,V),vt={text:Tt(Ye,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Tt(_e,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Tt(V,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let C=yt!=null?R(yt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const Vt="wn-toolbar-pos",tt=d&&(d.dataset.dock||d.dataset.layout)||"",Kt=`uxnote:site:${k}`,Xt=`uxnote:import-files:${k}`,qt=`uxnote:hidden:${k}`,kt=`uxnote:pending:${k}`,Yt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=Yt?{url:Yt,apiKey:d&&d.dataset.serverApiKey||""}:null,_t=R(d&&d.dataset.jsonExport,!0),Ct=R(d&&d.dataset.jsonImport,!0),Je=R(d&&d.dataset.mailExport,!0),Et=(d&&d.dataset.theme||"").trim().toLowerCase(),Qt=Et==="light"||Et==="dark"?Et:"auto",I=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Ze=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),We=.2,Jt=R(Ze,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:vt,customPosition:!1,dimEnabled:Jt,dimOpacity:Jt?We:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Zt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function et(){return Zt?Zt.matches:window.innerWidth<=640}function Wt(){const t=yn();t&&(C=t);const e=vn(),n=bt!=null?!R(bt,!0):null;r.hidden=e!==null?e:n!==null?n:R(Xe,!1),Ct&&(r.importFiles=Ln()),Gt(),Cn(),St(),Ge(),tn(),en(),at(r.hidden),E?Bt():An(),Y(),Ht(),ye(),Wn(),E||Ie(),wn()}function Gt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Ge(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function lo(){return`
    ...
    `)}function ho(){return Se()}function Te(){return`
    ...
    `)}function Ne(){return $(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function go(){return C==="top"?Me():Ne()}function $e(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function A(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Ie(){try{const t=localStorage.getItem(kt);if(!t)return;const e=JSON.parse(t);e.pageKey===A(window.location.href)&&J(e.id,!1),localStorage.removeItem(kt)}catch(t){}}let D=new Map,Pt=Promise.resolve(),j=!1;const bo={pending:"Server: checking",ok:"Server: connected",refused:"Server: refused it -- check the address or the key",unreachable:"Server: unreachable -- notes stay in this browser"};function ze(){const t=r.syncDot;if(!t)return;const e=r.syncStatus||"pending",n=bo[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function ft(t){r.syncStatus!==t&&(r.syncStatus=t,ze())}async function Z(t,e){let n;try{n=await fetch(t,e)}catch(o){throw ft("unreachable"),o}if(!n.ok)throw ft("refused"),new Error(`HTTP ${n.status}`);return ft("ok"),n}function Re(){return`${E.url}/annotations?site=${encodeURIComponent(k)}`}function He(t){return`${E.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function yo(t){return`${E.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function W(t){const e=Object.assign({},t);return E.apiKey&&(e["X-Uxnote-Key"]=E.apiKey),e}function Oe(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function ht(t,e){console.warn("Uxnote sync:",t,e),!j&&(j=!0,P(t))}function wt(t){return Pt=Pt.then(t,t),Pt}async function Bt(){if(E)try{const t=await Z(Re(),{headers:W({Accept:"application/json"})});let e;try{e=await t.json()}catch(n){throw ft("refused"),n}r.annotations=(e&&e.annotations||[]).filter(Nt),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=A(n.pageUrl||window.location.href))}),D=Oe(r.annotations),j=!1,X(),Y(),B(),L(),Ie()}catch(t){ht("Uxnote: could not read the annotations from the server",t)}}function Pe(){if(!E)return;const t=Oe(r.annotations);t.forEach((e,n)=>{D.get(n)!==e&&wt(()=>vo(n,e))}),D.forEach((e,n)=>{t.has(n)||wt(()=>ko(n))})}async function vo(t,e){try{await Z(He(t),{method:"PUT",headers:W({"Content-Type":"application/json"}),body:e}),D.set(t,e),j=!1}catch(n){ht("Uxnote: could not save this annotation on the server",n)}}async function ko(t){try{await Z(He(t),{method:"DELETE",headers:W()}),D.delete(t),j=!1}catch(e){ht("Uxnote: could not delete this annotation on the server",e)}}function Co(){E&&wt(async()=>{try{await Z(Re(),{method:"DELETE",headers:W()}),D=new Map,j=!1}catch(t){ht("Uxnote: could not delete the annotations on the server",t)}})}let gt=null,Be=A(window.location.href);function Eo(){gt=null;const t=A(window.location.href);t!==Be&&(Be=t,X(),Y(),B(),L(),wt(Bt))}function Ue(){gt&&clearTimeout(gt),gt=setTimeout(Eo,120)}function Qo(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const a=e.apply(this,o);return Ue(),a})}),window.addEventListener("popstate",Ue)}function Fe(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Lo(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const a=document.createElement("span");a.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(a),o.appendChild(i);const s=u=>{const g=!!u&&u.w>=4&&u.h>=4;n.style.display=g?"block":"none",g&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};s(null);const l=u=>({x:Math.min(Math.max(u.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(u.clientY,0),document.documentElement.clientHeight)}),c=(u,g)=>({x:Math.min(u.x,g.x),y:Math.min(u.y,g.y),w:Math.abs(g.x-u.x),h:Math.abs(g.y-u.y)});let p=null;const m=u=>{u.preventDefault(),p=l(u),s(null)},y=u=>{p&&(u.preventDefault(),s(c(p,l(u))))},h=u=>{if(!p)return;const g=c(p,l(u));if(p=null,g.w<4||g.h<4){s(null);return}b({x:g.x+window.scrollX,y:g.y+window.scrollY,w:g.w,h:g.h})},b=u=>{document.removeEventListener("keydown",f,!0),document.removeEventListener("mousemove",y,!0),document.removeEventListener("mouseup",h,!0),e.remove(),o.remove(),t(u)},f=u=>{u.key==="Escape"&&(u.preventDefault(),b(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",y,!0),document.addEventListener("mouseup",h,!0),document.addEventListener("keydown",f,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Ao(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,a=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-a)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const m=document.createElement("canvas");return m.width=c,m.height=p,m.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:m,w:c,h:p}}async function So(){if(!(!Fe()||r.mode==="screenshot")){O("screenshot");try{const t=await Lo();if(!t)return;const e=Ao(t).catch(c=>(console.warn("Uxnote screenshot:",c),null)),n=await Lt("Comment for this region?");if(!n)return;const o=await e;if(!o){P("Uxnote: could not capture that region");return}const{comment:a}=n,i=mt();let s=null;if(E){const c=await new Promise(m=>o.canvas.toBlob(m,"image/png")),p=c?await To(c,i):null;if(!p){P("Uxnote: could not send the screenshot to the server");return}s={url:p.url,w:o.w,h:o.h,capturedAt:Date.now()}}else s={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};const l={id:i,type:"screenshot",comment:a.trim(),snippet:"",pageUrl:window.location.href,pageKey:A(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:s,createdAt:Date.now(),status:"active"};r.annotations.push(l),T(),F(l,null),L()}finally{O(null)}}}async function To(t,e){try{const o=await(await Z(yo(e),{method:"PUT",headers:W({"Content-Type":"image/png"}),body:t})).json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function Mo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=E?new URL(`${E.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function No(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",a,!0),e.remove()},a=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",a,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wt):Wt(),window.Uxnote={refresh:N,setHidden:t=>at(!!t),toggleVisibility:()=>at(!r.hidden),isHidden:()=>!!r.hidden,sync:{pull:Bt,push:Pe,url:()=>E?E.url:null}}})();})();
