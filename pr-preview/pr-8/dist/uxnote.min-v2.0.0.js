(()=>{var So=Object.defineProperty,No=Object.defineProperties;var $o=Object.getOwnPropertyDescriptors;var Be=Object.getOwnPropertySymbols;var Io=Object.prototype.hasOwnProperty,zo=Object.prototype.propertyIsEnumerable;var Ue=(d,h,k)=>h in d?So(d,h,{enumerable:!0,configurable:!0,writable:!0,value:k}):d[h]=k,Ot=(d,h)=>{for(var k in h||(h={}))Io.call(h,k)&&Ue(d,k,h[k]);if(Be)for(var k of Be(h))zo.call(h,k)&&Ue(d,k,h[k]);return d},Fe=(d,h)=>No(d,$o(h));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),h=t=>d?d.getAttribute(t):null,k=`${location.protocol}//${location.host}`,Ve=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",gt=h("isToolVisibleAtFirstLaunch")||h("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),xt=h("isToolOnTopAtLaunch")||h("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),De=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),je=h("colorForHighlight")||h("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Bt=h("colorForTextHighligh")||h("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Ut=h("colorForElementHighlight")||h("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Ft="#4e9cf6",j=ot(je||Ut||Bt||Ft,Ft),Ke=ot(Bt||j,j),Xe=ot(Ut||j,j),bt={text:At(Ke,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:At(Xe,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:At(j,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let C=xt!=null?H(xt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const Vt="wn-toolbar-pos",G=d&&(d.dataset.dock||d.dataset.layout)||"",Dt=`uxnote:site:${k}`,jt=`uxnote:import-files:${k}`,Kt=`uxnote:hidden:${k}`,yt=`uxnote:pending:${k}`,Xt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=Xt?{url:Xt,apiKey:d&&d.dataset.serverApiKey||""}:null,qt=H(d&&d.dataset.jsonExport,!0),vt=H(d&&d.dataset.jsonImport,!0),qe=H(d&&d.dataset.mailExport,!0),kt=(d&&d.dataset.theme||"").trim().toLowerCase(),Ct=kt==="light"||kt==="dark"?kt:"auto",I=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Ye=h("isBackdropVisible")||h("isbackdropvisible")||h("backdropVisible")||h("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Je=.2,Yt=H(Ye,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:bt,customPosition:!1,dimEnabled:Yt,dimOpacity:Yt?Je:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Jt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function tt(){return Jt?Jt.matches:window.innerWidth<=640}function Zt(){const t=bn();t&&(C=t);const e=yn(),n=gt!=null?!H(gt,!0):null;r.hidden=e!==null?e:n!==null?n:H(De,!1),vt&&(r.importFiles=Qn()),_t(),kn(),Lt(),Ze(),_e(),We(),rt(r.hidden),E?Pt():Ln(),Y(),zt(),xe(),_n(),E||Ne(),hn()}function _t(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Ze(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function so(){return`
    ...
    `)}function fo(){return Le()}function Ae(){return`
    ...
    `)}function Me(){return $(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function wo(){return C==="top"?Te():Me()}function Se(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
