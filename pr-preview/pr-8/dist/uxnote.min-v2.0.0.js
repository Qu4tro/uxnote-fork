(()=>{var To=Object.defineProperty,Mo=Object.defineProperties;var So=Object.getOwnPropertyDescriptors;var Be=Object.getOwnPropertySymbols;var No=Object.prototype.hasOwnProperty,$o=Object.prototype.propertyIsEnumerable;var Ue=(d,w,k)=>w in d?To(d,w,{enumerable:!0,configurable:!0,writable:!0,value:k}):d[w]=k,Ot=(d,w)=>{for(var k in w||(w={}))No.call(w,k)&&Ue(d,k,w[k]);if(Be)for(var k of Be(w))$o.call(w,k)&&Ue(d,k,w[k]);return d},Fe=(d,w)=>Mo(d,So(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,k=`${location.protocol}//${location.host}`,Ve=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",gt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),xt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),De=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),je=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Bt=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Ut=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Ft="#4e9cf6",j=ot(je||Ut||Bt||Ft,Ft),Ke=ot(Bt||j,j),Xe=ot(Ut||j,j),bt={text:At(Ke,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:At(Xe,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:At(j,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let C=xt!=null?O(xt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const Vt="wn-toolbar-pos",G=d&&(d.dataset.dock||d.dataset.layout)||"",Dt=`uxnote:site:${k}`,jt=`uxnote:import-files:${k}`,Kt=`uxnote:hidden:${k}`,yt=`uxnote:pending:${k}`,Xt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=Xt?{url:Xt,apiKey:d&&d.dataset.serverApiKey||""}:null,qt=O(d&&d.dataset.jsonExport,!0),vt=O(d&&d.dataset.jsonImport,!0),kt=(d&&d.dataset.theme||"").trim().toLowerCase(),Ct=kt==="light"||kt==="dark"?kt:"auto",I=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,qe=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Ye=.2,Yt=O(qe,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:bt,customPosition:!1,dimEnabled:Yt,dimOpacity:Yt?Ye:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Jt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function tt(){return Jt?Jt.matches:window.innerWidth<=640}function Zt(){const t=xn();t&&(C=t);const e=bn(),n=gt!=null?!O(gt,!0):null;r.hidden=e!==null?e:n!==null?n:O(De,!1),vt&&(r.importFiles=En()),_t(),vn(),Lt(),Je(),Ze(),_e(),rt(r.hidden),E?Pt():Qn(),Y(),zt(),xe(),Zn(),E||Ne(),fn()}function _t(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Je(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function io(){return`
    ...
    `)}function Me(){return $(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function fo(){return C==="top"?Te():Me()}function Se(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function A(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Ne(){try{const t=localStorage.getItem(yt);if(!t)return;const e=JSON.parse(t);e.pageKey===A(window.location.href)&&Z(e.id,!1),localStorage.removeItem(yt)}catch(t){}}let V=new Map,Rt=Promise.resolve(),D=!1;function $e(){return`${E.url}/annotations?site=${encodeURIComponent(k)}`}function Ie(t){return`${E.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function wo(t){return`${E.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function _(t){const e=Object.assign({},t);return E.apiKey&&(e["X-Uxnote-Key"]=E.apiKey),e}function ze(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function mt(t,e){console.warn("Uxnote sync:",t,e),!D&&(D=!0,P(t))}function ft(t){return Rt=Rt.then(t,t),Rt}async function Pt(){if(E)try{const t=await fetch($e(),{headers:_({Accept:"application/json"})});if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=await t.json();r.annotations=(e&&e.annotations||[]).filter(Mt),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=A(n.pageUrl||window.location.href))}),V=ze(r.annotations),D=!1,X(),Y(),B(),L(),Ne()}catch(t){mt("Uxnote: could not read the annotations from the server",t)}}function He(){if(!E)return;const t=ze(r.annotations);t.forEach((e,n)=>{V.get(n)!==e&&ft(()=>go(n,e))}),V.forEach((e,n)=>{t.has(n)||ft(()=>xo(n))})}async function go(t,e){try{const n=await fetch(Ie(t),{method:"PUT",headers:_({"Content-Type":"application/json"}),body:e});if(!n.ok)throw new Error(`HTTP ${n.status}`);V.set(t,e),D=!1}catch(n){mt("Uxnote: could not save this annotation on the server",n)}}async function xo(t){try{const e=await fetch(Ie(t),{method:"DELETE",headers:_()});if(!e.ok)throw new Error(`HTTP ${e.status}`);V.delete(t),D=!1}catch(e){mt("Uxnote: could not delete this annotation on the server",e)}}function bo(){E&&ft(async()=>{try{const t=await fetch($e(),{method:"DELETE",headers:_()});if(!t.ok)throw new Error(`HTTP ${t.status}`);V=new Map,D=!1}catch(t){mt("Uxnote: could not delete the annotations on the server",t)}})}let ht=null,Re=A(window.location.href);function yo(){ht=null;const t=A(window.location.href);t!==Re&&(Re=t,X(),Y(),B(),L(),ft(Pt))}function Pe(){ht&&clearTimeout(ht),ht=setTimeout(yo,120)}function vo(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const a=e.apply(this,o);return Pe(),a})}),window.addEventListener("popstate",Pe)}function Oe(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function ko(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const a=document.createElement("span");a.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(a),o.appendChild(i);const s=u=>{const x=!!u&&u.w>=4&&u.h>=4;n.style.display=x?"block":"none",x&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};s(null);const l=u=>({x:Math.min(Math.max(u.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(u.clientY,0),document.documentElement.clientHeight)}),c=(u,x)=>({x:Math.min(u.x,x.x),y:Math.min(u.y,x.y),w:Math.abs(x.x-u.x),h:Math.abs(x.y-u.y)});let p=null;const m=u=>{u.preventDefault(),p=l(u),s(null)},h=u=>{p&&(u.preventDefault(),s(c(p,l(u))))},f=u=>{if(!p)return;const x=c(p,l(u));if(p=null,x.w<4||x.h<4){s(null);return}y({x:x.x+window.scrollX,y:x.y+window.scrollY,w:x.w,h:x.h})},y=u=>{document.removeEventListener("keydown",g,!0),document.removeEventListener("mousemove",h,!0),document.removeEventListener("mouseup",f,!0),e.remove(),o.remove(),t(u)},g=u=>{u.key==="Escape"&&(u.preventDefault(),y(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>y(null)),document.addEventListener("mousemove",h,!0),document.addEventListener("mouseup",f,!0),document.addEventListener("keydown",g,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Co(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,a=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-a)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const m=document.createElement("canvas");return m.width=c,m.height=p,m.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:m,w:c,h:p}}async function Eo(){if(!(!Oe()||r.mode==="screenshot")){R("screenshot");try{const t=await ko();if(!t)return;const e=Co(t).catch(c=>(console.warn("Uxnote screenshot:",c),null)),n=await Et("Comment for this region?");if(!n)return;const o=await e;if(!o){P("Uxnote: could not capture that region");return}const{comment:a}=n,i=ut();let s=null;if(E){const c=await new Promise(m=>o.canvas.toBlob(m,"image/png")),p=c?await Qo(c,i):null;if(!p){P("Uxnote: could not send the screenshot to the server");return}s={url:p.url,w:o.w,h:o.h,capturedAt:Date.now()}}else s={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};const l={id:i,type:"screenshot",comment:a.trim(),snippet:"",pageUrl:window.location.href,pageKey:A(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:s,createdAt:Date.now(),status:"active"};r.annotations.push(l),M(),F(l,null),L()}finally{R(null)}}}async function Qo(t,e){try{const n=await fetch(wo(e),{method:"PUT",headers:_({"Content-Type":"image/png"}),body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);const o=await n.json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function Lo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=E?new URL(`${E.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Ao(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",a,!0),e.remove()},a=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",a,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Zt):Zt(),window.Uxnote={refresh:N,setHidden:t=>rt(!!t),toggleVisibility:()=>rt(!r.hidden),isHidden:()=>!!r.hidden,sync:{pull:Pt,push:He,url:()=>E?E.url:null}}})();})();
