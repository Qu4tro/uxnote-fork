(()=>{var Io=Object.defineProperty,zo=Object.defineProperties;var Ro=Object.getOwnPropertyDescriptors;var Ve=Object.getOwnPropertySymbols;var Oo=Object.prototype.hasOwnProperty,Ho=Object.prototype.propertyIsEnumerable;var je=(d,w,k)=>w in d?Io(d,w,{enumerable:!0,configurable:!0,writable:!0,value:k}):d[w]=k,Ut=(d,w)=>{for(var k in w||(w={}))Oo.call(w,k)&&je(d,k,w[k]);if(Ve)for(var k of Ve(w))Ho.call(w,k)&&je(d,k,w[k]);return d},Ke=(d,w)=>zo(d,Ro(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,k=`${location.protocol}//${location.host}`,Xe=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",bt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),yt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),qe=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Ye=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Ft=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Dt=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),Vt="#4e9cf6",j=rt(Ye||Dt||Ft||Vt,Vt),Je=rt(Ft||j,j),_e=rt(Dt||j,j),vt={text:Tt(Je,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Tt(_e,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Tt(j,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let C=yt!=null?R(yt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const jt="wn-toolbar-pos",tt=d&&(d.dataset.dock||d.dataset.layout)||"",Kt=`uxnote:site:${k}`,Xt=`uxnote:import-files:${k}`,qt=`uxnote:hidden:${k}`,kt=`uxnote:pending:${k}`,Yt=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),E=Yt?{url:Yt,apiKey:d&&d.dataset.serverApiKey||""}:null,Jt=R(d&&d.dataset.jsonExport,!0),Ct=R(d&&d.dataset.jsonImport,!0),Ze=R(d&&d.dataset.mailExport,!0),Et=(d&&d.dataset.theme||"").trim().toLowerCase(),Qt=Et==="light"||Et==="dark"?Et:"auto",I=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,We=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Ge=.2,_t=R(We,!0),r={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:vt,customPosition:!1,dimEnabled:_t,dimOpacity:_t?Ge:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},Zt=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function et(){return Zt?Zt.matches:window.innerWidth<=640}function Wt(){const t=vn();t&&(C=t);const e=kn(),n=bt!=null?!R(bt,!0):null;r.hidden=e!==null?e:n!==null?n:R(qe,!1),Ct&&(r.importFiles=Ln()),Gt(),En(),St(),tn(),en(),nn(),at(r.hidden),E?Bt():Sn(),Y(),Ot(),ye(),Gn(),E||Ie(),gn()}function Gt(){const t=getComputedStyle(document.body);r.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function tn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function en(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${C}`;const e=f=>{const u=document.createElement("button");return u.className="wn-annot-btn wn-annotator",u.setAttribute("data-action",f.action),f.mode&&u.setAttribute("data-mode",f.mode),u.setAttribute("data-tip",f.tip),u.innerHTML=f.icon,u},n=f=>{const u=document.createElement("div");return u.className="wn-annot-group wn-annotator",f.forEach(g=>u.appendChild(e(g))),u},o=()=>{const f=document.createElement("div");return f.className="wn-annot-spacer wn-annotator",f},a=document.createDocumentFragment(),i=document.createElement("div");if(i.className="wn-annot-logo wn-annotator",i.innerHTML=co(),a.appendChild(i),E){const f=document.createElement("div");f.className="wn-annot-sync-dot wn-annotator",f.setAttribute("role","status"),a.appendChild(f),r.syncDot=f,ze()}const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:Se()},{action:"mode",mode:"element",tip:"Annotate an element",icon:po()}];Fe()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:ho()});const l=[];Ct&&l.push({action:"import",tip:"Import JSON",icon:mo()}),Jt&&l.push({action:"export",tip:"Export JSON",icon:uo()}),Ze&&l.push({action:"mail",tip:"Send by mail",icon:fo()});const c=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:xo()},{action:"toggle-panel",tip:"Show / hide annotations",icon:go()}];a.appendChild(o()),a.appendChild(n(s)),l.length&&(a.appendChild(o()),a.appendChild(n(l))),a.appendChild(o()),a.appendChild(n(c)),t.appendChild(a),document.body.appendChild(t),r.toolbar=t;const p=document.createElement("div");p.className="wn-annot-panel wn-annotator",p.innerHTML=`
    ...
    `,C==="left"&&(p.style.left="18px",p.style.right="auto"),document.body.appendChild(p),r.panel=p,p.style.display="none";const m=p.querySelector(".wn-annot-delete-all");m&&m.addEventListener("click",async f=>{f.stopPropagation(),await ao()});const y=document.createElement("div");y.className="wn-annot-marker-layer wn-annotator",document.body.appendChild(y),r.markerLayer=y;const h=document.createElement("div");h.className="wn-annot-outline wn-annotator",h.style.display="none",document.body.appendChild(h),r.outlineBox=h;const b=document.createElement("div");b.className="wn-annot-tip wn-annotator",b.textContent="Active mode",document.body.appendChild(b),r.tip=b,t.addEventListener("click",Tn),A(),ct(),lt(),O(),st(),xn(),on()}function te(){r.dimOverlay&&r.dimOverlay.classList.toggle("is-visible",!r.hidden)}function nn(){if(!r.dimEnabled||r.dimOverlay)return;const t=document.createElement("div");t.className="wn-annot-dimmer",t.setAttribute("aria-hidden","true"),t.style.setProperty("--wn-dim-opacity",String(r.dimOpacity));const e=document.body.firstChild;e?document.body.insertBefore(t,e):document.body.appendChild(t),r.dimOverlay=t,te()}function ee(){if(!r.visibilityToggle)return;const t=r.visibilityToggle,n=et()&&r.toolbar&&!r.hidden?r.toolbar:document.body;t.parentNode!==n&&(t.parentNode&&t.parentNode.removeChild(t),n===r.toolbar?r.toolbar.insertBefore(t,r.toolbar.firstChild):document.body.appendChild(t))}function on(){if(r.visibilityToggle)return;const t=document.createElement("button");t.type="button",t.className="wn-annot-visibility-btn wn-annotator",t.setAttribute("aria-label","Masquer Uxnote"),t.setAttribute("data-tip","Masquer Uxnote"),t.innerHTML=$e(),t.addEventListener("click",Nn),r.visibilityToggle=t,ee(),it(),de()}function rn(){if(r.commentModal)return r.commentModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-comment-card wn-annotator";const n=document.createElement("h4");n.textContent="Add a comment";const o=document.createElement("textarea");o.className="wn-annotator",o.placeholder="Your comment...";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator",i.textContent="Cancel";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",s.textContent="Save",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t),r.commentModal={backdrop:t,modal:e,textarea:o,title:n,okBtn:s,cancelBtn:i},r.commentModal}function nt(){const t=r.commentModal;if(!t||!r.toolbar||!t.backdrop.classList.contains("show"))return;const e=t.modal,n=r.toolbar.getBoundingClientRect(),o=.75*(parseFloat(getComputedStyle(e).fontSize)||16);e.style.left=`${n.left+n.width/2}px`,C==="top"?(e.style.top=`${n.bottom+o}px`,e.style.bottom=""):(e.style.top="",e.style.bottom=`${window.innerHeight-n.top+o}px`)}function ne(t,e=""){return new Promise(n=>{const o=rn(),{backdrop:a,textarea:i,title:s,okBtn:l,cancelBtn:c}=o;s.textContent=t||"Add a comment",i.value=e||"",i.placeholder="Your comment...",a.classList.add("show"),nt(),i.focus(),i.select();const p=b=>{a.classList.remove("show"),l.removeEventListener("click",m),c.removeEventListener("click",y),document.removeEventListener("keydown",h),window.removeEventListener("resize",nt),n(b)},m=()=>{p({comment:i.value.trim()})},y=()=>p(null),h=b=>{b.key==="Escape"&&p(null),b.key==="Enter"&&!(b.shiftKey||b.altKey)&&(b.preventDefault(),m())};l.textContent="Save",c.textContent="Cancel",l.addEventListener("click",m),c.addEventListener("click",y),document.addEventListener("keydown",h),window.addEventListener("resize",nt)})}async function At(t){const e=await ne(t);return e||null}function an(){if(r.importModal)return r.importModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-import-modal";const n=document.createElement("h4");n.textContent="Import JSON files";const o=document.createElement("div");o.className="wn-annot-import-body wn-annotator";const a=document.createElement("label");a.className="wn-annot-import-drop wn-annotator";const i=document.createElement("input");i.type="file",i.accept="application/json",i.multiple=!0,i.className="wn-annotator";const s=document.createElement("div"),l=document.createElement("div");l.className="wn-annot-import-drop-title wn-annotator",l.textContent="Drop JSON files here";const c=document.createElement("div");c.className="wn-annot-import-drop-sub wn-annotator",c.textContent="or click to select files",s.appendChild(l),s.appendChild(c),a.appendChild(i),a.appendChild(s);const p=document.createElement("div");p.className="wn-annot-import-panel wn-annotator";const m=document.createElement("div");m.className="wn-annot-import-title-row wn-annotator";const y=document.createElement("h5");y.textContent="Loaded files";const h=document.createElement("span");h.className="wn-annot-import-count wn-annotator",h.textContent="0";const b=document.createElement("p");b.textContent="Files are saved automatically.";const f=document.createElement("div");f.className="wn-annot-import-list wn-annotator",m.appendChild(y),m.appendChild(h),p.appendChild(m),p.appendChild(b),p.appendChild(f);const u=document.createElement("div");u.className="wn-annot-actions wn-annotator";const g=document.createElement("button");g.type="button",g.className="wn-annot-pill cancel wn-annotator",g.textContent="Close",u.appendChild(g),o.appendChild(a),o.appendChild(p),e.appendChild(n),e.appendChild(o),e.appendChild(u),t.appendChild(e),document.body.appendChild(t);const Q=()=>{t.classList.remove("show"),document.removeEventListener("keydown",M)},M=x=>{x.key==="Escape"&&Q()},G=x=>{x.target===t&&Q()};return g.addEventListener("click",Q),t.addEventListener("click",G),["dragenter","dragover"].forEach(x=>{a.addEventListener(x,v=>{v.preventDefault(),v.stopPropagation(),a.classList.add("dragover")})}),["dragleave","drop"].forEach(x=>{a.addEventListener(x,v=>{v.preventDefault(),v.stopPropagation(),a.classList.remove("dragover")})}),a.addEventListener("drop",x=>{var xt;const v=(xt=x.dataTransfer)==null?void 0:xt.files;v&&v.length&&oe(Array.from(v))}),i.addEventListener("change",x=>{const v=x.target.files;v&&v.length&&oe(Array.from(v)),i.value=""}),f.addEventListener("click",x=>{const v=x.target.closest("[data-import-remove]");v&&un(v.dataset.importRemove)}),r.importModal={backdrop:t,modal:e,fileInput:i,fileList:f,filesCount:h,onKey:M,close:Q},r.importModal}function sn(){if(!Ct)return;const t=an();ot(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function ot(){if(!r.importModal)return;const{fileList:t,filesCount:e}=r.importModal,{fileCounts:n}=ln();if(t.innerHTML="",r.importFiles.length)r.importFiles.forEach(o=>{const a=document.createElement("div");a.className="wn-annot-import-card wn-annotator";const i=document.createElement("div");i.className="wn-annot-import-meta wn-annotator";const s=document.createElement("div");s.className="wn-annot-import-name wn-annotator",s.textContent=o.name;const l=document.createElement("div");l.className="wn-annot-import-sub wn-annotator";const c=n.get(o.id)||0,p=o.pageUrl?` | ${fn(o.pageUrl,36)}`:"";l.textContent=`${c} comments | ${mn(o.size)}${p}`,i.appendChild(s),i.appendChild(l);const m=document.createElement("div");m.className="wn-annot-import-actions wn-annotator";const y=document.createElement("div");y.className="wn-annot-import-badge wn-annotator",y.textContent=String(c);const h=document.createElement("button");h.type="button",h.className="wn-annot-import-remove wn-annotator",h.dataset.importRemove=o.id,h.textContent="x",m.appendChild(y),m.appendChild(h),a.appendChild(i),a.appendChild(m),t.appendChild(a)});else{const o=document.createElement("div");o.className="wn-annot-import-empty wn-annotator",o.textContent="No imported files yet.",t.appendChild(o)}e.textContent=String(r.importFiles.length)}function ln(){const t=new Map;return r.annotations.forEach(e=>{e.importFileId&&t.set(e.importFileId,(t.get(e.importFileId)||0)+1)}),{fileCounts:t}}async function oe(t){if(!t||!t.length)return;const e=new Set(r.annotations.map(o=>o.id));let n=0;for(const o of t){const a=await cn(o,e);if(!a)continue;const{fileMeta:i,annotations:s}=a;s.length&&(r.importFiles.push(i),r.annotations.push(...s),n+=s.length)}if(!n){ot();return}T(),ce(),X(),Y(),B(),ot()}async function cn(t,e){let n;try{const c=await t.text();n=JSON.parse(c)}catch(c){return await ae(`Invalid JSON in ${t.name}.`,"Import error"),null}const o=Array.isArray(n)?n:n.annotations;if(!Array.isArray(o))return await ae(`Unsupported JSON format in ${t.name}.`,"Import error"),null;const a=Array.isArray(n)?t.lastModified:n.createdAt,i=Array.isArray(n)?"":n.pageUrl||"",s=Ae(),l=o.filter(Nt).map(c=>dn(c,{createdAt:a,pageUrl:i,fileId:s,existingIds:e}));return{fileMeta:{id:s,name:t.name,size:t.size,pageUrl:i,importedAt:Date.now()},annotations:l}}function dn(t,e){const n=t&&typeof t=="object"?t:{},o=n.pageUrl||e.pageUrl||window.location.href,a=pn(n.id,e.existingIds),i=Ke(Ut({},n),{id:a,createdAt:n.createdAt||e.createdAt||Date.now(),pageUrl:o,importFileId:e.fileId});return i.pageKey||(i.pageKey=L(o)),i}function pn(t,e){if(t&&!e.has(t))return e.add(t),t;let n;do n=mt();while(e.has(n));return e.add(n),n}function un(t){const e=r.importFiles.filter(n=>n.id!==t);e.length!==r.importFiles.length&&(r.importFiles=e,r.annotations=r.annotations.filter(n=>n.importFileId!==t),T(),ce(),X(),Y(),B(),ot())}function mn(t){if(!t)return"0 B";const e=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),e.length-1),o=t/Math.pow(1024,n);return`${o.toFixed(o<10&&n>0?1:0)} ${e[n]}`}function fn(t,e){return typeof t!="string"?"":t.length<=e?t:t.slice(0,e-3)+"..."}function hn(){if(r.dialogModal)return r.dialogModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator";const n=document.createElement("h4");n.className="wn-annotator";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator";const a=document.createElement("div");a.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",a.appendChild(i),a.appendChild(s),e.appendChild(n),e.appendChild(o),e.appendChild(a),t.appendChild(e),document.body.appendChild(t),r.dialogModal={backdrop:t,modal:e,title:n,message:o,okBtn:s,cancelBtn:i},r.dialogModal}function re({title:t="Information",message:e="",okLabel:n="OK",cancelLabel:o="Cancel",dismissOnBackdrop:a=!0}){return new Promise(i=>{const{backdrop:s,title:l,message:c,okBtn:p,cancelBtn:m}=hn();l.textContent=t,c.textContent=e,p.textContent=n;const y=!!o;m.style.display=y?"inline-flex":"none",m.textContent=o||"";const h=Q=>{s.classList.remove("show"),p.removeEventListener("click",b),m.removeEventListener("click",f),s.removeEventListener("click",u),document.removeEventListener("keydown",g),i(Q)},b=()=>h(!0),f=()=>h(!1),u=Q=>{Q.target===s&&a&&h(!1)},g=Q=>{Q.key==="Escape"&&h(!1),(Q.metaKey||Q.ctrlKey)&&Q.key==="Enter"&&b()};p.addEventListener("click",b),m.addEventListener("click",f),s.addEventListener("click",u),document.addEventListener("keydown",g),s.classList.add("show"),p.focus()})}async function wn(t,e="Confirmation"){return re({title:e,message:t,okLabel:"Confirm",cancelLabel:"Cancel"})}async function ae(t,e="Information"){await re({title:e,message:t,okLabel:"OK",cancelLabel:null})}function gn(){document.addEventListener("mouseup",$t),document.addEventListener("touchend",$t),document.addEventListener("pointerup",$t),document.addEventListener("mousemove",In),document.addEventListener("click",zn,!0),window.addEventListener("resize",N),window.addEventListener("resize",ct),window.addEventListener("resize",lt),window.addEventListener("resize",O),window.addEventListener("resize",it),window.addEventListener("scroll",N,{passive:!0}),Lo(),Qt==="auto"&&I&&(I.addEventListener?I.addEventListener("change",St):I.addListener&&I.addListener(St))}function xn(){if(!r.panel)return;const t=r.panel.querySelector("#wn-filter-search");if(!t)return;t.value=r.filters.query;const e=()=>{r.filters.query=t.value.trim().toLowerCase(),A()};t.addEventListener("input",e)}function H(t,e={}){const n=e.keepOutline;if(r.mode===t){r.mode=null,ie(),Lt(),n||dt();return}r.mode=t,ie(),bn(t),t!=="element"&&dt()}function ie(){r.toolbar.querySelectorAll('button[data-action="mode"]').forEach(e=>{e.getAttribute("data-mode")===r.mode?e.classList.add("active"):e.classList.remove("active")})}function bn(t){let e="";if(t==="text"?e="Select text then release to add a note.":t==="element"&&(e="Hover an element, click to annotate."),!e)return Lt();r.tip.textContent=e,r.tip.classList.add("show"),O(),requestAnimationFrame(O),requestAnimationFrame(O)}function Lt(){r.tip.classList.remove("show")}function yn(){if(r.toast)return r.toast;const t=document.createElement("div");return t.className="wn-annot-toast wn-annotator",t.setAttribute("aria-live","polite"),document.body.appendChild(t),r.toast=t,t}function P(t){if(!t)return;const e=yn();e.textContent=t,e.classList.add("show"),r.toastTimer&&clearTimeout(r.toastTimer),r.toastTimer=setTimeout(()=>{e.classList.remove("show")},2200)}function vn(){try{const t=localStorage.getItem(jt);if(t==="top"||t==="bottom")return t}catch(t){}return null}function kn(){try{const t=localStorage.getItem(qt);return t==null?null:t==="true"}catch(t){return null}}function Cn(t){try{localStorage.setItem(qt,t?"true":"false")}catch(e){}}function St(){const t=Qt==="dark"||Qt==="auto"&&!!(I&&I.matches);document.documentElement.setAttribute("data-wn-theme",t?"dark":"light")}function En(){if(!document||!document.documentElement)return;const t=document.documentElement,e=r.colors||vt,n=(i,s)=>{s&&t.style.setProperty(i,s)},o=e.text,a=e.element;n("--wn-text-highlight",o.base),n("--wn-text-highlight-overlay",o.overlay),n("--wn-text-highlight-soft",o.soft),n("--wn-element-highlight",a.base),n("--wn-element-highlight-soft",a.soft),n("--wn-element-highlight-soft-end",a.softer),n("--wn-element-highlight-strong",a.strong),n("--wn-element-highlight-shadow",a.shadow),n("--wn-marker-text",a.text)}function Tt(t,e={}){var s,l,c;const n=rt(t,"#000000"),o=(s=e.softAlpha)!=null?s:.12,a=(l=e.softerAlpha)!=null?l:.04,i=(c=e.overlayAlpha)!=null?c:.7;return{base:n,overlay:S(n,i,S("#000000",i)),soft:S(n,o,S("#000000",o)),softer:S(n,a,S("#000000",a)),strong:S(n,.9,n),shadow:S(n,.24,"rgba(0,0,0,0.24)"),pill:S(n,.16,"rgba(0,0,0,0.16)"),pillBorder:S(n,.28,"rgba(0,0,0,0.28)"),text:Qn(n)}}function rt(t,e){const n=Mt(t);return n||Mt(e)||"#000000"}function Mt(t){if(!t||typeof t!="string")return null;const n=t.trim().match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i);if(!n)return null;const o=n[1];return`#${(o.length===3?o.split("").map(i=>i+i).join(""):o).toLowerCase()}`}function se(t){const e=Mt(t);if(!e)return null;const n=parseInt(e.slice(1),16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function S(t,e=1,n=""){const o=se(t);if(!o)return n||"";const a=typeof e=="number"&&e>=0&&e<=1?e:1;return`rgba(${o.r}, ${o.g}, ${o.b}, ${a})`}function Qn(t){const e=se(t);return e?.299*e.r+.587*e.g+.114*e.b>160?"#0b1622":"#ffffff":"#0b1622"}function z(t){const e=r.colors||vt,n=t&&t.type;return n==="text"?e.text:n==="screenshot"?e.screenshot:e.element}function le(t,e){!t||!e||(t.style.setProperty("--wn-marker-bg",e.base),t.style.setProperty("--wn-marker-text",e.text),t.style.setProperty("--wn-marker-shadow",e.shadow))}function An(t,e){!t||!e||(t.style.setProperty("--wn-item-accent",e.base),t.style.setProperty("--wn-item-accent-strong",e.strong),t.style.setProperty("--wn-item-accent-shadow",e.shadow),t.style.setProperty("--wn-item-accent-soft",e.soft),t.style.setProperty("--wn-item-accent-soft-end",e.softer),t.style.setProperty("--wn-item-number-bg",e.pill),t.style.setProperty("--wn-item-number-border",e.pillBorder))}function R(t,e=!1){if(t==null||t==="")return e;const n=String(t).toLowerCase();return n==="true"||n==="1"||n==="yes"||n==="on"?!0:n==="false"||n==="0"||n==="no"||n==="off"?!1:e}function Ln(){try{const t=localStorage.getItem(Xt),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>n&&typeof n=="object").map(n=>({id:n.id||Ae(),name:String(n.name||"Imported file"),size:Number(n.size||0),pageUrl:typeof n.pageUrl=="string"?n.pageUrl:"",importedAt:Number(n.importedAt||0)})):[]}catch(t){return[]}}function ce(){try{localStorage.setItem(Xt,JSON.stringify(r.importFiles||[]))}catch(t){}}function O(){if(!r.tip||!r.toolbar)return;const t=r.toolbar.getBoundingClientRect(),e=r.tip,n=10,o=t.left+t.width/2,a=C==="bottom";e.style.left=`${o}px`,e.style.right="",e.style.transform="translateX(-50%)",e.style.top="",e.style.bottom="";const i=e.getBoundingClientRect();if(a){const s=Math.max(8,t.top-n-i.height);e.style.top=`${s}px`}else{const s=t.bottom+n;e.style.top=`${s}px`}}function Nt(t){return!!t&&(t.type==="text"||t.type==="element"||t.type==="screenshot")}function Sn(){try{const t=localStorage.getItem(Kt),e=t?JSON.parse(t):[];r.annotations=(e||[]).filter(Nt),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))})}catch(t){console.warn("Annotator storage error",t),r.annotations=[]}}function T(){if(E){Pe();return}try{localStorage.setItem(Kt,JSON.stringify(r.annotations))}catch(t){console.warn("Annotator storage save error",t)}}async function Tn(t){const e=t.target.closest("button");if(!e||!e.classList.contains("wn-annotator"))return;const n=e.getAttribute("data-action");if(n){if(n==="mode"){const o=e.getAttribute("data-mode");if(o==="screenshot"){await Mo();return}H(o);return}if(n==="export"){Jt&&io();return}if(n==="import"){sn();return}if(n==="mail"){await so();return}if(n==="toggle-panel"){Mn();return}if(n==="toggle-pos"){$n(C==="bottom"?"top":"bottom"),pe();return}}}function Mn(){const t=r.panel.style.display==="none";r.panel.style.display=t?"":"none",st()}function Nn(){at(!r.hidden)}function at(t){r.hidden=t,Cn(t),document.body.classList.toggle("wn-annot-hidden",t),t&&(H(null),Lt(),dt()),de(),te(),it(),ct(),t||(N(),lt(),O()),document.dispatchEvent(new CustomEvent("uxnote:visibility",{detail:{hidden:t}}))}function de(){if(!r.visibilityToggle)return;const t=r.hidden?"Show Uxnote":"Hide Uxnote";r.visibilityToggle.classList.toggle("is-muted",r.hidden),r.visibilityToggle.innerHTML=r.hidden?bo():$e(),r.visibilityToggle.setAttribute("aria-label",t),r.visibilityToggle.setAttribute("aria-pressed",r.hidden?"true":"false"),r.visibilityToggle.setAttribute("data-tip",t)}function it(){const t=r.visibilityToggle;if(!t)return;ee();const e=18;if(et()){r.hidden?(t.style.bottom=`${e}px`,t.style.left=`${e}px`,t.style.top="",t.style.right=""):(t.style.top="",t.style.right="",t.style.bottom="",t.style.left="");return}t.style.left="",t.style.right="",C==="top"?(t.style.top=`${e}px`,t.style.bottom=""):(t.style.bottom=`${e}px`,t.style.top="")}function st(){if(!r.panel||!r.toolbar)return;const t=r.toolbar.querySelector('button[data-action="toggle-panel"]');if(!t)return;const e=r.panel.style.display==="none";t.classList.toggle("active",!e)}function lt(){if(!r.panel||!r.toolbar)return;const t=r.panel,e=18,n=r.toolbar.getBoundingClientRect();if(et()){t.style.width="100vw",t.style.maxHeight="100vh",t.style.height="100vh",t.style.left="0",t.style.right="0",t.style.top="0",t.style.bottom="0",t.style.borderRadius="0";return}t.style.width=`min(360px, calc(100vw - ${e*2}px))`,t.style.maxHeight=`calc(100vh - ${e*2}px)`,t.style.left="auto",t.style.right=`${e}px`,t.style.top=`${e}px`,t.style.bottom=`${e}px`,t.style.height="",t.style.borderRadius="",C==="left"?(t.style.left=`${n.width+e}px`,t.style.right=`${e}px`):C==="right"&&(t.style.right=`${n.width+e}px`,t.style.left=`${e}px`)}function $n(t){C=t==="top"?"top":"bottom";const e=r.toolbar;e&&(e.classList.remove("wn-pos-top","wn-pos-bottom","wn-pos-left","wn-pos-right"),e.classList.add(`wn-pos-${C}`));try{localStorage.setItem(jt,C)}catch(n){}pe(),it(),O(),nt(),lt(),ct()}function pe(){if(!r.toolbar)return;const t=r.toolbar.querySelector('button[data-action="toggle-pos"]');t&&(t.innerHTML=C==="top"?Me():Ne())}function ct(){if(!r.toolbar||r.customPosition||!(tt==="push"||tt==="dock"||tt==="pad"||tt==="true"))return;const t=document.body;r.basePadding||Gt();const e=r.basePadding;if(r.hidden){t.style.paddingTop=`${e.top}px`,t.style.paddingRight=`${e.right}px`,t.style.paddingBottom=`${e.bottom}px`,t.style.paddingLeft=`${e.left}px`;return}const n=r.toolbar.getBoundingClientRect(),o=Ut({},e);C==="top"?o.top=e.top+n.height:C==="bottom"?o.bottom=e.bottom+n.height:C==="left"?o.left=e.left+n.width:C==="right"&&(o.right=e.right+n.width),t.style.paddingTop=`${o.top}px`,t.style.paddingRight=`${o.right}px`,t.style.paddingBottom=`${o.bottom}px`,t.style.paddingLeft=`${o.left}px`}async function $t(){if(r.mode!=="text")return;const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return;const e=t.getRangeAt(0);if(!e)return;if(!(U(e.commonAncestorContainer)&&U(e.startContainer)&&U(e.endContainer))){t.removeAllRanges(),P("This area is a popup or overlay. It cannot be annotated.");return}const o=t.toString().trim();if(!o)return;const a=await At("Comment for this highlight?");if(!a)return;const{comment:i}=a,s=mt(),l=Hn(e,o),c=pt(e,s);t.removeAllRanges();const p={id:s,type:"text",target:l,comment:i.trim(),snippet:o.slice(0,180),pageUrl:window.location.href,pageKey:L(window.location.href),createdAt:Date.now(),status:"active"};r.annotations.push(p),T(),F(p,c),A(),H(null,{keepOutline:!0})}function In(t){if(r.mode!=="element")return;const e=t.target;if(!e||!U(e)){dt();return}const n=e.getBoundingClientRect();On(n)}async function zn(t){if(r.mode!=="element")return;const e=t.target;if(!e||!U(e)){P("This area is a popup or overlay. It cannot be annotated.");return}t.preventDefault(),t.stopPropagation();const n=await At("Comment for this element?");if(!n)return;const{comment:o}=n,a=mt(),i=zt(e),s=Vn(e),l=e.getBoundingClientRect(),c={id:a,type:"element",target:{xpath:i,css:s,tag:e.tagName.toLowerCase()},comment:o.trim(),snippet:e.innerText?e.innerText.trim().slice(0,120):e.tagName,pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:l.x+window.scrollX,y:l.y+window.scrollY,w:l.width,h:l.height},createdAt:Date.now(),status:"active"};r.annotations.push(c),T(),F(c,e),xe(e,a),A(),H(null,{keepOutline:!0})}function It(t){const e=t&&t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}}function K(t){const e=r.highlightSpans[t];return e?Array.isArray(e)?e:[e]:Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`))}function X(){Object.keys(r.highlightSpans||{}).forEach(t=>{K(t).forEach(e=>{e&&e.parentNode&&It(e)})}),r.highlightSpans={},Array.from(document.querySelectorAll(".uxnote-textmark[data-uxnote-id], .wn-annot-highlight[data-wn-annot-id]")).forEach(t=>{t&&t.parentNode&&It(t)}),Object.values(r.markers||{}).forEach(t=>{t&&t.el&&t.el.parentNode&&t.el.parentNode.removeChild(t.el)}),r.markerLayer&&(r.markerLayer.innerHTML=""),r.markers={},Object.keys(r.elementTargets||{}).forEach(t=>{be(t)}),r.elementTargets={},Array.from(document.querySelectorAll(".uxnote-annotated[data-uxnote-ids]")).forEach(t=>{delete t.dataset.uxnoteIds,t.classList.remove("uxnote-annotated")})}function Rn(t){const e=r.markers[t];e&&e.el&&e.el.parentNode&&e.el.parentNode.removeChild(e.el),e&&e.frame&&e.frame.parentNode&&e.frame.parentNode.removeChild(e.frame),delete r.markers[t],be(t);let n=K(t);n.length||(n=Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)),n.length||(n=Array.from(document.querySelectorAll(`.wn-annot-highlight[data-wn-annot-id="${t}"]`)))),n.forEach(o=>{o&&It(o)}),delete r.highlightSpans[t]}function B(){Object.entries(r.markers).forEach(([t,e])=>{const n=r.annotations.findIndex(o=>o.id===t);n!==-1&&(e.el.textContent=n+1)})}function On(t){const e=r.outlineBox;e.style.display="block",e.style.left=`${t.x+window.scrollX}px`,e.style.top=`${t.y+window.scrollY}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`}function dt(){r.outlineBox.style.display="none"}function ue(t){return t?t.classList&&t.classList.contains("wn-annotator")||t.parentElement&&ue(t.parentElement):!1}function U(t){if(!t)return!1;const e=t.nodeType===Node.ELEMENT_NODE?t:t.nodeType===Node.DOCUMENT_NODE?document.body:t.parentElement;if(!e||ue(e))return!1;if(e.closest){if(e.closest("[data-uxnote-ignore]"))return!1;if(e.closest("[data-uxnote-allow]"))return!0;if(e.closest('#uxnote-root, .wn-annotator, dialog, [popover], [role="dialog"], [role="menu"], [role="tooltip"], [aria-modal="true"]'))return!1}return!0}function Hn(t,e){return{startXPath:zt(t.startContainer),startOffset:t.startOffset,endXPath:zt(t.endContainer),endOffset:t.endOffset,quote:e?String(e).slice(0,200):""}}function pt(t,e){let n=[];const o=t.cloneRange();if(Pn(o).forEach(i=>{const s=Bn(i,{start:i===o.startContainer?o.startOffset:0,end:i===o.endContainer?o.endOffset:i.length},e);s&&n.push(s)}),!n.length){const i=document.createElement("span");i.className="uxnote-textmark",i.dataset.uxnoteId=e,i.addEventListener("click",l=>{l.stopPropagation(),_(e)});const s=o.extractContents();i.appendChild(s),o.insertNode(i),n=[i]}return r.highlightSpans[e]=n,n[0]}function Uo(t,e){return pt(t,e)}function me(t,e){const n=document.createRange();return n.selectNodeContents(e),t.compareBoundaryPoints(Range.END_TO_START,n)>0&&t.compareBoundaryPoints(Range.START_TO_END,n)<0}function Pn(t){const e=[],n=document.createTreeWalker(t.commonAncestorContainer,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();)if(!(!o.nodeValue||!o.nodeValue.trim())){try{if(t.intersectsNode){if(!t.intersectsNode(o))continue}else if(!me(t,o))continue}catch(a){if(!me(t,o))continue}e.push(o)}return e}function Bn(t,e,n){if(!t||!t.parentNode)return null;const{start:o,end:a}=e;let i=t,s=a;if(o>0&&(i=i.splitText(o),s=a-o),s<i.length&&i.splitText(s),!i.parentNode)return null;const l=document.createElement("span");return l.className="uxnote-textmark",l.dataset.uxnoteId=n,l.addEventListener("click",c=>{c.stopPropagation(),_(n)}),i.parentNode.insertBefore(l,i),l.appendChild(i),l}function fe(t){return t?typeof t.isConnected=="boolean"?t.isConnected:document.body&&document.body.contains(t):!1}function Un(t,e){if(!t||!e)return null;const n=Math.max(t.x,e.x),o=Math.max(t.y,e.y),a=Math.min(t.x+t.width,e.x+e.width),i=Math.min(t.y+t.height,e.y+e.height),s=a-n,l=i-o;return s<=0||l<=0?null:{x:n,y:o,width:s,height:l}}function he(t){if(!t||!fe(t)||!t.getBoundingClientRect)return null;let e=t.getBoundingClientRect();if(!e.width||!e.height)return null;let n=t;for(;n&&n.nodeType===1;){if(n.tagName==="DETAILS"&&!n.open){const p=n.querySelector("summary");if(p&&!p.contains(t))return null}if(n.hasAttribute&&n.hasAttribute("hidden")||(n.getAttribute&&n.getAttribute("aria-hidden"))==="true")return null;const a=window.getComputedStyle(n);if(a.display==="none"||a.visibility==="hidden"||a.visibility==="collapse"||a.opacity==="0")return null;const i=a.overflowX||a.overflow,s=a.overflowY||a.overflow;if(i&&i!=="visible"||s&&s!=="visible"){const p=n.getBoundingClientRect(),m=Un(e,p);if(!m)return null;e=m}n=n.parentElement}return e}function Fn(t){let e=t&&t.nodeType===1?t:null;for(;e&&e.nodeType===1&&e!==document.body;){const n=window.getComputedStyle(e),o=n.zIndex;if(n.position!=="static"&&o!=="auto"||n.opacity!=="1"||n.transform!=="none"||n.filter!=="none"||n.perspective!=="none"||n.mixBlendMode!=="normal"||n.isolation==="isolate"||n.willChange&&n.willChange!=="auto"||n.contain&&n.contain!=="none")return e;e=e.parentElement}return document.body}function we(t){if(!t||t.nodeType!==1)return r.markerLayer||document.body;const e=t.offsetParent;return e&&e.nodeType===1?e:Fn(t)||r.markerLayer||document.body}function ge(t){return t===document.body||t===r.markerLayer||t===document.documentElement}function Dn(t){if(!t||t.nodeType!==1)return!1;let e=!1,n=t;for(;n&&n.nodeType===1&&n!==document.body;){if(n.tagName==="DETAILS"&&!n.open&&(n.open=!0,e=!0),n.tagName==="DIALOG"&&!n.open)try{typeof n.showModal=="function"?n.showModal():typeof n.show=="function"&&n.show(),e=!0}catch(a){}if(n.hasAttribute&&n.hasAttribute("popover"))try{typeof n.showPopover=="function"&&(n.showPopover(),e=!0)}catch(a){}if(n.hasAttribute&&n.hasAttribute("data-uxnote-open")){const a=n.getAttribute("data-uxnote-open");if(a){const i=document.querySelector(a);i&&typeof i.click=="function"&&(i.click(),e=!0)}}const o=n.getAttribute&&n.getAttribute("aria-hidden");if(n.hasAttribute&&n.hasAttribute("hidden")||o==="true"){const a=n.id;if(a){const i=document.querySelector(`[aria-controls="${ut(a)}"]`);i&&typeof i.click=="function"&&(i.click(),e=!0)}}n=n.parentElement}return e}function xe(t,e){if(!t||t.nodeType!==1)return!1;const n=t.dataset.uxnoteIds?t.dataset.uxnoteIds.split(",").filter(Boolean):[],o=new Set(n);return o.add(e),t.dataset.uxnoteIds=Array.from(o).join(","),t.classList.add("uxnote-annotated"),r.elementTargets[e]=t,!0}function be(t){const e=r.elementTargets[t];if(!e||e.nodeType!==1){delete r.elementTargets[t],Array.from(document.querySelectorAll("[data-uxnote-ids]")).forEach(i=>{const s=i.dataset.uxnoteIds?i.dataset.uxnoteIds.split(",").filter(Boolean):[];if(!s.includes(t))return;const l=s.filter(c=>c!==t);l.length?i.dataset.uxnoteIds=l.join(","):(delete i.dataset.uxnoteIds,i.classList.remove("uxnote-annotated"))});return}const o=(e.dataset.uxnoteIds?e.dataset.uxnoteIds.split(",").filter(Boolean):[]).filter(a=>a!==t);o.length?e.dataset.uxnoteIds=o.join(","):(delete e.dataset.uxnoteIds,e.classList.remove("uxnote-annotated")),delete r.elementTargets[t]}function zt(t){if(t===document.body)return"/html/body";const e=[];for(;t&&t!==document;){let n=1,o=t.previousSibling;for(;o;)o.nodeType===t.nodeType&&o.nodeName===t.nodeName&&n++,o=o.previousSibling;const a=t.nodeType===3?"text()":t.nodeName.toLowerCase();if(e.unshift(`${a}[${n}]`),t=t.parentNode,!t||t.nodeType!==1)break}return"/"+e.join("/")}function ut(t){return window.CSS&&typeof window.CSS.escape=="function"?window.CSS.escape(t):String(t).replace(/[^a-zA-Z0-9_-]/g,"\\$&")}function Vn(t){if(!t||t.nodeType!==1)return"";if(t.id)return`#${ut(t.id)}`;const e=[];let n=t,o=0;for(;n&&n.nodeType===1&&o<4;){let a=n.tagName.toLowerCase();const i=Array.from(n.classList||[]).filter(s=>s&&!s.startsWith("wn-")&&!s.startsWith("uxnote-"));if(i.length&&(a+=`.${i.slice(0,2).map(ut).join(".")}`),e.unshift(a),n.parentElement&&n.parentElement.id){e.unshift(`#${ut(n.parentElement.id)}`);break}n=n.parentElement,o+=1}return e.join(" > ")}function q(t){try{const e=document;return e.evaluate(t,e,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue}catch(e){return null}}function Y(){r.annotations.forEach(t=>{t.pageKey===L(window.location.href)&&jn(t)}),A()}function jn(t){const e=J(t);if(!e){t.status="missing",ye();return}t.status="active",Rt(t,e)}function Rt(t,e){if(e){if(e.type==="screenshot"){F(t,null);return}if(e.type==="text"&&e.range){const n=pt(e.range,t.id);F(t,n);return}e.type==="element"&&e.el&&(xe(e.el,t.id),F(t,e.el))}}function Kn(t){if(!t)return null;const e=q(t.startXPath),n=q(t.endXPath);if(!e||!n)return null;try{const o=document.createRange();return o.setStart(e,t.startOffset),o.setEnd(n,t.endOffset),o}catch(o){return null}}function J(t){return t?t.type==="screenshot"?t.rect?{type:"screenshot"}:null:t.target?t.type==="text"?Xn(t):t.type==="element"?Yn(t):null:null:null}function Xn(t){const e=t.target||{},n=Kn(e);if(n)return{type:"text",range:n};const o=e.quote||t.snippet||"";if(!o)return null;const a=qn(o);return a?{type:"text",range:a}:null}function qn(t){const e=String(t||"").trim();if(!e||e.length<4)return null;const n=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();){if(!o.nodeValue||!o.nodeValue.trim()||!U(o))continue;const a=o.nodeValue.indexOf(e);if(a===-1)continue;const i=document.createRange();return i.setStart(o,a),i.setEnd(o,a+e.length),i}return null}function Yn(t){const e=t.target||{};if(e.xpath){const a=q(e.xpath);if(a&&a.nodeType===1)return{type:"element",el:a}}if(e.css)try{const a=document.querySelector(e.css);if(a&&a.nodeType===1)return{type:"element",el:a}}catch(a){}const n=e.tag,o=(t.snippet||"").trim();if(n&&o){const a=document.querySelectorAll(n);for(const i of a)if(!(!i||i.nodeType!==1)&&(i.textContent||"").includes(o))return{type:"element",el:i}}return null}function Jn(){r.missingRetryTimer&&clearTimeout(r.missingRetryTimer),r.missingRetryTimer=setTimeout(()=>{Ot()},300)}function ye(){r.missingObserver||!window.MutationObserver||(r.missingObserver=new MutationObserver(()=>{r.annotations.some(t=>t.status==="missing")&&Jn()}),r.missingObserver.observe(document.body,{childList:!0,subtree:!0}))}function _n(){r.missingObserver&&(r.missingObserver.disconnect(),r.missingObserver=null)}function Ot(){let t=!1;r.annotations.forEach(e=>{if(e.status!=="missing"||e.pageKey!==L(window.location.href))return;const n=J(e);n&&(e.status="active",Rt(e,n),t=!0)}),t&&(T(),A(),N()),r.annotations.some(e=>e.status==="missing")||_n()}function Zn(){let t=!1;r.annotations.forEach(e=>{if(e.type!=="text"||e.pageKey!==L(window.location.href))return;const n=K(e.id).filter(fe);if(n.length){r.highlightSpans[e.id]=n,e.status==="missing"&&(e.status="active",t=!0);return}const o=J(e);if(o&&o.range){pt(o.range,e.id),e.status="active",t=!0;return}e.status!=="missing"&&(e.status="missing",t=!0)}),t&&(T(),A(),N())}function Wn(){r.layoutTimer&&clearTimeout(r.layoutTimer),r.layoutTimer=setTimeout(()=>{N(),Zn(),r.annotations.some(t=>t.status==="missing")&&Ot()},120)}function Gn(){r.layoutObserver||!window.MutationObserver||(r.layoutObserver=new MutationObserver(t=>{t.some(n=>{const o=n.target;return!(!o||o.classList&&o.classList.contains("wn-annotator")||o.closest&&o.closest(".wn-annotator"))})&&Wn()}),r.layoutObserver.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class","open","hidden","aria-hidden"]}))}function F(t,e){if(t.pageKey!==L(window.location.href)||!r.markerLayer)return;const n=r.markers[t.id];n&&n.el&&n.el.parentNode&&n.el.parentNode.removeChild(n.el);const o=document.createElement("div");o.className="wn-annot-marker wn-annotator",o.textContent=r.annotations.findIndex(c=>c.id===t.id)+1,o.dataset.wnAnnotId=t.id;const a=z(t);le(o,a),o.addEventListener("click",()=>_(t.id));const i=ke(t,e),s=ve(t,i),l=we(i&&i.anchor?i.anchor:e);if(o.parentNode!==l&&l.appendChild(o),o.style.zIndex=ge(l)?"":"9999",!i){o.style.display="none",r.markers[t.id]={el:o,rect:null,frame:s};return}o.style.display="",Ce(o,i,t),r.markers[t.id]={el:o,rect:i,frame:s}}function ve(t,e){const n=r.markers[t.id];let o=n?n.frame:null;if(t.type!=="screenshot"||!e)return o&&o.parentNode&&o.parentNode.removeChild(o),null;o||(o=document.createElement("div"),o.className="wn-annot-shot-frame wn-annotator");const a=r.markerLayer||document.body;return o.parentNode!==a&&a.appendChild(o),o.style.setProperty("--wn-shot-frame",z(t).base),o.style.left=`${e.x}px`,o.style.top=`${e.y}px`,o.style.width=`${e.w}px`,o.style.height=`${e.h}px`,o}function ke(t,e){var n;if(t.type==="text"){const a=(e?[e]:K(t.id))[0]||document.querySelector(`.uxnote-textmark[data-uxnote-id="${t.id}"]`);if(!a)return null;const i=he(a);return i?{x:i.x,y:i.y,w:i.width,h:i.height,anchor:a}:null}if(t.type==="element"){const o=(e&&e.nodeType===1?e:null)||r.elementTargets[t.id]||((n=t.target)!=null&&n.xpath?q(t.target.xpath):null);if(!o)return null;const a=he(o);return a?{x:a.x,y:a.y,w:a.width,h:a.height,anchor:o}:null}if(t.type==="screenshot"){const o=t.rect;return o?{x:o.x-window.scrollX,y:o.y-window.scrollY,w:o.w,h:o.h,anchor:null}:null}return null}function Ce(t,e,n){const o=to(n),i=(t.offsetParent||document.body).getBoundingClientRect(),s=i.x+window.scrollX,l=i.y+window.scrollY,c=e.x+window.scrollX,p=e.y+window.scrollY;t.style.left=`${c-s+e.w+o.x+4}px`,t.style.top=`${p-l+o.y-4}px`}function to(t){if(t.type!=="element")return{x:0,y:0};const e=t.target&&t.target.xpath;if(!e)return{x:0,y:0};const n=r.annotations.filter(i=>i.type==="element"&&i.pageKey===t.pageKey&&i.target&&i.target.xpath===e);if(n.length<=1)return{x:0,y:0};const o=n.findIndex(i=>i.id===t.id);return o<=0?{x:0,y:0}:{x:-o*24,y:0}}function N(){Object.entries(r.markers).forEach(([t,e])=>{const n=r.annotations.find(i=>i.id===t);if(!n)return;const o=n.status==="missing"?null:ke(n);if(e.frame=ve(n,o),!o){e.el.style.display="none",e.rect=null;return}e.el.style.display="",e.rect=o;const a=we(o.anchor);e.el.parentNode!==a&&a.appendChild(e.el),e.el.style.zIndex=ge(a)?"":"9999",Ce(e.el,o,n),le(e.el,z(n))})}function eo(){if(!r.panel)return;r.panel.style.display==="none"&&(r.panel.style.display="",st())}function no(t){if(!r.panel)return;eo();const e=r.panel.querySelector(".wn-annot-list");if(!e)return;e.querySelectorAll(".wn-annot-item").forEach(a=>a.classList.remove("is-focused"));const o=e.querySelector(`.wn-annot-item[data-id="${t}"]`);o&&(o.classList.add("is-focused"),o.scrollIntoView({behavior:"smooth",block:"nearest"}))}function _(t,e=!1,n,o){var l;const a=r.annotations.find(c=>c.id===t);if(!a)return;if(no(t),a.status==="missing"){const c=J(a);if(c)a.status="active",Rt(a,c),A();else{P("This annotation is not on this page.");return}}const i=J(a);if(i){const c=i.type==="element"?i.el:i.range&&i.range.commonAncestorContainer?i.range.commonAncestorContainer.parentElement:null;c&&Dn(c)&&setTimeout(()=>{N()},160)}if(!((o||a.pageKey)===L(window.location.href))&&e){try{localStorage.setItem(kt,JSON.stringify({id:a.id,pageKey:a.pageKey,pageUrl:n||a.pageUrl}))}catch(c){}window.location.href=n||a.pageUrl||window.location.href;return}if(a.type==="text"){const p=(K(t)||Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)))[0];p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),Ht(p,z(a).base))}else if(a.type==="element"){const c=i&&i.el?i.el:(l=a.target)!=null&&l.xpath?q(a.target.xpath):null;c&&c.scrollIntoView&&(c.scrollIntoView({behavior:"smooth",block:"center"}),Ht(c,z(a).base))}else if(a.type==="screenshot"&&a.rect){window.scrollTo({top:Math.max(0,a.rect.y+a.rect.h/2-window.innerHeight/2),behavior:"smooth"});const c=r.markers[a.id];c&&c.frame&&Ht(c.frame,z(a).base)}}function Ht(t,e){var i,s;t.style.transition="box-shadow 0.2s ease";const n=t.style.boxShadow,o=e||((s=(i=r.colors)==null?void 0:i.element)==null?void 0:s.base)||"#4e9cf6",a=S(o,.6,"rgba(78,156,246,0.6)");t.style.boxShadow=`0 0 0 3px ${a}`,setTimeout(()=>{t.style.boxShadow=n},800)}function Ee(){if(!r.panel)return null;let t=r.panel.querySelector(".wn-annot-footer");if(!t){t=document.createElement("div"),t.className="wn-annot-footer wn-annotator";const e=document.createElement("a");e.href="https://github.com/Qu4tro/uxnote-fork",e.target="_blank",e.rel="noreferrer noopener",e.textContent="uxnote-fork on GitHub",t.appendChild(e),r.panel.appendChild(t)}return t}function A(){const t=r.panel.querySelector(".wn-annot-list"),e=r.panel.querySelector("h3");if(t.innerHTML="",!r.annotations.length){const o=document.createElement("div");o.className="wn-annot-empty",o.textContent="No annotations yet.",t.appendChild(o),e&&(e.textContent="Annotations (0)");const a=Ee();return}const n=r.annotations.slice().sort((o,a)=>o.createdAt-a.createdAt).filter(o=>{const a=r.filters.query,i=`${o.comment||""} ${o.snippet||""}`.toLowerCase();return!a||i.includes(a)});e&&(e.textContent=`Annotations (${n.length})`),n.forEach((o,a)=>{const i=document.createElement("div");i.className="wn-annot-item",i.dataset.id=o.id,An(i,z(o));const s=document.createElement("div");s.className="wn-annot-card-top";const l=document.createElement("div");l.className="wn-annot-card-top-left";const c=document.createElement("div");if(c.className="wn-annot-number",c.textContent=`#${a+1}`,l.appendChild(c),o.status==="missing"){const x=document.createElement("div");x.className="wn-annot-missing",x.textContent="Missing",l.appendChild(x)}const p=document.createElement("div");p.className="wn-annot-card-top-right";const m=document.createElement("button");m.type="button",m.className="wn-annot-edit wn-annotator",m.setAttribute("aria-label","Edit this annotation"),m.innerHTML=wo(),m.addEventListener("click",async x=>{x.stopPropagation(),await ro(o.id)}),p.appendChild(m);const y=document.createElement("button");y.type="button",y.className="wn-annot-delete wn-annotator",y.setAttribute("aria-label","Delete this annotation"),y.innerHTML=Te(),y.addEventListener("click",x=>{x.stopPropagation(),oo(o.id)}),p.appendChild(y),s.appendChild(l),s.appendChild(p);const h=document.createElement("div");h.className="wn-annot-comment";const b=o.comment||"\u2014";h.textContent=b;const f=document.createElement("div");f.className="wn-annot-meta";const u=new Date(o.createdAt),g=u.toLocaleDateString(void 0,{year:"numeric",month:"2-digit",day:"2-digit"}),Q=u.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});f.textContent=`${g} \u2022 ${Q}`,l.appendChild(f);const M=document.createElement("button");M.type="button",M.className="wn-annot-showmore wn-annotator",M.textContent="See more",M.addEventListener("click",x=>{x.stopPropagation();const v=h.classList.toggle("expanded");M.textContent=v?"See less":"See more"}),b.length<160&&(M.style.display="none"),i.appendChild(s),i.appendChild(h);const G=No(o);if(G){const x=document.createElement("div");x.className="wn-annot-shot";const v=document.createElement("img");v.src=G,v.alt="The screenshot of this annotation",v.addEventListener("click",xt=>{xt.stopPropagation(),$o(G)}),x.appendChild(v),i.appendChild(x)}i.appendChild(M),i.addEventListener("click",()=>{_(o.id,!0,o.pageUrl,o.pageKey),et()&&r.panel&&(r.panel.style.display="none",st())}),t.appendChild(i)}),Ee()}function oo(t){const e=r.annotations.findIndex(n=>n.id===t);e!==-1&&(r.annotations.splice(e,1),T(),Rn(t),A(),B(),N())}async function ro(t){const e=r.annotations.find(a=>a.id===t);if(!e)return;const n=await ne("Edit this annotation",e.comment||"");if(!n)return;const{comment:o}=n;e.comment=o.trim(),T(),A()}async function ao(){!r.annotations.length||!await wn("Delete all annotations?","Delete")||(r.annotations=[],E?Qo():T(),X(),A(),B())}function io(){const t=Qe(),e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),o=document.createElement("a");o.href=n,o.download=Le(),o.click(),URL.revokeObjectURL(n)}function Qe(t=r.annotations){return{pageUrl:window.location.href,createdAt:Date.now(),annotations:t}}async function so(){lo(r.annotations)}function lo(t){const e=Qe(t),n=JSON.stringify(e,null,2),o=encodeURIComponent(Le()),a=encodeURIComponent(n),i=(Xe||"").trim(),s=i?encodeURIComponent(i):"",l="?";window.location.href=`mailto:${s}${l}subject=${o}&body=${a}`}function mt(){return"wn-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function Ae(){return"imp-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function Le(){const t=new Date,e=l=>String(l).padStart(2,"0"),n=`${e(t.getDate())}-${e(t.getMonth()+1)}-${t.getFullYear()}`,o=`${e(t.getHours())}-${e(t.getMinutes())}`,a=(document.title||"").trim(),i=l=>l.toLowerCase().replace(/[^a-z0-9]+/gi,"-").replace(/^-+|-+$/g,"")||"annotations";let s;return a?s=`${i(a)}-annotations`:window.location&&window.location.hostname?s=`${i(window.location.hostname)}-annotations`:s="annotations",`${s}_${n}_${o}.json`}const $=t=>`
  ...
  `;function co(){return`
    ...
    `)}function wo(){return Se()}function Te(){return`
    ...
    `)}function Ne(){return $(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function xo(){return C==="top"?Me():Ne()}function $e(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function L(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Ie(){try{const t=localStorage.getItem(kt);if(!t)return;const e=JSON.parse(t);e.pageKey===L(window.location.href)&&_(e.id,!1),localStorage.removeItem(kt)}catch(t){}}let D=new Map,Pt=Promise.resolve(),V=!1;const yo={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes stay in this browser"};function ze(){const t=r.syncDot;if(!t)return;const e=r.syncStatus||"pending",n=yo[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function ft(t){r.syncStatus!==t&&(r.syncStatus=t,ze())}async function Z(t,e){let n;try{n=await fetch(t,e)}catch(o){throw ft("unreachable"),o}if(!n.ok)throw ft("refused"),new Error(`HTTP ${n.status}`);return ft("ok"),n}function Re(){return`${E.url}/annotations?site=${encodeURIComponent(k)}`}function Oe(t){return`${E.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function vo(t){return`${E.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function W(t){const e=Object.assign({},t);return E.apiKey&&(e["X-Uxnote-Key"]=E.apiKey),e}function He(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function ht(t,e){console.warn("Uxnote sync:",t,e),!V&&(V=!0,P(t))}function wt(t){return Pt=Pt.then(t,t),Pt}async function Bt(){if(E)try{const t=await Z(Re(),{headers:W({Accept:"application/json"})});let e;try{e=await t.json()}catch(n){throw ft("refused"),n}r.annotations=(e&&e.annotations||[]).filter(Nt),r.annotations.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))}),D=He(r.annotations),V=!1,X(),Y(),B(),A(),Ie()}catch(t){ht("Uxnote: could not read the annotations from the server",t)}}function Pe(){if(!E)return;const t=He(r.annotations);t.forEach((e,n)=>{D.get(n)!==e&&wt(()=>Co(n,e))}),D.forEach((e,n)=>{t.has(n)||wt(()=>Eo(n))})}async function ko(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),a=await De(o,t.id,{rethrow:!0});if(!a)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:a.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}async function Co(t,e){try{const n=r.annotations.find(o=>o.id===t);n&&n.screenshot&&n.screenshot.dataUrl&&(await ko(n),e=JSON.stringify(n)),await Z(Oe(t),{method:"PUT",headers:W({"Content-Type":"application/json"}),body:e}),D.set(t,e),V=!1}catch(n){ht("Uxnote: could not save this annotation on the server",n)}}async function Eo(t){try{await Z(Oe(t),{method:"DELETE",headers:W()}),D.delete(t),V=!1}catch(e){ht("Uxnote: could not delete this annotation on the server",e)}}function Qo(){E&&wt(async()=>{try{await Z(Re(),{method:"DELETE",headers:W()}),D=new Map,V=!1}catch(t){ht("Uxnote: could not delete the annotations on the server",t)}})}let gt=null,Be=L(window.location.href);function Ao(){gt=null;const t=L(window.location.href);t!==Be&&(Be=t,X(),Y(),B(),A(),wt(Bt))}function Ue(){gt&&clearTimeout(gt),gt=setTimeout(Ao,120)}function Lo(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const a=e.apply(this,o);return Ue(),a})}),window.addEventListener("popstate",Ue)}function Fe(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function So(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const a=document.createElement("span");a.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(a),o.appendChild(i);const s=u=>{const g=!!u&&u.w>=4&&u.h>=4;n.style.display=g?"block":"none",g&&(n.style.left=`${u.x}px`,n.style.top=`${u.y}px`,n.style.width=`${u.w}px`,n.style.height=`${u.h}px`)};s(null);const l=u=>({x:Math.min(Math.max(u.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(u.clientY,0),document.documentElement.clientHeight)}),c=(u,g)=>({x:Math.min(u.x,g.x),y:Math.min(u.y,g.y),w:Math.abs(g.x-u.x),h:Math.abs(g.y-u.y)});let p=null;const m=u=>{u.preventDefault(),p=l(u),s(null)},y=u=>{p&&(u.preventDefault(),s(c(p,l(u))))},h=u=>{if(!p)return;const g=c(p,l(u));if(p=null,g.w<4||g.h<4){s(null);return}b({x:g.x+window.scrollX,y:g.y+window.scrollY,w:g.w,h:g.h})},b=u=>{document.removeEventListener("keydown",f,!0),document.removeEventListener("mousemove",y,!0),document.removeEventListener("mouseup",h,!0),e.remove(),o.remove(),t(u)},f=u=>{u.key==="Escape"&&(u.preventDefault(),b(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",y,!0),document.addEventListener("mouseup",h,!0),document.addEventListener("keydown",f,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function To(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,a=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-a)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const m=document.createElement("canvas");return m.width=c,m.height=p,m.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:m,w:c,h:p}}async function Mo(){if(!(!Fe()||r.mode==="screenshot")){H("screenshot");try{const t=await So();if(!t)return;const e=To(t).catch(c=>(console.warn("Uxnote screenshot:",c),null)),n=await At("Comment for this region?");if(!n)return;const o=await e;if(!o){P("Uxnote: could not capture that region");return}const{comment:a}=n,i=mt();let s={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(E){const c=await new Promise(m=>o.canvas.toBlob(m,"image/png")),p=c?await De(c,i):null;p?s={url:p.url,w:o.w,h:o.h,capturedAt:Date.now()}:P("Uxnote: the picture stays on this device until the server answers")}const l={id:i,type:"screenshot",comment:a.trim(),snippet:"",pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:s,createdAt:Date.now(),status:"active"};r.annotations.push(l),T(),F(l,null),A()}finally{H(null)}}}async function De(t,e,n={}){try{const a=await(await Z(vo(e),{method:"PUT",headers:W({"Content-Type":"image/png"}),body:t})).json();return a&&a.url?a:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function No(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=E?new URL(`${E.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function $o(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",a,!0),e.remove()},a=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",a,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Wt):Wt(),window.Uxnote={refresh:N,setHidden:t=>at(!!t),toggleVisibility:()=>at(!r.hidden),isHidden:()=>!!r.hidden,sync:{pull:Bt,push:Pe,url:()=>E?E.url:null}}})();})();
