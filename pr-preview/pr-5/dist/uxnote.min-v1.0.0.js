(()=>{var ra=Object.defineProperty,ia=Object.defineProperties;var sa=Object.getOwnPropertyDescriptors;var sn=Object.getOwnPropertySymbols;var la=Object.prototype.hasOwnProperty,ca=Object.prototype.propertyIsEnumerable;var ln=(u,y,k)=>y in u?ra(u,y,{enumerable:!0,configurable:!0,writable:!0,value:k}):u[y]=k,Zt=(u,y)=>{for(var k in y||(y={}))la.call(y,k)&&ln(u,k,y[k]);if(sn)for(var k of sn(y))ca.call(y,k)&&ln(u,k,y[k]);return u},cn=(u,y)=>ia(u,sa(y));(()=>{if(window.Uxnote)return;const u=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>u?u.getAttribute(t):null,k=`${location.protocol}//${location.host}`,dn=u&&(u.dataset.mailto||u.dataset.email||u.dataset.to)||"",Tt=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||u&&(u.dataset.isToolVisibleAtFirstLaunch||u.dataset.istoolvisibleatfirstlaunch),Mt=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||u&&(u.dataset.isToolOnTopAtLaunch||u.dataset.istoolontopatlaunch),pn=u&&(u.dataset.hiddentoolbydefault||u.dataset.hidden||u.dataset.collapsed||u.dataset.startHidden||""),un=y("colorForHighlight")||y("colorForHighligh")||u&&(u.dataset.colorForHighlight||u.dataset.colorForHighligh),Gt=y("colorForTextHighligh")||y("colorForTextHighlight")||u&&(u.dataset.colorForTextHighligh||u.dataset.colorForTextHighlight),Qt=y("colorForElementHighlight")||y("colorForElementHighligh")||u&&(u.dataset.colorForElementHighlight||u.dataset.colorForElementHighligh),te="#4e9cf6",tt=mt(un||Qt||Gt||te,te),mn=mt(Gt||tt,tt),fn=mt(Qt||tt,tt),zt={text:Ut(mn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Ut(fn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Ut(tt,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let E=Mt!=null?j(Mt,!1)?"top":"bottom":u&&u.dataset.position||"bottom";const ee="wn-toolbar-pos",ct=u&&(u.dataset.dock||u.dataset.layout)||"",ne=`uxnote:site:${k}`,oe=`uxnote:annotator:${k}`,ae=`uxnote:annotators:${k}`,re=`uxnote:import-files:${k}`,ie=`uxnote:hidden:${k}`,$t=`uxnote:pending:${k}`,se=(u&&u.dataset.serverUrl||"").trim().replace(/\/+$/,""),L=se?{url:se,apiKey:u&&u.dataset.serverApiKey||""}:null,le=j(u&&u.dataset.jsonExport,!0),It=j(u&&u.dataset.jsonImport,!0),hn=j(u&&u.dataset.mailExport,!0),wn=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||u&&(u.dataset.isBackdropVisible||u.dataset.isbackdropvisible||u.dataset.backdropVisible||u.dataset.backdropvisible||u.dataset.dim||u.dataset.dimpage||u.dataset.dimmer||u.dataset.overlay||u.dataset.dimLevel||u.dataset.dimlevel||u.dataset.dimstrength),gn=.2,ce=j(wn,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:zt,customPosition:!1,dimEnabled:ce,dimOpacity:ce?gn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},de=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function dt(){return de?de.matches:window.innerWidth<=640}function pe(){const t=Kn();t&&(E=t);const e=qn(),n=Tt!=null?!j(Tt,!0):null;a.hidden=e!==null?e:n!==null?n:j(pn,!1),a.annotatorName=Ee(),a.annotatorNames=Wn(),It&&(a.importFiles=Gn()),ue(),Vn(),xn(),bn(),yn(),ht(a.hidden),L?Wt():Qn(),ft(),at(),Xt(),Be(),Lo(),L||_e(),Fn()}function ue(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function xn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}function bn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${E}`;const e=f=>{const p=document.createElement("button");return p.className="wn-annot-btn wn-annotator",p.setAttribute("data-action",f.action),f.mode&&p.setAttribute("data-mode",f.mode),p.setAttribute("data-tip",f.tip),p.innerHTML=f.icon,p},n=f=>{const p=document.createElement("div");return p.className="wn-annot-group wn-annotator",f.forEach(g=>p.appendChild(e(g))),p},o=()=>{const f=document.createElement("div");return f.className="wn-annot-spacer wn-annotator",f},r=document.createDocumentFragment(),i=document.createElement("div");if(i.className="wn-annot-logo wn-annotator",i.innerHTML=Oo(),r.appendChild(i),L){const f=document.createElement("div");f.className="wn-annot-sync-dot wn-annotator",f.setAttribute("role","status"),r.appendChild(f),a.syncDot=f,Je()}const s=[{action:"mode",mode:"text",tip:"Highlight text",icon:Ke()},{action:"mode",mode:"element",tip:"Annotate an element",icon:Po()}];nn()&&s.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:Ho()});const c=[];It&&c.push({action:"import",tip:"Import JSON",icon:Uo()}),le&&c.push({action:"export",tip:"Export JSON",icon:Bo()}),hn&&c.push({action:"mail",tip:"Send by mail",icon:Fo()});const l=[{action:"toggle-pos",tip:"Toolbar top / bottom",icon:Ko()},{action:"toggle-panel",tip:"Show / hide annotations",icon:jo()}];r.appendChild(o()),r.appendChild(n(s)),c.length&&(r.appendChild(o()),r.appendChild(n(c))),r.appendChild(o()),r.appendChild(n(l)),t.appendChild(r),document.body.appendChild(t),a.toolbar=t;const d=document.createElement("div");d.className="wn-annot-panel wn-annotator",d.innerHTML=`
  ...
  `;function Oo(){return`
    ...
    `)}function Do(){return Ke()}function qe(){return`
    ...
    `)}function Ve(){return F(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Ko(){return E==="top"?Xe():Ve()}function Ye(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function T(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function _e(){try{const t=localStorage.getItem($t);if(!t)return;const e=JSON.parse(t);e.pageKey===T(window.location.href)&&it(e.id,!1),localStorage.removeItem($t)}catch(t){}}let G=new Map,Jt=Promise.resolve(),Q=!1;const Xo={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes stay in this browser"};function Je(){const t=a.syncDot;if(!t)return;const e=a.syncStatus||"pending",n=Xo[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function Et(t){a.syncStatus!==t&&(a.syncStatus=t,Je())}async function st(t,e){let n;try{n=await fetch(t,e)}catch(o){throw Et("unreachable"),o}if(!n.ok)throw Et("refused"),new Error(`HTTP ${n.status}`);return Et("ok"),n}function We(){return`${L.url}/annotations?site=${encodeURIComponent(k)}`}function Ze(t){return`${L.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function Vo(t){return`${L.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function lt(t){const e=Object.assign({},t);return L.apiKey&&(e["X-Uxnote-Key"]=L.apiKey),e}function Ge(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function Lt(t,e){console.warn("Uxnote sync:",t,e),!Q&&(Q=!0,_(t))}function At(t){return Jt=Jt.then(t,t),Jt}async function Wt(){if(L)try{const t=await st(We(),{headers:lt({Accept:"application/json"})});let e;try{e=await t.json()}catch(n){throw Et("refused"),n}a.annotations=(e&&e.annotations||[]).filter(Ht),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=T(n.pageUrl||window.location.href))}),G=Ge(a.annotations),Q=!1,ft(),nt(),at(),J(),S(),_e()}catch(t){Lt("Uxnote: could not read the annotations from the server",t)}}function Qe(){if(!L)return;const t=Ge(a.annotations);t.forEach((e,n)=>{G.get(n)!==e&&At(()=>_o(n,e))}),G.forEach((e,n)=>{t.has(n)||At(()=>Jo(n))})}async function Yo(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),r=await on(o,t.id,{rethrow:!0});if(!r)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:r.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}async function _o(t,e){try{const n=a.annotations.find(o=>o.id===t);n&&n.screenshot&&n.screenshot.dataUrl&&(await Yo(n),e=JSON.stringify(n)),await st(Ze(t),{method:"PUT",headers:lt({"Content-Type":"application/json"}),body:e}),G.set(t,e),Q=!1}catch(n){Lt("Uxnote: could not save this annotation on the server",n)}}async function Jo(t){try{await st(Ze(t),{method:"DELETE",headers:lt()}),G.delete(t),Q=!1}catch(e){Lt("Uxnote: could not delete this annotation on the server",e)}}function Wo(){L&&At(async()=>{try{await st(We(),{method:"DELETE",headers:lt()}),G=new Map,Q=!1}catch(t){Lt("Uxnote: could not delete the annotations on the server",t)}})}let Nt=null,tn=T(window.location.href);function Zo(){Nt=null;const t=T(window.location.href);t!==tn&&(tn=t,nt(),at(),J(),S(),At(Wt))}function en(){Nt&&clearTimeout(Nt),Nt=setTimeout(Zo,120)}function Go(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const r=e.apply(this,o);return en(),r})}),window.addEventListener("popstate",en)}function nn(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Qo(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=p=>{const g=!!p&&p.w>=4&&p.h>=4;n.style.display=g?"block":"none",g&&(n.style.left=`${p.x}px`,n.style.top=`${p.y}px`,n.style.width=`${p.w}px`,n.style.height=`${p.h}px`)};s(null);const c=p=>({x:Math.min(Math.max(p.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(p.clientY,0),document.documentElement.clientHeight)}),l=(p,g)=>({x:Math.min(p.x,g.x),y:Math.min(p.y,g.y),w:Math.abs(g.x-p.x),h:Math.abs(g.y-p.y)});let d=null;const m=p=>{p.preventDefault(),d=c(p),s(null)},h=p=>{d&&(p.preventDefault(),s(l(d,c(p))))},w=p=>{if(!d)return;const g=l(d,c(p));if(d=null,g.w<4||g.h<4){s(null);return}x({x:g.x+window.scrollX,y:g.y+window.scrollY,w:g.w,h:g.h})},x=p=>{document.removeEventListener("keydown",f,!0),document.removeEventListener("mousemove",h,!0),document.removeEventListener("mouseup",w,!0),e.remove(),o.remove(),t(p)},f=p=>{p.key==="Escape"&&(p.preventDefault(),x(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>x(null)),document.addEventListener("mousemove",h,!0),document.addEventListener("mouseup",w,!0),document.addEventListener("keydown",f,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function ta(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),c=Math.max(0,Math.round((t.y-i)*o)),l=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),d=Math.min(e.height-c,Math.max(1,Math.round(t.h*o)));if(l<1||d<1)return null;const m=document.createElement("canvas");return m.width=l,m.height=d,m.getContext("2d").drawImage(e,s,c,l,d,0,0,l,d),{canvas:m,w:l,h:d}}async function ea(){if(!(!nn()||a.mode==="screenshot")){Y("screenshot");try{const t=await Qo();if(!t)return;const e=ta(t).catch(m=>(console.warn("Uxnote screenshot:",m),null)),n=await Rt("Comment for this region?");if(!n)return;const o=await e;if(!o){_("Uxnote: could not capture that region");return}const{comment:r,priority:i,author:s}=n,c=kt();let l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(L){const m=await new Promise(w=>o.canvas.toBlob(w,"image/png")),h=m?await on(m,c):null;h?l={url:h.url,w:o.w,h:o.h,capturedAt:Date.now()}:_("Uxnote: the picture stays on this device until the server answers")}const d={id:c,type:"screenshot",comment:r.trim(),author:s||a.annotatorName||"",priority:i||"medium",snippet:"",pageUrl:window.location.href,pageKey:T(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(d),O(),Z(d,null),S()}finally{Y(null)}}}async function on(t,e,n={}){try{const r=await(await st(Vo(e),{method:"PUT",headers:lt({"Content-Type":"image/png"}),body:t})).json();return r&&r.url?r:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function na(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=L?new URL(`${L.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function oa(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",r,!0),e.remove()},r=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",r,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",pe):pe(),window.Uxnote={refresh:U,setHidden:t=>ht(!!t),toggleVisibility:()=>ht(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:Wt,push:Qe,url:()=>L?L.url:null}}})();})();
