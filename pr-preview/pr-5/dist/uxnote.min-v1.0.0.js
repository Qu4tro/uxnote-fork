(()=>{var Go=Object.defineProperty,Qo=Object.defineProperties;var ta=Object.getOwnPropertyDescriptors;var on=Object.getOwnPropertySymbols;var ea=Object.prototype.hasOwnProperty,na=Object.prototype.propertyIsEnumerable;var an=(p,y,C)=>y in p?Go(p,y,{enumerable:!0,configurable:!0,writable:!0,value:C}):p[y]=C,Wt=(p,y)=>{for(var C in y||(y={}))ea.call(y,C)&&an(p,C,y[C]);if(on)for(var C of on(y))na.call(y,C)&&an(p,C,y[C]);return p},rn=(p,y)=>Qo(p,ta(y));(()=>{if(window.Uxnote)return;const p=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>p?p.getAttribute(t):null,C=`${location.protocol}//${location.host}`,sn=p&&(p.dataset.mailto||p.dataset.email||p.dataset.to)||"",St=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||p&&(p.dataset.isToolVisibleAtFirstLaunch||p.dataset.istoolvisibleatfirstlaunch),Tt=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||p&&(p.dataset.isToolOnTopAtLaunch||p.dataset.istoolontopatlaunch),ln=p&&(p.dataset.hiddentoolbydefault||p.dataset.hidden||p.dataset.collapsed||p.dataset.startHidden||""),cn=y("colorForHighlight")||y("colorForHighligh")||p&&(p.dataset.colorForHighlight||p.dataset.colorForHighligh),Zt=y("colorForTextHighligh")||y("colorForTextHighlight")||p&&(p.dataset.colorForTextHighligh||p.dataset.colorForTextHighlight),Gt=y("colorForElementHighlight")||y("colorForElementHighligh")||p&&(p.dataset.colorForElementHighlight||p.dataset.colorForElementHighligh),Qt="#4e9cf6",tt=mt(cn||Gt||Zt||Qt,Qt),dn=mt(Zt||tt,tt),pn=mt(Gt||tt,tt),Mt={text:Bt(dn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Bt(pn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Bt(tt,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=Tt!=null?_(Tt,!1)?"top":"bottom":p&&p.dataset.position||"bottom";const te="wn-toolbar-pos",lt=p&&(p.dataset.dock||p.dataset.layout)||"",ee=`uxnote:site:${C}`,ne=`uxnote:annotator:${C}`,oe=`uxnote:annotators:${C}`,ae=`uxnote:import-files:${C}`,re=`uxnote:hidden:${C}`,$t=`uxnote:pending:${C}`,ie=(p&&p.dataset.serverUrl||"").trim().replace(/\/+$/,""),L=ie?{url:ie,apiKey:p&&p.dataset.serverApiKey||""}:null,se=_(p&&p.dataset.jsonExport,!0),zt=_(p&&p.dataset.jsonImport,!0),un=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||p&&(p.dataset.isBackdropVisible||p.dataset.isbackdropvisible||p.dataset.backdropVisible||p.dataset.backdropvisible||p.dataset.dim||p.dataset.dimpage||p.dataset.dimmer||p.dataset.overlay||p.dataset.dimLevel||p.dataset.dimlevel||p.dataset.dimstrength),mn=.2,le=_(un,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:Mt,customPosition:!1,dimEnabled:le,dimOpacity:le?mn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},ce=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function ct(){return ce?ce.matches:window.innerWidth<=640}function de(){const t=Fn();t&&(k=t);const e=Un(),n=St!=null?!_(St,!0):null;a.hidden=e!==null?e:n!==null?n:_(ln,!1),a.annotatorName=Ce(),a.annotatorNames=Vn(),zt&&(a.importFiles=_n()),pe(),jn(),fn(),hn(),wn(),ht(a.hidden),L?Jt():Jn(),ft(),at(),Kt(),Oe(),vo(),L||Ye(),On()}function pe(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function fn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function Mo(){return`
    ...
    `)}function Xe(){return U(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Bo(){return k==="top"?Ke():Xe()}function Ve(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
