(()=>{var ta=Object.defineProperty,ea=Object.defineProperties;var na=Object.getOwnPropertyDescriptors;var nn=Object.getOwnPropertySymbols;var oa=Object.prototype.hasOwnProperty,aa=Object.prototype.propertyIsEnumerable;var on=(u,y,k)=>y in u?ta(u,y,{enumerable:!0,configurable:!0,writable:!0,value:k}):u[y]=k,Jt=(u,y)=>{for(var k in y||(y={}))oa.call(y,k)&&on(u,k,y[k]);if(nn)for(var k of nn(y))aa.call(y,k)&&on(u,k,y[k]);return u},an=(u,y)=>ea(u,na(y));(()=>{if(window.Uxnote)return;const u=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),y=t=>u?u.getAttribute(t):null,k=`${location.protocol}//${location.host}`,rn=u&&(u.dataset.mailto||u.dataset.email||u.dataset.to)||"",Nt=y("isToolVisibleAtFirstLaunch")||y("istoolvisibleatfirstlaunch")||u&&(u.dataset.isToolVisibleAtFirstLaunch||u.dataset.istoolvisibleatfirstlaunch),St=y("isToolOnTopAtLaunch")||y("istoolontopatlaunch")||u&&(u.dataset.isToolOnTopAtLaunch||u.dataset.istoolontopatlaunch),sn=u&&(u.dataset.hiddentoolbydefault||u.dataset.hidden||u.dataset.collapsed||u.dataset.startHidden||""),ln=y("colorForHighlight")||y("colorForHighligh")||u&&(u.dataset.colorForHighlight||u.dataset.colorForHighligh),Wt=y("colorForTextHighligh")||y("colorForTextHighlight")||u&&(u.dataset.colorForTextHighligh||u.dataset.colorForTextHighlight),Zt=y("colorForElementHighlight")||y("colorForElementHighligh")||u&&(u.dataset.colorForElementHighlight||u.dataset.colorForElementHighligh),Gt="#4e9cf6",tt=ut(ln||Zt||Wt||Gt,Gt),cn=ut(Wt||tt,tt),dn=ut(Zt||tt,tt),Tt={text:Pt(cn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Pt(dn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Pt(tt,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let E=St!=null?j(St,!1)?"top":"bottom":u&&u.dataset.position||"bottom";const Qt="wn-toolbar-pos",lt=u&&(u.dataset.dock||u.dataset.layout)||"",te=`uxnote:site:${k}`,ee=`uxnote:annotator:${k}`,ne=`uxnote:annotators:${k}`,oe=`uxnote:import-files:${k}`,ae=`uxnote:hidden:${k}`,Mt=`uxnote:pending:${k}`,re=(u&&u.dataset.serverUrl||"").trim().replace(/\/+$/,""),L=re?{url:re,apiKey:u&&u.dataset.serverApiKey||""}:null,ie=j(u&&u.dataset.jsonExport,!0),$t=j(u&&u.dataset.jsonImport,!0),pn=j(u&&u.dataset.mailExport,!0),un=y("isBackdropVisible")||y("isbackdropvisible")||y("backdropVisible")||y("backdropvisible")||u&&(u.dataset.isBackdropVisible||u.dataset.isbackdropvisible||u.dataset.backdropVisible||u.dataset.backdropvisible||u.dataset.dim||u.dataset.dimpage||u.dataset.dimmer||u.dataset.overlay||u.dataset.dimLevel||u.dataset.dimlevel||u.dataset.dimstrength),mn=.2,se=j(un,!0),a={mode:null,annotations:[],annotatorName:"",annotatorNames:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,exportModal:null,markerLayer:null,colors:Tt,customPosition:!1,dimEnabled:se,dimOpacity:se?mn:0,dimOverlay:null,filters:{priority:"all",author:"all",query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null},le=window.matchMedia?window.matchMedia("(max-width: 640px)"):null;function ct(){return le?le.matches:window.innerWidth<=640}function ce(){const t=Fn();t&&(E=t);const e=Un(),n=Nt!=null?!j(Nt,!0):null;a.hidden=e!==null?e:n!==null?n:j(sn,!1),a.annotatorName=Ce(),a.annotatorNames=Vn(),$t&&(a.importFiles=_n()),de(),jn(),fn(),hn(),gn(),ft(a.hidden),L?_t():Jn(),mt(),at(),Kt(),Oe(),vo(),L||Ve(),On()}function de(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function fn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
  ...
  `;function $o(){return`
    ...
    `)}function zo(){return F(`
      ...
      <path d="M3 12h3" />
      <path d="M18 12h3" />
    `)}function Io(){return F(`
      <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" />
      <path d="M7 11l5 5l5 -5" />
      <path d="M12 4l0 12" />
    `)}function Ro(){return F(`
      <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" />
      <path d="M7 9l5 -5l5 5" />
      <path d="M12 4l0 12" />
    `)}function Oo(){return F(`
    ...
    `)}function Bo(){return De()}function je(){return`
    ...
    `)}function qe(){return F(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Fo(){return E==="top"?Ke():qe()}function Xe(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function T(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function Ve(){try{const t=localStorage.getItem(Mt);if(!t)return;const e=JSON.parse(t);e.pageKey===T(window.location.href)&&it(e.id,!1),localStorage.removeItem(Mt)}catch(t){}}let G=new Map,Yt=Promise.resolve(),Q=!1;function Ye(){return`${L.url}/annotations?site=${encodeURIComponent(k)}`}function _e(t){return`${L.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function Do(t){return`${L.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(k)}`}function st(t){const e=Object.assign({},t);return L.apiKey&&(e["X-Uxnote-Key"]=L.apiKey),e}function Je(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function kt(t,e){console.warn("Uxnote sync:",t,e),!Q&&(Q=!0,_(t))}function Et(t){return Yt=Yt.then(t,t),Yt}async function _t(){if(L)try{const t=await fetch(Ye(),{headers:st({Accept:"application/json"})});if(!t.ok)throw new Error(`HTTP ${t.status}`);const e=await t.json();a.annotations=(e&&e.annotations||[]).filter(Ht),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=T(n.pageUrl||window.location.href))}),G=Je(a.annotations),Q=!1,mt(),nt(),at(),J(),S(),Ve()}catch(t){kt("Uxnote: could not read the annotations from the server",t)}}function We(){if(!L)return;const t=Je(a.annotations);t.forEach((e,n)=>{G.get(n)!==e&&Et(()=>jo(n,e))}),G.forEach((e,n)=>{t.has(n)||Et(()=>Ko(n))})}async function jo(t,e){try{const n=await fetch(_e(t),{method:"PUT",headers:st({"Content-Type":"application/json"}),body:e});if(!n.ok)throw new Error(`HTTP ${n.status}`);G.set(t,e),Q=!1}catch(n){kt("Uxnote: could not save this annotation on the server",n)}}async function Ko(t){try{const e=await fetch(_e(t),{method:"DELETE",headers:st()});if(!e.ok)throw new Error(`HTTP ${e.status}`);G.delete(t),Q=!1}catch(e){kt("Uxnote: could not delete this annotation on the server",e)}}function qo(){L&&Et(async()=>{try{const t=await fetch(Ye(),{method:"DELETE",headers:st()});if(!t.ok)throw new Error(`HTTP ${t.status}`);G=new Map,Q=!1}catch(t){kt("Uxnote: could not delete the annotations on the server",t)}})}let Lt=null,Ze=T(window.location.href);function Xo(){Lt=null;const t=T(window.location.href);t!==Ze&&(Ze=t,nt(),at(),J(),S(),Et(_t))}function Ge(){Lt&&clearTimeout(Lt),Lt=setTimeout(Xo,120)}function Vo(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const r=e.apply(this,o);return Ge(),r})}),window.addEventListener("popstate",Ge)}function Qe(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Yo(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=p=>{const w=!!p&&p.w>=4&&p.h>=4;n.style.display=w?"block":"none",w&&(n.style.left=`${p.x}px`,n.style.top=`${p.y}px`,n.style.width=`${p.w}px`,n.style.height=`${p.h}px`)};s(null);const c=p=>({x:Math.min(Math.max(p.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(p.clientY,0),document.documentElement.clientHeight)}),l=(p,w)=>({x:Math.min(p.x,w.x),y:Math.min(p.y,w.y),w:Math.abs(w.x-p.x),h:Math.abs(w.y-p.y)});let d=null;const m=p=>{p.preventDefault(),d=c(p),s(null)},f=p=>{d&&(p.preventDefault(),s(l(d,c(p))))},g=p=>{if(!d)return;const w=l(d,c(p));if(d=null,w.w<4||w.h<4){s(null);return}x({x:w.x+window.scrollX,y:w.y+window.scrollY,w:w.w,h:w.h})},x=p=>{document.removeEventListener("keydown",h,!0),document.removeEventListener("mousemove",f,!0),document.removeEventListener("mouseup",g,!0),e.remove(),o.remove(),t(p)},h=p=>{p.key==="Escape"&&(p.preventDefault(),x(null))};e.addEventListener("mousedown",m),i.addEventListener("click",()=>x(null)),document.addEventListener("mousemove",f,!0),document.addEventListener("mouseup",g,!0),document.addEventListener("keydown",h,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function _o(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),c=Math.max(0,Math.round((t.y-i)*o)),l=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),d=Math.min(e.height-c,Math.max(1,Math.round(t.h*o)));if(l<1||d<1)return null;const m=document.createElement("canvas");return m.width=l,m.height=d,m.getContext("2d").drawImage(e,s,c,l,d,0,0,l,d),{canvas:m,w:l,h:d}}async function Jo(){if(!(!Qe()||a.mode==="screenshot")){Y("screenshot");try{const t=await Yo();if(!t)return;const e=_o(t).catch(m=>(console.warn("Uxnote screenshot:",m),null)),n=await zt("Comment for this region?");if(!n)return;const o=await e;if(!o){_("Uxnote: could not capture that region");return}const{comment:r,priority:i,author:s}=n,c=Ct();let l=null;if(L){const m=await new Promise(g=>o.canvas.toBlob(g,"image/png")),f=m?await Wo(m,c):null;if(!f){_("Uxnote: could not send the screenshot to the server");return}l={url:f.url,w:o.w,h:o.h,capturedAt:Date.now()}}else l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};const d={id:c,type:"screenshot",comment:r.trim(),author:s||a.annotatorName||"",priority:i||"medium",snippet:"",pageUrl:window.location.href,pageKey:T(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(d),O(),Z(d,null),S()}finally{Y(null)}}}async function Wo(t,e){try{const n=await fetch(Do(e),{method:"PUT",headers:st({"Content-Type":"image/png"}),body:t});if(!n.ok)throw new Error(`HTTP ${n.status}`);const o=await n.json();return o&&o.url?o:null}catch(n){return console.warn("Uxnote screenshot:",n),null}}function Zo(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=L?new URL(`${L.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Go(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=()=>{document.removeEventListener("keydown",r,!0),e.remove()},r=i=>{i.key==="Escape"&&(i.preventDefault(),o())};e.addEventListener("click",o),document.addEventListener("keydown",r,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ce):ce(),window.Uxnote={refresh:H,setHidden:t=>ft(!!t),toggleVisibility:()=>ft(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:_t,push:We,url:()=>L?L.url:null}}})();})();
