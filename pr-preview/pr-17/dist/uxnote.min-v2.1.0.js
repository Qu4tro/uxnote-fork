(()=>{var Ga=Object.defineProperty,tr=Object.defineProperties;var er=Object.getOwnPropertyDescriptors;var Hn=Object.getOwnPropertySymbols;var nr=Object.prototype.hasOwnProperty,or=Object.prototype.propertyIsEnumerable;var On=(d,w,C)=>w in d?Ga(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,xe=(d,w)=>{for(var C in w||(w={}))nr.call(w,C)&&On(d,C,w[C]);if(Hn)for(var C of Hn(w))or.call(w,C)&&On(d,C,w[C]);return d},Rn=(d,w)=>tr(d,er(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,zn=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Pt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Ht=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Bn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Un=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),Fn=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),Dn=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),jn=w("colorForRegionHighlight")||d&&d.dataset.colorForRegionHighlight,Vn="#4e9cf6",Kn="#8b5cf6",Xn="#f59f00",Ot=bt(Un),be=Ot||Vn,ye=Ot||Kn,Yn=xt(Fn||be,be),qn=xt(Dn||ye,ye),ve=Ot||Xn,Wn=xt(jn||ve,ve),Rt={text:Jt(Yn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Jt(qn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Jt(Wn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=Ht!=null?V(Ht,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const ke="wn-toolbar-pos",mt=d&&(d.dataset.dock||d.dataset.layout)||"",zt=`uxnote:site:${C}`,Ce=`${zt}:synced`,Ee=`uxnote:import-files:${C}`,Te=`uxnote:hidden:${C}`,Bt=`uxnote:pending:${C}`,Le=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),b=Le?{url:Le,apiKey:d&&d.dataset.serverApiKey||""}:null,Ut=V(d&&d.dataset.jsonExport,!0),Ft=V(d&&d.dataset.jsonImport,!0),Se=zn.trim(),_n=/^[^\s@,;]+@[^\s@,;]+\.[^\s@,;]+$/.test(Se),ft=(d&&d.dataset.theme||"").trim().toLowerCase(),_=ft==="light"||ft==="dark"||ft==="reverse-auto"?ft:"auto",Jn=_==="auto"||_==="reverse-auto",Dt=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,jt=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,Vt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function D(){return jt?jt.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return Vt?Vt.matches:window.innerWidth<=640||window.innerHeight<=480}function Kt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const Zn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Gn=.2,Ae=V(Zn,!D()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Rt,customPosition:!1,dimEnabled:Ae,dimOpacity:Ae?Gn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function Qe(){const t=Eo();t&&(k=t);const e=To(),n=Pt!=null?!V(Pt,!0):null;a.hidden=e!==null?e:n!==null?n:V(Bn,!1),Ft&&(a.importFiles=Mo()),Me(),So(),Ue(),to(),ao(),ro(),vt(a.hidden),No(),b&&!Ra()&&(a.annotations=[]),lt(),pe(),an(),ha(),b||fe(),b&&(R(Mt),Ba()),yo()}function Me(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function to(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}const eo=["commentModal","dialogModal"];function Xt(t,e){const n=document.createElement("div");n.className="wn-annot-sheet-grip wn-annotator";const o=document.createElement("span");o.className="wn-annot-sheet-handle wn-annotator",o.setAttribute("aria-hidden","true");const r=document.createElement("button");return r.type="button",r.className="wn-annot-sheet-close wn-annotator",r.setAttribute("aria-label",t),r.innerHTML=fn(),r.addEventListener("click",i=>{i.stopPropagation(),e()}),n.appendChild(o),n.appendChild(r),no(n,e),n}function no(t,e){let n=null,o=0,r=0,i=0;const s=c=>{n&&(i=Math.max(0,c.clientY-o),n.style.transform=`translateY(${i}px)`)},l=()=>{if(!n)return;t.removeEventListener("pointermove",s),t.removeEventListener("pointerup",l),t.removeEventListener("pointercancel",l);const c=n.getBoundingClientRect().height||1,p=i/Math.max(1,Date.now()-r);n.style.transform="",n.style.transition="",n=null,(i>c/3||i>40&&p>.5)&&e()};t.addEventListener("pointerdown",c=>{c.target.closest(".wn-annot-sheet-close")||(n=t.closest(".wn-annot-sheet"),n&&(o=c.clientY,r=Date.now(),i=0,n.style.transition="none",t.setPointerCapture&&t.setPointerCapture(c.pointerId),t.addEventListener("pointermove",s),t.addEventListener("pointerup",l),t.addEventListener("pointercancel",l)))})}function oo(){return a.hidden||!I()?!1:a.panel&&a.panel.style.display!=="none"?!0:eo.some(t=>{const e=a[t];return e&&e.backdrop.classList.contains("show")})}function z(){const t=oo();if(t===!!a.scrollLocked)return;const e=document.documentElement;a.scrollLocked=t,t?(a.scrollLockPrev=e.style.overflow,e.style.overflow="hidden"):(e.style.overflow=a.scrollLockPrev||"",a.scrollLockPrev="")}function j(){const t=document.documentElement,e=(i,s)=>{t.style.setProperty("--wn-sheet-bottom",`${i}px`),t.style.setProperty("--wn-sheet-top-guard",`${s}px`)};if(!a.toolbar||!I()||a.hidden){e(0,0);return}const n=a.toolbar.getBoundingClientRect(),o=8,r=t.clientHeight;if(k==="top"){e(0,Math.max(0,Math.round(n.bottom+o)));return}e(Math.max(0,Math.round(r-n.top+o)),0)}function wt(t){a.panel&&(a.panel.style.display=t?"":"none",Gt(),z())}function Ne(){const t=a.toolbar;if(!t)return;const e=I(),n=h=>{const m=document.createElement("button");return m.className="wn-annot-btn wn-annotator",m.setAttribute("data-action",h.action),h.mode&&m.setAttribute("data-mode",h.mode),m.setAttribute("data-tip",h.tip),m.innerHTML=h.icon,m},o=h=>{const m=document.createElement("div");return m.className="wn-annot-group wn-annotator",h.forEach(y=>m.appendChild(n(y))),m},r=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},i=a.visibilityToggle;i&&i.parentNode===t&&t.removeChild(i),t.innerHTML="";const s=document.createDocumentFragment(),l=document.createElement("div");if(l.className="wn-annot-logo wn-annotator",l.innerHTML=Ca(),s.appendChild(l),b){const h=document.createElement("div");h.className="wn-annot-sync-dot wn-annotator",h.setAttribute("role","status"),s.appendChild(h),a.syncDot=h,kn()}const c=[{action:"mode",mode:"text",tip:"Highlight text",icon:un()},{action:"mode",mode:"element",tip:"Annotate an element",icon:Ea()}];In()&&c.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:Sa()});const p=[];Ft&&!e&&p.push({action:"import",tip:"Import JSON",icon:Ta()}),Ut&&!e&&p.push({action:"export",tip:"Export JSON",icon:hn()}),_n&&!e&&p.push({action:"mail",tip:"Send by mail",icon:La()});const u=[];e||u.push({action:"toggle-pos",tip:"Toolbar top / bottom",icon:Ma()}),u.push({action:"toggle-panel",tip:"Show / hide annotations",icon:Qa()}),s.appendChild(r()),s.appendChild(o(c)),p.length&&(s.appendChild(r()),s.appendChild(o(p))),s.appendChild(r()),s.appendChild(o(u)),t.appendChild(s),te(),Wt(),Gt(),Yt()}function $e(){Ne(),G(),tt(),O(),J(),et(),j(),We(),z(),M()}function ao(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${k}`,document.body.appendChild(t),a.toolbar=t,Ne();const e=document.createElement("div");e.className="wn-annot-panel wn-annot-sheet wn-annotator",e.innerHTML=`
  ...
  `;function Ca(){return`
    ...
    `)}function Aa(){return un()}function mn(){return`
    ...
    `)}function gn(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function Ma(){return k==="top"?wn():gn()}function xn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function L(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function fe(){try{const t=localStorage.getItem(Bt);if(!t)return;const e=JSON.parse(t);e.pageKey===L(window.location.href)&&dt(e.id,!1),localStorage.removeItem(Bt)}catch(t){}}let A=new Map,we=Promise.resolve(),Y=!1,bn=!1;const yn=3e5,vn=1e4,$a=yn;let Tt=null,Lt=vn,St="/health";const Ia={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes are held here until it answers"};function kn(){const t=a.syncDot;if(!t)return;const e=a.syncStatus||"pending",n=Ia[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function pt(t){a.syncStatus!==t&&(a.syncStatus=t,kn())}async function q(t,e){let n;try{n=await fetch(t,e)}catch(o){throw pt("unreachable"),o}if(!n.ok){pt("refused");const o=new Error(`HTTP ${n.status}`);throw o.status=n.status,o}return pt("ok"),n}function ge(){return`${b.url}/annotations?site=${encodeURIComponent(C)}`}function Cn(t){return`${b.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function Pa(){return St?`${b.url}${St}`:ge()}function Ha(t){return`${b.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function W(t){const e=Object.assign({},t);return b.apiKey&&(e["X-Uxnote-Key"]=b.apiKey),e}function Oa(t){return new Map(t.map(e=>[e.id,ut(e)]))}function ut(t){const e=typeof t=="string"?t:JSON.stringify(t);let n=2166136261;for(let o=0;o<e.length;o+=1)n^=e.charCodeAt(o),n=Math.imul(n,16777619)>>>0;return`${e.length}:${n.toString(36)}`}function At(){try{localStorage.setItem(Ce,JSON.stringify(Array.from(A)))}catch(t){console.warn("Annotator storage save error",t),En()}}function Ra(){let t=null;try{t=localStorage.getItem(Ce);const e=t?JSON.parse(t):[];A=new Map(Array.isArray(e)?e:[])}catch(e){console.warn("Uxnote sync: the stored server snapshot is unreadable",e),A=new Map}return t!==null}function Qt(t,e){console.warn("Uxnote sync:",t,e),!Y&&(Y=!0,P(t))}function En(){bn||(bn=!0,P("Uxnote: this browser has no room left, so notes are not kept for a reload"))}function R(t){return we=we.then(t,t),we}async function Mt(){if(!b)return;let t;try{const n=await q(ge(),{headers:W({Accept:"application/json"})});try{t=await n.json()}catch(o){throw pt("refused"),o}}catch(n){Qt("Uxnote: could not read the annotations from the server",n),fe();return}const e=(t&&t.annotations||[]).filter(Zt);e.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))}),za(e),Y=!1,yt(),at(),lt(),K(),T(),Nt(),fe()}function za(t){const e=new Map(t.map(r=>[r.id,r])),n=[],o=new Set;a.annotations.forEach(r=>{const i=A.get(r.id);if(i===void 0||i!==ut(r)){n.push(r),o.add(r.id);return}const s=e.get(r.id);s&&(n.push(s),o.add(r.id))}),t.forEach(r=>{o.has(r.id)||n.push(r)}),a.annotations=n,A=Oa(t)}async function Tn(){try{const t=await q(Pa(),{headers:W({Accept:"application/json"})});try{await t.json()}catch(e){return pt("refused"),!1}return!0}catch(t){return St&&t.status===404?(St="",Tn()):!1}}async function Ln(t){Tt=null;const e=a.syncStatus==="ok";if(!await Tn()){Sn(Lt),Lt=Math.min(Lt*2,$a);return}Lt=vn,Sn(yn),!t&&!e&&R(Mt)}function Sn(t){Tt&&clearTimeout(Tt),Tt=setTimeout(()=>R(()=>Ln(!1)),t)}function Ba(){b&&R(()=>Ln(!0))}function Nt(){if(!b)return;const t=new Map(a.annotations.map(e=>[e.id,JSON.stringify(e)]));t.forEach((e,n)=>{A.get(n)!==ut(e)&&R(()=>Qn(n,e))}),A.forEach((e,n)=>{t.has(n)||R(()=>Mn(n))})}async function Ua(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),r=await Pn(o,t.id,{rethrow:!0});if(!r)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:r.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}function Fa(){b&&(window.addEventListener("online",()=>Nt()),document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&An()}),window.addEventListener("pagehide",An))}function An(){if(!b)return;const t=new Map(a.annotations.map(e=>[e.id,JSON.stringify(e)]));t.forEach((e,n)=>{A.get(n)!==ut(e)&&Qn(n,e,{keepalive:!0})}),A.forEach((e,n)=>{t.has(n)||Mn(n,{keepalive:!0})})}async function Qn(t,e,n={}){try{const o=a.annotations.find(i=>i.id===t),r=o&&o.screenshot&&o.screenshot.dataUrl;r&&(await Ua(o),e=JSON.stringify(o)),await q(Cn(t),{method:"PUT",headers:W({"Content-Type":"application/json"}),keepalive:!!n.keepalive,body:e}),A.set(t,ut(e)),Y=!1,r?yt():At()}catch(o){Qt("Uxnote: could not save this annotation on the server",o)}}async function Mn(t,e={}){try{await q(Cn(t),{method:"DELETE",headers:W(),keepalive:!!e.keepalive}),A.delete(t),Y=!1,At()}catch(n){Qt("Uxnote: could not delete this annotation on the server",n)}}function Da(){b&&R(async()=>{try{await q(ge(),{method:"DELETE",headers:W()}),A=new Map,Y=!1,At()}catch(t){Qt("Uxnote: could not delete the annotations on the server",t)}})}let $t=null,Nn=L(window.location.href);function ja(){$t=null;const t=L(window.location.href);t!==Nn&&(Nn=t,at(),lt(),K(),T(),R(Mt))}function $n(){$t&&clearTimeout($t),$t=setTimeout(ja,120)}function Va(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const r=e.apply(this,o);return $n(),r})}),window.addEventListener("popstate",$n)}function In(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Ka(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=f=>{const x=!!f&&f.w>=4&&f.h>=4;n.style.display=x?"block":"none",x&&(n.style.left=`${f.x}px`,n.style.top=`${f.y}px`,n.style.width=`${f.w}px`,n.style.height=`${f.h}px`)};s(null);const l=f=>({x:Math.min(Math.max(f.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(f.clientY,0),document.documentElement.clientHeight)}),c=(f,x)=>({x:Math.min(f.x,x.x),y:Math.min(f.y,x.y),w:Math.abs(x.x-f.x),h:Math.abs(x.y-f.y)});let p=null;const u=f=>{f.preventDefault(),p=l(f),s(null)},h=f=>{p&&(f.preventDefault(),s(c(p,l(f))))},m=f=>{if(!p)return;const x=c(p,l(f));if(p=null,x.w<4||x.h<4){s(null);return}y({x:x.x+window.scrollX,y:x.y+window.scrollY,w:x.w,h:x.h})},y=f=>{document.removeEventListener("keydown",S,!0),document.removeEventListener("mousemove",h,!0),document.removeEventListener("mouseup",m,!0),e.remove(),o.remove(),t(f)},S=f=>{f.key==="Escape"&&(f.preventDefault(),y(null))};e.addEventListener("mousedown",u),i.addEventListener("click",()=>y(null)),document.addEventListener("mousemove",h,!0),document.addEventListener("mouseup",m,!0),document.addEventListener("keydown",S,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function Xa(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const u=document.createElement("canvas");return u.width=c,u.height=p,u.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:u,w:c,h:p}}function Ya(){const t=document.documentElement;return{x:window.scrollX,y:window.scrollY,w:t.clientWidth,h:t.clientHeight}}const qa=2e4;function Wa(t){const e=Xa(t).then(o=>({shot:o}),o=>(console.warn("Uxnote screenshot:",o),{shot:null})),n=new Promise(o=>{setTimeout(()=>o({shot:null,timedOut:!0}),qa)});return Promise.race([e,n])}async function _a(){if(!(!In()||a.mode==="screenshot")){B("screenshot");try{const t=D()?Ya():await Ka();if(!t)return;const e=Wa(t),n=await qt("Comment for this region?");if(!n)return;const{shot:o,timedOut:r}=await e;if(!o){P(r?"Uxnote: the page took too long to capture":"Uxnote: could not capture that region");return}const{comment:i}=n,s=Et();let l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(b){const p=await new Promise(h=>o.canvas.toBlob(h,"image/png")),u=p?await Pn(p,s):null;u?l={url:u.url,w:o.w,h:o.h,capturedAt:Date.now()}:P("Uxnote: the picture stays on this device until the server answers")}const c={id:s,type:"screenshot",comment:i.trim(),snippet:"",pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(c),H(),X(c,null),T()}finally{B(null)}}}async function Pn(t,e,n={}){try{const r=await(await q(Ha(e),{method:"PUT",headers:W({"Content-Type":"image/png"}),body:t})).json();return r&&r.url?r:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function Ja(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=b?new URL(`${b.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Za(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=document.createElement("button");o.type="button",o.className="wn-shot-lightbox-close wn-annotator",o.setAttribute("aria-label","Close the screenshot"),o.innerHTML=fn(),e.appendChild(o);const r=()=>{document.removeEventListener("keydown",i,!0),e.remove()},i=s=>{s.key==="Escape"&&(s.preventDefault(),r())};o.addEventListener("click",r),e.addEventListener("click",r),document.addEventListener("keydown",i,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qe):Qe(),window.Uxnote={refresh:M,setHidden:t=>vt(!!t),toggleVisibility:()=>vt(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:Mt,push:Nt,url:()=>b?b.url:null}}})();})();
