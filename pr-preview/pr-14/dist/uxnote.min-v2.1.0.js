(()=>{var Ta=Object.defineProperty,La=Object.defineProperties;var Qa=Object.getOwnPropertyDescriptors;var vn=Object.getOwnPropertySymbols;var Sa=Object.prototype.hasOwnProperty,Aa=Object.prototype.propertyIsEnumerable;var kn=(d,w,C)=>w in d?Ta(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,de=(d,w)=>{for(var C in w||(w={}))Sa.call(w,C)&&kn(d,C,w[C]);if(vn)for(var C of vn(w))Aa.call(w,C)&&kn(d,C,w[C]);return d},Cn=(d,w)=>La(d,Qa(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,En=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Lt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Qt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Tn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Ln=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),pe=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),ue=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),he="#4e9cf6",X=wt(Ln||ue||pe||he,he),Qn=wt(pe||X,X),Sn=wt(ue||X,X),St={text:Ft(Qn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Ft(Sn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Ft(X,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let v=Qt!=null?B(Qt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const me="wn-toolbar-pos",ut=d&&(d.dataset.dock||d.dataset.layout)||"",fe=`uxnote:site:${C}`,we=`uxnote:import-files:${C}`,ge=`uxnote:hidden:${C}`,At=`uxnote:pending:${C}`,xe=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),k=xe?{url:xe,apiKey:d&&d.dataset.serverApiKey||""}:null,Mt=B(d&&d.dataset.jsonExport,!0),Nt=B(d&&d.dataset.jsonImport,!0),An=B(d&&d.dataset.mailExport,!0),ht=(d&&d.dataset.theme||"").trim().toLowerCase(),q=ht==="light"||ht==="dark"||ht==="reverse-auto"?ht:"auto",Mn=q==="auto"||q==="reverse-auto",$t=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,It=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,Pt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function F(){return It?It.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return Pt?Pt.matches:window.innerWidth<=640||window.innerHeight<=480}function zt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const Nn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),$n=.2,be=B(Nn,!F()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:St,customPosition:!1,dimEnabled:be,dimOpacity:be?$n:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function ye(){const t=eo();t&&(v=t);const e=no(),n=Lt!=null?!B(Lt,!0):null;a.hidden=e!==null?e:n!==null?n:B(Tn,!1),Nt&&(a.importFiles=so()),ve(),ao(),Ne(),In(),On(),Hn(),gt(a.hidden),k?le():lo(),it(),ne(),We(),Ko(),k||dn(),Zn()}function ve(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function In(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}const Pn=["commentModal","dialogModal"];function Rt(t,e){const n=document.createElement("div");n.className="wn-annot-sheet-grip wn-annotator";const o=document.createElement("span");o.className="wn-annot-sheet-handle wn-annotator",o.setAttribute("aria-hidden","true");const r=document.createElement("button");return r.type="button",r.className="wn-annot-sheet-close wn-annotator",r.setAttribute("aria-label",t),r.innerHTML=rn(),r.addEventListener("click",i=>{i.stopPropagation(),e()}),n.appendChild(o),n.appendChild(r),zn(n,e),n}function zn(t,e){let n=null,o=0,r=0,i=0;const s=c=>{n&&(i=Math.max(0,c.clientY-o),n.style.transform=`translateY(${i}px)`)},l=()=>{if(!n)return;t.removeEventListener("pointermove",s),t.removeEventListener("pointerup",l),t.removeEventListener("pointercancel",l);const c=n.getBoundingClientRect().height||1,p=i/Math.max(1,Date.now()-r);n.style.transform="",n.style.transition="",n=null,(i>c/3||i>40&&p>.5)&&e()};t.addEventListener("pointerdown",c=>{c.target.closest(".wn-annot-sheet-close")||(n=t.closest(".wn-annot-sheet"),n&&(o=c.clientY,r=Date.now(),i=0,n.style.transition="none",t.setPointerCapture&&t.setPointerCapture(c.pointerId),t.addEventListener("pointermove",s),t.addEventListener("pointerup",l),t.addEventListener("pointercancel",l)))})}function Rn(){return a.hidden||!I()?!1:a.panel&&a.panel.style.display!=="none"?!0:Pn.some(t=>{const e=a[t];return e&&e.backdrop.classList.contains("show")})}function O(){const t=Rn();if(t===!!a.scrollLocked)return;const e=document.documentElement;a.scrollLocked=t,t?(a.scrollLockPrev=e.style.overflow,e.style.overflow="hidden"):(e.style.overflow=a.scrollLockPrev||"",a.scrollLockPrev="")}function D(){const t=document.documentElement,e=(i,s)=>{t.style.setProperty("--wn-sheet-bottom",`${i}px`),t.style.setProperty("--wn-sheet-top-guard",`${s}px`)};if(!a.toolbar||!I()||a.hidden){e(0,0);return}const n=a.toolbar.getBoundingClientRect(),o=8,r=t.clientHeight;if(v==="top"){e(0,Math.max(0,Math.round(n.bottom+o)));return}e(Math.max(0,Math.round(r-n.top+o)),0)}function mt(t){a.panel&&(a.panel.style.display=t?"":"none",Vt(),O())}function ke(){const t=a.toolbar;if(!t)return;const e=I(),n=h=>{const m=document.createElement("button");return m.className="wn-annot-btn wn-annotator",m.setAttribute("data-action",h.action),h.mode&&m.setAttribute("data-mode",h.mode),m.setAttribute("data-tip",h.tip),m.innerHTML=h.icon,m},o=h=>{const m=document.createElement("div");return m.className="wn-annot-group wn-annotator",h.forEach(b=>m.appendChild(n(b))),m},r=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},i=a.visibilityToggle;i&&i.parentNode===t&&t.removeChild(i),t.innerHTML="";const s=document.createDocumentFragment(),l=document.createElement("div");if(l.className="wn-annot-logo wn-annotator",l.innerHTML=ea(),s.appendChild(l),k){const h=document.createElement("div");h.className="wn-annot-sync-dot wn-annotator",h.setAttribute("role","status"),s.appendChild(h),a.syncDot=h,pn()}const c=[{action:"mode",mode:"text",tip:"Highlight text",icon:nn()},{action:"mode",mode:"element",tip:"Annotate an element",icon:na()}];bn()&&c.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:ra()});const p=[];Nt&&!e&&p.push({action:"import",tip:"Import JSON",icon:oa()}),Mt&&!e&&p.push({action:"export",tip:"Export JSON",icon:on()}),An&&!e&&p.push({action:"mail",tip:"Send by mail",icon:aa()});const u=[];e||u.push({action:"toggle-pos",tip:"Toolbar top / bottom",icon:la()}),u.push({action:"toggle-panel",tip:"Show / hide annotations",icon:sa()}),s.appendChild(r()),s.appendChild(o(c)),p.length&&(s.appendChild(r()),s.appendChild(o(p))),s.appendChild(r()),s.appendChild(o(u)),t.appendChild(s),Kt(),Bt(),Vt(),Ot()}function Ce(){ke(),J(),Z(),z(),W(),G(),D(),Ue(),O(),M()}function On(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${v}`,document.body.appendChild(t),a.toolbar=t,ke();const e=document.createElement("div");e.className="wn-annot-panel wn-annot-sheet wn-annotator",e.innerHTML=`
      <div class="wn-annot-panel-head wn-annotator">
        <div class="wn-annot-panel-top wn-annotator">
          ...
          <div class="wn-annot-panel-tools wn-annotator">
            ${Mt?`<button class="wn-annot-panel-export wn-annotator" type="button">${on()}<span>Export</span></button>`:""}
    ...
    `,v==="left"&&(e.style.left="18px",e.style.right="auto"),document.body.appendChild(e),a.panel=e,e.style.display="none";const n=e.querySelector(".wn-annot-delete-all");n&&n.addEventListener("click",async c=>{c.stopPropagation(),await Jo()});const o=e.querySelector(".wn-annot-panel-head");o&&o.insertBefore(Rt("Close the annotations",()=>mt(!1)),o.firstChild);const r=e.querySelector(".wn-annot-panel-export");r&&r.addEventListener("click",c=>{c.stopPropagation(),Le()});const i=document.createElement("div");i.className="wn-annot-marker-layer wn-annotator",document.body.appendChild(i),a.markerLayer=i;const s=document.createElement("div");s.className="wn-annot-outline wn-annotator",s.style.display="none",document.body.appendChild(s),a.outlineBox=s;const l=document.createElement("div");l.className="wn-annot-tip wn-annotator",l.textContent="Active mode",document.body.appendChild(l),a.tip=l,t.addEventListener("click",co),T(),G(),D(),Z(),z(),Vt(),Gn(),Bn()}function Ee(){a.dimOverlay&&a.dimOverlay.classList.toggle("is-visible",!a.hidden)}function Hn(){if(!a.dimEnabled||a.dimOverlay)return;const t=document.createElement("div");t.className="wn-annot-dimmer",t.setAttribute("aria-hidden","true"),t.style.setProperty("--wn-dim-opacity",String(a.dimOpacity));const e=document.body.firstChild;e?document.body.insertBefore(t,e):document.body.appendChild(t),a.dimOverlay=t,Ee()}function Ot(){if(!a.visibilityToggle)return;const t=a.visibilityToggle,n=I()&&a.toolbar&&!a.hidden?a.toolbar:document.body;t.parentNode!==n&&(t.parentNode&&t.parentNode.removeChild(t),n===a.toolbar?a.toolbar.insertBefore(t,a.toolbar.firstChild):document.body.appendChild(t))}function Bn(){if(a.visibilityToggle)return;const t=document.createElement("button");t.type="button",t.className="wn-annot-visibility-btn wn-annotator",t.setAttribute("aria-label","Hide Uxnote"),t.setAttribute("data-tip","Hide Uxnote"),t.innerHTML=cn(),t.addEventListener("click",uo),a.visibilityToggle=t,Ot(),J(),ze()}function Un(){if(a.commentModal)return a.commentModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-comment-card wn-annot-sheet wn-annotator";const n=document.createElement("h4");n.textContent="Add a comment";const o=document.createElement("textarea");o.className="wn-annotator",o.placeholder="Your comment...";const r=document.createElement("div");r.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator",i.textContent="Cancel";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",s.textContent="Save",r.appendChild(i),r.appendChild(s),e.appendChild(Rt("Discard this comment",()=>i.click())),e.appendChild(n),e.appendChild(o),e.appendChild(r),t.appendChild(e),document.body.appendChild(t),a.commentModal={backdrop:t,modal:e,textarea:o,title:n,okBtn:s,cancelBtn:i},a.commentModal}function W(){const t=a.commentModal;if(!t||!a.toolbar||!t.backdrop.classList.contains("show"))return;const e=t.modal;if(I()){e.style.left="",e.style.top="",e.style.bottom="";return}const n=a.toolbar.getBoundingClientRect(),o=.75*(parseFloat(getComputedStyle(e).fontSize)||16);e.style.left=`${n.left+n.width/2}px`,v==="top"?(e.style.top=`${n.bottom+o}px`,e.style.bottom=""):(e.style.top="",e.style.bottom=`${window.innerHeight-n.top+o}px`)}function Te(t,e=""){return new Promise(n=>{const o=Un(),{backdrop:r,textarea:i,title:s,okBtn:l,cancelBtn:c}=o;s.textContent=t||"Add a comment",i.value=e||"",i.placeholder="Your comment...",r.classList.add("show"),W(),O(),i.focus(),i.select();const p=b=>{r.classList.remove("show"),O(),l.removeEventListener("click",u),c.removeEventListener("click",h),document.removeEventListener("keydown",m),window.removeEventListener("resize",W),n(b)},u=()=>{p({comment:i.value.trim()})},h=()=>p(null),m=b=>{b.key==="Escape"&&p(null),b.key==="Enter"&&!(b.shiftKey||b.altKey)&&(b.preventDefault(),u())};l.textContent="Save",c.textContent="Cancel",l.addEventListener("click",u),c.addEventListener("click",h),document.addEventListener("keydown",m),window.addEventListener("resize",W)})}async function Ht(t){const e=await Te(t);return e||null}function Le(){if(Mt){if(I()){Zo();return}tn()}}function Fn(){if(a.importModal)return a.importModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-import-modal";const n=document.createElement("h4");n.textContent="Import JSON files";const o=document.createElement("div");o.className="wn-annot-import-body wn-annotator";const r=document.createElement("label");r.className="wn-annot-import-drop wn-annotator";const i=document.createElement("input");i.type="file",i.accept="application/json",i.multiple=!0,i.className="wn-annotator";const s=document.createElement("div"),l=document.createElement("div");l.className="wn-annot-import-drop-title wn-annotator",l.textContent="Drop JSON files here";const c=document.createElement("div");c.className="wn-annot-import-drop-sub wn-annotator",c.textContent="or click to select files",s.appendChild(l),s.appendChild(c),r.appendChild(i),r.appendChild(s);const p=document.createElement("div");p.className="wn-annot-import-panel wn-annotator";const u=document.createElement("div");u.className="wn-annot-import-title-row wn-annotator";const h=document.createElement("h5");h.textContent="Loaded files";const m=document.createElement("span");m.className="wn-annot-import-count wn-annotator",m.textContent="0";const b=document.createElement("p");b.textContent="Files are saved automatically.";const Q=document.createElement("div");Q.className="wn-annot-import-list wn-annotator",u.appendChild(h),u.appendChild(m),p.appendChild(u),p.appendChild(b),p.appendChild(Q);const f=document.createElement("div");f.className="wn-annot-actions wn-annotator";const x=document.createElement("button");x.type="button",x.className="wn-annot-pill cancel wn-annotator",x.textContent="Close",f.appendChild(x),o.appendChild(r),o.appendChild(p),e.appendChild(n),e.appendChild(o),e.appendChild(f),t.appendChild(e),document.body.appendChild(t);const E=()=>{t.classList.remove("show"),document.removeEventListener("keydown",$)},$=g=>{g.key==="Escape"&&E()},pt=g=>{g.target===t&&E()};return x.addEventListener("click",E),t.addEventListener("click",pt),["dragenter","dragover"].forEach(g=>{r.addEventListener(g,y=>{y.preventDefault(),y.stopPropagation(),r.classList.add("dragover")})}),["dragleave","drop"].forEach(g=>{r.addEventListener(g,y=>{y.preventDefault(),y.stopPropagation(),r.classList.remove("dragover")})}),r.addEventListener("drop",g=>{var Tt;const y=(Tt=g.dataTransfer)==null?void 0:Tt.files;y&&y.length&&Qe(Array.from(y))}),i.addEventListener("change",g=>{const y=g.target.files;y&&y.length&&Qe(Array.from(y)),i.value=""}),Q.addEventListener("click",g=>{const y=g.target.closest("[data-import-remove]");y&&Xn(y.dataset.importRemove)}),a.importModal={backdrop:t,modal:e,fileInput:i,fileList:Q,filesCount:m,onKey:$,close:E},a.importModal}function Dn(){if(!Nt)return;const t=Fn();ft(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function ft(){if(!a.importModal)return;const{fileList:t,filesCount:e}=a.importModal,{fileCounts:n}=jn();if(t.innerHTML="",a.importFiles.length)a.importFiles.forEach(o=>{const r=document.createElement("div");r.className="wn-annot-import-card wn-annotator";const i=document.createElement("div");i.className="wn-annot-import-meta wn-annotator";const s=document.createElement("div");s.className="wn-annot-import-name wn-annotator",s.textContent=o.name;const l=document.createElement("div");l.className="wn-annot-import-sub wn-annotator";const c=n.get(o.id)||0,p=o.pageUrl?` | ${Wn(o.pageUrl,36)}`:"";l.textContent=`${c} comments | ${qn(o.size)}${p}`,i.appendChild(s),i.appendChild(l);const u=document.createElement("div");u.className="wn-annot-import-actions wn-annotator";const h=document.createElement("div");h.className="wn-annot-import-badge wn-annotator",h.textContent=String(c);const m=document.createElement("button");m.type="button",m.className="wn-annot-import-remove wn-annotator",m.dataset.importRemove=o.id,m.textContent="x",u.appendChild(h),u.appendChild(m),r.appendChild(i),r.appendChild(u),t.appendChild(r)});else{const o=document.createElement("div");o.className="wn-annot-import-empty wn-annotator",o.textContent="No imported files yet.",t.appendChild(o)}e.textContent=String(a.importFiles.length)}function jn(){const t=new Map;return a.annotations.forEach(e=>{e.importFileId&&t.set(e.importFileId,(t.get(e.importFileId)||0)+1)}),{fileCounts:t}}async function Qe(t){if(!t||!t.length)return;const e=new Set(a.annotations.map(o=>o.id));let n=0;for(const o of t){const r=await Vn(o,e);if(!r)continue;const{fileMeta:i,annotations:s}=r;s.length&&(a.importFiles.push(i),a.annotations.push(...s),n+=s.length)}if(!n){ft();return}A(),Pe(),nt(),it(),V(),ft()}async function Vn(t,e){let n;try{const c=await t.text();n=JSON.parse(c)}catch(c){return await Ae(`Invalid JSON in ${t.name}.`,"Import error"),null}const o=Array.isArray(n)?n:n.annotations;if(!Array.isArray(o))return await Ae(`Unsupported JSON format in ${t.name}.`,"Import error"),null;const r=Array.isArray(n)?t.lastModified:n.createdAt,i=Array.isArray(n)?"":n.pageUrl||"",s=en(),l=o.filter(jt).map(c=>Kn(c,{createdAt:r,pageUrl:i,fileId:s,existingIds:e}));return{fileMeta:{id:s,name:t.name,size:t.size,pageUrl:i,importedAt:Date.now()},annotations:l}}function Kn(t,e){const n=t&&typeof t=="object"?t:{},o=n.pageUrl||e.pageUrl||window.location.href,r=Yn(n.id,e.existingIds),i=Cn(de({},n),{id:r,createdAt:n.createdAt||e.createdAt||Date.now(),pageUrl:o,importFileId:e.fileId});return i.pageKey||(i.pageKey=L(o)),i}function Yn(t,e){if(t&&!e.has(t))return e.add(t),t;let n;do n=yt();while(e.has(n));return e.add(n),n}function Xn(t){const e=a.importFiles.filter(n=>n.id!==t);e.length!==a.importFiles.length&&(a.importFiles=e,a.annotations=a.annotations.filter(n=>n.importFileId!==t),A(),Pe(),nt(),it(),V(),ft())}function qn(t){if(!t)return"0 B";const e=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),e.length-1),o=t/Math.pow(1024,n);return`${o.toFixed(o<10&&n>0?1:0)} ${e[n]}`}function Wn(t,e){return typeof t!="string"?"":t.length<=e?t:t.slice(0,e-3)+"..."}function _n(){if(a.dialogModal)return a.dialogModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-sheet wn-annotator";const n=document.createElement("h4");n.className="wn-annotator";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator";const r=document.createElement("div");r.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",r.appendChild(i),r.appendChild(s),e.appendChild(Rt("Dismiss",()=>i.click())),e.appendChild(n),e.appendChild(o),e.appendChild(r),t.appendChild(e),document.body.appendChild(t),a.dialogModal={backdrop:t,modal:e,title:n,message:o,okBtn:s,cancelBtn:i},a.dialogModal}function Se({title:t="Information",message:e="",okLabel:n="OK",cancelLabel:o="Cancel",dismissOnBackdrop:r=!0}){return new Promise(i=>{const{backdrop:s,title:l,message:c,okBtn:p,cancelBtn:u}=_n();l.textContent=t,c.textContent=e,p.textContent=n;const h=!!o;u.style.display=h?"inline-flex":"none",u.textContent=o||"";const m=E=>{s.classList.remove("show"),O(),p.removeEventListener("click",b),u.removeEventListener("click",Q),s.removeEventListener("click",f),document.removeEventListener("keydown",x),i(E)},b=()=>m(!0),Q=()=>m(!1),f=E=>{E.target===s&&r&&m(!1)},x=E=>{E.key==="Escape"&&m(!1),(E.metaKey||E.ctrlKey)&&E.key==="Enter"&&b()};p.addEventListener("click",b),u.addEventListener("click",Q),s.addEventListener("click",f),document.addEventListener("keydown",x),s.classList.add("show"),O(),p.focus()})}async function Jn(t,e="Confirmation"){return Se({title:e,message:t,okLabel:"Confirm",cancelLabel:"Cancel"})}async function Ae(t,e="Information"){await Se({title:e,message:t,okLabel:"OK",cancelLabel:null})}function Zn(){document.addEventListener("mouseup",Yt),document.addEventListener("touchend",Yt),document.addEventListener("pointerup",Yt),document.addEventListener("selectionchange",xo),document.addEventListener("mousemove",mo),document.addEventListener("click",fo,!0),window.addEventListener("resize",M),window.addEventListener("resize",G),window.addEventListener("resize",Z),window.addEventListener("resize",D),window.addEventListener("resize",z),window.addEventListener("resize",J),window.addEventListener("resize",Ue),window.addEventListener("scroll",M,{passive:!0}),ha(),wa(),zt(It,Ce),zt(Pt,Ce),Mn&&zt($t,Ne)}function Gn(){if(!a.panel)return;const t=a.panel.querySelector("#wn-filter-search");if(!t)return;t.value=a.filters.query;const e=()=>{a.filters.query=t.value.trim().toLowerCase(),T()};t.addEventListener("input",e)}function j(t,e={}){const n=e.keepOutline;if(a.mode===t){a.mode=null,Bt(),_(),Me(),n||ot();return}a.mode=t,Bt(),Ut(t),Me(),t!=="element"&&ot()}function Me(){a.selectionTimer&&(clearTimeout(a.selectionTimer),a.selectionTimer=null),tt(),Ve()}function Bt(){a.toolbar.querySelectorAll('button[data-action="mode"]').forEach(e=>{e.getAttribute("data-mode")===a.mode?e.classList.add("active"):e.classList.remove("active")})}function Ut(t){const e=F();let n="";if(t==="text"?n=e?"Select text, then tap Add note.":"Select text then release to add a note.":t==="element"&&(n=e?"Tap an element to preview it, then pin it.":"Hover an element, click to annotate."),!n)return _();a.tip.textContent=n,a.tip.classList.add("show"),z(),requestAnimationFrame(z),requestAnimationFrame(z)}function _(){a.tip.classList.remove("show")}function to(){if(a.toast)return a.toast;const t=document.createElement("div");return t.className="wn-annot-toast wn-annotator",t.setAttribute("aria-live","polite"),document.body.appendChild(t),a.toast=t,t}function P(t){if(!t)return;const e=to();e.textContent=t,e.classList.add("show"),a.toastTimer&&clearTimeout(a.toastTimer),a.toastTimer=setTimeout(()=>{e.classList.remove("show")},2200)}function eo(){try{const t=localStorage.getItem(me);if(t==="top"||t==="bottom")return t}catch(t){}return null}function no(){try{const t=localStorage.getItem(ge);return t==null?null:t==="true"}catch(t){return null}}function oo(t){try{localStorage.setItem(ge,t?"true":"false")}catch(e){}}function Ne(){const t=!!($t&&$t.matches),e=q==="dark"||q==="auto"&&t||q==="reverse-auto"&&!t;document.documentElement.setAttribute("data-wn-theme",e?"dark":"light")}function ao(){if(!document||!document.documentElement)return;const t=document.documentElement,e=a.colors||St,n=(i,s)=>{s&&t.style.setProperty(i,s)},o=e.text,r=e.element;n("--wn-text-highlight",o.base),n("--wn-text-highlight-overlay",o.overlay),n("--wn-text-highlight-soft",o.soft),n("--wn-element-highlight",r.base),n("--wn-element-highlight-soft",r.soft),n("--wn-element-highlight-soft-end",r.softer),n("--wn-element-highlight-strong",r.strong),n("--wn-element-highlight-shadow",r.shadow),n("--wn-marker-text",r.text)}function Ft(t,e={}){var s,l,c;const n=wt(t,"#000000"),o=(s=e.softAlpha)!=null?s:.12,r=(l=e.softerAlpha)!=null?l:.04,i=(c=e.overlayAlpha)!=null?c:.7;return{base:n,overlay:S(n,i,S("#000000",i)),soft:S(n,o,S("#000000",o)),softer:S(n,r,S("#000000",r)),strong:S(n,.9,n),shadow:S(n,.24,"rgba(0,0,0,0.24)"),pill:S(n,.16,"rgba(0,0,0,0.16)"),pillBorder:S(n,.28,"rgba(0,0,0,0.28)"),text:ro(n)}}function wt(t,e){const n=Dt(t);return n||Dt(e)||"#000000"}function Dt(t){if(!t||typeof t!="string")return null;const n=t.trim().match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i);if(!n)return null;const o=n[1];return`#${(o.length===3?o.split("").map(i=>i+i).join(""):o).toLowerCase()}`}function $e(t){const e=Dt(t);if(!e)return null;const n=parseInt(e.slice(1),16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function S(t,e=1,n=""){const o=$e(t);if(!o)return n||"";const r=typeof e=="number"&&e>=0&&e<=1?e:1;return`rgba(${o.r}, ${o.g}, ${o.b}, ${r})`}function ro(t){const e=$e(t);return e?.299*e.r+.587*e.g+.114*e.b>160?"#0b1622":"#ffffff":"#0b1622"}function H(t){const e=a.colors||St,n=t&&t.type;return n==="text"?e.text:n==="screenshot"?e.screenshot:e.element}function Ie(t,e){!t||!e||(t.style.setProperty("--wn-marker-bg",e.base),t.style.setProperty("--wn-marker-text",e.text),t.style.setProperty("--wn-marker-shadow",e.shadow))}function io(t,e){!t||!e||(t.style.setProperty("--wn-item-accent",e.base),t.style.setProperty("--wn-item-accent-strong",e.strong),t.style.setProperty("--wn-item-accent-shadow",e.shadow),t.style.setProperty("--wn-item-accent-soft",e.soft),t.style.setProperty("--wn-item-accent-soft-end",e.softer),t.style.setProperty("--wn-item-number-bg",e.pill),t.style.setProperty("--wn-item-number-border",e.pillBorder))}function B(t,e=!1){if(t==null||t==="")return e;const n=String(t).toLowerCase();return n==="true"||n==="1"||n==="yes"||n==="on"?!0:n==="false"||n==="0"||n==="no"||n==="off"?!1:e}function so(){try{const t=localStorage.getItem(we),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>n&&typeof n=="object").map(n=>({id:n.id||en(),name:String(n.name||"Imported file"),size:Number(n.size||0),pageUrl:typeof n.pageUrl=="string"?n.pageUrl:"",importedAt:Number(n.importedAt||0)})):[]}catch(t){return[]}}function Pe(){try{localStorage.setItem(we,JSON.stringify(a.importFiles||[]))}catch(t){}}function z(){if(!a.tip||!a.toolbar)return;const t=a.toolbar.getBoundingClientRect(),e=a.tip,n=10,o=t.left+t.width/2,r=v==="bottom";e.style.left=`${o}px`,e.style.right="",e.style.transform="translateX(-50%)",e.style.top="",e.style.bottom="";const i=e.getBoundingClientRect();if(r){const s=Math.max(8,t.top-n-i.height);e.style.top=`${s}px`}else{const s=t.bottom+n;e.style.top=`${s}px`}}function jt(t){return!!t&&(t.type==="text"||t.type==="element"||t.type==="screenshot")}function lo(){try{const t=localStorage.getItem(fe),e=t?JSON.parse(t):[];a.annotations=(e||[]).filter(jt),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))})}catch(t){console.warn("Annotator storage error",t),a.annotations=[]}}function A(){if(k){ce();return}try{localStorage.setItem(fe,JSON.stringify(a.annotations))}catch(t){console.warn("Annotator storage save error",t),P("Uxnote: this browser has no room left to store notes")}}async function co(t){const e=t.target.closest("button");if(!e||!e.classList.contains("wn-annotator"))return;const n=e.getAttribute("data-action");if(n){if(n==="mode"){const o=e.getAttribute("data-mode");if(o==="screenshot"){await ka();return}j(o);return}if(n==="export"){Le();return}if(n==="import"){Dn();return}if(n==="mail"){await Go();return}if(n==="toggle-panel"){po();return}if(n==="toggle-pos"){ho(v==="bottom"?"top":"bottom"),Kt();return}}}function po(){mt(a.panel.style.display==="none")}function uo(){gt(!a.hidden)}function gt(t){a.hidden=t,oo(t),document.body.classList.toggle("wn-annot-hidden",t),t&&(j(null),_(),ot()),ze(),Ee(),J(),G(),D(),O(),t||(M(),Z(),z()),document.dispatchEvent(new CustomEvent("uxnote:visibility",{detail:{hidden:t}}))}function ze(){if(!a.visibilityToggle)return;const t=a.hidden?"Show Uxnote":"Hide Uxnote";a.visibilityToggle.classList.toggle("is-muted",a.hidden),a.visibilityToggle.innerHTML=a.hidden?ca():cn(),a.visibilityToggle.setAttribute("aria-label",t),a.visibilityToggle.setAttribute("aria-pressed",a.hidden?"true":"false"),a.visibilityToggle.setAttribute("data-tip",t)}function J(){const t=a.visibilityToggle;if(!t)return;Ot();const e=18;if(I()){a.hidden?(t.style.bottom=`max(${e}px, env(safe-area-inset-bottom))`,t.style.left=`max(${e}px, env(safe-area-inset-left))`,t.style.top="",t.style.right=""):(t.style.top="",t.style.right="",t.style.bottom="",t.style.left="");return}t.style.left="",t.style.right="",v==="top"?(t.style.top=`${e}px`,t.style.bottom=""):(t.style.bottom=`${e}px`,t.style.top="")}function Vt(){if(!a.panel||!a.toolbar)return;const t=a.toolbar.querySelector('button[data-action="toggle-panel"]');if(!t)return;const e=a.panel.style.display==="none";t.classList.toggle("active",!e)}function Z(){if(!a.panel||!a.toolbar)return;const t=a.panel,e=18,n=a.toolbar.getBoundingClientRect();if(I()){t.style.width="",t.style.height="",t.style.maxHeight="",t.style.left="",t.style.right="",t.style.top="",t.style.bottom="",t.style.borderRadius="",t.style.paddingTop="",t.style.paddingBottom="",D();return}t.style.width=`min(360px, calc(100% - ${e*2}px))`,t.style.maxHeight=`calc(100vh - ${e*2}px)`,t.style.maxHeight=`calc(100dvh - ${e*2}px)`,t.style.left="auto",t.style.right=`${e}px`,t.style.top=`${e}px`,t.style.bottom=`${e}px`,t.style.height="",t.style.borderRadius="",t.style.paddingTop="",t.style.paddingBottom="",v==="left"?(t.style.left=`${n.width+e}px`,t.style.right=`${e}px`):v==="right"&&(t.style.right=`${n.width+e}px`,t.style.left=`${e}px`)}function ho(t){v=t==="top"?"top":"bottom";const e=a.toolbar;e&&(e.classList.remove("wn-pos-top","wn-pos-bottom","wn-pos-left","wn-pos-right"),e.classList.add(`wn-pos-${v}`));try{localStorage.setItem(me,v)}catch(n){}Kt(),J(),z(),W(),Z(),G(),D()}function Kt(){if(!a.toolbar)return;const t=a.toolbar.querySelector('button[data-action="toggle-pos"]');t&&(t.innerHTML=v==="top"?sn():ln())}function G(){if(!a.toolbar||a.customPosition||!(ut==="push"||ut==="dock"||ut==="pad"||ut==="true"))return;const t=document.body;a.basePadding||ve();const e=a.basePadding;if(a.hidden){t.style.paddingTop=`${e.top}px`,t.style.paddingRight=`${e.right}px`,t.style.paddingBottom=`${e.bottom}px`,t.style.paddingLeft=`${e.left}px`;return}const n=a.toolbar.getBoundingClientRect(),o=de({},e);v==="top"?o.top=e.top+n.height:v==="bottom"?o.bottom=e.bottom+n.height:v==="left"?o.left=e.left+n.width:v==="right"&&(o.right=e.right+n.width),t.style.paddingTop=`${o.top}px`,t.style.paddingRight=`${o.right}px`,t.style.paddingBottom=`${o.bottom}px`,t.style.paddingLeft=`${o.left}px`}function Re(t){return U(t.commonAncestorContainer)&&U(t.startContainer)&&U(t.endContainer)}async function Yt(){if(a.mode!=="text"||F())return;const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return;const e=t.getRangeAt(0);if(!e)return;if(!Re(e)){t.removeAllRanges(),P("This area is a popup or overlay. It cannot be annotated.");return}const n=t.toString().trim();n&&await Oe(e,n)}async function Oe(t,e){const n=await Ht("Comment for this highlight?");if(!n)return;const{comment:o}=n,r=yt(),i=Ao(t,e),s=xt(t,r),l=window.getSelection();l&&l.removeAllRanges();const c={id:r,type:"text",target:i,comment:o.trim(),snippet:e.slice(0,180),pageUrl:window.location.href,pageKey:L(window.location.href),createdAt:Date.now(),status:"active"};a.annotations.push(c),A(),K(c,s),T(),j(null,{keepOutline:!0})}function mo(t){if(a.mode!=="element")return;const e=t.target;if(!e||!U(e)){ot();return}He(e)}function He(t){const e=Zt(t);if(!e){ot();return}So(e)}async function fo(t){if(a.mode!=="element")return;const e=t.target;if(!Jt(e)){if(!e||!U(e)){P("This area is a popup or overlay. It cannot be annotated.");return}if(t.preventDefault(),t.stopPropagation(),F()){To(e);return}await Be(e)}}async function Be(t){const e=await Ht("Comment for this element?");if(!e)return;const{comment:n}=e,o=yt(),r=te(t),i=zo(t),s=t.getBoundingClientRect(),l={id:o,type:"element",target:{xpath:r,css:i,tag:t.tagName.toLowerCase()},comment:n.trim(),snippet:t.innerText?t.innerText.trim().slice(0,120):t.tagName,pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:s.x+window.scrollX,y:s.y+window.scrollY,w:s.width,h:s.height},createdAt:Date.now(),status:"active"};a.annotations.push(l),A(),K(l,t),Xe(t,o),T(),j(null,{keepOutline:!0})}const wo=400;function Xt(t){if(!t||!a.toolbar||!t.classList.contains("show"))return;const e=document.documentElement,n=a.toolbar.getBoundingClientRect(),o=8;if(v==="top"){t.style.top=`${Math.round(n.bottom+o)}px`,t.style.bottom="auto";return}t.style.top="auto",t.style.bottom=`${Math.round(e.clientHeight-n.top+o)}px`}function Ue(){Xt(a.selectionBar);const t=a.elementPicker;!t||!t.bar.classList.contains("show")||Wt()}function Fe(){const t=a.commentModal;return!!(t&&t.backdrop.classList.contains("show"))}function go(){const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return null;const e=t.getRangeAt(0);return!e||!e.toString().trim()||!Re(e)?null:e}function xo(){if(F()){if(a.selectionTimer&&clearTimeout(a.selectionTimer),a.selectionTimer=null,a.mode!=="text"||Fe()){tt();return}a.selectionTimer=setTimeout(bo,wo)}}function bo(){if(a.selectionTimer=null,a.mode!=="text"||Fe())return tt();const t=go();if(!t)return tt();a.selectionRange=t.cloneRange(),vo()}function yo(){if(a.selectionBar)return a.selectionBar;const t=document.createElement("div");t.className="wn-annot-actionbar wn-annot-selection-bar wn-annotator";const e=document.createElement("button");return e.type="button",e.className="primary wn-annotator",e.textContent="Add note",e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),ko()}),t.appendChild(e),document.body.appendChild(t),a.selectionBar=t,t}function vo(){const t=yo();_(),t.classList.add("show"),Xt(t)}function tt(){a.selectionRange=null;const t=a.selectionBar;!t||!t.classList.contains("show")||(t.classList.remove("show"),a.mode&&!a.hidden&&Ut(a.mode))}async function ko(){const t=a.selectionRange;if(tt(),!t)return;if(!at(t.startContainer)||!at(t.endContainer)){P("That text is no longer on the page.");return}const e=t.toString().trim();e&&await Oe(t,e)}function Co(t){if(!t||t.nodeType!==1)return"";const e=t.tagName.toLowerCase();if(t.id)return`${e}#${t.id}`;const n=Array.from(t.classList||[]).filter(o=>o&&!o.startsWith("wn-")&&!o.startsWith("uxnote-"));return n.length?`${e}.${n.slice(0,2).join(".")}`:e}function Eo(){if(a.elementPicker)return a.elementPicker;const t=document.createElement("div");t.className="wn-annot-actionbar wn-annot-pick-bar wn-annotator";const e=document.createElement("span");e.className="wn-annot-pick-name wn-annotator";const n=(s,l,c)=>{const p=document.createElement("button");return p.type="button",p.className=`${l} wn-annotator`,p.textContent=s,p.addEventListener("click",u=>{u.preventDefault(),u.stopPropagation(),c()}),p},o=n("Wider","wn-annot-pick-wider",()=>je(1)),r=n("Narrower","wn-annot-pick-narrower",()=>je(-1)),i=n("Pin here","primary wn-annot-pick-pin",Lo);return t.appendChild(e),t.appendChild(r),t.appendChild(o),t.appendChild(i),document.body.appendChild(t),a.elementPicker={bar:t,name:e,wider:o,narrower:r,pin:i},a.elementPicker}function To(t){a.elementTrail=[t],a.elementTrailIndex=0;const e=Eo();_(),e.bar.classList.add("show"),Wt()}function qt(){return a.elementTrail[a.elementTrailIndex]||null}function De(){const t=qt();if(a.elementTrailIndex<a.elementTrail.length-1)return a.elementTrail[a.elementTrailIndex+1];if(!t||t===document.body)return null;const e=t.parentElement;return!e||!U(e)?null:e}function je(t){if(t>0){const e=De();if(!e)return;a.elementTrailIndex===a.elementTrail.length-1&&a.elementTrail.push(e),a.elementTrailIndex+=1}else{if(a.elementTrailIndex===0)return;a.elementTrailIndex-=1}Wt()}function Wt(){const t=a.elementPicker,e=qt();!t||!e||(t.name.textContent=Co(e),t.narrower.disabled=a.elementTrailIndex===0,t.wider.disabled=!De(),He(e),Xt(t.bar))}function Ve(){a.elementTrail=[],a.elementTrailIndex=0;const t=a.elementPicker;!t||!t.bar.classList.contains("show")||(t.bar.classList.remove("show"),a.mode&&!a.hidden&&Ut(a.mode))}async function Lo(){const t=qt();if(Ve(),!t||!at(t)){P("That element is no longer on the page.");return}await Be(t)}function _t(t){const e=t&&t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}}function et(t){const e=a.highlightSpans[t];return e?Array.isArray(e)?e:[e]:Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`))}function nt(){Object.keys(a.highlightSpans||{}).forEach(t=>{et(t).forEach(e=>{e&&e.parentNode&&_t(e)})}),a.highlightSpans={},Array.from(document.querySelectorAll(".uxnote-textmark[data-uxnote-id], .wn-annot-highlight[data-wn-annot-id]")).forEach(t=>{t&&t.parentNode&&_t(t)}),Object.values(a.markers||{}).forEach(t=>{t&&t.el&&t.el.parentNode&&t.el.parentNode.removeChild(t.el)}),a.markerLayer&&(a.markerLayer.innerHTML=""),a.markers={},Object.keys(a.elementTargets||{}).forEach(t=>{qe(t)}),a.elementTargets={},Array.from(document.querySelectorAll(".uxnote-annotated[data-uxnote-ids]")).forEach(t=>{delete t.dataset.uxnoteIds,t.classList.remove("uxnote-annotated")})}function Qo(t){const e=a.markers[t];e&&e.el&&e.el.parentNode&&e.el.parentNode.removeChild(e.el),e&&e.frame&&e.frame.parentNode&&e.frame.parentNode.removeChild(e.frame),delete a.markers[t],qe(t);let n=et(t);n.length||(n=Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)),n.length||(n=Array.from(document.querySelectorAll(`.wn-annot-highlight[data-wn-annot-id="${t}"]`)))),n.forEach(o=>{o&&_t(o)}),delete a.highlightSpans[t]}function V(){Object.entries(a.markers).forEach(([t,e])=>{const n=a.annotations.findIndex(o=>o.id===t);n!==-1&&(e.el.textContent=n+1)})}function So(t){const e=a.outlineBox;e.style.display="block",e.style.left=`${t.x+window.scrollX}px`,e.style.top=`${t.y+window.scrollY}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`}function ot(){a.outlineBox.style.display="none"}function Jt(t){return t?t.classList&&t.classList.contains("wn-annotator")||t.parentElement&&Jt(t.parentElement):!1}function U(t){if(!t)return!1;const e=t.nodeType===Node.ELEMENT_NODE?t:t.nodeType===Node.DOCUMENT_NODE?document.body:t.parentElement;if(!e||Jt(e))return!1;if(e.closest){if(e.closest("[data-uxnote-ignore]"))return!1;if(e.closest("[data-uxnote-allow]"))return!0;if(e.closest('#uxnote-root, .wn-annotator, dialog, [popover], [role="dialog"], [role="menu"], [role="tooltip"], [aria-modal="true"]'))return!1}return!0}function Ao(t,e){return{startXPath:te(t.startContainer),startOffset:t.startOffset,endXPath:te(t.endContainer),endOffset:t.endOffset,quote:e?String(e).slice(0,200):""}}function xt(t,e){let n=[];const o=t.cloneRange();if(Mo(o).forEach(i=>{const s=No(i,{start:i===o.startContainer?o.startOffset:0,end:i===o.endContainer?o.endOffset:i.length},e);s&&n.push(s)}),!n.length){const i=document.createElement("span");i.className="uxnote-textmark",i.dataset.uxnoteId=e,i.addEventListener("click",l=>{l.stopPropagation(),lt(e)});const s=o.extractContents();i.appendChild(s),o.insertNode(i),n=[i]}return a.highlightSpans[e]=n,n[0]}function $a(t,e){return xt(t,e)}function Ke(t,e){const n=document.createRange();return n.selectNodeContents(e),t.compareBoundaryPoints(Range.END_TO_START,n)>0&&t.compareBoundaryPoints(Range.START_TO_END,n)<0}function Mo(t){const e=[],n=document.createTreeWalker(t.commonAncestorContainer,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();)if(!(!o.nodeValue||!o.nodeValue.trim())){try{if(t.intersectsNode){if(!t.intersectsNode(o))continue}else if(!Ke(t,o))continue}catch(r){if(!Ke(t,o))continue}e.push(o)}return e}function No(t,e,n){if(!t||!t.parentNode)return null;const{start:o,end:r}=e;let i=t,s=r;if(o>0&&(i=i.splitText(o),s=r-o),s<i.length&&i.splitText(s),!i.parentNode)return null;const l=document.createElement("span");return l.className="uxnote-textmark",l.dataset.uxnoteId=n,l.addEventListener("click",c=>{c.stopPropagation(),lt(n)}),i.parentNode.insertBefore(l,i),l.appendChild(i),l}function at(t){return t?typeof t.isConnected=="boolean"?t.isConnected:document.body&&document.body.contains(t):!1}function $o(t,e){if(!t||!e)return null;const n=Math.max(t.x,e.x),o=Math.max(t.y,e.y),r=Math.min(t.x+t.width,e.x+e.width),i=Math.min(t.y+t.height,e.y+e.height),s=r-n,l=i-o;return s<=0||l<=0?null:{x:n,y:o,width:s,height:l}}function Zt(t){if(!t||!at(t)||!t.getBoundingClientRect)return null;let e=t.getBoundingClientRect();if(!e.width||!e.height)return null;let n=t;for(;n&&n.nodeType===1;){if(n.tagName==="DETAILS"&&!n.open){const p=n.querySelector("summary");if(p&&!p.contains(t))return null}if(n.hasAttribute&&n.hasAttribute("hidden")||(n.getAttribute&&n.getAttribute("aria-hidden"))==="true")return null;const r=window.getComputedStyle(n);if(r.display==="none"||r.visibility==="hidden"||r.visibility==="collapse"||r.opacity==="0")return null;const i=r.overflowX||r.overflow,s=r.overflowY||r.overflow;if(i&&i!=="visible"||s&&s!=="visible"){const p=n.getBoundingClientRect(),u=$o(e,p);if(!u)return null;e=u}n=n.parentElement}return e}function Io(t){let e=t&&t.nodeType===1?t:null;for(;e&&e.nodeType===1&&e!==document.body;){const n=window.getComputedStyle(e),o=n.zIndex;if(n.position!=="static"&&o!=="auto"||n.opacity!=="1"||n.transform!=="none"||n.filter!=="none"||n.perspective!=="none"||n.mixBlendMode!=="normal"||n.isolation==="isolate"||n.willChange&&n.willChange!=="auto"||n.contain&&n.contain!=="none")return e;e=e.parentElement}return document.body}function Ye(t){if(!t||t.nodeType!==1)return a.markerLayer||document.body;const e=t.offsetParent;return e&&e.nodeType===1?e:Io(t)||a.markerLayer||document.body}function Gt(t){return t===document.body||t===a.markerLayer||t===document.documentElement}function Po(t){if(!t||t.nodeType!==1)return!1;let e=!1,n=t;for(;n&&n.nodeType===1&&n!==document.body;){if(n.tagName==="DETAILS"&&!n.open&&(n.open=!0,e=!0),n.tagName==="DIALOG"&&!n.open)try{typeof n.showModal=="function"?n.showModal():typeof n.show=="function"&&n.show(),e=!0}catch(r){}if(n.hasAttribute&&n.hasAttribute("popover"))try{typeof n.showPopover=="function"&&(n.showPopover(),e=!0)}catch(r){}if(n.hasAttribute&&n.hasAttribute("data-uxnote-open")){const r=n.getAttribute("data-uxnote-open");if(r){const i=document.querySelector(r);i&&typeof i.click=="function"&&(i.click(),e=!0)}}const o=n.getAttribute&&n.getAttribute("aria-hidden");if(n.hasAttribute&&n.hasAttribute("hidden")||o==="true"){const r=n.id;if(r){const i=document.querySelector(`[aria-controls="${bt(r)}"]`);i&&typeof i.click=="function"&&(i.click(),e=!0)}}n=n.parentElement}return e}function Xe(t,e){if(!t||t.nodeType!==1)return!1;const n=t.dataset.uxnoteIds?t.dataset.uxnoteIds.split(",").filter(Boolean):[],o=new Set(n);return o.add(e),t.dataset.uxnoteIds=Array.from(o).join(","),t.classList.add("uxnote-annotated"),a.elementTargets[e]=t,!0}function qe(t){const e=a.elementTargets[t];if(!e||e.nodeType!==1){delete a.elementTargets[t],Array.from(document.querySelectorAll("[data-uxnote-ids]")).forEach(i=>{const s=i.dataset.uxnoteIds?i.dataset.uxnoteIds.split(",").filter(Boolean):[];if(!s.includes(t))return;const l=s.filter(c=>c!==t);l.length?i.dataset.uxnoteIds=l.join(","):(delete i.dataset.uxnoteIds,i.classList.remove("uxnote-annotated"))});return}const o=(e.dataset.uxnoteIds?e.dataset.uxnoteIds.split(",").filter(Boolean):[]).filter(r=>r!==t);o.length?e.dataset.uxnoteIds=o.join(","):(delete e.dataset.uxnoteIds,e.classList.remove("uxnote-annotated")),delete a.elementTargets[t]}function te(t){if(t===document.body)return"/html/body";const e=[];for(;t&&t!==document;){let n=1,o=t.previousSibling;for(;o;)o.nodeType===t.nodeType&&o.nodeName===t.nodeName&&n++,o=o.previousSibling;const r=t.nodeType===3?"text()":t.nodeName.toLowerCase();if(e.unshift(`${r}[${n}]`),t=t.parentNode,!t||t.nodeType!==1)break}return"/"+e.join("/")}function bt(t){return window.CSS&&typeof window.CSS.escape=="function"?window.CSS.escape(t):String(t).replace(/[^a-zA-Z0-9_-]/g,"\\$&")}function zo(t){if(!t||t.nodeType!==1)return"";if(t.id)return`#${bt(t.id)}`;const e=[];let n=t,o=0;for(;n&&n.nodeType===1&&o<4;){let r=n.tagName.toLowerCase();const i=Array.from(n.classList||[]).filter(s=>s&&!s.startsWith("wn-")&&!s.startsWith("uxnote-"));if(i.length&&(r+=`.${i.slice(0,2).map(bt).join(".")}`),e.unshift(r),n.parentElement&&n.parentElement.id){e.unshift(`#${bt(n.parentElement.id)}`);break}n=n.parentElement,o+=1}return e.join(" > ")}function rt(t){try{const e=document;return e.evaluate(t,e,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue}catch(e){return null}}function it(){a.annotations.forEach(t=>{t.pageKey===L(window.location.href)&&Ro(t)}),T()}function Ro(t){const e=st(t);if(!e){t.status="missing",We();return}t.status="active",ee(t,e)}function ee(t,e){if(e){if(e.type==="screenshot"){K(t,null);return}if(e.type==="text"&&e.range){const n=xt(e.range,t.id);K(t,n);return}e.type==="element"&&e.el&&(Xe(e.el,t.id),K(t,e.el))}}function Oo(t){if(!t)return null;const e=rt(t.startXPath),n=rt(t.endXPath);if(!e||!n)return null;try{const o=document.createRange();return o.setStart(e,t.startOffset),o.setEnd(n,t.endOffset),o}catch(o){return null}}function st(t){return t?t.type==="screenshot"?t.rect?{type:"screenshot"}:null:t.target?t.type==="text"?Ho(t):t.type==="element"?Uo(t):null:null:null}function Ho(t){const e=t.target||{},n=Oo(e);if(n)return{type:"text",range:n};const o=e.quote||t.snippet||"";if(!o)return null;const r=Bo(o);return r?{type:"text",range:r}:null}function Bo(t){const e=String(t||"").trim();if(!e||e.length<4)return null;const n=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();){if(!o.nodeValue||!o.nodeValue.trim()||!U(o))continue;const r=o.nodeValue.indexOf(e);if(r===-1)continue;const i=document.createRange();return i.setStart(o,r),i.setEnd(o,r+e.length),i}return null}function Uo(t){const e=t.target||{};if(e.xpath){const r=rt(e.xpath);if(r&&r.nodeType===1)return{type:"element",el:r}}if(e.css)try{const r=document.querySelector(e.css);if(r&&r.nodeType===1)return{type:"element",el:r}}catch(r){}const n=e.tag,o=(t.snippet||"").trim();if(n&&o){const r=document.querySelectorAll(n);for(const i of r)if(!(!i||i.nodeType!==1)&&(i.textContent||"").includes(o))return{type:"element",el:i}}return null}function Fo(){a.missingRetryTimer&&clearTimeout(a.missingRetryTimer),a.missingRetryTimer=setTimeout(()=>{ne()},300)}function We(){a.missingObserver||!window.MutationObserver||(a.missingObserver=new MutationObserver(()=>{a.annotations.some(t=>t.status==="missing")&&Fo()}),a.missingObserver.observe(document.body,{childList:!0,subtree:!0}))}function Do(){a.missingObserver&&(a.missingObserver.disconnect(),a.missingObserver=null)}function ne(){let t=!1;a.annotations.forEach(e=>{if(e.status!=="missing"||e.pageKey!==L(window.location.href))return;const n=st(e);n&&(e.status="active",ee(e,n),t=!0)}),t&&(A(),T(),M()),a.annotations.some(e=>e.status==="missing")||Do()}function jo(){let t=!1;a.annotations.forEach(e=>{if(e.type!=="text"||e.pageKey!==L(window.location.href))return;const n=et(e.id).filter(at);if(n.length){a.highlightSpans[e.id]=n,e.status==="missing"&&(e.status="active",t=!0);return}const o=st(e);if(o&&o.range){xt(o.range,e.id),e.status="active",t=!0;return}e.status!=="missing"&&(e.status="missing",t=!0)}),t&&(A(),T(),M())}function Vo(){a.layoutTimer&&clearTimeout(a.layoutTimer),a.layoutTimer=setTimeout(()=>{M(),jo(),a.annotations.some(t=>t.status==="missing")&&ne()},120)}function Ko(){a.layoutObserver||!window.MutationObserver||(a.layoutObserver=new MutationObserver(t=>{t.some(n=>{const o=n.target;return!(!o||o.classList&&o.classList.contains("wn-annotator")||o.closest&&o.closest(".wn-annotator"))})&&Vo()}),a.layoutObserver.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class","open","hidden","aria-hidden"]}))}function K(t,e){if(t.pageKey!==L(window.location.href)||!a.markerLayer)return;const n=a.markers[t.id];n&&n.el&&n.el.parentNode&&n.el.parentNode.removeChild(n.el);const o=document.createElement("div");o.className="wn-annot-marker wn-annotator",o.textContent=a.annotations.findIndex(c=>c.id===t.id)+1,o.dataset.wnAnnotId=t.id;const r=H(t);Ie(o,r),o.addEventListener("click",()=>lt(t.id));const i=Je(t,e),s=_e(t,i),l=Ye(i&&i.anchor?i.anchor:e);if(o.parentNode!==l&&l.appendChild(o),o.style.zIndex=Gt(l)?"":"9999",!i){o.style.display="none",a.markers[t.id]={el:o,rect:null,frame:s};return}o.style.display="",Ze(o,i,t),a.markers[t.id]={el:o,rect:i,frame:s}}function _e(t,e){const n=a.markers[t.id];let o=n?n.frame:null;if(t.type!=="screenshot"||!e)return o&&o.parentNode&&o.parentNode.removeChild(o),null;o||(o=document.createElement("div"),o.className="wn-annot-shot-frame wn-annotator");const r=a.markerLayer||document.body;return o.parentNode!==r&&r.appendChild(o),o.style.setProperty("--wn-shot-frame",H(t).base),o.style.left=`${e.x}px`,o.style.top=`${e.y}px`,o.style.width=`${e.w}px`,o.style.height=`${e.h}px`,o}function Je(t,e){var n;if(t.type==="text"){const r=(e?[e]:et(t.id))[0]||document.querySelector(`.uxnote-textmark[data-uxnote-id="${t.id}"]`);if(!r)return null;const i=Zt(r);return i?{x:i.x,y:i.y,w:i.width,h:i.height,anchor:r}:null}if(t.type==="element"){const o=(e&&e.nodeType===1?e:null)||a.elementTargets[t.id]||((n=t.target)!=null&&n.xpath?rt(t.target.xpath):null);if(!o)return null;const r=Zt(o);return r?{x:r.x,y:r.y,w:r.width,h:r.height,anchor:o}:null}if(t.type==="screenshot"){const o=t.rect;return o?{x:o.x-window.scrollX,y:o.y-window.scrollY,w:o.w,h:o.h,anchor:null}:null}return null}function Ze(t,e,n){const o=Yo(n),r=t.offsetParent||document.body,i=r.getBoundingClientRect(),s=i.x+window.scrollX,l=i.y+window.scrollY,c=e.x+window.scrollX,p=e.y+window.scrollY,u=c-s+e.w+o.x+4,h=Gt(r)?document.documentElement.clientWidth:r.clientWidth,m=(t.offsetWidth||25)/2;t.style.left=`${h?Math.min(u,h-m-2):u}px`,t.style.top=`${p-l+o.y-4}px`}function Yo(t){if(t.type!=="element")return{x:0,y:0};const e=t.target&&t.target.xpath;if(!e)return{x:0,y:0};const n=a.annotations.filter(i=>i.type==="element"&&i.pageKey===t.pageKey&&i.target&&i.target.xpath===e);if(n.length<=1)return{x:0,y:0};const o=n.findIndex(i=>i.id===t.id);return o<=0?{x:0,y:0}:{x:-o*24,y:0}}function M(){Object.entries(a.markers).forEach(([t,e])=>{const n=a.annotations.find(i=>i.id===t);if(!n)return;const o=n.status==="missing"?null:Je(n);if(e.frame=_e(n,o),!o){e.el.style.display="none",e.rect=null;return}e.el.style.display="",e.rect=o;const r=Ye(o.anchor);e.el.parentNode!==r&&r.appendChild(e.el),e.el.style.zIndex=Gt(r)?"":"9999",Ze(e.el,o,n),Ie(e.el,H(n))})}function Xo(){a.panel&&a.panel.style.display==="none"&&mt(!0)}function qo(t){if(!a.panel)return;Xo();const e=a.panel.querySelector(".wn-annot-list");if(!e)return;e.querySelectorAll(".wn-annot-item").forEach(r=>r.classList.remove("is-focused"));const o=e.querySelector(`.wn-annot-item[data-id="${t}"]`);o&&(o.classList.add("is-focused"),o.scrollIntoView({behavior:"smooth",block:"nearest"}))}function lt(t,e=!1,n,o){var l;const r=a.annotations.find(c=>c.id===t);if(!r)return;if(qo(t),r.status==="missing"){const c=st(r);if(c)r.status="active",ee(r,c),T();else{P("This annotation is not on this page.");return}}const i=st(r);if(i){const c=i.type==="element"?i.el:i.range&&i.range.commonAncestorContainer?i.range.commonAncestorContainer.parentElement:null;c&&Po(c)&&setTimeout(()=>{M()},160)}if(!((o||r.pageKey)===L(window.location.href))&&e){try{localStorage.setItem(At,JSON.stringify({id:r.id,pageKey:r.pageKey,pageUrl:n||r.pageUrl}))}catch(c){}window.location.href=n||r.pageUrl||window.location.href;return}if(r.type==="text"){const p=(et(t)||Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)))[0];p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),oe(p,H(r).base))}else if(r.type==="element"){const c=i&&i.el?i.el:(l=r.target)!=null&&l.xpath?rt(r.target.xpath):null;c&&c.scrollIntoView&&(c.scrollIntoView({behavior:"smooth",block:"center"}),oe(c,H(r).base))}else if(r.type==="screenshot"&&r.rect){window.scrollTo({top:Math.max(0,r.rect.y+r.rect.h/2-window.innerHeight/2),behavior:"smooth"});const c=a.markers[r.id];c&&c.frame&&oe(c.frame,H(r).base)}}function oe(t,e){var i,s;t.style.transition="box-shadow 0.2s ease";const n=t.style.boxShadow,o=e||((s=(i=a.colors)==null?void 0:i.element)==null?void 0:s.base)||"#4e9cf6",r=S(o,.6,"rgba(78,156,246,0.6)");t.style.boxShadow=`0 0 0 3px ${r}`,setTimeout(()=>{t.style.boxShadow=n},800)}function Ge(){if(!a.panel)return null;let t=a.panel.querySelector(".wn-annot-footer");if(!t){t=document.createElement("div"),t.className="wn-annot-footer wn-annotator";const e=document.createElement("a");e.href="https://github.com/Qu4tro/uxnote-fork",e.target="_blank",e.rel="noreferrer noopener",e.textContent="uxnote-fork on GitHub",t.appendChild(e),a.panel.appendChild(t)}return t}function T(){const t=a.panel.querySelector(".wn-annot-list"),e=a.panel.querySelector("h3");if(t.innerHTML="",!a.annotations.length){const o=document.createElement("div");o.className="wn-annot-empty",o.textContent="No annotations yet.",t.appendChild(o),e&&(e.textContent="Annotations (0)");const r=Ge();return}const n=a.annotations.slice().sort((o,r)=>o.createdAt-r.createdAt).filter(o=>{const r=a.filters.query,i=`${o.comment||""} ${o.snippet||""}`.toLowerCase();return!r||i.includes(r)});e&&(e.textContent=`Annotations (${n.length})`),n.forEach((o,r)=>{const i=document.createElement("div");i.className="wn-annot-item",i.dataset.id=o.id,io(i,H(o));const s=document.createElement("div");s.className="wn-annot-card-top";const l=document.createElement("div");l.className="wn-annot-card-top-left";const c=document.createElement("div");if(c.className="wn-annot-number",c.textContent=`#${r+1}`,l.appendChild(c),o.status==="missing"){const g=document.createElement("div");g.className="wn-annot-missing",g.textContent="Missing",l.appendChild(g)}const p=document.createElement("div");p.className="wn-annot-card-top-right";const u=document.createElement("button");u.type="button",u.className="wn-annot-edit wn-annotator",u.setAttribute("aria-label","Edit this annotation"),u.innerHTML=ia(),u.addEventListener("click",async g=>{g.stopPropagation(),await _o(o.id)}),p.appendChild(u);const h=document.createElement("button");h.type="button",h.className="wn-annot-delete wn-annotator",h.setAttribute("aria-label","Delete this annotation"),h.innerHTML=an(),h.addEventListener("click",g=>{g.stopPropagation(),Wo(o.id)}),p.appendChild(h),s.appendChild(l),s.appendChild(p);const m=document.createElement("div");m.className="wn-annot-comment";const b=o.comment||"\u2014";m.textContent=b;const Q=document.createElement("div");Q.className="wn-annot-meta";const f=new Date(o.createdAt),x=f.toLocaleDateString(void 0,{year:"numeric",month:"2-digit",day:"2-digit"}),E=f.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});Q.textContent=`${x} \u2022 ${E}`,l.appendChild(Q);const $=document.createElement("button");$.type="button",$.className="wn-annot-showmore wn-annotator",$.textContent="See more",$.addEventListener("click",g=>{g.stopPropagation();const y=m.classList.toggle("expanded");$.textContent=y?"See less":"See more"}),b.length<160&&($.style.display="none"),i.appendChild(s),i.appendChild(m);const pt=Ca(o);if(pt){const g=document.createElement("div");g.className="wn-annot-shot";const y=document.createElement("img");y.src=pt,y.alt="The screenshot of this annotation",y.addEventListener("click",Tt=>{Tt.stopPropagation(),Ea(pt)}),g.appendChild(y),i.appendChild(g)}i.appendChild($),i.addEventListener("click",()=>{lt(o.id,!0,o.pageUrl,o.pageKey),I()&&mt(!1)}),t.appendChild(i)}),Ge()}function Wo(t){const e=a.annotations.findIndex(n=>n.id===t);e!==-1&&(a.annotations.splice(e,1),A(),Qo(t),T(),V(),M())}async function _o(t){const e=a.annotations.find(r=>r.id===t);if(!e)return;const n=await Te("Edit this annotation",e.comment||"");if(!n)return;const{comment:o}=n;e.comment=o.trim(),A(),T()}async function Jo(){!a.annotations.length||!await Jn("Delete all annotations?","Delete")||(a.annotations=[],k?ma():A(),nt(),T(),V())}function tn(){const t=ae(),e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),o=document.createElement("a");o.href=n,o.download=re(),o.click(),URL.revokeObjectURL(n)}async function Zo(){const t=re(),e=JSON.stringify(ae(),null,2);if(navigator.share&&navigator.canShare&&typeof File=="function"){const n=new File([e],t,{type:"application/json"});try{if(navigator.canShare({files:[n]})){await navigator.share({files:[n],title:t});return}}catch(o){if(o&&o.name==="AbortError")return}}tn()}function ae(t=a.annotations){return{pageUrl:window.location.href,createdAt:Date.now(),annotations:t}}async function Go(){ta(a.annotations)}function ta(t){const e=ae(t),n=JSON.stringify(e,null,2),o=encodeURIComponent(re()),r=encodeURIComponent(n),i=(En||"").trim(),s=i?encodeURIComponent(i):"",l="?";window.location.href=`mailto:${s}${l}subject=${o}&body=${r}`}function yt(){return"wn-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function en(){return"imp-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function re(){const t=new Date,e=l=>String(l).padStart(2,"0"),n=`${e(t.getDate())}-${e(t.getMonth()+1)}-${t.getFullYear()}`,o=`${e(t.getHours())}-${e(t.getMinutes())}`,r=(document.title||"").trim(),i=l=>l.toLowerCase().replace(/[^a-z0-9]+/gi,"-").replace(/^-+|-+$/g,"")||"annotations";let s;return r?s=`${i(r)}-annotations`:window.location&&window.location.hostname?s=`${i(window.location.hostname)}-annotations`:s="annotations",`${s}_${n}_${o}.json`}const N=t=>`
  ...
  `;function ea(){return`
    ...
    `)}function ln(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function la(){return v==="top"?sn():ln()}function cn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function L(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function dn(){try{const t=localStorage.getItem(At);if(!t)return;const e=JSON.parse(t);e.pageKey===L(window.location.href)&&lt(e.id,!1),localStorage.removeItem(At)}catch(t){}}let R=new Map,ie=Promise.resolve(),Y=!1;const da={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes stay in this browser"};function pn(){const t=a.syncDot;if(!t)return;const e=a.syncStatus||"pending",n=da[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function vt(t){a.syncStatus!==t&&(a.syncStatus=t,pn())}async function ct(t,e){let n;try{n=await fetch(t,e)}catch(o){throw vt("unreachable"),o}if(!n.ok)throw vt("refused"),new Error(`HTTP ${n.status}`);return vt("ok"),n}function un(){return`${k.url}/annotations?site=${encodeURIComponent(C)}`}function hn(t){return`${k.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function pa(t){return`${k.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function dt(t){const e=Object.assign({},t);return k.apiKey&&(e["X-Uxnote-Key"]=k.apiKey),e}function se(t){return new Map(t.map(e=>[e.id,JSON.stringify(e)]))}function kt(t,e){console.warn("Uxnote sync:",t,e),!Y&&(Y=!0,P(t))}function Ct(t){return ie=ie.then(t,t),ie}async function le(){if(k)try{const t=await ct(un(),{headers:dt({Accept:"application/json"})});let e;try{e=await t.json()}catch(n){throw vt("refused"),n}a.annotations=(e&&e.annotations||[]).filter(jt),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))}),R=se(a.annotations),Y=!1,nt(),it(),V(),T(),dn()}catch(t){kt("Uxnote: could not read the annotations from the server",t)}}function ce(){if(!k)return;const t=se(a.annotations);t.forEach((e,n)=>{R.get(n)!==e&&Ct(()=>fn(n,e))}),R.forEach((e,n)=>{t.has(n)||Ct(()=>wn(n))})}async function ua(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),r=await yn(o,t.id,{rethrow:!0});if(!r)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:r.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}function ha(){k&&(window.addEventListener("online",()=>ce()),document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&mn()}),window.addEventListener("pagehide",mn))}function mn(){if(!k)return;const t=se(a.annotations);t.forEach((e,n)=>{R.get(n)!==e&&fn(n,e,{keepalive:!0})}),R.forEach((e,n)=>{t.has(n)||wn(n,{keepalive:!0})})}async function fn(t,e,n={}){try{const o=a.annotations.find(r=>r.id===t);o&&o.screenshot&&o.screenshot.dataUrl&&(await ua(o),e=JSON.stringify(o)),await ct(hn(t),{method:"PUT",headers:dt({"Content-Type":"application/json"}),keepalive:!!n.keepalive,body:e}),R.set(t,e),Y=!1}catch(o){kt("Uxnote: could not save this annotation on the server",o)}}async function wn(t,e={}){try{await ct(hn(t),{method:"DELETE",headers:dt(),keepalive:!!e.keepalive}),R.delete(t),Y=!1}catch(n){kt("Uxnote: could not delete this annotation on the server",n)}}function ma(){k&&Ct(async()=>{try{await ct(un(),{method:"DELETE",headers:dt()}),R=new Map,Y=!1}catch(t){kt("Uxnote: could not delete the annotations on the server",t)}})}let Et=null,gn=L(window.location.href);function fa(){Et=null;const t=L(window.location.href);t!==gn&&(gn=t,nt(),it(),V(),T(),Ct(le))}function xn(){Et&&clearTimeout(Et),Et=setTimeout(fa,120)}function wa(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const r=e.apply(this,o);return xn(),r})}),window.addEventListener("popstate",xn)}function bn(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function ga(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=f=>{const x=!!f&&f.w>=4&&f.h>=4;n.style.display=x?"block":"none",x&&(n.style.left=`${f.x}px`,n.style.top=`${f.y}px`,n.style.width=`${f.w}px`,n.style.height=`${f.h}px`)};s(null);const l=f=>({x:Math.min(Math.max(f.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(f.clientY,0),document.documentElement.clientHeight)}),c=(f,x)=>({x:Math.min(f.x,x.x),y:Math.min(f.y,x.y),w:Math.abs(x.x-f.x),h:Math.abs(x.y-f.y)});let p=null;const u=f=>{f.preventDefault(),p=l(f),s(null)},h=f=>{p&&(f.preventDefault(),s(c(p,l(f))))},m=f=>{if(!p)return;const x=c(p,l(f));if(p=null,x.w<4||x.h<4){s(null);return}b({x:x.x+window.scrollX,y:x.y+window.scrollY,w:x.w,h:x.h})},b=f=>{document.removeEventListener("keydown",Q,!0),document.removeEventListener("mousemove",h,!0),document.removeEventListener("mouseup",m,!0),e.remove(),o.remove(),t(f)},Q=f=>{f.key==="Escape"&&(f.preventDefault(),b(null))};e.addEventListener("mousedown",u),i.addEventListener("click",()=>b(null)),document.addEventListener("mousemove",h,!0),document.addEventListener("mouseup",m,!0),document.addEventListener("keydown",Q,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function xa(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const u=document.createElement("canvas");return u.width=c,u.height=p,u.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:u,w:c,h:p}}function ba(){const t=document.documentElement;return{x:window.scrollX,y:window.scrollY,w:t.clientWidth,h:t.clientHeight}}const ya=2e4;function va(t){const e=xa(t).then(o=>({shot:o}),o=>(console.warn("Uxnote screenshot:",o),{shot:null})),n=new Promise(o=>{setTimeout(()=>o({shot:null,timedOut:!0}),ya)});return Promise.race([e,n])}async function ka(){if(!(!bn()||a.mode==="screenshot")){j("screenshot");try{const t=F()?ba():await ga();if(!t)return;const e=va(t),n=await Ht("Comment for this region?");if(!n)return;const{shot:o,timedOut:r}=await e;if(!o){P(r?"Uxnote: the page took too long to capture":"Uxnote: could not capture that region");return}const{comment:i}=n,s=yt();let l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(k){const p=await new Promise(h=>o.canvas.toBlob(h,"image/png")),u=p?await yn(p,s):null;u?l={url:u.url,w:o.w,h:o.h,capturedAt:Date.now()}:P("Uxnote: the picture stays on this device until the server answers")}const c={id:s,type:"screenshot",comment:i.trim(),snippet:"",pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(c),A(),K(c,null),T()}finally{j(null)}}}async function yn(t,e,n={}){try{const r=await(await ct(pa(e),{method:"PUT",headers:dt({"Content-Type":"image/png"}),body:t})).json();return r&&r.url?r:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function Ca(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=k?new URL(`${k.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function Ea(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=document.createElement("button");o.type="button",o.className="wn-shot-lightbox-close wn-annotator",o.setAttribute("aria-label","Close the screenshot"),o.innerHTML=rn(),e.appendChild(o);const r=()=>{document.removeEventListener("keydown",i,!0),e.remove()},i=s=>{s.key==="Escape"&&(s.preventDefault(),r())};o.addEventListener("click",r),e.addEventListener("click",r),document.addEventListener("keydown",i,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ye):ye(),window.Uxnote={refresh:M,setHidden:t=>gt(!!t),toggleVisibility:()=>gt(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:le,push:ce,url:()=>k?k.url:null}}})();})();
