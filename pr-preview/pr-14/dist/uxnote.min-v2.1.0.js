(()=>{var Ea=Object.defineProperty,Ta=Object.defineProperties;var La=Object.getOwnPropertyDescriptors;var vn=Object.getOwnPropertySymbols;var Qa=Object.prototype.hasOwnProperty,Sa=Object.prototype.propertyIsEnumerable;var kn=(d,w,C)=>w in d?Ea(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,de=(d,w)=>{for(var C in w||(w={}))Qa.call(w,C)&&kn(d,C,w[C]);if(vn)for(var C of vn(w))Sa.call(w,C)&&kn(d,C,w[C]);return d},Cn=(d,w)=>Ta(d,La(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,En=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Et=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Tt=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Tn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Ln=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),pe=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),ue=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),he="#4e9cf6",X=mt(Ln||ue||pe||he,he),Qn=mt(pe||X,X),Sn=mt(ue||X,X),Lt={text:Ft(Qn,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Ft(Sn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Ft(X,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let v=Tt!=null?B(Tt,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const me="wn-toolbar-pos",pt=d&&(d.dataset.dock||d.dataset.layout)||"",fe=`uxnote:site:${C}`,we=`uxnote:import-files:${C}`,ge=`uxnote:hidden:${C}`,Qt=`uxnote:pending:${C}`,xe=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),k=xe?{url:xe,apiKey:d&&d.dataset.serverApiKey||""}:null,St=B(d&&d.dataset.jsonExport,!0),At=B(d&&d.dataset.jsonImport,!0),An=B(d&&d.dataset.mailExport,!0),Mt=(d&&d.dataset.theme||"").trim().toLowerCase(),Nt=Mt==="light"||Mt==="dark"?Mt:"auto",$t=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,It=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,Pt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function F(){return It?It.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return Pt?Pt.matches:window.innerWidth<=640||window.innerHeight<=480}function zt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const Mn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Nn=.2,be=B(Mn,!F()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Lt,customPosition:!1,dimEnabled:be,dimOpacity:be?Nn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function ye(){const t=to();t&&(v=t);const e=eo(),n=Et!=null?!B(Et,!0):null;a.hidden=e!==null?e:n!==null?n:B(Tn,!1),At&&(a.importFiles=io()),ve(),oo(),Ne(),$n(),Rn(),On(),ft(a.hidden),k?le():so(),rt(),ne(),We(),Vo(),k||dn(),Jn()}function ve(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function $n(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}const In=["commentModal","dialogModal"];function Rt(t,e){const n=document.createElement("div");n.className="wn-annot-sheet-grip wn-annotator";const o=document.createElement("span");o.className="wn-annot-sheet-handle wn-annotator",o.setAttribute("aria-hidden","true");const r=document.createElement("button");return r.type="button",r.className="wn-annot-sheet-close wn-annotator",r.setAttribute("aria-label",t),r.innerHTML=rn(),r.addEventListener("click",i=>{i.stopPropagation(),e()}),n.appendChild(o),n.appendChild(r),Pn(n,e),n}function Pn(t,e){let n=null,o=0,r=0,i=0;const s=c=>{n&&(i=Math.max(0,c.clientY-o),n.style.transform=`translateY(${i}px)`)},l=()=>{if(!n)return;t.removeEventListener("pointermove",s),t.removeEventListener("pointerup",l),t.removeEventListener("pointercancel",l);const c=n.getBoundingClientRect().height||1,p=i/Math.max(1,Date.now()-r);n.style.transform="",n.style.transition="",n=null,(i>c/3||i>40&&p>.5)&&e()};t.addEventListener("pointerdown",c=>{c.target.closest(".wn-annot-sheet-close")||(n=t.closest(".wn-annot-sheet"),n&&(o=c.clientY,r=Date.now(),i=0,n.style.transition="none",t.setPointerCapture&&t.setPointerCapture(c.pointerId),t.addEventListener("pointermove",s),t.addEventListener("pointerup",l),t.addEventListener("pointercancel",l)))})}function zn(){return a.hidden||!I()?!1:a.panel&&a.panel.style.display!=="none"?!0:In.some(t=>{const e=a[t];return e&&e.backdrop.classList.contains("show")})}function O(){const t=zn();if(t===!!a.scrollLocked)return;const e=document.documentElement;a.scrollLocked=t,t?(a.scrollLockPrev=e.style.overflow,e.style.overflow="hidden"):(e.style.overflow=a.scrollLockPrev||"",a.scrollLockPrev="")}function D(){const t=document.documentElement,e=(i,s)=>{t.style.setProperty("--wn-sheet-bottom",`${i}px`),t.style.setProperty("--wn-sheet-top-guard",`${s}px`)};if(!a.toolbar||!I()||a.hidden){e(0,0);return}const n=a.toolbar.getBoundingClientRect(),o=8,r=t.clientHeight;if(v==="top"){e(0,Math.max(0,Math.round(n.bottom+o)));return}e(Math.max(0,Math.round(r-n.top+o)),0)}function ut(t){a.panel&&(a.panel.style.display=t?"":"none",Vt(),O())}function ke(){const t=a.toolbar;if(!t)return;const e=I(),n=h=>{const m=document.createElement("button");return m.className="wn-annot-btn wn-annotator",m.setAttribute("data-action",h.action),h.mode&&m.setAttribute("data-mode",h.mode),m.setAttribute("data-tip",h.tip),m.innerHTML=h.icon,m},o=h=>{const m=document.createElement("div");return m.className="wn-annot-group wn-annotator",h.forEach(b=>m.appendChild(n(b))),m},r=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},i=a.visibilityToggle;i&&i.parentNode===t&&t.removeChild(i),t.innerHTML="";const s=document.createDocumentFragment(),l=document.createElement("div");if(l.className="wn-annot-logo wn-annotator",l.innerHTML=ta(),s.appendChild(l),k){const h=document.createElement("div");h.className="wn-annot-sync-dot wn-annotator",h.setAttribute("role","status"),s.appendChild(h),a.syncDot=h,pn()}const c=[{action:"mode",mode:"text",tip:"Highlight text",icon:nn()},{action:"mode",mode:"element",tip:"Annotate an element",icon:ea()}];bn()&&c.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:aa()});const p=[];At&&!e&&p.push({action:"import",tip:"Import JSON",icon:na()}),St&&!e&&p.push({action:"export",tip:"Export JSON",icon:on()}),An&&!e&&p.push({action:"mail",tip:"Send by mail",icon:oa()});const u=[];e||u.push({action:"toggle-pos",tip:"Toolbar top / bottom",icon:sa()}),u.push({action:"toggle-panel",tip:"Show / hide annotations",icon:ia()}),s.appendChild(r()),s.appendChild(o(c)),p.length&&(s.appendChild(r()),s.appendChild(o(p))),s.appendChild(r()),s.appendChild(o(u)),t.appendChild(s),Kt(),Bt(),Vt(),Ot()}function Ce(){ke(),_(),J(),z(),q(),Z(),D(),Ue(),O(),M()}function Rn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${v}`,document.body.appendChild(t),a.toolbar=t,ke();const e=document.createElement("div");e.className="wn-annot-panel wn-annot-sheet wn-annotator",e.innerHTML=`
  ...
  `;function ta(){return`
    ...
    `)}function ra(){return nn()}function an(){return`
    ...
    `)}function ln(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function sa(){return v==="top"?sn():ln()}function cn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
