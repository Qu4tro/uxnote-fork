(()=>{var Va=Object.defineProperty,Ka=Object.defineProperties;var Xa=Object.getOwnPropertyDescriptors;var Pn=Object.getOwnPropertySymbols;var Ya=Object.prototype.hasOwnProperty,qa=Object.prototype.propertyIsEnumerable;var On=(d,w,C)=>w in d?Va(d,w,{enumerable:!0,configurable:!0,writable:!0,value:C}):d[w]=C,xe=(d,w)=>{for(var C in w||(w={}))Ya.call(w,C)&&On(d,C,w[C]);if(Pn)for(var C of Pn(w))qa.call(w,C)&&On(d,C,w[C]);return d},Hn=(d,w)=>Ka(d,Xa(w));(()=>{if(window.Uxnote)return;const d=document.currentScript||Array.from(document.querySelectorAll("script")).find(t=>(t.getAttribute("src")||"").includes("annotator.js")),w=t=>d?d.getAttribute(t):null,C=`${location.protocol}//${location.host}`,zn=d&&(d.dataset.mailto||d.dataset.email||d.dataset.to)||"",Pt=w("isToolVisibleAtFirstLaunch")||w("istoolvisibleatfirstlaunch")||d&&(d.dataset.isToolVisibleAtFirstLaunch||d.dataset.istoolvisibleatfirstlaunch),Ot=w("isToolOnTopAtLaunch")||w("istoolontopatlaunch")||d&&(d.dataset.isToolOnTopAtLaunch||d.dataset.istoolontopatlaunch),Rn=d&&(d.dataset.hiddentoolbydefault||d.dataset.hidden||d.dataset.collapsed||d.dataset.startHidden||""),Bn=w("colorForHighlight")||w("colorForHighligh")||d&&(d.dataset.colorForHighlight||d.dataset.colorForHighligh),be=w("colorForTextHighligh")||w("colorForTextHighlight")||d&&(d.dataset.colorForTextHighligh||d.dataset.colorForTextHighlight),ye=w("colorForElementHighlight")||w("colorForElementHighligh")||d&&(d.dataset.colorForElementHighlight||d.dataset.colorForElementHighligh),ve="#4e9cf6",W=bt(Bn||ye||be||ve,ve),Un=bt(be||W,W),Fn=bt(ye||W,W),Ht={text:Wt(Un,{overlayAlpha:.7,softAlpha:.18,softerAlpha:.08}),element:Wt(Fn,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04}),screenshot:Wt(W,{overlayAlpha:.35,softAlpha:.12,softerAlpha:.04})};let k=Ot!=null?U(Ot,!1)?"top":"bottom":d&&d.dataset.position||"bottom";const ke="wn-toolbar-pos",ft=d&&(d.dataset.dock||d.dataset.layout)||"",zt=`uxnote:site:${C}`,Ce=`${zt}:synced`,Ee=`uxnote:import-files:${C}`,Te=`uxnote:hidden:${C}`,Rt=`uxnote:pending:${C}`,Le=(d&&d.dataset.serverUrl||"").trim().replace(/\/+$/,""),b=Le?{url:Le,apiKey:d&&d.dataset.serverApiKey||""}:null,Bt=U(d&&d.dataset.jsonExport,!0),Ut=U(d&&d.dataset.jsonImport,!0),Dn=U(d&&d.dataset.mailExport,!0),wt=(d&&d.dataset.theme||"").trim().toLowerCase(),J=wt==="light"||wt==="dark"||wt==="reverse-auto"?wt:"auto",jn=J==="auto"||J==="reverse-auto",Ft=window.matchMedia?window.matchMedia("(prefers-color-scheme: dark)"):null,Dt=window.matchMedia?window.matchMedia("(pointer: coarse) and (hover: none)"):null,jt=window.matchMedia?window.matchMedia("(max-width: 640px), (max-height: 480px)"):null;function D(){return Dt?Dt.matches:"ontouchstart"in window||navigator.maxTouchPoints>0}function I(){return jt?jt.matches:window.innerWidth<=640||window.innerHeight<=480}function Vt(t,e){t&&(t.addEventListener?t.addEventListener("change",e):t.addListener&&t.addListener(e))}const Vn=w("isBackdropVisible")||w("isbackdropvisible")||w("backdropVisible")||w("backdropvisible")||d&&(d.dataset.isBackdropVisible||d.dataset.isbackdropvisible||d.dataset.backdropVisible||d.dataset.backdropvisible||d.dataset.dim||d.dataset.dimpage||d.dataset.dimmer||d.dataset.overlay||d.dataset.dimLevel||d.dataset.dimlevel||d.dataset.dimstrength),Kn=.2,Se=U(Vn,!D()),a={mode:null,annotations:[],importFiles:[],markers:{},highlightSpans:{},elementTargets:{},outlineBox:null,selectionBar:null,selectionTimer:null,selectionRange:null,elementPicker:null,elementTrail:[],elementTrailIndex:0,toolbar:null,panel:null,visibilityToggle:null,commentModal:null,dialogModal:null,importModal:null,markerLayer:null,syncDot:null,syncStatus:null,colors:Ht,customPosition:!1,dimEnabled:Se,dimOpacity:Se?Kn:0,dimOverlay:null,filters:{query:""},hidden:!1,missingObserver:null,missingRetryTimer:null,layoutObserver:null,layoutTimer:null,toast:null,toastTimer:null};function Ae(){const t=fo();t&&(k=t);const e=wo(),n=Pt!=null?!U(Pt,!0):null;a.hidden=e!==null?e:n!==null?n:U(Rn,!1),Ut&&(a.importFiles=vo()),Qe(),xo(),Be(),Xn(),Wn(),Jn(),vt(a.hidden),ko(),b&&!Aa()&&(a.annotations=[]),ct(),pe(),on(),aa(),b||fe(),b&&(z(Mt),Ma()),uo()}function Qe(){const t=getComputedStyle(document.body);a.basePadding={top:parseFloat(t.paddingTop)||0,right:parseFloat(t.paddingRight)||0,bottom:parseFloat(t.paddingBottom)||0,left:parseFloat(t.paddingLeft)||0}}function Xn(){const t=document.createElement("style");t.setAttribute("data-wn-style","annotator"),t.textContent=`
    ...
    `,document.head.appendChild(t)}const Yn=["commentModal","dialogModal"];function Kt(t,e){const n=document.createElement("div");n.className="wn-annot-sheet-grip wn-annotator";const o=document.createElement("span");o.className="wn-annot-sheet-handle wn-annotator",o.setAttribute("aria-hidden","true");const r=document.createElement("button");return r.type="button",r.className="wn-annot-sheet-close wn-annotator",r.setAttribute("aria-label",t),r.innerHTML=mn(),r.addEventListener("click",i=>{i.stopPropagation(),e()}),n.appendChild(o),n.appendChild(r),qn(n,e),n}function qn(t,e){let n=null,o=0,r=0,i=0;const s=c=>{n&&(i=Math.max(0,c.clientY-o),n.style.transform=`translateY(${i}px)`)},l=()=>{if(!n)return;t.removeEventListener("pointermove",s),t.removeEventListener("pointerup",l),t.removeEventListener("pointercancel",l);const c=n.getBoundingClientRect().height||1,p=i/Math.max(1,Date.now()-r);n.style.transform="",n.style.transition="",n=null,(i>c/3||i>40&&p>.5)&&e()};t.addEventListener("pointerdown",c=>{c.target.closest(".wn-annot-sheet-close")||(n=t.closest(".wn-annot-sheet"),n&&(o=c.clientY,r=Date.now(),i=0,n.style.transition="none",t.setPointerCapture&&t.setPointerCapture(c.pointerId),t.addEventListener("pointermove",s),t.addEventListener("pointerup",l),t.addEventListener("pointercancel",l)))})}function _n(){return a.hidden||!I()?!1:a.panel&&a.panel.style.display!=="none"?!0:Yn.some(t=>{const e=a[t];return e&&e.backdrop.classList.contains("show")})}function R(){const t=_n();if(t===!!a.scrollLocked)return;const e=document.documentElement;a.scrollLocked=t,t?(a.scrollLockPrev=e.style.overflow,e.style.overflow="hidden"):(e.style.overflow=a.scrollLockPrev||"",a.scrollLockPrev="")}function j(){const t=document.documentElement,e=(i,s)=>{t.style.setProperty("--wn-sheet-bottom",`${i}px`),t.style.setProperty("--wn-sheet-top-guard",`${s}px`)};if(!a.toolbar||!I()||a.hidden){e(0,0);return}const n=a.toolbar.getBoundingClientRect(),o=8,r=t.clientHeight;if(k==="top"){e(0,Math.max(0,Math.round(n.bottom+o)));return}e(Math.max(0,Math.round(r-n.top+o)),0)}function gt(t){a.panel&&(a.panel.style.display=t?"":"none",Gt(),R())}function Me(){const t=a.toolbar;if(!t)return;const e=I(),n=h=>{const m=document.createElement("button");return m.className="wn-annot-btn wn-annotator",m.setAttribute("data-action",h.action),h.mode&&m.setAttribute("data-mode",h.mode),m.setAttribute("data-tip",h.tip),m.innerHTML=h.icon,m},o=h=>{const m=document.createElement("div");return m.className="wn-annot-group wn-annotator",h.forEach(y=>m.appendChild(n(y))),m},r=()=>{const h=document.createElement("div");return h.className="wn-annot-spacer wn-annotator",h},i=a.visibilityToggle;i&&i.parentNode===t&&t.removeChild(i),t.innerHTML="";const s=document.createDocumentFragment(),l=document.createElement("div");if(l.className="wn-annot-logo wn-annotator",l.innerHTML=ma(),s.appendChild(l),b){const h=document.createElement("div");h.className="wn-annot-sync-dot wn-annotator",h.setAttribute("role","status"),s.appendChild(h),a.syncDot=h,vn()}const c=[{action:"mode",mode:"text",tip:"Highlight text",icon:pn()},{action:"mode",mode:"element",tip:"Annotate an element",icon:fa()}];$n()&&c.push({action:"mode",mode:"screenshot",tip:"Capture a region",icon:xa()});const p=[];Ut&&!e&&p.push({action:"import",tip:"Import JSON",icon:wa()}),Bt&&!e&&p.push({action:"export",tip:"Export JSON",icon:un()}),Dn&&!e&&p.push({action:"mail",tip:"Send by mail",icon:ga()});const u=[];e||u.push({action:"toggle-pos",tip:"Toolbar top / bottom",icon:va()}),u.push({action:"toggle-panel",tip:"Show / hide annotations",icon:ya()}),s.appendChild(r()),s.appendChild(o(c)),p.length&&(s.appendChild(r()),s.appendChild(o(p))),s.appendChild(r()),s.appendChild(o(u)),t.appendChild(s),te(),qt(),Gt(),Xt()}function Ne(){Me(),tt(),et(),H(),Z(),nt(),j(),qe(),R(),M()}function Wn(){const t=document.createElement("div");t.className=`wn-annot-toolbar wn-annotator wn-pos-${k}`,document.body.appendChild(t),a.toolbar=t,Me();const e=document.createElement("div");e.className="wn-annot-panel wn-annot-sheet wn-annotator",e.innerHTML=`
      <div class="wn-annot-panel-head wn-annotator">
        <div class="wn-annot-panel-top wn-annotator">
          ...
          <div class="wn-annot-panel-tools wn-annotator">
            ${Bt?`<button class="wn-annot-panel-export wn-annotator" type="button">${un()}<span>Export</span></button>`:""}
    ...
    `,k==="left"&&(e.style.left="18px",e.style.right="auto"),document.body.appendChild(e),a.panel=e,e.style.display="none";const n=e.querySelector(".wn-annot-delete-all");n&&n.addEventListener("click",async c=>{c.stopPropagation(),await da()});const o=e.querySelector(".wn-annot-panel-head");o&&o.insertBefore(Kt("Close the annotations",()=>gt(!1)),o.firstChild);const r=e.querySelector(".wn-annot-panel-export");r&&r.addEventListener("click",c=>{c.stopPropagation(),Pe()});const i=document.createElement("div");i.className="wn-annot-marker-layer wn-annotator",document.body.appendChild(i),a.markerLayer=i;const s=document.createElement("div");s.className="wn-annot-outline wn-annotator",s.style.display="none",document.body.appendChild(s),a.outlineBox=s;const l=document.createElement("div");l.className="wn-annot-tip wn-annotator",l.textContent="Active mode",document.body.appendChild(l),a.tip=l,t.addEventListener("click",Co),T(),nt(),j(),et(),H(),Gt(),ho(),Zn()}function $e(){a.dimOverlay&&a.dimOverlay.classList.toggle("is-visible",!a.hidden)}function Jn(){if(!a.dimEnabled||a.dimOverlay)return;const t=document.createElement("div");t.className="wn-annot-dimmer",t.setAttribute("aria-hidden","true"),t.style.setProperty("--wn-dim-opacity",String(a.dimOpacity));const e=document.body.firstChild;e?document.body.insertBefore(t,e):document.body.appendChild(t),a.dimOverlay=t,$e()}function Xt(){if(!a.visibilityToggle)return;const t=a.visibilityToggle,n=I()&&a.toolbar&&!a.hidden?a.toolbar:document.body;t.parentNode!==n&&(t.parentNode&&t.parentNode.removeChild(t),n===a.toolbar?a.toolbar.insertBefore(t,a.toolbar.firstChild):document.body.appendChild(t))}function Zn(){if(a.visibilityToggle)return;const t=document.createElement("button");t.type="button",t.className="wn-annot-visibility-btn wn-annotator",t.setAttribute("aria-label","Hide Uxnote"),t.setAttribute("data-tip","Hide Uxnote"),t.innerHTML=gn(),t.addEventListener("click",To),a.visibilityToggle=t,Xt(),tt(),je()}function Gn(){if(a.commentModal)return a.commentModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-comment-card wn-annot-sheet wn-annotator";const n=document.createElement("h4");n.textContent="Add a comment";const o=document.createElement("textarea");o.className="wn-annotator",o.placeholder="Your comment...";const r=document.createElement("div");r.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator",i.textContent="Cancel";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",s.textContent="Save",r.appendChild(i),r.appendChild(s),e.appendChild(Kt("Discard this comment",()=>i.click())),e.appendChild(n),e.appendChild(o),e.appendChild(r),t.appendChild(e),document.body.appendChild(t),a.commentModal={backdrop:t,modal:e,textarea:o,title:n,okBtn:s,cancelBtn:i},a.commentModal}function Z(){const t=a.commentModal;if(!t||!a.toolbar||!t.backdrop.classList.contains("show"))return;const e=t.modal;if(I()){e.style.left="",e.style.top="",e.style.bottom="";return}const n=a.toolbar.getBoundingClientRect(),o=.75*(parseFloat(getComputedStyle(e).fontSize)||16);e.style.left=`${n.left+n.width/2}px`,k==="top"?(e.style.top=`${n.bottom+o}px`,e.style.bottom=""):(e.style.top="",e.style.bottom=`${window.innerHeight-n.top+o}px`)}function Ie(t,e=""){return new Promise(n=>{const o=Gn(),{backdrop:r,textarea:i,title:s,okBtn:l,cancelBtn:c}=o;s.textContent=t||"Add a comment",i.value=e||"",i.placeholder="Your comment...",r.classList.add("show"),Z(),R(),i.focus(),i.select();const p=y=>{r.classList.remove("show"),R(),l.removeEventListener("click",u),c.removeEventListener("click",h),document.removeEventListener("keydown",m),window.removeEventListener("resize",Z),n(y)},u=()=>{p({comment:i.value.trim()})},h=()=>p(null),m=y=>{y.key==="Escape"&&p(null),y.key==="Enter"&&!(y.shiftKey||y.altKey)&&(y.preventDefault(),u())};l.textContent="Save",c.textContent="Cancel",l.addEventListener("click",u),c.addEventListener("click",h),document.addEventListener("keydown",m),window.addEventListener("resize",Z)})}async function Yt(t){const e=await Ie(t);return e||null}function Pe(){if(Bt){if(I()){pa();return}cn()}}function to(){if(a.importModal)return a.importModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annotator wn-annot-import-modal";const n=document.createElement("h4");n.textContent="Import JSON files";const o=document.createElement("div");o.className="wn-annot-import-body wn-annotator";const r=document.createElement("label");r.className="wn-annot-import-drop wn-annotator";const i=document.createElement("input");i.type="file",i.accept="application/json",i.multiple=!0,i.className="wn-annotator";const s=document.createElement("div"),l=document.createElement("div");l.className="wn-annot-import-drop-title wn-annotator",l.textContent="Drop JSON files here";const c=document.createElement("div");c.className="wn-annot-import-drop-sub wn-annotator",c.textContent="or click to select files",s.appendChild(l),s.appendChild(c),r.appendChild(i),r.appendChild(s);const p=document.createElement("div");p.className="wn-annot-import-panel wn-annotator";const u=document.createElement("div");u.className="wn-annot-import-title-row wn-annotator";const h=document.createElement("h5");h.textContent="Loaded files";const m=document.createElement("span");m.className="wn-annot-import-count wn-annotator",m.textContent="0";const y=document.createElement("p");y.textContent="Files are saved automatically.";const S=document.createElement("div");S.className="wn-annot-import-list wn-annotator",u.appendChild(h),u.appendChild(m),p.appendChild(u),p.appendChild(y),p.appendChild(S);const f=document.createElement("div");f.className="wn-annot-actions wn-annotator";const x=document.createElement("button");x.type="button",x.className="wn-annot-pill cancel wn-annotator",x.textContent="Close",f.appendChild(x),o.appendChild(r),o.appendChild(p),e.appendChild(n),e.appendChild(o),e.appendChild(f),t.appendChild(e),document.body.appendChild(t);const E=()=>{t.classList.remove("show"),document.removeEventListener("keydown",$)},$=g=>{g.key==="Escape"&&E()},mt=g=>{g.target===t&&E()};return x.addEventListener("click",E),t.addEventListener("click",mt),["dragenter","dragover"].forEach(g=>{r.addEventListener(g,v=>{v.preventDefault(),v.stopPropagation(),r.classList.add("dragover")})}),["dragleave","drop"].forEach(g=>{r.addEventListener(g,v=>{v.preventDefault(),v.stopPropagation(),r.classList.remove("dragover")})}),r.addEventListener("drop",g=>{var It;const v=(It=g.dataTransfer)==null?void 0:It.files;v&&v.length&&Oe(Array.from(v))}),i.addEventListener("change",g=>{const v=g.target.files;v&&v.length&&Oe(Array.from(v)),i.value=""}),S.addEventListener("click",g=>{const v=g.target.closest("[data-import-remove]");v&&io(v.dataset.importRemove)}),a.importModal={backdrop:t,modal:e,fileInput:i,fileList:S,filesCount:m,onKey:$,close:E},a.importModal}function eo(){if(!Ut)return;const t=to();xt(),t.backdrop.classList.add("show"),document.addEventListener("keydown",t.onKey)}function xt(){if(!a.importModal)return;const{fileList:t,filesCount:e}=a.importModal,{fileCounts:n}=no();if(t.innerHTML="",a.importFiles.length)a.importFiles.forEach(o=>{const r=document.createElement("div");r.className="wn-annot-import-card wn-annotator";const i=document.createElement("div");i.className="wn-annot-import-meta wn-annotator";const s=document.createElement("div");s.className="wn-annot-import-name wn-annotator",s.textContent=o.name;const l=document.createElement("div");l.className="wn-annot-import-sub wn-annotator";const c=n.get(o.id)||0,p=o.pageUrl?` | ${lo(o.pageUrl,36)}`:"";l.textContent=`${c} comments | ${so(o.size)}${p}`,i.appendChild(s),i.appendChild(l);const u=document.createElement("div");u.className="wn-annot-import-actions wn-annotator";const h=document.createElement("div");h.className="wn-annot-import-badge wn-annotator",h.textContent=String(c);const m=document.createElement("button");m.type="button",m.className="wn-annot-import-remove wn-annotator",m.dataset.importRemove=o.id,m.textContent="x",u.appendChild(h),u.appendChild(m),r.appendChild(i),r.appendChild(u),t.appendChild(r)});else{const o=document.createElement("div");o.className="wn-annot-import-empty wn-annotator",o.textContent="No imported files yet.",t.appendChild(o)}e.textContent=String(a.importFiles.length)}function no(){const t=new Map;return a.annotations.forEach(e=>{e.importFileId&&t.set(e.importFileId,(t.get(e.importFileId)||0)+1)}),{fileCounts:t}}async function Oe(t){if(!t||!t.length)return;const e=new Set(a.annotations.map(o=>o.id));let n=0;for(const o of t){const r=await oo(o,e);if(!r)continue;const{fileMeta:i,annotations:s}=r;s.length&&(a.importFiles.push(i),a.annotations.push(...s),n+=s.length)}if(!n){xt();return}O(),De(),rt(),ct(),K(),xt()}async function oo(t,e){let n;try{const c=await t.text();n=JSON.parse(c)}catch(c){return await ze(`Invalid JSON in ${t.name}.`,"Import error"),null}const o=Array.isArray(n)?n:n.annotations;if(!Array.isArray(o))return await ze(`Unsupported JSON format in ${t.name}.`,"Import error"),null;const r=Array.isArray(n)?t.lastModified:n.createdAt,i=Array.isArray(n)?"":n.pageUrl||"",s=dn(),l=o.filter(Zt).map(c=>ao(c,{createdAt:r,pageUrl:i,fileId:s,existingIds:e}));return{fileMeta:{id:s,name:t.name,size:t.size,pageUrl:i,importedAt:Date.now()},annotations:l}}function ao(t,e){const n=t&&typeof t=="object"?t:{},o=n.pageUrl||e.pageUrl||window.location.href,r=ro(n.id,e.existingIds),i=Hn(xe({},n),{id:r,createdAt:n.createdAt||e.createdAt||Date.now(),pageUrl:o,importFileId:e.fileId});return i.pageKey||(i.pageKey=L(o)),i}function ro(t,e){if(t&&!e.has(t))return e.add(t),t;let n;do n=Et();while(e.has(n));return e.add(n),n}function io(t){const e=a.importFiles.filter(n=>n.id!==t);e.length!==a.importFiles.length&&(a.importFiles=e,a.annotations=a.annotations.filter(n=>n.importFileId!==t),O(),De(),rt(),ct(),K(),xt())}function so(t){if(!t)return"0 B";const e=["B","KB","MB","GB"],n=Math.min(Math.floor(Math.log(t)/Math.log(1024)),e.length-1),o=t/Math.pow(1024,n);return`${o.toFixed(o<10&&n>0?1:0)} ${e[n]}`}function lo(t,e){return typeof t!="string"?"":t.length<=e?t:t.slice(0,e-3)+"..."}function co(){if(a.dialogModal)return a.dialogModal;const t=document.createElement("div");t.className="wn-annot-modal-backdrop wn-annotator";const e=document.createElement("div");e.className="wn-annot-modal wn-annot-sheet wn-annotator";const n=document.createElement("h4");n.className="wn-annotator";const o=document.createElement("div");o.className="wn-annot-dialog-message wn-annotator";const r=document.createElement("div");r.className="wn-annot-actions wn-annotator";const i=document.createElement("button");i.type="button",i.className="wn-annot-pill cancel wn-annotator";const s=document.createElement("button");return s.type="button",s.className="wn-annot-pill primary wn-annotator",r.appendChild(i),r.appendChild(s),e.appendChild(Kt("Dismiss",()=>i.click())),e.appendChild(n),e.appendChild(o),e.appendChild(r),t.appendChild(e),document.body.appendChild(t),a.dialogModal={backdrop:t,modal:e,title:n,message:o,okBtn:s,cancelBtn:i},a.dialogModal}function He({title:t="Information",message:e="",okLabel:n="OK",cancelLabel:o="Cancel",dismissOnBackdrop:r=!0}){return new Promise(i=>{const{backdrop:s,title:l,message:c,okBtn:p,cancelBtn:u}=co();l.textContent=t,c.textContent=e,p.textContent=n;const h=!!o;u.style.display=h?"inline-flex":"none",u.textContent=o||"";const m=E=>{s.classList.remove("show"),R(),p.removeEventListener("click",y),u.removeEventListener("click",S),s.removeEventListener("click",f),document.removeEventListener("keydown",x),i(E)},y=()=>m(!0),S=()=>m(!1),f=E=>{E.target===s&&r&&m(!1)},x=E=>{E.key==="Escape"&&m(!1),(E.metaKey||E.ctrlKey)&&E.key==="Enter"&&y()};p.addEventListener("click",y),u.addEventListener("click",S),s.addEventListener("click",f),document.addEventListener("keydown",x),s.classList.add("show"),R(),p.focus()})}async function po(t,e="Confirmation"){return He({title:e,message:t,okLabel:"Confirm",cancelLabel:"Cancel"})}async function ze(t,e="Information"){await He({title:e,message:t,okLabel:"OK",cancelLabel:null})}function uo(){document.addEventListener("mouseup",ee),document.addEventListener("touchend",ee),document.addEventListener("pointerup",ee),document.addEventListener("selectionchange",No),document.addEventListener("mousemove",So),document.addEventListener("click",Ao,!0),window.addEventListener("resize",M),window.addEventListener("resize",nt),window.addEventListener("resize",et),window.addEventListener("resize",j),window.addEventListener("resize",H),window.addEventListener("resize",tt),window.addEventListener("resize",qe),window.addEventListener("scroll",M,{passive:!0}),$a(),Oa(),Vt(Dt,Ne),Vt(jt,Ne),jn&&Vt(Ft,Be)}function ho(){if(!a.panel)return;const t=a.panel.querySelector("#wn-filter-search");if(!t)return;t.value=a.filters.query;const e=()=>{a.filters.query=t.value.trim().toLowerCase(),T()};t.addEventListener("input",e)}function V(t,e={}){const n=e.keepOutline;if(a.mode===t){a.mode=null,qt(),G(),Re(),n||it();return}a.mode=t,qt(),_t(t),Re(),t!=="element"&&it()}function Re(){a.selectionTimer&&(clearTimeout(a.selectionTimer),a.selectionTimer=null),ot(),Ze()}function qt(){a.toolbar.querySelectorAll('button[data-action="mode"]').forEach(e=>{e.getAttribute("data-mode")===a.mode?e.classList.add("active"):e.classList.remove("active")})}function _t(t){const e=D();let n="";if(t==="text"?n=e?"Select text, then tap Add note.":"Select text then release to add a note.":t==="element"&&(n=e?"Tap an element to preview it, then pin it.":"Hover an element, click to annotate."),!n)return G();a.tip.textContent=n,a.tip.classList.add("show"),H(),requestAnimationFrame(H),requestAnimationFrame(H)}function G(){a.tip.classList.remove("show")}function mo(){if(a.toast)return a.toast;const t=document.createElement("div");return t.className="wn-annot-toast wn-annotator",t.setAttribute("aria-live","polite"),document.body.appendChild(t),a.toast=t,t}function P(t){if(!t)return;const e=mo();e.textContent=t,e.classList.add("show"),a.toastTimer&&clearTimeout(a.toastTimer),a.toastTimer=setTimeout(()=>{e.classList.remove("show")},2200)}function fo(){try{const t=localStorage.getItem(ke);if(t==="top"||t==="bottom")return t}catch(t){}return null}function wo(){try{const t=localStorage.getItem(Te);return t==null?null:t==="true"}catch(t){return null}}function go(t){try{localStorage.setItem(Te,t?"true":"false")}catch(e){}}function Be(){const t=!!(Ft&&Ft.matches),e=J==="dark"||J==="auto"&&t||J==="reverse-auto"&&!t;document.documentElement.setAttribute("data-wn-theme",e?"dark":"light")}function xo(){if(!document||!document.documentElement)return;const t=document.documentElement,e=a.colors||Ht,n=(i,s)=>{s&&t.style.setProperty(i,s)},o=e.text,r=e.element;n("--wn-text-highlight",o.base),n("--wn-text-highlight-overlay",o.overlay),n("--wn-text-highlight-soft",o.soft),n("--wn-element-highlight",r.base),n("--wn-element-highlight-soft",r.soft),n("--wn-element-highlight-soft-end",r.softer),n("--wn-element-highlight-strong",r.strong),n("--wn-element-highlight-shadow",r.shadow),n("--wn-marker-text",r.text)}function Wt(t,e={}){var s,l,c;const n=bt(t,"#000000"),o=(s=e.softAlpha)!=null?s:.12,r=(l=e.softerAlpha)!=null?l:.04,i=(c=e.overlayAlpha)!=null?c:.7;return{base:n,overlay:Q(n,i,Q("#000000",i)),soft:Q(n,o,Q("#000000",o)),softer:Q(n,r,Q("#000000",r)),strong:Q(n,.9,n),shadow:Q(n,.24,"rgba(0,0,0,0.24)"),pill:Q(n,.16,"rgba(0,0,0,0.16)"),pillBorder:Q(n,.28,"rgba(0,0,0,0.28)"),text:bo(n)}}function bt(t,e){const n=Jt(t);return n||Jt(e)||"#000000"}function Jt(t){if(!t||typeof t!="string")return null;const n=t.trim().match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i);if(!n)return null;const o=n[1];return`#${(o.length===3?o.split("").map(i=>i+i).join(""):o).toLowerCase()}`}function Ue(t){const e=Jt(t);if(!e)return null;const n=parseInt(e.slice(1),16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function Q(t,e=1,n=""){const o=Ue(t);if(!o)return n||"";const r=typeof e=="number"&&e>=0&&e<=1?e:1;return`rgba(${o.r}, ${o.g}, ${o.b}, ${r})`}function bo(t){const e=Ue(t);return e?.299*e.r+.587*e.g+.114*e.b>160?"#0b1622":"#ffffff":"#0b1622"}function B(t){const e=a.colors||Ht,n=t&&t.type;return n==="text"?e.text:n==="screenshot"?e.screenshot:e.element}function Fe(t,e){!t||!e||(t.style.setProperty("--wn-marker-bg",e.base),t.style.setProperty("--wn-marker-text",e.text),t.style.setProperty("--wn-marker-shadow",e.shadow))}function yo(t,e){!t||!e||(t.style.setProperty("--wn-item-accent",e.base),t.style.setProperty("--wn-item-accent-strong",e.strong),t.style.setProperty("--wn-item-accent-shadow",e.shadow),t.style.setProperty("--wn-item-accent-soft",e.soft),t.style.setProperty("--wn-item-accent-soft-end",e.softer),t.style.setProperty("--wn-item-number-bg",e.pill),t.style.setProperty("--wn-item-number-border",e.pillBorder))}function U(t,e=!1){if(t==null||t==="")return e;const n=String(t).toLowerCase();return n==="true"||n==="1"||n==="yes"||n==="on"?!0:n==="false"||n==="0"||n==="no"||n==="off"?!1:e}function vo(){try{const t=localStorage.getItem(Ee),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>n&&typeof n=="object").map(n=>({id:n.id||dn(),name:String(n.name||"Imported file"),size:Number(n.size||0),pageUrl:typeof n.pageUrl=="string"?n.pageUrl:"",importedAt:Number(n.importedAt||0)})):[]}catch(t){return[]}}function De(){try{localStorage.setItem(Ee,JSON.stringify(a.importFiles||[]))}catch(t){}}function H(){if(!a.tip||!a.toolbar)return;const t=a.toolbar.getBoundingClientRect(),e=a.tip,n=10,o=t.left+t.width/2,r=k==="bottom";e.style.left=`${o}px`,e.style.right="",e.style.transform="translateX(-50%)",e.style.top="",e.style.bottom="";const i=e.getBoundingClientRect();if(r){const s=Math.max(8,t.top-n-i.height);e.style.top=`${s}px`}else{const s=t.bottom+n;e.style.top=`${s}px`}}function Zt(t){return!!t&&(t.type==="text"||t.type==="element"||t.type==="screenshot")}function ko(){try{const t=localStorage.getItem(zt),e=t?JSON.parse(t):[];a.annotations=(e||[]).filter(Zt),a.annotations.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))})}catch(t){console.warn("Annotator storage error",t),a.annotations=[]}}function O(){yt(),b&&Nt()}function yt(){try{localStorage.setItem(zt,JSON.stringify(a.annotations)),b&&At()}catch(t){console.warn("Annotator storage save error",t),Cn()}}async function Co(t){const e=t.target.closest("button");if(!e||!e.classList.contains("wn-annotator"))return;const n=e.getAttribute("data-action");if(n){if(n==="mode"){const o=e.getAttribute("data-mode");if(o==="screenshot"){await Fa();return}V(o);return}if(n==="export"){Pe();return}if(n==="import"){eo();return}if(n==="mail"){await ua();return}if(n==="toggle-panel"){Eo();return}if(n==="toggle-pos"){Lo(k==="bottom"?"top":"bottom"),te();return}}}function Eo(){gt(a.panel.style.display==="none")}function To(){vt(!a.hidden)}function vt(t){a.hidden=t,go(t),document.body.classList.toggle("wn-annot-hidden",t),t&&(V(null),G(),it()),je(),$e(),tt(),nt(),j(),R(),t||(M(),et(),H()),document.dispatchEvent(new CustomEvent("uxnote:visibility",{detail:{hidden:t}}))}function je(){if(!a.visibilityToggle)return;const t=a.hidden?"Show Uxnote":"Hide Uxnote";a.visibilityToggle.classList.toggle("is-muted",a.hidden),a.visibilityToggle.innerHTML=a.hidden?ka():gn(),a.visibilityToggle.setAttribute("aria-label",t),a.visibilityToggle.setAttribute("aria-pressed",a.hidden?"true":"false"),a.visibilityToggle.setAttribute("data-tip",t)}function tt(){const t=a.visibilityToggle;if(!t)return;Xt();const e=18;if(I()){a.hidden?(t.style.bottom=`max(${e}px, env(safe-area-inset-bottom))`,t.style.left=`max(${e}px, env(safe-area-inset-left))`,t.style.top="",t.style.right=""):(t.style.top="",t.style.right="",t.style.bottom="",t.style.left="");return}t.style.left="",t.style.right="",k==="top"?(t.style.top=`${e}px`,t.style.bottom=""):(t.style.bottom=`${e}px`,t.style.top="")}function Gt(){if(!a.panel||!a.toolbar)return;const t=a.toolbar.querySelector('button[data-action="toggle-panel"]');if(!t)return;const e=a.panel.style.display==="none";t.classList.toggle("active",!e)}function et(){if(!a.panel||!a.toolbar)return;const t=a.panel,e=18,n=a.toolbar.getBoundingClientRect();if(I()){t.style.width="",t.style.height="",t.style.maxHeight="",t.style.left="",t.style.right="",t.style.top="",t.style.bottom="",t.style.borderRadius="",t.style.paddingTop="",t.style.paddingBottom="",j();return}t.style.width=`min(360px, calc(100% - ${e*2}px))`,t.style.maxHeight=`calc(100vh - ${e*2}px)`,t.style.maxHeight=`calc(100dvh - ${e*2}px)`,t.style.left="auto",t.style.right=`${e}px`,t.style.top=`${e}px`,t.style.bottom=`${e}px`,t.style.height="",t.style.borderRadius="",t.style.paddingTop="",t.style.paddingBottom="",k==="left"?(t.style.left=`${n.width+e}px`,t.style.right=`${e}px`):k==="right"&&(t.style.right=`${n.width+e}px`,t.style.left=`${e}px`)}function Lo(t){k=t==="top"?"top":"bottom";const e=a.toolbar;e&&(e.classList.remove("wn-pos-top","wn-pos-bottom","wn-pos-left","wn-pos-right"),e.classList.add(`wn-pos-${k}`));try{localStorage.setItem(ke,k)}catch(n){}te(),tt(),H(),Z(),et(),nt(),j()}function te(){if(!a.toolbar)return;const t=a.toolbar.querySelector('button[data-action="toggle-pos"]');t&&(t.innerHTML=k==="top"?fn():wn())}function nt(){if(!a.toolbar||a.customPosition||!(ft==="push"||ft==="dock"||ft==="pad"||ft==="true"))return;const t=document.body;a.basePadding||Qe();const e=a.basePadding;if(a.hidden){t.style.paddingTop=`${e.top}px`,t.style.paddingRight=`${e.right}px`,t.style.paddingBottom=`${e.bottom}px`,t.style.paddingLeft=`${e.left}px`;return}const n=a.toolbar.getBoundingClientRect(),o=xe({},e);k==="top"?o.top=e.top+n.height:k==="bottom"?o.bottom=e.bottom+n.height:k==="left"?o.left=e.left+n.width:k==="right"&&(o.right=e.right+n.width),t.style.paddingTop=`${o.top}px`,t.style.paddingRight=`${o.right}px`,t.style.paddingBottom=`${o.bottom}px`,t.style.paddingLeft=`${o.left}px`}function Ve(t){return F(t.commonAncestorContainer)&&F(t.startContainer)&&F(t.endContainer)}async function ee(){if(a.mode!=="text"||D())return;const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return;const e=t.getRangeAt(0);if(!e)return;if(!Ve(e)){t.removeAllRanges(),P("This area is a popup or overlay. It cannot be annotated.");return}const n=t.toString().trim();n&&await Ke(e,n)}async function Ke(t,e){const n=await Yt("Comment for this highlight?");if(!n)return;const{comment:o}=n,r=Et(),i=Do(t,e),s=kt(t,r),l=window.getSelection();l&&l.removeAllRanges();const c={id:r,type:"text",target:i,comment:o.trim(),snippet:e.slice(0,180),pageUrl:window.location.href,pageKey:L(window.location.href),createdAt:Date.now(),status:"active"};a.annotations.push(c),O(),X(c,s),T(),V(null,{keepOutline:!0})}function So(t){if(a.mode!=="element")return;const e=t.target;if(!e||!F(e)){it();return}Xe(e)}function Xe(t){const e=se(t);if(!e){it();return}Fo(e)}async function Ao(t){if(a.mode!=="element")return;const e=t.target;if(!ie(e)){if(!e||!F(e)){P("This area is a popup or overlay. It cannot be annotated.");return}if(t.preventDefault(),t.stopPropagation(),D()){Ro(e);return}await Ye(e)}}async function Ye(t){const e=await Yt("Comment for this element?");if(!e)return;const{comment:n}=e,o=Et(),r=ce(t),i=qo(t),s=t.getBoundingClientRect(),l={id:o,type:"element",target:{xpath:r,css:i,tag:t.tagName.toLowerCase()},comment:n.trim(),snippet:t.innerText?t.innerText.trim().slice(0,120):t.tagName,pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:s.x+window.scrollX,y:s.y+window.scrollY,w:s.width,h:s.height},createdAt:Date.now(),status:"active"};a.annotations.push(l),O(),X(l,t),en(t,o),T(),V(null,{keepOutline:!0})}const Qo=400;function ne(t){if(!t||!a.toolbar||!t.classList.contains("show"))return;const e=document.documentElement,n=a.toolbar.getBoundingClientRect(),o=8;if(k==="top"){t.style.top=`${Math.round(n.bottom+o)}px`,t.style.bottom="auto";return}t.style.top="auto",t.style.bottom=`${Math.round(e.clientHeight-n.top+o)}px`}function qe(){ne(a.selectionBar);const t=a.elementPicker;!t||!t.bar.classList.contains("show")||ae()}function _e(){const t=a.commentModal;return!!(t&&t.backdrop.classList.contains("show"))}function Mo(){const t=window.getSelection();if(!t||t.rangeCount===0||t.isCollapsed)return null;const e=t.getRangeAt(0);return!e||!e.toString().trim()||!Ve(e)?null:e}function No(){if(D()){if(a.selectionTimer&&clearTimeout(a.selectionTimer),a.selectionTimer=null,a.mode!=="text"||_e()){ot();return}a.selectionTimer=setTimeout($o,Qo)}}function $o(){if(a.selectionTimer=null,a.mode!=="text"||_e())return ot();const t=Mo();if(!t)return ot();a.selectionRange=t.cloneRange(),Po()}function Io(){if(a.selectionBar)return a.selectionBar;const t=document.createElement("div");t.className="wn-annot-actionbar wn-annot-selection-bar wn-annotator";const e=document.createElement("button");return e.type="button",e.className="primary wn-annotator",e.textContent="Add note",e.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),Oo()}),t.appendChild(e),document.body.appendChild(t),a.selectionBar=t,t}function Po(){const t=Io();G(),t.classList.add("show"),ne(t)}function ot(){a.selectionRange=null;const t=a.selectionBar;!t||!t.classList.contains("show")||(t.classList.remove("show"),a.mode&&!a.hidden&&_t(a.mode))}async function Oo(){const t=a.selectionRange;if(ot(),!t)return;if(!st(t.startContainer)||!st(t.endContainer)){P("That text is no longer on the page.");return}const e=t.toString().trim();e&&await Ke(t,e)}function Ho(t){if(!t||t.nodeType!==1)return"";const e=t.tagName.toLowerCase();if(t.id)return`${e}#${t.id}`;const n=Array.from(t.classList||[]).filter(o=>o&&!o.startsWith("wn-")&&!o.startsWith("uxnote-"));return n.length?`${e}.${n.slice(0,2).join(".")}`:e}function zo(){if(a.elementPicker)return a.elementPicker;const t=document.createElement("div");t.className="wn-annot-actionbar wn-annot-pick-bar wn-annotator";const e=document.createElement("span");e.className="wn-annot-pick-name wn-annotator";const n=(s,l,c)=>{const p=document.createElement("button");return p.type="button",p.className=`${l} wn-annotator`,p.textContent=s,p.addEventListener("click",u=>{u.preventDefault(),u.stopPropagation(),c()}),p},o=n("Wider","wn-annot-pick-wider",()=>Je(1)),r=n("Narrower","wn-annot-pick-narrower",()=>Je(-1)),i=n("Pin here","primary wn-annot-pick-pin",Bo);return t.appendChild(e),t.appendChild(r),t.appendChild(o),t.appendChild(i),document.body.appendChild(t),a.elementPicker={bar:t,name:e,wider:o,narrower:r,pin:i},a.elementPicker}function Ro(t){a.elementTrail=[t],a.elementTrailIndex=0;const e=zo();G(),e.bar.classList.add("show"),ae()}function oe(){return a.elementTrail[a.elementTrailIndex]||null}function We(){const t=oe();if(a.elementTrailIndex<a.elementTrail.length-1)return a.elementTrail[a.elementTrailIndex+1];if(!t||t===document.body)return null;const e=t.parentElement;return!e||!F(e)?null:e}function Je(t){if(t>0){const e=We();if(!e)return;a.elementTrailIndex===a.elementTrail.length-1&&a.elementTrail.push(e),a.elementTrailIndex+=1}else{if(a.elementTrailIndex===0)return;a.elementTrailIndex-=1}ae()}function ae(){const t=a.elementPicker,e=oe();!t||!e||(t.name.textContent=Ho(e),t.narrower.disabled=a.elementTrailIndex===0,t.wider.disabled=!We(),Xe(e),ne(t.bar))}function Ze(){a.elementTrail=[],a.elementTrailIndex=0;const t=a.elementPicker;!t||!t.bar.classList.contains("show")||(t.bar.classList.remove("show"),a.mode&&!a.hidden&&_t(a.mode))}async function Bo(){const t=oe();if(Ze(),!t||!st(t)){P("That element is no longer on the page.");return}await Ye(t)}function re(t){const e=t&&t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}}function at(t){const e=a.highlightSpans[t];return e?Array.isArray(e)?e:[e]:Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`))}function rt(){Object.keys(a.highlightSpans||{}).forEach(t=>{at(t).forEach(e=>{e&&e.parentNode&&re(e)})}),a.highlightSpans={},Array.from(document.querySelectorAll(".uxnote-textmark[data-uxnote-id], .wn-annot-highlight[data-wn-annot-id]")).forEach(t=>{t&&t.parentNode&&re(t)}),Object.values(a.markers||{}).forEach(t=>{t&&t.el&&t.el.parentNode&&t.el.parentNode.removeChild(t.el)}),a.markerLayer&&(a.markerLayer.innerHTML=""),a.markers={},Object.keys(a.elementTargets||{}).forEach(t=>{nn(t)}),a.elementTargets={},Array.from(document.querySelectorAll(".uxnote-annotated[data-uxnote-ids]")).forEach(t=>{delete t.dataset.uxnoteIds,t.classList.remove("uxnote-annotated")})}function Uo(t){const e=a.markers[t];e&&e.el&&e.el.parentNode&&e.el.parentNode.removeChild(e.el),e&&e.frame&&e.frame.parentNode&&e.frame.parentNode.removeChild(e.frame),delete a.markers[t],nn(t);let n=at(t);n.length||(n=Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)),n.length||(n=Array.from(document.querySelectorAll(`.wn-annot-highlight[data-wn-annot-id="${t}"]`)))),n.forEach(o=>{o&&re(o)}),delete a.highlightSpans[t]}function K(){Object.entries(a.markers).forEach(([t,e])=>{const n=a.annotations.findIndex(o=>o.id===t);n!==-1&&(e.el.textContent=n+1)})}function Fo(t){const e=a.outlineBox;e.style.display="block",e.style.left=`${t.x+window.scrollX}px`,e.style.top=`${t.y+window.scrollY}px`,e.style.width=`${t.width}px`,e.style.height=`${t.height}px`}function it(){a.outlineBox.style.display="none"}function ie(t){return t?t.classList&&t.classList.contains("wn-annotator")||t.parentElement&&ie(t.parentElement):!1}function F(t){if(!t)return!1;const e=t.nodeType===Node.ELEMENT_NODE?t:t.nodeType===Node.DOCUMENT_NODE?document.body:t.parentElement;if(!e||ie(e))return!1;if(e.closest){if(e.closest("[data-uxnote-ignore]"))return!1;if(e.closest("[data-uxnote-allow]"))return!0;if(e.closest('#uxnote-root, .wn-annotator, dialog, [popover], [role="dialog"], [role="menu"], [role="tooltip"], [aria-modal="true"]'))return!1}return!0}function Do(t,e){return{startXPath:ce(t.startContainer),startOffset:t.startOffset,endXPath:ce(t.endContainer),endOffset:t.endOffset,quote:e?String(e).slice(0,200):""}}function kt(t,e){let n=[];const o=t.cloneRange();if(jo(o).forEach(i=>{const s=Vo(i,{start:i===o.startContainer?o.startOffset:0,end:i===o.endContainer?o.endOffset:i.length},e);s&&n.push(s)}),!n.length){const i=document.createElement("span");i.className="uxnote-textmark",i.dataset.uxnoteId=e,i.addEventListener("click",l=>{l.stopPropagation(),pt(e)});const s=o.extractContents();i.appendChild(s),o.insertNode(i),n=[i]}return a.highlightSpans[e]=n,n[0]}function Ja(t,e){return kt(t,e)}function Ge(t,e){const n=document.createRange();return n.selectNodeContents(e),t.compareBoundaryPoints(Range.END_TO_START,n)>0&&t.compareBoundaryPoints(Range.START_TO_END,n)<0}function jo(t){const e=[],n=document.createTreeWalker(t.commonAncestorContainer,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();)if(!(!o.nodeValue||!o.nodeValue.trim())){try{if(t.intersectsNode){if(!t.intersectsNode(o))continue}else if(!Ge(t,o))continue}catch(r){if(!Ge(t,o))continue}e.push(o)}return e}function Vo(t,e,n){if(!t||!t.parentNode)return null;const{start:o,end:r}=e;let i=t,s=r;if(o>0&&(i=i.splitText(o),s=r-o),s<i.length&&i.splitText(s),!i.parentNode)return null;const l=document.createElement("span");return l.className="uxnote-textmark",l.dataset.uxnoteId=n,l.addEventListener("click",c=>{c.stopPropagation(),pt(n)}),i.parentNode.insertBefore(l,i),l.appendChild(i),l}function st(t){return t?typeof t.isConnected=="boolean"?t.isConnected:document.body&&document.body.contains(t):!1}function Ko(t,e){if(!t||!e)return null;const n=Math.max(t.x,e.x),o=Math.max(t.y,e.y),r=Math.min(t.x+t.width,e.x+e.width),i=Math.min(t.y+t.height,e.y+e.height),s=r-n,l=i-o;return s<=0||l<=0?null:{x:n,y:o,width:s,height:l}}function se(t){if(!t||!st(t)||!t.getBoundingClientRect)return null;let e=t.getBoundingClientRect();if(!e.width||!e.height)return null;let n=t;for(;n&&n.nodeType===1;){if(n.tagName==="DETAILS"&&!n.open){const p=n.querySelector("summary");if(p&&!p.contains(t))return null}if(n.hasAttribute&&n.hasAttribute("hidden")||(n.getAttribute&&n.getAttribute("aria-hidden"))==="true")return null;const r=window.getComputedStyle(n);if(r.display==="none"||r.visibility==="hidden"||r.visibility==="collapse"||r.opacity==="0")return null;const i=r.overflowX||r.overflow,s=r.overflowY||r.overflow;if(i&&i!=="visible"||s&&s!=="visible"){const p=n.getBoundingClientRect(),u=Ko(e,p);if(!u)return null;e=u}n=n.parentElement}return e}function Xo(t){let e=t&&t.nodeType===1?t:null;for(;e&&e.nodeType===1&&e!==document.body;){const n=window.getComputedStyle(e),o=n.zIndex;if(n.position!=="static"&&o!=="auto"||n.opacity!=="1"||n.transform!=="none"||n.filter!=="none"||n.perspective!=="none"||n.mixBlendMode!=="normal"||n.isolation==="isolate"||n.willChange&&n.willChange!=="auto"||n.contain&&n.contain!=="none")return e;e=e.parentElement}return document.body}function tn(t){if(!t||t.nodeType!==1)return a.markerLayer||document.body;const e=t.offsetParent;return e&&e.nodeType===1?e:Xo(t)||a.markerLayer||document.body}function le(t){return t===document.body||t===a.markerLayer||t===document.documentElement}function Yo(t){if(!t||t.nodeType!==1)return!1;let e=!1,n=t;for(;n&&n.nodeType===1&&n!==document.body;){if(n.tagName==="DETAILS"&&!n.open&&(n.open=!0,e=!0),n.tagName==="DIALOG"&&!n.open)try{typeof n.showModal=="function"?n.showModal():typeof n.show=="function"&&n.show(),e=!0}catch(r){}if(n.hasAttribute&&n.hasAttribute("popover"))try{typeof n.showPopover=="function"&&(n.showPopover(),e=!0)}catch(r){}if(n.hasAttribute&&n.hasAttribute("data-uxnote-open")){const r=n.getAttribute("data-uxnote-open");if(r){const i=document.querySelector(r);i&&typeof i.click=="function"&&(i.click(),e=!0)}}const o=n.getAttribute&&n.getAttribute("aria-hidden");if(n.hasAttribute&&n.hasAttribute("hidden")||o==="true"){const r=n.id;if(r){const i=document.querySelector(`[aria-controls="${Ct(r)}"]`);i&&typeof i.click=="function"&&(i.click(),e=!0)}}n=n.parentElement}return e}function en(t,e){if(!t||t.nodeType!==1)return!1;const n=t.dataset.uxnoteIds?t.dataset.uxnoteIds.split(",").filter(Boolean):[],o=new Set(n);return o.add(e),t.dataset.uxnoteIds=Array.from(o).join(","),t.classList.add("uxnote-annotated"),a.elementTargets[e]=t,!0}function nn(t){const e=a.elementTargets[t];if(!e||e.nodeType!==1){delete a.elementTargets[t],Array.from(document.querySelectorAll("[data-uxnote-ids]")).forEach(i=>{const s=i.dataset.uxnoteIds?i.dataset.uxnoteIds.split(",").filter(Boolean):[];if(!s.includes(t))return;const l=s.filter(c=>c!==t);l.length?i.dataset.uxnoteIds=l.join(","):(delete i.dataset.uxnoteIds,i.classList.remove("uxnote-annotated"))});return}const o=(e.dataset.uxnoteIds?e.dataset.uxnoteIds.split(",").filter(Boolean):[]).filter(r=>r!==t);o.length?e.dataset.uxnoteIds=o.join(","):(delete e.dataset.uxnoteIds,e.classList.remove("uxnote-annotated")),delete a.elementTargets[t]}function ce(t){if(t===document.body)return"/html/body";const e=[];for(;t&&t!==document;){let n=1,o=t.previousSibling;for(;o;)o.nodeType===t.nodeType&&o.nodeName===t.nodeName&&n++,o=o.previousSibling;const r=t.nodeType===3?"text()":t.nodeName.toLowerCase();if(e.unshift(`${r}[${n}]`),t=t.parentNode,!t||t.nodeType!==1)break}return"/"+e.join("/")}function Ct(t){return window.CSS&&typeof window.CSS.escape=="function"?window.CSS.escape(t):String(t).replace(/[^a-zA-Z0-9_-]/g,"\\$&")}function qo(t){if(!t||t.nodeType!==1)return"";if(t.id)return`#${Ct(t.id)}`;const e=[];let n=t,o=0;for(;n&&n.nodeType===1&&o<4;){let r=n.tagName.toLowerCase();const i=Array.from(n.classList||[]).filter(s=>s&&!s.startsWith("wn-")&&!s.startsWith("uxnote-"));if(i.length&&(r+=`.${i.slice(0,2).map(Ct).join(".")}`),e.unshift(r),n.parentElement&&n.parentElement.id){e.unshift(`#${Ct(n.parentElement.id)}`);break}n=n.parentElement,o+=1}return e.join(" > ")}function lt(t){try{const e=document;return e.evaluate(t,e,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue}catch(e){return null}}function ct(){a.annotations.forEach(t=>{t.pageKey===L(window.location.href)&&_o(t)}),T()}function _o(t){const e=dt(t);if(!e){t.status="missing",on();return}t.status="active",de(t,e)}function de(t,e){if(e){if(e.type==="screenshot"){X(t,null);return}if(e.type==="text"&&e.range){const n=kt(e.range,t.id);X(t,n);return}e.type==="element"&&e.el&&(en(e.el,t.id),X(t,e.el))}}function Wo(t){if(!t)return null;const e=lt(t.startXPath),n=lt(t.endXPath);if(!e||!n)return null;try{const o=document.createRange();return o.setStart(e,t.startOffset),o.setEnd(n,t.endOffset),o}catch(o){return null}}function dt(t){return t?t.type==="screenshot"?t.rect?{type:"screenshot"}:null:t.target?t.type==="text"?Jo(t):t.type==="element"?Go(t):null:null:null}function Jo(t){const e=t.target||{},n=Wo(e);if(n)return{type:"text",range:n};const o=e.quote||t.snippet||"";if(!o)return null;const r=Zo(o);return r?{type:"text",range:r}:null}function Zo(t){const e=String(t||"").trim();if(!e||e.length<4)return null;const n=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let o;for(;o=n.nextNode();){if(!o.nodeValue||!o.nodeValue.trim()||!F(o))continue;const r=o.nodeValue.indexOf(e);if(r===-1)continue;const i=document.createRange();return i.setStart(o,r),i.setEnd(o,r+e.length),i}return null}function Go(t){const e=t.target||{};if(e.xpath){const r=lt(e.xpath);if(r&&r.nodeType===1)return{type:"element",el:r}}if(e.css)try{const r=document.querySelector(e.css);if(r&&r.nodeType===1)return{type:"element",el:r}}catch(r){}const n=e.tag,o=(t.snippet||"").trim();if(n&&o){const r=document.querySelectorAll(n);for(const i of r)if(!(!i||i.nodeType!==1)&&(i.textContent||"").includes(o))return{type:"element",el:i}}return null}function ta(){a.missingRetryTimer&&clearTimeout(a.missingRetryTimer),a.missingRetryTimer=setTimeout(()=>{pe()},300)}function on(){a.missingObserver||!window.MutationObserver||(a.missingObserver=new MutationObserver(()=>{a.annotations.some(t=>t.status==="missing")&&ta()}),a.missingObserver.observe(document.body,{childList:!0,subtree:!0}))}function ea(){a.missingObserver&&(a.missingObserver.disconnect(),a.missingObserver=null)}function pe(){let t=!1;a.annotations.forEach(e=>{if(e.status!=="missing"||e.pageKey!==L(window.location.href))return;const n=dt(e);n&&(e.status="active",de(e,n),t=!0)}),t&&(O(),T(),M()),a.annotations.some(e=>e.status==="missing")||ea()}function na(){let t=!1;a.annotations.forEach(e=>{if(e.type!=="text"||e.pageKey!==L(window.location.href))return;const n=at(e.id).filter(st);if(n.length){a.highlightSpans[e.id]=n,e.status==="missing"&&(e.status="active",t=!0);return}const o=dt(e);if(o&&o.range){kt(o.range,e.id),e.status="active",t=!0;return}e.status!=="missing"&&(e.status="missing",t=!0)}),t&&(O(),T(),M())}function oa(){a.layoutTimer&&clearTimeout(a.layoutTimer),a.layoutTimer=setTimeout(()=>{M(),na(),a.annotations.some(t=>t.status==="missing")&&pe()},120)}function aa(){a.layoutObserver||!window.MutationObserver||(a.layoutObserver=new MutationObserver(t=>{t.some(n=>{const o=n.target;return!(!o||o.classList&&o.classList.contains("wn-annotator")||o.closest&&o.closest(".wn-annotator"))})&&oa()}),a.layoutObserver.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["style","class","open","hidden","aria-hidden"]}))}function X(t,e){if(t.pageKey!==L(window.location.href)||!a.markerLayer)return;const n=a.markers[t.id];n&&n.el&&n.el.parentNode&&n.el.parentNode.removeChild(n.el);const o=document.createElement("div");o.className="wn-annot-marker wn-annotator",o.textContent=a.annotations.findIndex(c=>c.id===t.id)+1,o.dataset.wnAnnotId=t.id;const r=B(t);Fe(o,r),o.addEventListener("click",()=>pt(t.id));const i=rn(t,e),s=an(t,i),l=tn(i&&i.anchor?i.anchor:e);if(o.parentNode!==l&&l.appendChild(o),o.style.zIndex=le(l)?"":"9999",!i){o.style.display="none",a.markers[t.id]={el:o,rect:null,frame:s};return}o.style.display="",sn(o,i,t),a.markers[t.id]={el:o,rect:i,frame:s}}function an(t,e){const n=a.markers[t.id];let o=n?n.frame:null;if(t.type!=="screenshot"||!e)return o&&o.parentNode&&o.parentNode.removeChild(o),null;o||(o=document.createElement("div"),o.className="wn-annot-shot-frame wn-annotator");const r=a.markerLayer||document.body;return o.parentNode!==r&&r.appendChild(o),o.style.setProperty("--wn-shot-frame",B(t).base),o.style.left=`${e.x}px`,o.style.top=`${e.y}px`,o.style.width=`${e.w}px`,o.style.height=`${e.h}px`,o}function rn(t,e){var n;if(t.type==="text"){const r=(e?[e]:at(t.id))[0]||document.querySelector(`.uxnote-textmark[data-uxnote-id="${t.id}"]`);if(!r)return null;const i=se(r);return i?{x:i.x,y:i.y,w:i.width,h:i.height,anchor:r}:null}if(t.type==="element"){const o=(e&&e.nodeType===1?e:null)||a.elementTargets[t.id]||((n=t.target)!=null&&n.xpath?lt(t.target.xpath):null);if(!o)return null;const r=se(o);return r?{x:r.x,y:r.y,w:r.width,h:r.height,anchor:o}:null}if(t.type==="screenshot"){const o=t.rect;return o?{x:o.x-window.scrollX,y:o.y-window.scrollY,w:o.w,h:o.h,anchor:null}:null}return null}function sn(t,e,n){const o=ra(n),r=t.offsetParent||document.body,i=r.getBoundingClientRect(),s=i.x+window.scrollX,l=i.y+window.scrollY,c=e.x+window.scrollX,p=e.y+window.scrollY,u=c-s+e.w+o.x+4,h=le(r)?document.documentElement.clientWidth:r.clientWidth,m=(t.offsetWidth||25)/2;t.style.left=`${h?Math.min(u,h-m-2):u}px`,t.style.top=`${p-l+o.y-4}px`}function ra(t){if(t.type!=="element")return{x:0,y:0};const e=t.target&&t.target.xpath;if(!e)return{x:0,y:0};const n=a.annotations.filter(i=>i.type==="element"&&i.pageKey===t.pageKey&&i.target&&i.target.xpath===e);if(n.length<=1)return{x:0,y:0};const o=n.findIndex(i=>i.id===t.id);return o<=0?{x:0,y:0}:{x:-o*24,y:0}}function M(){Object.entries(a.markers).forEach(([t,e])=>{const n=a.annotations.find(i=>i.id===t);if(!n)return;const o=n.status==="missing"?null:rn(n);if(e.frame=an(n,o),!o){e.el.style.display="none",e.rect=null;return}e.el.style.display="",e.rect=o;const r=tn(o.anchor);e.el.parentNode!==r&&r.appendChild(e.el),e.el.style.zIndex=le(r)?"":"9999",sn(e.el,o,n),Fe(e.el,B(n))})}function ia(){a.panel&&a.panel.style.display==="none"&&gt(!0)}function sa(t){if(!a.panel)return;ia();const e=a.panel.querySelector(".wn-annot-list");if(!e)return;e.querySelectorAll(".wn-annot-item").forEach(r=>r.classList.remove("is-focused"));const o=e.querySelector(`.wn-annot-item[data-id="${t}"]`);o&&(o.classList.add("is-focused"),o.scrollIntoView({behavior:"smooth",block:"nearest"}))}function pt(t,e=!1,n,o){var l;const r=a.annotations.find(c=>c.id===t);if(!r)return;if(sa(t),r.status==="missing"){const c=dt(r);if(c)r.status="active",de(r,c),T();else{P("This annotation is not on this page.");return}}const i=dt(r);if(i){const c=i.type==="element"?i.el:i.range&&i.range.commonAncestorContainer?i.range.commonAncestorContainer.parentElement:null;c&&Yo(c)&&setTimeout(()=>{M()},160)}if(!((o||r.pageKey)===L(window.location.href))&&e){try{localStorage.setItem(Rt,JSON.stringify({id:r.id,pageKey:r.pageKey,pageUrl:n||r.pageUrl}))}catch(c){}window.location.href=n||r.pageUrl||window.location.href;return}if(r.type==="text"){const p=(at(t)||Array.from(document.querySelectorAll(`.uxnote-textmark[data-uxnote-id="${t}"]`)))[0];p&&(p.scrollIntoView({behavior:"smooth",block:"center"}),ue(p,B(r).base))}else if(r.type==="element"){const c=i&&i.el?i.el:(l=r.target)!=null&&l.xpath?lt(r.target.xpath):null;c&&c.scrollIntoView&&(c.scrollIntoView({behavior:"smooth",block:"center"}),ue(c,B(r).base))}else if(r.type==="screenshot"&&r.rect){window.scrollTo({top:Math.max(0,r.rect.y+r.rect.h/2-window.innerHeight/2),behavior:"smooth"});const c=a.markers[r.id];c&&c.frame&&ue(c.frame,B(r).base)}}function ue(t,e){var i,s;t.style.transition="box-shadow 0.2s ease";const n=t.style.boxShadow,o=e||((s=(i=a.colors)==null?void 0:i.element)==null?void 0:s.base)||"#4e9cf6",r=Q(o,.6,"rgba(78,156,246,0.6)");t.style.boxShadow=`0 0 0 3px ${r}`,setTimeout(()=>{t.style.boxShadow=n},800)}function ln(){if(!a.panel)return null;let t=a.panel.querySelector(".wn-annot-footer");if(!t){t=document.createElement("div"),t.className="wn-annot-footer wn-annotator";const e=document.createElement("a");e.href="https://github.com/Qu4tro/uxnote-fork",e.target="_blank",e.rel="noreferrer noopener",e.textContent="uxnote-fork on GitHub",t.appendChild(e),a.panel.appendChild(t)}return t}function T(){const t=a.panel.querySelector(".wn-annot-list"),e=a.panel.querySelector("h3");if(t.innerHTML="",!a.annotations.length){const o=document.createElement("div");o.className="wn-annot-empty",o.textContent="No annotations yet.",t.appendChild(o),e&&(e.textContent="Annotations (0)");const r=ln();return}const n=a.annotations.slice().sort((o,r)=>o.createdAt-r.createdAt).filter(o=>{const r=a.filters.query,i=`${o.comment||""} ${o.snippet||""}`.toLowerCase();return!r||i.includes(r)});e&&(e.textContent=`Annotations (${n.length})`),n.forEach((o,r)=>{const i=document.createElement("div");i.className="wn-annot-item",i.dataset.id=o.id,yo(i,B(o));const s=document.createElement("div");s.className="wn-annot-card-top";const l=document.createElement("div");l.className="wn-annot-card-top-left";const c=document.createElement("div");if(c.className="wn-annot-number",c.textContent=`#${r+1}`,l.appendChild(c),o.status==="missing"){const g=document.createElement("div");g.className="wn-annot-missing",g.textContent="Missing",l.appendChild(g)}const p=document.createElement("div");p.className="wn-annot-card-top-right";const u=document.createElement("button");u.type="button",u.className="wn-annot-edit wn-annotator",u.setAttribute("aria-label","Edit this annotation"),u.innerHTML=ba(),u.addEventListener("click",async g=>{g.stopPropagation(),await ca(o.id)}),p.appendChild(u);const h=document.createElement("button");h.type="button",h.className="wn-annot-delete wn-annotator",h.setAttribute("aria-label","Delete this annotation"),h.innerHTML=hn(),h.addEventListener("click",g=>{g.stopPropagation(),la(o.id)}),p.appendChild(h),s.appendChild(l),s.appendChild(p);const m=document.createElement("div");m.className="wn-annot-comment";const y=o.comment||"\u2014";m.textContent=y;const S=document.createElement("div");S.className="wn-annot-meta";const f=new Date(o.createdAt),x=f.toLocaleDateString(void 0,{year:"numeric",month:"2-digit",day:"2-digit"}),E=f.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});S.textContent=`${x} \u2022 ${E}`,l.appendChild(S);const $=document.createElement("button");$.type="button",$.className="wn-annot-showmore wn-annotator",$.textContent="See more",$.addEventListener("click",g=>{g.stopPropagation();const v=m.classList.toggle("expanded");$.textContent=v?"See less":"See more"}),y.length<160&&($.style.display="none"),i.appendChild(s),i.appendChild(m);const mt=Da(o);if(mt){const g=document.createElement("div");g.className="wn-annot-shot";const v=document.createElement("img");v.src=mt,v.alt="The screenshot of this annotation",v.addEventListener("click",It=>{It.stopPropagation(),ja(mt)}),g.appendChild(v),i.appendChild(g)}i.appendChild($),i.addEventListener("click",()=>{pt(o.id,!0,o.pageUrl,o.pageKey),I()&&gt(!1)}),t.appendChild(i)}),ln()}function la(t){const e=a.annotations.findIndex(n=>n.id===t);e!==-1&&(a.annotations.splice(e,1),O(),Uo(t),T(),K(),M())}async function ca(t){const e=a.annotations.find(r=>r.id===t);if(!e)return;const n=await Ie("Edit this annotation",e.comment||"");if(!n)return;const{comment:o}=n;e.comment=o.trim(),O(),T()}async function da(){!a.annotations.length||!await po("Delete all annotations?","Delete")||(a.annotations=[],yt(),b&&Ia(),rt(),T(),K())}function cn(){const t=he(),e=new Blob([JSON.stringify(t,null,2)],{type:"application/json"}),n=URL.createObjectURL(e),o=document.createElement("a");o.href=n,o.download=me(),o.click(),URL.revokeObjectURL(n)}async function pa(){const t=me(),e=JSON.stringify(he(),null,2);if(navigator.share&&navigator.canShare&&typeof File=="function"){const n=new File([e],t,{type:"application/json"});try{if(navigator.canShare({files:[n]})){await navigator.share({files:[n],title:t});return}}catch(o){if(o&&o.name==="AbortError")return}}cn()}function he(t=a.annotations){return{pageUrl:window.location.href,createdAt:Date.now(),annotations:t}}async function ua(){ha(a.annotations)}function ha(t){const e=he(t),n=JSON.stringify(e,null,2),o=encodeURIComponent(me()),r=encodeURIComponent(n),i=(zn||"").trim(),s=i?encodeURIComponent(i):"",l="?";window.location.href=`mailto:${s}${l}subject=${o}&body=${r}`}function Et(){if(typeof crypto.randomUUID=="function")return crypto.randomUUID();const t=crypto.getRandomValues(new Uint8Array(16));t[6]=t[6]&15|64,t[8]=t[8]&63|128;const e=Array.from(t,n=>n.toString(16).padStart(2,"0")).join("");return`${e.slice(0,8)}-${e.slice(8,12)}-${e.slice(12,16)}-${e.slice(16,20)}-${e.slice(20)}`}function dn(){return"imp-"+Math.random().toString(36).slice(2,8)+Date.now().toString(36)}function me(){const t=new Date,e=l=>String(l).padStart(2,"0"),n=`${e(t.getDate())}-${e(t.getMonth()+1)}-${t.getFullYear()}`,o=`${e(t.getHours())}-${e(t.getMinutes())}`,r=(document.title||"").trim(),i=l=>l.toLowerCase().replace(/[^a-z0-9]+/gi,"-").replace(/^-+|-+$/g,"")||"annotations";let s;return r?s=`${i(r)}-annotations`:window.location&&window.location.hostname?s=`${i(window.location.hostname)}-annotations`:s="annotations",`${s}_${n}_${o}.json`}const N=t=>`
  ...
  `;function ma(){return`
    ...
    `)}function un(){return N(`
      ...
      <path d="M12 4l0 12" />
    `)}function wa(){return N(`
      <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-2" />
      <path d="M7 9l5 -5l5 5" />
      <path d="M12 4l0 12" />
    `)}function ga(){return N(`
    ...
    `)}function ba(){return pn()}function hn(){return`
    ...
    `)}function wn(){return N(`
      ...
      <path d="M12 14l0 -12" />
      <path d="M7 7l5 -5l5 5" />
    `)}function va(){return k==="top"?fn():wn()}function gn(){return`
      <svg class="wn-annot-icon" viewBox="0 0 24 24" aria-hidden="true">
        <path
    ...
    `}function L(t){try{const e=new URL(t,window.location.href);return`${e.origin}${e.pathname}`}catch(e){return`${window.location.origin}${window.location.pathname}`}}function fe(){try{const t=localStorage.getItem(Rt);if(!t)return;const e=JSON.parse(t);e.pageKey===L(window.location.href)&&pt(e.id,!1),localStorage.removeItem(Rt)}catch(t){}}let A=new Map,we=Promise.resolve(),Y=!1,xn=!1;const bn=3e5,yn=1e4,Ca=bn;let Tt=null,Lt=yn,St="/health";const Ea={pending:"Checking the server",ok:"Server connected",refused:"Server refused it: check the address or the key",unreachable:"Server unreachable: notes are held here until it answers"};function vn(){const t=a.syncDot;if(!t)return;const e=a.syncStatus||"pending",n=Ea[e];t.setAttribute("data-sync-status",e),t.setAttribute("data-tip",n),t.setAttribute("aria-label",n)}function ut(t){a.syncStatus!==t&&(a.syncStatus=t,vn())}async function q(t,e){let n;try{n=await fetch(t,e)}catch(o){throw ut("unreachable"),o}if(!n.ok){ut("refused");const o=new Error(`HTTP ${n.status}`);throw o.status=n.status,o}return ut("ok"),n}function ge(){return`${b.url}/annotations?site=${encodeURIComponent(C)}`}function kn(t){return`${b.url}/annotations/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function Ta(){return St?`${b.url}${St}`:ge()}function La(t){return`${b.url}/screenshots/${encodeURIComponent(t)}?site=${encodeURIComponent(C)}`}function _(t){const e=Object.assign({},t);return b.apiKey&&(e["X-Uxnote-Key"]=b.apiKey),e}function Sa(t){return new Map(t.map(e=>[e.id,ht(e)]))}function ht(t){const e=typeof t=="string"?t:JSON.stringify(t);let n=2166136261;for(let o=0;o<e.length;o+=1)n^=e.charCodeAt(o),n=Math.imul(n,16777619)>>>0;return`${e.length}:${n.toString(36)}`}function At(){try{localStorage.setItem(Ce,JSON.stringify(Array.from(A)))}catch(t){console.warn("Annotator storage save error",t),Cn()}}function Aa(){let t=null;try{t=localStorage.getItem(Ce);const e=t?JSON.parse(t):[];A=new Map(Array.isArray(e)?e:[])}catch(e){console.warn("Uxnote sync: the stored server snapshot is unreadable",e),A=new Map}return t!==null}function Qt(t,e){console.warn("Uxnote sync:",t,e),!Y&&(Y=!0,P(t))}function Cn(){xn||(xn=!0,P("Uxnote: this browser has no room left, so notes are not kept for a reload"))}function z(t){return we=we.then(t,t),we}async function Mt(){if(!b)return;let t;try{const n=await q(ge(),{headers:_({Accept:"application/json"})});try{t=await n.json()}catch(o){throw ut("refused"),o}}catch(n){Qt("Uxnote: could not read the annotations from the server",n),fe();return}const e=(t&&t.annotations||[]).filter(Zt);e.forEach(n=>{n.pageKey||(n.pageKey=L(n.pageUrl||window.location.href))}),Qa(e),Y=!1,yt(),rt(),ct(),K(),T(),Nt(),fe()}function Qa(t){const e=new Map(t.map(r=>[r.id,r])),n=[],o=new Set;a.annotations.forEach(r=>{const i=A.get(r.id);if(i===void 0||i!==ht(r)){n.push(r),o.add(r.id);return}const s=e.get(r.id);s&&(n.push(s),o.add(r.id))}),t.forEach(r=>{o.has(r.id)||n.push(r)}),a.annotations=n,A=Sa(t)}async function En(){try{const t=await q(Ta(),{headers:_({Accept:"application/json"})});try{await t.json()}catch(e){return ut("refused"),!1}return!0}catch(t){return St&&t.status===404?(St="",En()):!1}}async function Tn(t){Tt=null;const e=a.syncStatus==="ok";if(!await En()){Ln(Lt),Lt=Math.min(Lt*2,Ca);return}Lt=yn,Ln(bn),!t&&!e&&z(Mt)}function Ln(t){Tt&&clearTimeout(Tt),Tt=setTimeout(()=>z(()=>Tn(!1)),t)}function Ma(){b&&z(()=>Tn(!0))}function Nt(){if(!b)return;const t=new Map(a.annotations.map(e=>[e.id,JSON.stringify(e)]));t.forEach((e,n)=>{A.get(n)!==ht(e)&&z(()=>An(n,e))}),A.forEach((e,n)=>{t.has(n)||z(()=>Qn(n))})}async function Na(t){const e=t&&t.screenshot;if(!e||!e.dataUrl)return!1;const o=await(await fetch(e.dataUrl)).blob(),r=await In(o,t.id,{rethrow:!0});if(!r)throw new Error("the screenshot upload answered with no address");return t.screenshot={url:r.url,w:e.w,h:e.h,capturedAt:e.capturedAt},!0}function $a(){b&&(window.addEventListener("online",()=>Nt()),document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Sn()}),window.addEventListener("pagehide",Sn))}function Sn(){if(!b)return;const t=new Map(a.annotations.map(e=>[e.id,JSON.stringify(e)]));t.forEach((e,n)=>{A.get(n)!==ht(e)&&An(n,e,{keepalive:!0})}),A.forEach((e,n)=>{t.has(n)||Qn(n,{keepalive:!0})})}async function An(t,e,n={}){try{const o=a.annotations.find(i=>i.id===t),r=o&&o.screenshot&&o.screenshot.dataUrl;r&&(await Na(o),e=JSON.stringify(o)),await q(kn(t),{method:"PUT",headers:_({"Content-Type":"application/json"}),keepalive:!!n.keepalive,body:e}),A.set(t,ht(e)),Y=!1,r?yt():At()}catch(o){Qt("Uxnote: could not save this annotation on the server",o)}}async function Qn(t,e={}){try{await q(kn(t),{method:"DELETE",headers:_(),keepalive:!!e.keepalive}),A.delete(t),Y=!1,At()}catch(n){Qt("Uxnote: could not delete this annotation on the server",n)}}function Ia(){b&&z(async()=>{try{await q(ge(),{method:"DELETE",headers:_()}),A=new Map,Y=!1,At()}catch(t){Qt("Uxnote: could not delete the annotations on the server",t)}})}let $t=null,Mn=L(window.location.href);function Pa(){$t=null;const t=L(window.location.href);t!==Mn&&(Mn=t,rt(),ct(),K(),T(),z(Mt))}function Nn(){$t&&clearTimeout($t),$t=setTimeout(Pa,120)}function Oa(){["pushState","replaceState"].forEach(t=>{const e=history[t];typeof e=="function"&&(history[t]=function(...o){const r=e.apply(this,o);return Nn(),r})}),window.addEventListener("popstate",Nn)}function $n(){return!!(window.snapdom&&typeof window.snapdom.toCanvas=="function")}function Ha(){return new Promise(t=>{const e=document.createElement("div");e.className="wn-shot-overlay wn-annotator";const n=document.createElement("div");n.className="wn-shot-rect wn-annotator",e.appendChild(n);const o=document.createElement("div");o.className="wn-shot-hint wn-annotator";const r=document.createElement("span");r.textContent="Drag to frame a region. Escape stops.";const i=document.createElement("button");i.type="button",i.textContent="Cancel",o.appendChild(r),o.appendChild(i);const s=f=>{const x=!!f&&f.w>=4&&f.h>=4;n.style.display=x?"block":"none",x&&(n.style.left=`${f.x}px`,n.style.top=`${f.y}px`,n.style.width=`${f.w}px`,n.style.height=`${f.h}px`)};s(null);const l=f=>({x:Math.min(Math.max(f.clientX,0),document.documentElement.clientWidth),y:Math.min(Math.max(f.clientY,0),document.documentElement.clientHeight)}),c=(f,x)=>({x:Math.min(f.x,x.x),y:Math.min(f.y,x.y),w:Math.abs(x.x-f.x),h:Math.abs(x.y-f.y)});let p=null;const u=f=>{f.preventDefault(),p=l(f),s(null)},h=f=>{p&&(f.preventDefault(),s(c(p,l(f))))},m=f=>{if(!p)return;const x=c(p,l(f));if(p=null,x.w<4||x.h<4){s(null);return}y({x:x.x+window.scrollX,y:x.y+window.scrollY,w:x.w,h:x.h})},y=f=>{document.removeEventListener("keydown",S,!0),document.removeEventListener("mousemove",h,!0),document.removeEventListener("mouseup",m,!0),e.remove(),o.remove(),t(f)},S=f=>{f.key==="Escape"&&(f.preventDefault(),y(null))};e.addEventListener("mousedown",u),i.addEventListener("click",()=>y(null)),document.addEventListener("mousemove",h,!0),document.addEventListener("mouseup",m,!0),document.addEventListener("keydown",S,!0),document.body.appendChild(e),document.body.appendChild(o)})}async function za(t){const e=await window.snapdom.toCanvas(document.body,{scale:1,exclude:[".wn-annotator",".wn-annot-dimmer"],excludeMode:"remove"}),n=document.body.getBoundingClientRect(),o=n.width?e.width/n.width:1,r=n.left+window.scrollX,i=n.top+window.scrollY,s=Math.max(0,Math.round((t.x-r)*o)),l=Math.max(0,Math.round((t.y-i)*o)),c=Math.min(e.width-s,Math.max(1,Math.round(t.w*o))),p=Math.min(e.height-l,Math.max(1,Math.round(t.h*o)));if(c<1||p<1)return null;const u=document.createElement("canvas");return u.width=c,u.height=p,u.getContext("2d").drawImage(e,s,l,c,p,0,0,c,p),{canvas:u,w:c,h:p}}function Ra(){const t=document.documentElement;return{x:window.scrollX,y:window.scrollY,w:t.clientWidth,h:t.clientHeight}}const Ba=2e4;function Ua(t){const e=za(t).then(o=>({shot:o}),o=>(console.warn("Uxnote screenshot:",o),{shot:null})),n=new Promise(o=>{setTimeout(()=>o({shot:null,timedOut:!0}),Ba)});return Promise.race([e,n])}async function Fa(){if(!(!$n()||a.mode==="screenshot")){V("screenshot");try{const t=D()?Ra():await Ha();if(!t)return;const e=Ua(t),n=await Yt("Comment for this region?");if(!n)return;const{shot:o,timedOut:r}=await e;if(!o){P(r?"Uxnote: the page took too long to capture":"Uxnote: could not capture that region");return}const{comment:i}=n,s=Et();let l={dataUrl:o.canvas.toDataURL("image/png"),w:o.w,h:o.h,capturedAt:Date.now()};if(b){const p=await new Promise(h=>o.canvas.toBlob(h,"image/png")),u=p?await In(p,s):null;u?l={url:u.url,w:o.w,h:o.h,capturedAt:Date.now()}:P("Uxnote: the picture stays on this device until the server answers")}const c={id:s,type:"screenshot",comment:i.trim(),snippet:"",pageUrl:window.location.href,pageKey:L(window.location.href),rect:{x:t.x,y:t.y,w:t.w,h:t.h},screenshot:l,createdAt:Date.now(),status:"active"};a.annotations.push(c),O(),X(c,null),T()}finally{V(null)}}}async function In(t,e,n={}){try{const r=await(await q(La(e),{method:"PUT",headers:_({"Content-Type":"image/png"}),body:t})).json();return r&&r.url?r:null}catch(o){if(console.warn("Uxnote screenshot:",o),n.rethrow)throw o;return null}}function Da(t){const e=t&&t.screenshot;if(!e)return null;if(e.dataUrl)return e.dataUrl;if(!e.url)return null;try{const n=b?new URL(`${b.url}/`,window.location.href):window.location.href;return new URL(e.url,n).href}catch(n){return e.url}}function ja(t){const e=document.createElement("div");e.className="wn-shot-lightbox wn-annotator";const n=document.createElement("img");n.src=t,n.alt="The screenshot of this annotation",e.appendChild(n);const o=document.createElement("button");o.type="button",o.className="wn-shot-lightbox-close wn-annotator",o.setAttribute("aria-label","Close the screenshot"),o.innerHTML=mn(),e.appendChild(o);const r=()=>{document.removeEventListener("keydown",i,!0),e.remove()},i=s=>{s.key==="Escape"&&(s.preventDefault(),r())};o.addEventListener("click",r),e.addEventListener("click",r),document.addEventListener("keydown",i,!0),document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ae):Ae(),window.Uxnote={refresh:M,setHidden:t=>vt(!!t),toggleVisibility:()=>vt(!a.hidden),isHidden:()=>!!a.hidden,sync:{pull:Mt,push:Nt,url:()=>b?b.url:null}}})();})();
