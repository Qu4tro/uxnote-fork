...
```html
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.1.0/uxnote.min-v3.1.0.js"></script>
```

Two tags for the region screenshots, snapdom first:

```html
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.1.0/snapdom.min.js"></script>
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.1.0/uxnote.min-v3.1.0.js"></script>
```

Both files are assets of the `v3.1.0` release, and every release carries both.
...
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.1.0/uxnote.min-v3.1.0.js"
