...
```html
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.0.1/uxnote.min-v3.0.1.js"></script>
```

Two tags for the region screenshots, snapdom first:

```html
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.0.1/snapdom.min.js"></script>
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.0.1/uxnote.min-v3.0.1.js"></script>
```

Both files are assets of the `v3.0.1` release, and every release carries both.
...
<script src="https://github.com/Qu4tro/uxnote-fork/releases/download/v3.0.1/uxnote.min-v3.0.1.js"
